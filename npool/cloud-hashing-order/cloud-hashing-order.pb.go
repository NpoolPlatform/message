...
var file_npool_cloud_hashing_order_cloud_hashing_order_proto_rawDesc = []byte{
	...
	0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x68, 0x61, 0x73, 0x68, 0x69, 0x6e, 0x67, 0x2e, 0x6f, 0x72,
	0x64, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x2e, 0x4f, 0x75, 0x74, 0x4f, 0x66, 0x47, 0x61, 0x73, 0x52,
	0x05, 0x49, 0x6e, 0x66, 0x6f, 0x73, 0x22, 0xd7, 0x03, 0x0a, 0x07, 0x50, 0x61, 0x79, 0x6d, 0x65,
	...
	0x74, 0x61, 0x69, 0x6c, 0x52, 0x05, 0x49, 0x6e, 0x66, 0x6f, 0x73, 0x32, 0xd4, 0x22, 0x0a, 0x11,
...
var file_npool_cloud_hashing_order_cloud_hashing_order_proto_msgTypes = make([]protoimpl.MessageInfo, 61)
var file_npool_cloud_hashing_order_cloud_hashing_order_proto_goTypes = []interface{}{
	...
	(*GetPaymentByOrderRequest)(nil),              // 40: cloud.hashing.order.v1.GetPaymentByOrderRequest
	(*GetPaymentByOrderResponse)(nil),             // 41: cloud.hashing.order.v1.GetPaymentByOrderResponse
	(*GetPaymentsByStateRequest)(nil),             // 42: cloud.hashing.order.v1.GetPaymentsByStateRequest
	(*GetPaymentsByStateResponse)(nil),            // 43: cloud.hashing.order.v1.GetPaymentsByStateResponse
	(*GetPaymentsByAppRequest)(nil),               // 44: cloud.hashing.order.v1.GetPaymentsByAppRequest
	(*GetPaymentsByAppResponse)(nil),              // 45: cloud.hashing.order.v1.GetPaymentsByAppResponse
	(*GetPaymentsByAppUserRequest)(nil),           // 46: cloud.hashing.order.v1.GetPaymentsByAppUserRequest
	(*GetPaymentsByAppUserResponse)(nil),          // 47: cloud.hashing.order.v1.GetPaymentsByAppUserResponse
	(*GetPaymentsRequest)(nil),                    // 48: cloud.hashing.order.v1.GetPaymentsRequest
	(*GetPaymentsResponse)(nil),                   // 49: cloud.hashing.order.v1.GetPaymentsResponse
	(*OrderDetail)(nil),                           // 50: cloud.hashing.order.v1.OrderDetail
	(*GetOrderDetailRequest)(nil),                 // 51: cloud.hashing.order.v1.GetOrderDetailRequest
	(*GetOrderDetailResponse)(nil),                // 52: cloud.hashing.order.v1.GetOrderDetailResponse
	(*GetOrdersDetailByAppUserRequest)(nil),       // 53: cloud.hashing.order.v1.GetOrdersDetailByAppUserRequest
	(*GetOrdersDetailByAppUserResponse)(nil),      // 54: cloud.hashing.order.v1.GetOrdersDetailByAppUserResponse
	(*GetOrdersShortDetailByAppUserRequest)(nil),  // 55: cloud.hashing.order.v1.GetOrdersShortDetailByAppUserRequest
	(*GetOrdersShortDetailByAppUserResponse)(nil), // 56: cloud.hashing.order.v1.GetOrdersShortDetailByAppUserResponse
	(*GetOrdersDetailByAppRequest)(nil),           // 57: cloud.hashing.order.v1.GetOrdersDetailByAppRequest
	(*GetOrdersDetailByAppResponse)(nil),          // 58: cloud.hashing.order.v1.GetOrdersDetailByAppResponse
	(*GetOrdersDetailByGoodRequest)(nil),          // 59: cloud.hashing.order.v1.GetOrdersDetailByGoodRequest
	(*GetOrdersDetailByGoodResponse)(nil),         // 60: cloud.hashing.order.v1.GetOrdersDetailByGoodResponse
...
var file_npool_cloud_hashing_order_cloud_hashing_order_proto_depIdxs = []int32{
	...
	33, // 24: cloud.hashing.order.v1.GetPaymentByOrderResponse.Info:type_name -> cloud.hashing.order.v1.Payment
	33, // 25: cloud.hashing.order.v1.GetPaymentsByStateResponse.Infos:type_name -> cloud.hashing.order.v1.Payment
	33, // 26: cloud.hashing.order.v1.GetPaymentsByAppResponse.Infos:type_name -> cloud.hashing.order.v1.Payment
	33, // 27: cloud.hashing.order.v1.GetPaymentsByAppUserResponse.Infos:type_name -> cloud.hashing.order.v1.Payment
	33, // 28: cloud.hashing.order.v1.GetPaymentsResponse.Infos:type_name -> cloud.hashing.order.v1.Payment
	...
	23, // 32: cloud.hashing.order.v1.OrderDetail.Compensates:type_name -> cloud.hashing.order.v1.Compensate
	28, // 33: cloud.hashing.order.v1.OrderDetail.OutOfGases:type_name -> cloud.hashing.order.v1.OutOfGas
	33, // 34: cloud.hashing.order.v1.OrderDetail.Payment:type_name -> cloud.hashing.order.v1.Payment
	50, // 35: cloud.hashing.order.v1.GetOrderDetailResponse.Info:type_name -> cloud.hashing.order.v1.OrderDetail
	50, // 36: cloud.hashing.order.v1.GetOrdersDetailByAppUserResponse.Infos:type_name -> cloud.hashing.order.v1.OrderDetail
	50, // 37: cloud.hashing.order.v1.GetOrdersShortDetailByAppUserResponse.Infos:type_name -> cloud.hashing.order.v1.OrderDetail
	50, // 38: cloud.hashing.order.v1.GetOrdersDetailByAppResponse.Infos:type_name -> cloud.hashing.order.v1.OrderDetail
	50, // 39: cloud.hashing.order.v1.GetOrdersDetailByGoodResponse.Infos:type_name -> cloud.hashing.order.v1.OrderDetail
	61, // 40: cloud.hashing.order.v1.CloudHashingOrder.Version:input_type -> google.protobuf.Empty
	...
	51, // 47: cloud.hashing.order.v1.CloudHashingOrder.GetOrderDetail:input_type -> cloud.hashing.order.v1.GetOrderDetailRequest
	...
	24, // 52: cloud.hashing.order.v1.CloudHashingOrder.CreateCompensate:input_type -> cloud.hashing.order.v1.CreateCompensateRequest
	26, // 53: cloud.hashing.order.v1.CloudHashingOrder.GetCompensatesByOrder:input_type -> cloud.hashing.order.v1.GetCompensatesByOrderRequest
	29, // 54: cloud.hashing.order.v1.CloudHashingOrder.CreateOutOfGas:input_type -> cloud.hashing.order.v1.CreateOutOfGasRequest
	31, // 55: cloud.hashing.order.v1.CloudHashingOrder.GetOutOfGasesByOrder:input_type -> cloud.hashing.order.v1.GetOutOfGasesByOrderRequest
	34, // 56: cloud.hashing.order.v1.CloudHashingOrder.CreatePayment:input_type -> cloud.hashing.order.v1.CreatePaymentRequest
	36, // 57: cloud.hashing.order.v1.CloudHashingOrder.GetPayment:input_type -> cloud.hashing.order.v1.GetPaymentRequest
	38, // 58: cloud.hashing.order.v1.CloudHashingOrder.UpdatePayment:input_type -> cloud.hashing.order.v1.UpdatePaymentRequest
	40, // 59: cloud.hashing.order.v1.CloudHashingOrder.GetPaymentByOrder:input_type -> cloud.hashing.order.v1.GetPaymentByOrderRequest
	42, // 60: cloud.hashing.order.v1.CloudHashingOrder.GetPaymentsByState:input_type -> cloud.hashing.order.v1.GetPaymentsByStateRequest
	44, // 61: cloud.hashing.order.v1.CloudHashingOrder.GetPaymentsByApp:input_type -> cloud.hashing.order.v1.GetPaymentsByAppRequest
	46, // 62: cloud.hashing.order.v1.CloudHashingOrder.GetPaymentsByAppUser:input_type -> cloud.hashing.order.v1.GetPaymentsByAppUserRequest
	48, // 63: cloud.hashing.order.v1.CloudHashingOrder.GetPayments:input_type -> cloud.hashing.order.v1.GetPaymentsRequest
	53, // 64: cloud.hashing.order.v1.CloudHashingOrder.GetOrdersDetailByAppUser:input_type -> cloud.hashing.order.v1.GetOrdersDetailByAppUserRequest
	55, // 65: cloud.hashing.order.v1.CloudHashingOrder.GetOrdersShortDetailByAppUser:input_type -> cloud.hashing.order.v1.GetOrdersShortDetailByAppUserRequest
	57, // 66: cloud.hashing.order.v1.CloudHashingOrder.GetOrdersDetailByApp:input_type -> cloud.hashing.order.v1.GetOrdersDetailByAppRequest
	59, // 67: cloud.hashing.order.v1.CloudHashingOrder.GetOrdersDetailByGood:input_type -> cloud.hashing.order.v1.GetOrdersDetailByGoodRequest
	62, // 68: cloud.hashing.order.v1.CloudHashingOrder.Version:output_type -> npool.v1.VersionResponse
	2,  // 69: cloud.hashing.order.v1.CloudHashingOrder.CreateGoodPaying:output_type -> cloud.hashing.order.v1.CreateGoodPayingResponse
	4,  // 70: cloud.hashing.order.v1.CloudHashingOrder.GetGoodPayingByOrder:output_type -> cloud.hashing.order.v1.GetGoodPayingByOrderResponse
	7,  // 71: cloud.hashing.order.v1.CloudHashingOrder.CreateGasPaying:output_type -> cloud.hashing.order.v1.CreateGasPayingResponse
	9,  // 72: cloud.hashing.order.v1.CloudHashingOrder.GetGasPayingsByOrder:output_type -> cloud.hashing.order.v1.GetGasPayingsByOrderResponse
	12, // 73: cloud.hashing.order.v1.CloudHashingOrder.CreateOrder:output_type -> cloud.hashing.order.v1.CreateOrderResponse
	14, // 74: cloud.hashing.order.v1.CloudHashingOrder.GetOrder:output_type -> cloud.hashing.order.v1.GetOrderResponse
	52, // 75: cloud.hashing.order.v1.CloudHashingOrder.GetOrderDetail:output_type -> cloud.hashing.order.v1.GetOrderDetailResponse
	16, // 76: cloud.hashing.order.v1.CloudHashingOrder.GetOrdersByAppUser:output_type -> cloud.hashing.order.v1.GetOrdersByAppUserResponse
	18, // 77: cloud.hashing.order.v1.CloudHashingOrder.GetOrderByAppUserCouponTypeID:output_type -> cloud.hashing.order.v1.GetOrderByAppUserCouponTypeIDResponse
	20, // 78: cloud.hashing.order.v1.CloudHashingOrder.GetOrdersByApp:output_type -> cloud.hashing.order.v1.GetOrdersByAppResponse
	22, // 79: cloud.hashing.order.v1.CloudHashingOrder.GetOrdersByGood:output_type -> cloud.hashing.order.v1.GetOrdersByGoodResponse
	25, // 80: cloud.hashing.order.v1.CloudHashingOrder.CreateCompensate:output_type -> cloud.hashing.order.v1.CreateCompensateResponse
	27, // 81: cloud.hashing.order.v1.CloudHashingOrder.GetCompensatesByOrder:output_type -> cloud.hashing.order.v1.GetCompensatesByOrderResponse
	30, // 82: cloud.hashing.order.v1.CloudHashingOrder.CreateOutOfGas:output_type -> cloud.hashing.order.v1.CreateOutOfGasResponse
	32, // 83: cloud.hashing.order.v1.CloudHashingOrder.GetOutOfGasesByOrder:output_type -> cloud.hashing.order.v1.GetOutOfGasesByOrderResponse
	35, // 84: cloud.hashing.order.v1.CloudHashingOrder.CreatePayment:output_type -> cloud.hashing.order.v1.CreatePaymentResponse
	37, // 85: cloud.hashing.order.v1.CloudHashingOrder.GetPayment:output_type -> cloud.hashing.order.v1.GetPaymentResponse
	39, // 86: cloud.hashing.order.v1.CloudHashingOrder.UpdatePayment:output_type -> cloud.hashing.order.v1.UpdatePaymentResponse
	41, // 87: cloud.hashing.order.v1.CloudHashingOrder.GetPaymentByOrder:output_type -> cloud.hashing.order.v1.GetPaymentByOrderResponse
	43, // 88: cloud.hashing.order.v1.CloudHashingOrder.GetPaymentsByState:output_type -> cloud.hashing.order.v1.GetPaymentsByStateResponse
	45, // 89: cloud.hashing.order.v1.CloudHashingOrder.GetPaymentsByApp:output_type -> cloud.hashing.order.v1.GetPaymentsByAppResponse
	47, // 90: cloud.hashing.order.v1.CloudHashingOrder.GetPaymentsByAppUser:output_type -> cloud.hashing.order.v1.GetPaymentsByAppUserResponse
	49, // 91: cloud.hashing.order.v1.CloudHashingOrder.GetPayments:output_type -> cloud.hashing.order.v1.GetPaymentsResponse
	54, // 92: cloud.hashing.order.v1.CloudHashingOrder.GetOrdersDetailByAppUser:output_type -> cloud.hashing.order.v1.GetOrdersDetailByAppUserResponse
	56, // 93: cloud.hashing.order.v1.CloudHashingOrder.GetOrdersShortDetailByAppUser:output_type -> cloud.hashing.order.v1.GetOrdersShortDetailByAppUserResponse
	58, // 94: cloud.hashing.order.v1.CloudHashingOrder.GetOrdersDetailByApp:output_type -> cloud.hashing.order.v1.GetOrdersDetailByAppResponse
	60, // 95: cloud.hashing.order.v1.CloudHashingOrder.GetOrdersDetailByGood:output_type -> cloud.hashing.order.v1.GetOrdersDetailByGoodResponse
