...
type GetApisByServiceNameMethodNameRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	ServiceName string   `protobuf:"bytes,20,opt,name=ServiceName,proto3" json:"ServiceName,omitempty"`
	MethodName  []string `protobuf:"bytes,40,rep,name=MethodName,proto3" json:"MethodName,omitempty"`
}

func (x *GetApisByServiceNameMethodNameRequest) Reset() {
	*x = GetApisByServiceNameMethodNameRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetApisByServiceNameMethodNameRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetApisByServiceNameMethodNameRequest) ProtoMessage() {}

func (x *GetApisByServiceNameMethodNameRequest) ProtoReflect() protoreflect.Message {
	mi := &file_npool_apimgr_apimgr_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetApisByServiceNameMethodNameRequest.ProtoReflect.Descriptor instead.
func (*GetApisByServiceNameMethodNameRequest) Descriptor() ([]byte, []int) {
	return file_npool_apimgr_apimgr_proto_rawDescGZIP(), []int{7}
}

func (x *GetApisByServiceNameMethodNameRequest) GetServiceName() string {
	if x != nil {
		return x.ServiceName
	}
	return ""
...
func (x *GetApisByServiceNameMethodNameRequest) GetMethodName() []string {
	if x != nil {
		return x.MethodName
	}
	return nil
...
type GetApisByServiceNameMethodNameResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetApisByServiceNameMethodNameResponse) Reset() {
	*x = GetApisByServiceNameMethodNameResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetApisByServiceNameMethodNameResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetApisByServiceNameMethodNameResponse) ProtoMessage() {}

func (x *GetApisByServiceNameMethodNameResponse) ProtoReflect() protoreflect.Message {
	mi := &file_npool_apimgr_apimgr_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetApisByServiceNameMethodNameResponse.ProtoReflect.Descriptor instead.
func (*GetApisByServiceNameMethodNameResponse) Descriptor() ([]byte, []int) {
	return file_npool_apimgr_apimgr_proto_rawDescGZIP(), []int{8}
}

func (x *GetApisByServiceNameMethodNameResponse) GetInfos() []*ServicePath {
	if x != nil {
		return x.Infos
	}
	return nil
...
var file_npool_apimgr_apimgr_proto_rawDesc = []byte{
	...
	,
	...
	0x32, 0x1b, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x72, 0x2e, 0x76,
	0x31, 0x2e, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x50, 0x61, 0x74, 0x68, 0x52, 0x05, 0x49,
	0x6e, 0x66, 0x6f, 0x73, 0x32, 0xf0, 0x03, 0x0a, 0x0a, 0x41, 0x70, 0x69, 0x4d, 0x61, 0x6e, 0x61,
	...
	0x69, 0x6f, 0x6e, 0x3a, 0x01, 0x2a, 0x12, 0x66, 0x0a, 0x08, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74,
	0x65, 0x72, 0x12, 0x1f, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x72,
	0x2e, 0x76, 0x31, 0x2e, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x1a, 0x20, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65,
	...
	,
	...
	0x6c, 0x2f, 0x61, 0x70, 0x69, 0x6d, 0x67, 0x72, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_npool_apimgr_apimgr_proto_goTypes = []interface{}{
	...
	(*GetApisByServiceNameMethodNameRequest)(nil),  // 7: api.manager.v1.GetApisByServiceNameMethodNameRequest
	(*GetApisByServiceNameMethodNameResponse)(nil), // 8: api.manager.v1.GetApisByServiceNameMethodNameResponse
...
var file_npool_apimgr_apimgr_proto_depIdxs = []int32{
	...
	4,  // 4: api.manager.v1.GetApisByServiceNameMethodNameResponse.Infos:type_name -> api.manager.v1.ServicePath
	...
	7,  // 8: api.manager.v1.ApiManager.GetApisByServiceNameMethodName:input_type -> api.manager.v1.GetApisByServiceNameMethodNameRequest
	...
	8,  // 12: api.manager.v1.ApiManager.GetApisByServiceNameMethodName:output_type -> api.manager.v1.GetApisByServiceNameMethodNameResponse
...
func file_npool_apimgr_apimgr_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_npool_apimgr_apimgr_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetApisByServiceNameMethodNameRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_npool_apimgr_apimgr_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetApisByServiceNameMethodNameResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
