...
const (
	...
	Gateway_GetAppReadStates_FullMethodName     = "/notif.gateway.announcement.readstate.v1.Gateway/GetAppReadStates"
	Gateway_GetNAppReadStates_FullMethodName    = "/notif.gateway.announcement.readstate.v1.Gateway/GetNAppReadStates"
)
