...
var file_npool_notif_gw_v1_announcement_readstate_readstate_proto_rawDesc = []byte{
	...
	0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa3, 0x02, 0x0a, 0x09,
	0x52, 0x65, 0x61, 0x64, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x26, 0x0a, 0x0e, 0x41, 0x6e, 0x6e,
...
var file_npool_notif_gw_v1_announcement_readstate_readstate_proto_depIdxs = []int32{
	0,  // 0: notif.gateway.announcement.readstate.v1.CreateReadStateResponse.Info:type_name -> notif.gateway.announcement.readstate.v1.ReadState
	...
	1,  // 6: notif.gateway.announcement.readstate.v1.Gateway.CreateReadState:input_type -> notif.gateway.announcement.readstate.v1.CreateReadStateRequest
	3,  // 7: notif.gateway.announcement.readstate.v1.Gateway.GetReadState:input_type -> notif.gateway.announcement.readstate.v1.GetReadStateRequest
	5,  // 8: notif.gateway.announcement.readstate.v1.Gateway.GetReadStates:input_type -> notif.gateway.announcement.readstate.v1.GetReadStatesRequest
	7,  // 9: notif.gateway.announcement.readstate.v1.Gateway.GetAppUserReadStates:input_type -> notif.gateway.announcement.readstate.v1.GetAppUserReadStatesRequest
	9,  // 10: notif.gateway.announcement.readstate.v1.Gateway.GetAppReadStates:input_type -> notif.gateway.announcement.readstate.v1.GetAppReadStatesRequest
	11, // 11: notif.gateway.announcement.readstate.v1.Gateway.GetNAppReadStates:input_type -> notif.gateway.announcement.readstate.v1.GetNAppReadStatesRequest
	2,  // 12: notif.gateway.announcement.readstate.v1.Gateway.CreateReadState:output_type -> notif.gateway.announcement.readstate.v1.CreateReadStateResponse
	4,  // 13: notif.gateway.announcement.readstate.v1.Gateway.GetReadState:output_type -> notif.gateway.announcement.readstate.v1.GetReadStateResponse
	6,  // 14: notif.gateway.announcement.readstate.v1.Gateway.GetReadStates:output_type -> notif.gateway.announcement.readstate.v1.GetReadStatesResponse
	8,  // 15: notif.gateway.announcement.readstate.v1.Gateway.GetAppUserReadStates:output_type -> notif.gateway.announcement.readstate.v1.GetAppUserReadStatesResponse
	10, // 16: notif.gateway.announcement.readstate.v1.Gateway.GetAppReadStates:output_type -> notif.gateway.announcement.readstate.v1.GetAppReadStatesResponse
	12, // 17: notif.gateway.announcement.readstate.v1.Gateway.GetNAppReadStates:output_type -> notif.gateway.announcement.readstate.v1.GetNAppReadStatesResponse
