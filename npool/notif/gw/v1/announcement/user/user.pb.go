...
func (x *GetNAppAnnouncementUsersRequest) GetOffset() int32 {
	if x != nil {
		return x.Offset
	}
	return 0
...
func (x *GetNAppAnnouncementUsersRequest) GetLimit() int32 {
	if x != nil {
		return x.Limit
	}
	return 0
...
var file_npool_notif_gw_v1_announcement_user_user_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x05, 0x52, 0x05, 0x4c, 0x69, 0x6d, 0x69, 0x74, 0x22, 0x83, 0x01, 0x0a, 0x1f,
