...
type Notif struct {
	...
	EventType    v1.UsedFor           `protobuf:"varint,80,opt,name=EventType,proto3,enum=npool.basetypes.v1.UsedFor" json:"EventType,omitempty"`
...
var file_npool_notif_gw_v1_notif_notif_proto_depIdxs = []int32{
	9,  // 0: notif.gateway.notif3.v1.Notif.EventType:type_name -> npool.basetypes.v1.UsedFor
