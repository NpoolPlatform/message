...
var file_npool_notif_gw_v1_notif_notif_proto_rawDesc = []byte{
	...
	0x31, 0x2e, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x52, 0x04, 0x49, 0x6e, 0x66, 0x6f, 0x22, 0x6e, 0x0a,
	...
	0x18, 0x28, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x05, 0x4c, 0x69, 0x6d, 0x69, 0x74, 0x22, 0x5f, 0x0a,
	...
	0x6c, 0x18, 0x14, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x05, 0x54, 0x6f, 0x74, 0x61, 0x6c, 0x22, 0x8d,
	...
	0x74, 0x18, 0x28, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x05, 0x4c, 0x69, 0x6d, 0x69, 0x74, 0x22, 0x66,
	0x0a, 0x18, 0x47, 0x65, 0x74, 0x41, 0x70, 0x70, 0x55, 0x73, 0x65, 0x72, 0x4e, 0x6f, 0x74, 0x69,
	...
	0x05, 0x54, 0x6f, 0x74, 0x61, 0x6c, 0x32, 0xa1, 0x03, 0x0a, 0x07, 0x47, 0x61, 0x74, 0x65, 0x77,
	...
	0x2f, 0x67, 0x65, 0x74, 0x2f, 0x6e, 0x6f, 0x74, 0x69, 0x66, 0x3a, 0x01, 0x2a, 0x12, 0x7d, 0x0a,
...
var file_npool_notif_gw_v1_notif_notif_proto_goTypes = []interface{}{
	...
	(*GetAppUserNotifsRequest)(nil),  // 5: notif.gateway.notif3.v1.GetAppUserNotifsRequest
	(*GetAppUserNotifsResponse)(nil), // 6: notif.gateway.notif3.v1.GetAppUserNotifsResponse
	(notif.EventType)(0),             // 7: notif.manager.notif1.v1.EventType
	(channel.NotifChannel)(0),        // 8: notif.manager.channel.v1.NotifChannel
}
var file_npool_notif_gw_v1_notif_notif_proto_depIdxs = []int32{
	7, // 0: notif.gateway.notif3.v1.Notif.EventType:type_name -> notif.manager.notif1.v1.EventType
	8, // 1: notif.gateway.notif3.v1.Notif.Channels:type_name -> notif.manager.channel.v1.NotifChannel
	0, // 2: notif.gateway.notif3.v1.GetNotifResponse.Info:type_name -> notif.gateway.notif3.v1.Notif
	0, // 3: notif.gateway.notif3.v1.GetNotifsResponse.Infos:type_name -> notif.gateway.notif3.v1.Notif
	0, // 4: notif.gateway.notif3.v1.GetAppUserNotifsResponse.Infos:type_name -> notif.gateway.notif3.v1.Notif
	1, // 5: notif.gateway.notif3.v1.Gateway.GetNotif:input_type -> notif.gateway.notif3.v1.GetNotifRequest
	3, // 6: notif.gateway.notif3.v1.Gateway.GetNotifs:input_type -> notif.gateway.notif3.v1.GetNotifsRequest
	5, // 7: notif.gateway.notif3.v1.Gateway.GetAppUserNotifs:input_type -> notif.gateway.notif3.v1.GetAppUserNotifsRequest
	2, // 8: notif.gateway.notif3.v1.Gateway.GetNotif:output_type -> notif.gateway.notif3.v1.GetNotifResponse
	4, // 9: notif.gateway.notif3.v1.Gateway.GetNotifs:output_type -> notif.gateway.notif3.v1.GetNotifsResponse
	6, // 10: notif.gateway.notif3.v1.Gateway.GetAppUserNotifs:output_type -> notif.gateway.notif3.v1.GetAppUserNotifsResponse
