...
const (
	Manager_CreateUser_FullMethodName     = "/notif.manager.user.v1.Manager/CreateUser"
	Manager_CreateUsers_FullMethodName    = "/notif.manager.user.v1.Manager/CreateUsers"
	Manager_UpdateUser_FullMethodName     = "/notif.manager.user.v1.Manager/UpdateUser"
	Manager_GetUser_FullMethodName        = "/notif.manager.user.v1.Manager/GetUser"
	Manager_GetUserOnly_FullMethodName    = "/notif.manager.user.v1.Manager/GetUserOnly"
	Manager_GetUsers_FullMethodName       = "/notif.manager.user.v1.Manager/GetUsers"
	Manager_ExistUser_FullMethodName      = "/notif.manager.user.v1.Manager/ExistUser"
	Manager_ExistUserConds_FullMethodName = "/notif.manager.user.v1.Manager/ExistUserConds"
	Manager_CountUsers_FullMethodName     = "/notif.manager.user.v1.Manager/CountUsers"
	Manager_DeleteUser_FullMethodName     = "/notif.manager.user.v1.Manager/DeleteUser"
)
...
func (c *managerClient) CreateUser(ctx context.Context, in *CreateUserRequest, opts ...grpc.CallOption) (*CreateUserResponse, error) {
	...
	err := c.cc.Invoke(ctx, Manager_CreateUser_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *managerClient) CreateUsers(ctx context.Context, in *CreateUsersRequest, opts ...grpc.CallOption) (*CreateUsersResponse, error) {
	...
	err := c.cc.Invoke(ctx, Manager_CreateUsers_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *managerClient) GetUser(ctx context.Context, in *GetUserRequest, opts ...grpc.CallOption) (*GetUserResponse, error) {
	...
	err := c.cc.Invoke(ctx, Manager_GetUser_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *managerClient) GetUserOnly(ctx context.Context, in *GetUserOnlyRequest, opts ...grpc.CallOption) (*GetUserOnlyResponse, error) {
	...
	err := c.cc.Invoke(ctx, Manager_GetUserOnly_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *managerClient) GetUsers(ctx context.Context, in *GetUsersRequest, opts ...grpc.CallOption) (*GetUsersResponse, error) {
	...
	err := c.cc.Invoke(ctx, Manager_GetUsers_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *managerClient) ExistUser(ctx context.Context, in *ExistUserRequest, opts ...grpc.CallOption) (*ExistUserResponse, error) {
	...
	err := c.cc.Invoke(ctx, Manager_ExistUser_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *managerClient) ExistUserConds(ctx context.Context, in *ExistUserCondsRequest, opts ...grpc.CallOption) (*ExistUserCondsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Manager_ExistUserConds_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *managerClient) CountUsers(ctx context.Context, in *CountUsersRequest, opts ...grpc.CallOption) (*CountUsersResponse, error) {
	...
	err := c.cc.Invoke(ctx, Manager_CountUsers_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *managerClient) DeleteUser(ctx context.Context, in *DeleteUserRequest, opts ...grpc.CallOption) (*DeleteUserResponse, error) {
	...
	err := c.cc.Invoke(ctx, Manager_DeleteUser_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Manager_CreateUsers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Manager_CreateUsers_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Manager_GetUserOnly_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Manager_GetUserOnly_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Manager_ExistUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Manager_ExistUser_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Manager_ExistUserConds_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Manager_ExistUserConds_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Manager_CountUsers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Manager_CountUsers_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
