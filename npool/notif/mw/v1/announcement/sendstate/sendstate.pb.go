...
var file_npool_notif_mw_v1_announcement_sendstate_sendstate_proto_rawDesc = []byte{
	...
	0x7d, 0x0a, 0x14, 0x47, 0x65, 0x74, 0x53, 0x65, 0x6e, 0x64, 0x53, 0x74, 0x61, 0x74, 0x65, 0x73,
	...
	0x01, 0x28, 0x0d, 0x52, 0x05, 0x54, 0x6f, 0x74, 0x61, 0x6c, 0x32, 0xa5, 0x01, 0x0a, 0x0a, 0x4d,
	0x69, 0x64, 0x64, 0x6c, 0x65, 0x77, 0x61, 0x72, 0x65, 0x12, 0x96, 0x01, 0x0a, 0x0d, 0x47, 0x65,
	0x74, 0x53, 0x65, 0x6e, 0x64, 0x53, 0x74, 0x61, 0x74, 0x65, 0x73, 0x12, 0x40, 0x2e, 0x6e, 0x6f,
...
var file_npool_notif_mw_v1_announcement_sendstate_sendstate_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_npool_notif_mw_v1_announcement_sendstate_sendstate_proto_goTypes = []interface{}{
	...
	(*GetSendStatesRequest)(nil),  // 1: notif.middleware.announcement.sendstate.v1.GetSendStatesRequest
	(*GetSendStatesResponse)(nil), // 2: notif.middleware.announcement.sendstate.v1.GetSendStatesResponse
	(channel.NotifChannel)(0),     // 3: notif.manager.channel.v1.NotifChannel
	(*sendstate.Conds)(nil),       // 4: notif.manager.sendstate.v1.Conds
}
var file_npool_notif_mw_v1_announcement_sendstate_sendstate_proto_depIdxs = []int32{
	3, // 0: notif.middleware.announcement.sendstate.v1.SendState.Channel:type_name -> notif.manager.channel.v1.NotifChannel
	4, // 1: notif.middleware.announcement.sendstate.v1.GetSendStatesRequest.Conds:type_name -> notif.manager.sendstate.v1.Conds
	0, // 2: notif.middleware.announcement.sendstate.v1.GetSendStatesResponse.Infos:type_name -> notif.middleware.announcement.sendstate.v1.SendState
	1, // 3: notif.middleware.announcement.sendstate.v1.Middleware.GetSendStates:input_type -> notif.middleware.announcement.sendstate.v1.GetSendStatesRequest
	2, // 4: notif.middleware.announcement.sendstate.v1.Middleware.GetSendStates:output_type -> notif.middleware.announcement.sendstate.v1.GetSendStatesResponse
