...
var file_npool_notif_mw_v1_announcement_announcement_proto_rawDesc = []byte{
	...
	0x65, 0x6e, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x28, 0x0a, 0x16, 0x47, 0x65, 0x74,
	...
	0x20, 0x01, 0x28, 0x0d, 0x52, 0x05, 0x54, 0x6f, 0x74, 0x61, 0x6c, 0x32, 0xa5, 0x02, 0x0a, 0x0a,
	0x4d, 0x69, 0x64, 0x64, 0x6c, 0x65, 0x77, 0x61, 0x72, 0x65, 0x12, 0x88, 0x01, 0x0a, 0x0f, 0x47,
	0x65, 0x74, 0x41, 0x6e, 0x6e, 0x6f, 0x75, 0x6e, 0x63, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x12, 0x38,
	...
	0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x8b, 0x01, 0x0a, 0x10, 0x47, 0x65, 0x74, 0x41, 0x6e, 0x6e,
...
var file_npool_notif_mw_v1_announcement_announcement_proto_goTypes = []interface{}{
	(*GetAnnouncementRequest)(nil),    // 0: notif.middleware.announcement.v1.GetAnnouncementRequest
	(*GetAnnouncementResponse)(nil),   // 1: notif.middleware.announcement.v1.GetAnnouncementResponse
	(*GetAnnouncementsRequest)(nil),   // 2: notif.middleware.announcement.v1.GetAnnouncementsRequest
	(*GetAnnouncementsResponse)(nil),  // 3: notif.middleware.announcement.v1.GetAnnouncementsResponse
	(*announcement.Announcement)(nil), // 4: notif.manager.announcement.v1.Announcement
}
var file_npool_notif_mw_v1_announcement_announcement_proto_depIdxs = []int32{
	4, // 0: notif.middleware.announcement.v1.GetAnnouncementResponse.Info:type_name -> notif.manager.announcement.v1.Announcement
	4, // 1: notif.middleware.announcement.v1.GetAnnouncementsResponse.Infos:type_name -> notif.manager.announcement.v1.Announcement
	0, // 2: notif.middleware.announcement.v1.Middleware.GetAnnouncement:input_type -> notif.middleware.announcement.v1.GetAnnouncementRequest
	2, // 3: notif.middleware.announcement.v1.Middleware.GetAnnouncements:input_type -> notif.middleware.announcement.v1.GetAnnouncementsRequest
	1, // 4: notif.middleware.announcement.v1.Middleware.GetAnnouncement:output_type -> notif.middleware.announcement.v1.GetAnnouncementResponse
	3, // 5: notif.middleware.announcement.v1.Middleware.GetAnnouncements:output_type -> notif.middleware.announcement.v1.GetAnnouncementsResponse
