...
func (x *ReadState) GetChannelsStr() string {
	if x != nil {
...
type GetAnnouncementReadStatesRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetAnnouncementReadStatesRequest) Reset() {
	*x = GetAnnouncementReadStatesRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetAnnouncementReadStatesRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetAnnouncementReadStatesRequest) ProtoMessage() {}

func (x *GetAnnouncementReadStatesRequest) ProtoReflect() protoreflect.Message {
	mi := &file_npool_notif_mw_v1_announcement_readstate_readstate_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetAnnouncementReadStatesRequest.ProtoReflect.Descriptor instead.
func (*GetAnnouncementReadStatesRequest) Descriptor() ([]byte, []int) {
	return file_npool_notif_mw_v1_announcement_readstate_readstate_proto_rawDescGZIP(), []int{5}
}

func (x *GetAnnouncementReadStatesRequest) GetConds() *readstate.Conds {
	if x != nil {
		return x.Conds
	}
	return nil
...
func (x *GetAnnouncementReadStatesRequest) GetOffset() int32 {
	if x != nil {
		return x.Offset
	}
	return 0
...
func (x *GetAnnouncementReadStatesRequest) GetLimit() int32 {
	if x != nil {
		return x.Limit
	}
	return 0
...
type GetAnnouncementReadStatesResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetAnnouncementReadStatesResponse) Reset() {
	*x = GetAnnouncementReadStatesResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetAnnouncementReadStatesResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetAnnouncementReadStatesResponse) ProtoMessage() {}

func (x *GetAnnouncementReadStatesResponse) ProtoReflect() protoreflect.Message {
	mi := &file_npool_notif_mw_v1_announcement_readstate_readstate_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetAnnouncementReadStatesResponse.ProtoReflect.Descriptor instead.
func (*GetAnnouncementReadStatesResponse) Descriptor() ([]byte, []int) {
	return file_npool_notif_mw_v1_announcement_readstate_readstate_proto_rawDescGZIP(), []int{6}
}

func (x *GetAnnouncementReadStatesResponse) GetInfos() []*ReadState {
	if x != nil {
		return x.Infos
	}
	return nil
...
func (x *GetAnnouncementReadStatesResponse) GetTotal() uint32 {
	if x != nil {
		return x.Total
	}
	return 0
...
var file_npool_notif_mw_v1_announcement_readstate_readstate_proto_rawDesc = []byte{
	...
	0x65, 0x2f, 0x72, 0x65, 0x61, 0x64, 0x73, 0x74, 0x61, 0x74, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	...
	0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xd5, 0x02, 0x0a, 0x09,
	...
	0x18, 0x32, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x12,
	0x20, 0x0a, 0x0b, 0x43, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x73, 0x53, 0x74, 0x72, 0x18, 0x3c,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x43, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x73, 0x53, 0x74,
	0x72, 0x12, 0x42, 0x0a, 0x08, 0x43, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x73, 0x18, 0x3d, 0x20,
	...
	0x52, 0x65, 0x61, 0x64, 0x18, 0x50, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0b, 0x41, 0x6c, 0x72, 0x65,
	0x61, 0x64, 0x79, 0x52, 0x65, 0x61, 0x64, 0x12, 0x1c, 0x0a, 0x09, 0x43, 0x72, 0x65, 0x61, 0x74,
	...
	0x64, 0x41, 0x74, 0x22, 0x55, 0x0a, 0x13, 0x47, 0x65, 0x74, 0x52, 0x65, 0x61, 0x64, 0x53, 0x74,
	0x61, 0x74, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x26, 0x0a, 0x0e, 0x41, 0x6e,
	...
	0x28, 0x09, 0x52, 0x06, 0x55, 0x73, 0x65, 0x72, 0x49, 0x44, 0x22, 0x61, 0x0a, 0x14, 0x47, 0x65,
	...
	0x61, 0x64, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x04, 0x49, 0x6e, 0x66, 0x6f, 0x22, 0x7d, 0x0a,
	0x14, 0x47, 0x65, 0x74, 0x52, 0x65, 0x61, 0x64, 0x53, 0x74, 0x61, 0x74, 0x65, 0x73, 0x52, 0x65,
	...
	0x61, 0x67, 0x65, 0x72, 0x2e, 0x72, 0x65, 0x61, 0x64, 0x73, 0x74, 0x61, 0x74, 0x65, 0x2e, 0x76,
	...
	0x1e, 0x20, 0x01, 0x28, 0x05, 0x52, 0x05, 0x4c, 0x69, 0x6d, 0x69, 0x74, 0x22, 0x7a, 0x0a, 0x15,
	...
	0x0d, 0x52, 0x05, 0x54, 0x6f, 0x74, 0x61, 0x6c, 0x22, 0x89, 0x01, 0x0a, 0x20, 0x47, 0x65, 0x74,
	...
	0x69, 0x6d, 0x69, 0x74, 0x22, 0x86, 0x01, 0x0a, 0x21, 0x47, 0x65, 0x74, 0x41, 0x6e, 0x6e, 0x6f,
	0x75, 0x6e, 0x63, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x61, 0x64, 0x53, 0x74, 0x61, 0x74,
	...
	0x18, 0x14, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x05, 0x54, 0x6f, 0x74, 0x61, 0x6c, 0x32, 0xf8, 0x03,
	...
	,
	...
	0x65, 0x2e, 0x76, 0x31, 0x2e, 0x47, 0x65, 0x74, 0x41, 0x6e, 0x6e, 0x6f, 0x75, 0x6e, 0x63, 0x65,
	0x6d, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x61, 0x64, 0x53, 0x74, 0x61, 0x74, 0x65, 0x73, 0x52, 0x65,
...
var file_npool_notif_mw_v1_announcement_readstate_readstate_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_npool_notif_mw_v1_announcement_readstate_readstate_proto_goTypes = []interface{}{
	...
	(*GetReadStateRequest)(nil),               // 1: notif.middleware.announcement.readstate.v1.GetReadStateRequest
	(*GetReadStateResponse)(nil),              // 2: notif.middleware.announcement.readstate.v1.GetReadStateResponse
	(*GetReadStatesRequest)(nil),              // 3: notif.middleware.announcement.readstate.v1.GetReadStatesRequest
	(*GetReadStatesResponse)(nil),             // 4: notif.middleware.announcement.readstate.v1.GetReadStatesResponse
	(*GetAnnouncementReadStatesRequest)(nil),  // 5: notif.middleware.announcement.readstate.v1.GetAnnouncementReadStatesRequest
	(*GetAnnouncementReadStatesResponse)(nil), // 6: notif.middleware.announcement.readstate.v1.GetAnnouncementReadStatesResponse
	(channel.NotifChannel)(0),                 // 7: notif.manager.channel.v1.NotifChannel
	(*readstate.Conds)(nil),                   // 8: notif.manager.readstate.v1.Conds
}
var file_npool_notif_mw_v1_announcement_readstate_readstate_proto_depIdxs = []int32{
	7, // 0: notif.middleware.announcement.readstate.v1.ReadState.Channels:type_name -> notif.manager.channel.v1.NotifChannel
	0, // 1: notif.middleware.announcement.readstate.v1.GetReadStateResponse.Info:type_name -> notif.middleware.announcement.readstate.v1.ReadState
	8, // 2: notif.middleware.announcement.readstate.v1.GetReadStatesRequest.Conds:type_name -> notif.manager.readstate.v1.Conds
	0, // 3: notif.middleware.announcement.readstate.v1.GetReadStatesResponse.Infos:type_name -> notif.middleware.announcement.readstate.v1.ReadState
	8, // 4: notif.middleware.announcement.readstate.v1.GetAnnouncementReadStatesRequest.Conds:type_name -> notif.manager.readstate.v1.Conds
	0, // 5: notif.middleware.announcement.readstate.v1.GetAnnouncementReadStatesResponse.Infos:type_name -> notif.middleware.announcement.readstate.v1.ReadState
	1, // 6: notif.middleware.announcement.readstate.v1.Middleware.GetReadState:input_type -> notif.middleware.announcement.readstate.v1.GetReadStateRequest
	3, // 7: notif.middleware.announcement.readstate.v1.Middleware.GetReadStates:input_type -> notif.middleware.announcement.readstate.v1.GetReadStatesRequest
	5, // 8: notif.middleware.announcement.readstate.v1.Middleware.GetAnnouncementReadStates:input_type -> notif.middleware.announcement.readstate.v1.GetAnnouncementReadStatesRequest
	2, // 9: notif.middleware.announcement.readstate.v1.Middleware.GetReadState:output_type -> notif.middleware.announcement.readstate.v1.GetReadStateResponse
	4, // 10: notif.middleware.announcement.readstate.v1.Middleware.GetReadStates:output_type -> notif.middleware.announcement.readstate.v1.GetReadStatesResponse
	6, // 11: notif.middleware.announcement.readstate.v1.Middleware.GetAnnouncementReadStates:output_type -> notif.middleware.announcement.readstate.v1.GetAnnouncementReadStatesResponse
...
func file_npool_notif_mw_v1_announcement_readstate_readstate_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_npool_notif_mw_v1_announcement_readstate_readstate_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetAnnouncementReadStatesRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_npool_notif_mw_v1_announcement_readstate_readstate_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetAnnouncementReadStatesResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
