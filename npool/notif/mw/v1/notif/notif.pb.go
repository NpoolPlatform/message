...
var file_npool_notif_mw_v1_notif_notif_proto_rawDesc = []byte{
	...
	0x74, 0x22, 0x4b, 0x0a, 0x12, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x4e, 0x6f, 0x74, 0x69, 0x66,
	...
	0x0a, 0x13, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x52, 0x65, 0x73,
	...
	0x66, 0x6f, 0x32, 0xc8, 0x03, 0x0a, 0x0a, 0x4d, 0x69, 0x64, 0x64, 0x6c, 0x65, 0x77, 0x61, 0x72,
...
var file_npool_notif_mw_v1_notif_notif_proto_goTypes = []interface{}{
	...
	(*GetNotifRequest)(nil),      // 3: notif.middleware.notif2.v1.GetNotifRequest
	(*GetNotifResponse)(nil),     // 4: notif.middleware.notif2.v1.GetNotifResponse
	(*GetNotifsRequest)(nil),     // 5: notif.middleware.notif2.v1.GetNotifsRequest
	(*GetNotifsResponse)(nil),    // 6: notif.middleware.notif2.v1.GetNotifsResponse
	(*GetNotifOnlyRequest)(nil),  // 7: notif.middleware.notif2.v1.GetNotifOnlyRequest
	(*GetNotifOnlyResponse)(nil), // 8: notif.middleware.notif2.v1.GetNotifOnlyResponse
	(*notif.NotifReq)(nil),       // 9: notif.manager.notif1.v1.NotifReq
	(*notif.Conds)(nil),          // 10: notif.manager.notif1.v1.Conds
}
var file_npool_notif_mw_v1_notif_notif_proto_depIdxs = []int32{
	9,  // 0: notif.middleware.notif2.v1.CreateNotifRequest.Info:type_name -> notif.manager.notif1.v1.NotifReq
	0,  // 1: notif.middleware.notif2.v1.CreateNotifResponse.Info:type_name -> notif.middleware.notif2.v1.Notif
	0,  // 2: notif.middleware.notif2.v1.GetNotifResponse.Info:type_name -> notif.middleware.notif2.v1.Notif
	10, // 3: notif.middleware.notif2.v1.GetNotifsRequest.Conds:type_name -> notif.manager.notif1.v1.Conds
	0,  // 4: notif.middleware.notif2.v1.GetNotifsResponse.Infos:type_name -> notif.middleware.notif2.v1.Notif
	10, // 5: notif.middleware.notif2.v1.GetNotifOnlyRequest.Conds:type_name -> notif.manager.notif1.v1.Conds
	0,  // 6: notif.middleware.notif2.v1.GetNotifOnlyResponse.Info:type_name -> notif.middleware.notif2.v1.Notif
	1,  // 7: notif.middleware.notif2.v1.Middleware.CreateNotif:input_type -> notif.middleware.notif2.v1.CreateNotifRequest
	3,  // 8: notif.middleware.notif2.v1.Middleware.GetNotif:input_type -> notif.middleware.notif2.v1.GetNotifRequest
	5,  // 9: notif.middleware.notif2.v1.Middleware.GetNotifs:input_type -> notif.middleware.notif2.v1.GetNotifsRequest
	7,  // 10: notif.middleware.notif2.v1.Middleware.GetNotifOnly:input_type -> notif.middleware.notif2.v1.GetNotifOnlyRequest
	2,  // 11: notif.middleware.notif2.v1.Middleware.CreateNotif:output_type -> notif.middleware.notif2.v1.CreateNotifResponse
	4,  // 12: notif.middleware.notif2.v1.Middleware.GetNotif:output_type -> notif.middleware.notif2.v1.GetNotifResponse
	6,  // 13: notif.middleware.notif2.v1.Middleware.GetNotifs:output_type -> notif.middleware.notif2.v1.GetNotifsResponse
	8,  // 14: notif.middleware.notif2.v1.Middleware.GetNotifOnly:output_type -> notif.middleware.notif2.v1.GetNotifOnlyResponse
