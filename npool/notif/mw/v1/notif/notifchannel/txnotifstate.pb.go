...
// 	protoc        v3.18.1
// source: npool/notif/mw/v1/notif/notifchannel/txnotifstate.proto
...
func (x *GetNotifChannelsRequest) Reset() {
	*x = GetNotifChannelsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_npool_notif_mw_v1_notif_notifchannel_txnotifstate_proto_msgTypes[0]
...
func (*GetNotifChannelsRequest) Descriptor() ([]byte, []int) {
	return file_npool_notif_mw_v1_notif_notifchannel_txnotifstate_proto_rawDescGZIP(), []int{0}
}
...
func (x *GetNotifChannelsResponse) Reset() {
	*x = GetNotifChannelsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_npool_notif_mw_v1_notif_notifchannel_txnotifstate_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetNotifChannelsResponse) Descriptor() ([]byte, []int) {
	return file_npool_notif_mw_v1_notif_notifchannel_txnotifstate_proto_rawDescGZIP(), []int{1}
}
...
func (x *GetNotifChannelOnlyRequest) Reset() {
	*x = GetNotifChannelOnlyRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_npool_notif_mw_v1_notif_notifchannel_txnotifstate_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetNotifChannelOnlyRequest) Descriptor() ([]byte, []int) {
	return file_npool_notif_mw_v1_notif_notifchannel_txnotifstate_proto_rawDescGZIP(), []int{2}
}
...
func (x *GetNotifChannelOnlyResponse) Reset() {
	*x = GetNotifChannelOnlyResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_npool_notif_mw_v1_notif_notifchannel_txnotifstate_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetNotifChannelOnlyResponse) Descriptor() ([]byte, []int) {
	return file_npool_notif_mw_v1_notif_notifchannel_txnotifstate_proto_rawDescGZIP(), []int{3}
}
...
var File_npool_notif_mw_v1_notif_notifchannel_txnotifstate_proto protoreflect.FileDescriptor

var file_npool_notif_mw_v1_notif_notifchannel_txnotifstate_proto_rawDesc = []byte{
	...
	0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x2f, 0x74, 0x78, 0x6e, 0x6f, 0x74, 0x69, 0x66, 0x73, 0x74,
	0x61, 0x74, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x21, 0x6e, 0x6f, 0x74, 0x69, 0x66,
...
var (
	file_npool_notif_mw_v1_notif_notifchannel_txnotifstate_proto_rawDescOnce sync.Once
	file_npool_notif_mw_v1_notif_notifchannel_txnotifstate_proto_rawDescData = file_npool_notif_mw_v1_notif_notifchannel_txnotifstate_proto_rawDesc
)

func file_npool_notif_mw_v1_notif_notifchannel_txnotifstate_proto_rawDescGZIP() []byte {
	file_npool_notif_mw_v1_notif_notifchannel_txnotifstate_proto_rawDescOnce.Do(func() {
		file_npool_notif_mw_v1_notif_notifchannel_txnotifstate_proto_rawDescData = protoimpl.X.CompressGZIP(file_npool_notif_mw_v1_notif_notifchannel_txnotifstate_proto_rawDescData)
	})
	return file_npool_notif_mw_v1_notif_notifchannel_txnotifstate_proto_rawDescData
}

var file_npool_notif_mw_v1_notif_notifchannel_txnotifstate_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_npool_notif_mw_v1_notif_notifchannel_txnotifstate_proto_goTypes = []interface{}{
...
var file_npool_notif_mw_v1_notif_notifchannel_txnotifstate_proto_depIdxs = []int32{
...
func init() { file_npool_notif_mw_v1_notif_notifchannel_txnotifstate_proto_init() }
func file_npool_notif_mw_v1_notif_notifchannel_txnotifstate_proto_init() {
	if File_npool_notif_mw_v1_notif_notifchannel_txnotifstate_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_npool_notif_mw_v1_notif_notifchannel_txnotifstate_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_npool_notif_mw_v1_notif_notifchannel_txnotifstate_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_npool_notif_mw_v1_notif_notifchannel_txnotifstate_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_npool_notif_mw_v1_notif_notifchannel_txnotifstate_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_npool_notif_mw_v1_notif_notifchannel_txnotifstate_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_npool_notif_mw_v1_notif_notifchannel_txnotifstate_proto_goTypes,
		DependencyIndexes: file_npool_notif_mw_v1_notif_notifchannel_txnotifstate_proto_depIdxs,
		MessageInfos:      file_npool_notif_mw_v1_notif_notifchannel_txnotifstate_proto_msgTypes,
	}.Build()
	File_npool_notif_mw_v1_notif_notifchannel_txnotifstate_proto = out.File
	file_npool_notif_mw_v1_notif_notifchannel_txnotifstate_proto_rawDesc = nil
	file_npool_notif_mw_v1_notif_notifchannel_txnotifstate_proto_goTypes = nil
	file_npool_notif_mw_v1_notif_notifchannel_txnotifstate_proto_depIdxs = nil
}
