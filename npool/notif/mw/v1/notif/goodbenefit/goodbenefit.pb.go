...
type GoodBenefitReq struct {
	...
	Notified    *bool      `protobuf:"varint,90,opt,name=Notified,proto3,oneof" json:"Notified,omitempty"`
}
...
func (x *GoodBenefitReq) GetNotified() bool {
...
var file_npool_notif_mw_v1_notif_goodbenefit_goodbenefit_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x08, 0x48, 0x08, 0x52, 0x08, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x69, 0x65, 0x64,
