...
type GoodBenefit struct {
	...
	State string `protobuf:"bytes,50,opt,name=State,proto3" json:"State,omitempty" sql:"state"`
...
func (x *GoodBenefit) GetState() string {
	if x != nil {
		return x.State
	}
	return ""
...
var file_npool_notif_mw_v1_notif_goodbenefit_goodbenefit_proto_rawDesc = []byte{
	...
	0x5f, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x69, 0x65, 0x64, 0x22, 0xa7, 0x02, 0x0a, 0x0b, 0x47, 0x6f,
	...
	0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x53, 0x74, 0x61, 0x74, 0x65, 0x18, 0x32,
	...
	0x50, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x54, 0x78, 0x49, 0x44, 0x12, 0x1a, 0x0a, 0x08, 0x4e,
	0x6f, 0x74, 0x69, 0x66, 0x69, 0x65, 0x64, 0x18, 0x5a, 0x20, 0x01, 0x28, 0x08, 0x52, 0x08, 0x4e,
	0x6f, 0x74, 0x69, 0x66, 0x69, 0x65, 0x64, 0x12, 0x1c, 0x0a, 0x09, 0x43, 0x72, 0x65, 0x61, 0x74,
	...
	0x64, 0x41, 0x74, 0x22, 0x94, 0x02, 0x0a, 0x05, 0x43, 0x6f, 0x6e, 0x64, 0x73, 0x12, 0x2c, 0x0a,
	...
	0x01, 0x12, 0x38, 0x0a, 0x08, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x69, 0x65, 0x64, 0x18, 0x1e, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x62, 0x61, 0x73, 0x65, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2e,
	0x76, 0x31, 0x2e, 0x55, 0x69, 0x6e, 0x74, 0x33, 0x32, 0x56, 0x61, 0x6c, 0x48, 0x02, 0x52, 0x08,
...
var file_npool_notif_mw_v1_notif_goodbenefit_goodbenefit_proto_depIdxs = []int32{
	...
	16, // 1: notif.middleware.notif.goodbenefit.v1.Conds.ID:type_name -> basetypes.v1.StringVal
	16, // 2: notif.middleware.notif.goodbenefit.v1.Conds.GoodID:type_name -> basetypes.v1.StringVal
	17, // 3: notif.middleware.notif.goodbenefit.v1.Conds.Notified:type_name -> basetypes.v1.Uint32Val
	17, // 4: notif.middleware.notif.goodbenefit.v1.Conds.BenefitDate:type_name -> basetypes.v1.Uint32Val
	0,  // 5: notif.middleware.notif.goodbenefit.v1.CreateGoodBenefitRequest.Info:type_name -> notif.middleware.notif.goodbenefit.v1.GoodBenefitReq
	1,  // 6: notif.middleware.notif.goodbenefit.v1.CreateGoodBenefitResponse.Info:type_name -> notif.middleware.notif.goodbenefit.v1.GoodBenefit
	0,  // 7: notif.middleware.notif.goodbenefit.v1.UpdateGoodBenefitRequest.Info:type_name -> notif.middleware.notif.goodbenefit.v1.GoodBenefitReq
	1,  // 8: notif.middleware.notif.goodbenefit.v1.UpdateGoodBenefitResponse.Info:type_name -> notif.middleware.notif.goodbenefit.v1.GoodBenefit
	2,  // 9: notif.middleware.notif.goodbenefit.v1.GetGoodBenefitsRequest.Conds:type_name -> notif.middleware.notif.goodbenefit.v1.Conds
	1,  // 10: notif.middleware.notif.goodbenefit.v1.GetGoodBenefitsResponse.Infos:type_name -> notif.middleware.notif.goodbenefit.v1.GoodBenefit
	1,  // 11: notif.middleware.notif.goodbenefit.v1.GetGoodBenefitResponse.Info:type_name -> notif.middleware.notif.goodbenefit.v1.GoodBenefit
	2,  // 12: notif.middleware.notif.goodbenefit.v1.ExistGoodBenefitCondsRequest.Conds:type_name -> notif.middleware.notif.goodbenefit.v1.Conds
	0,  // 13: notif.middleware.notif.goodbenefit.v1.DeleteGoodBenefitRequest.Info:type_name -> notif.middleware.notif.goodbenefit.v1.GoodBenefitReq
	1,  // 14: notif.middleware.notif.goodbenefit.v1.DeleteGoodBenefitResponse.Info:type_name -> notif.middleware.notif.goodbenefit.v1.GoodBenefit
	3,  // 15: notif.middleware.notif.goodbenefit.v1.Middleware.CreateGoodBenefit:input_type -> notif.middleware.notif.goodbenefit.v1.CreateGoodBenefitRequest
	5,  // 16: notif.middleware.notif.goodbenefit.v1.Middleware.UpdateGoodBenefit:input_type -> notif.middleware.notif.goodbenefit.v1.UpdateGoodBenefitRequest
	7,  // 17: notif.middleware.notif.goodbenefit.v1.Middleware.GetGoodBenefits:input_type -> notif.middleware.notif.goodbenefit.v1.GetGoodBenefitsRequest
	9,  // 18: notif.middleware.notif.goodbenefit.v1.Middleware.GetGoodBenefit:input_type -> notif.middleware.notif.goodbenefit.v1.GetGoodBenefitRequest
	11, // 19: notif.middleware.notif.goodbenefit.v1.Middleware.ExistGoodBenefitConds:input_type -> notif.middleware.notif.goodbenefit.v1.ExistGoodBenefitCondsRequest
	13, // 20: notif.middleware.notif.goodbenefit.v1.Middleware.DeleteGoodBenefit:input_type -> notif.middleware.notif.goodbenefit.v1.DeleteGoodBenefitRequest
	4,  // 21: notif.middleware.notif.goodbenefit.v1.Middleware.CreateGoodBenefit:output_type -> notif.middleware.notif.goodbenefit.v1.CreateGoodBenefitResponse
	6,  // 22: notif.middleware.notif.goodbenefit.v1.Middleware.UpdateGoodBenefit:output_type -> notif.middleware.notif.goodbenefit.v1.UpdateGoodBenefitResponse
	8,  // 23: notif.middleware.notif.goodbenefit.v1.Middleware.GetGoodBenefits:output_type -> notif.middleware.notif.goodbenefit.v1.GetGoodBenefitsResponse
	10, // 24: notif.middleware.notif.goodbenefit.v1.Middleware.GetGoodBenefit:output_type -> notif.middleware.notif.goodbenefit.v1.GetGoodBenefitResponse
	12, // 25: notif.middleware.notif.goodbenefit.v1.Middleware.ExistGoodBenefitConds:output_type -> notif.middleware.notif.goodbenefit.v1.ExistGoodBenefitCondsResponse
	14, // 26: notif.middleware.notif.goodbenefit.v1.Middleware.DeleteGoodBenefit:output_type -> notif.middleware.notif.goodbenefit.v1.DeleteGoodBenefitResponse
