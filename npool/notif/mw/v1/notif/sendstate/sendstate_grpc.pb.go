...
const (
	Middleware_CreateSendState_FullMethodName     = "/notif.middleware.notif.sendstate.v1.Middleware/CreateSendState"
	Middleware_CreateSendStates_FullMethodName    = "/notif.middleware.notif.sendstate.v1.Middleware/CreateSendStates"
	Middleware_GetSendStates_FullMethodName       = "/notif.middleware.notif.sendstate.v1.Middleware/GetSendStates"
	Middleware_GetSendState_FullMethodName        = "/notif.middleware.notif.sendstate.v1.Middleware/GetSendState"
	Middleware_GetSendStateOnly_FullMethodName    = "/notif.middleware.notif.sendstate.v1.Middleware/GetSendStateOnly"
	Middleware_ExistSendState_FullMethodName      = "/notif.middleware.notif.sendstate.v1.Middleware/ExistSendState"
	Middleware_ExistSendStateConds_FullMethodName = "/notif.middleware.notif.sendstate.v1.Middleware/ExistSendStateConds"
	Middleware_DeleteSendState_FullMethodName     = "/notif.middleware.notif.sendstate.v1.Middleware/DeleteSendState"
)
...
func (c *middlewareClient) CreateSendStates(ctx context.Context, in *CreateSendStatesRequest, opts ...grpc.CallOption) (*CreateSendStatesResponse, error) {
	...
	err := c.cc.Invoke(ctx, Middleware_CreateSendStates_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Middleware_CreateSendStates_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Middleware_CreateSendStates_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Middleware_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "notif.middleware.notif.sendstate.v1.Middleware",
	...
	Metadata: "npool/notif/mw/v1/notif/sendstate/sendstate.proto",
}
