...
var file_npool_notif_mw_v1_template_sms_sms_proto_rawDesc = []byte{
	...
	0x74, 0x65, 0x12, 0x2f, 0x2e, 0x6e, 0x6f, 0x74, 0x69, 0x66, 0x2e, 0x6d, 0x69, 0x64, 0x64, 0x6c,
	...
	0x53, 0x54, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65, 0x73, 0x12, 0x30, 0x2e, 0x6e, 0x6f, 0x74,
	...
	0x6c, 0x61, 0x74, 0x65, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x31, 0x2e, 0x6e,
	...
	0x6c, 0x61, 0x74, 0x65, 0x4f, 0x6e, 0x6c, 0x79, 0x12, 0x33, 0x2e, 0x6e, 0x6f, 0x74, 0x69, 0x66,
...
var file_npool_notif_mw_v1_template_sms_sms_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_npool_notif_mw_v1_template_sms_sms_proto_goTypes = []interface{}{
	(*GetSMSTemplateRequest)(nil),      // 0: notif.middleware.sms1.v1.GetSMSTemplateRequest
	(*GetSMSTemplateResponse)(nil),     // 1: notif.middleware.sms1.v1.GetSMSTemplateResponse
	(*GetSMSTemplatesRequest)(nil),     // 2: notif.middleware.sms1.v1.GetSMSTemplatesRequest
	(*GetSMSTemplatesResponse)(nil),    // 3: notif.middleware.sms1.v1.GetSMSTemplatesResponse
	(*GetSMSTemplateOnlyRequest)(nil),  // 4: notif.middleware.sms1.v1.GetSMSTemplateOnlyRequest
	(*GetSMSTemplateOnlyResponse)(nil), // 5: notif.middleware.sms1.v1.GetSMSTemplateOnlyResponse
	(*sms.SMSTemplate)(nil),            // 6: notif.manager.template.sms.v1.SMSTemplate
	(*sms.Conds)(nil),                  // 7: notif.manager.template.sms.v1.Conds
}
var file_npool_notif_mw_v1_template_sms_sms_proto_depIdxs = []int32{
	6, // 0: notif.middleware.sms1.v1.GetSMSTemplateResponse.Info:type_name -> notif.manager.template.sms.v1.SMSTemplate
	7, // 1: notif.middleware.sms1.v1.GetSMSTemplatesRequest.Conds:type_name -> notif.manager.template.sms.v1.Conds
	6, // 2: notif.middleware.sms1.v1.GetSMSTemplatesResponse.Infos:type_name -> notif.manager.template.sms.v1.SMSTemplate
	7, // 3: notif.middleware.sms1.v1.GetSMSTemplateOnlyRequest.Conds:type_name -> notif.manager.template.sms.v1.Conds
	6, // 4: notif.middleware.sms1.v1.GetSMSTemplateOnlyResponse.Info:type_name -> notif.manager.template.sms.v1.SMSTemplate
	0, // 5: notif.middleware.sms1.v1.Middleware.GetSMSTemplate:input_type -> notif.middleware.sms1.v1.GetSMSTemplateRequest
	2, // 6: notif.middleware.sms1.v1.Middleware.GetSMSTemplates:input_type -> notif.middleware.sms1.v1.GetSMSTemplatesRequest
	4, // 7: notif.middleware.sms1.v1.Middleware.GetSMSTemplateOnly:input_type -> notif.middleware.sms1.v1.GetSMSTemplateOnlyRequest
	1, // 8: notif.middleware.sms1.v1.Middleware.GetSMSTemplate:output_type -> notif.middleware.sms1.v1.GetSMSTemplateResponse
	3, // 9: notif.middleware.sms1.v1.Middleware.GetSMSTemplates:output_type -> notif.middleware.sms1.v1.GetSMSTemplatesResponse
	5, // 10: notif.middleware.sms1.v1.Middleware.GetSMSTemplateOnly:output_type -> notif.middleware.sms1.v1.GetSMSTemplateOnlyResponse
