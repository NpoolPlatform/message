...
var file_npool_notif_mw_v1_template_email_email_proto_rawDesc = []byte{
	...
	0x6c, 0x2f, 0x6e, 0x6f, 0x74, 0x69, 0x66, 0x2f, 0x6d, 0x67, 0x72, 0x2f, 0x76, 0x31, 0x2f, 0x74,
	...
	0x69, 0x6c, 0x54, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65, 0x12, 0x33, 0x2e, 0x6e, 0x6f, 0x74,
	...
	0x65, 0x73, 0x74, 0x1a, 0x35, 0x2e, 0x6e, 0x6f, 0x74, 0x69, 0x66, 0x2e, 0x6d, 0x69, 0x64, 0x64,
	...
	0x65, 0x4f, 0x6e, 0x6c, 0x79, 0x12, 0x37, 0x2e, 0x6e, 0x6f, 0x74, 0x69, 0x66, 0x2e, 0x6d, 0x69,
...
var file_npool_notif_mw_v1_template_email_email_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_npool_notif_mw_v1_template_email_email_proto_goTypes = []interface{}{
	(*GetEmailTemplateRequest)(nil),      // 0: notif.middleware.email1.v1.GetEmailTemplateRequest
	(*GetEmailTemplateResponse)(nil),     // 1: notif.middleware.email1.v1.GetEmailTemplateResponse
	(*GetEmailTemplatesRequest)(nil),     // 2: notif.middleware.email1.v1.GetEmailTemplatesRequest
	(*GetEmailTemplatesResponse)(nil),    // 3: notif.middleware.email1.v1.GetEmailTemplatesResponse
	(*GetEmailTemplateOnlyRequest)(nil),  // 4: notif.middleware.email1.v1.GetEmailTemplateOnlyRequest
	(*GetEmailTemplateOnlyResponse)(nil), // 5: notif.middleware.email1.v1.GetEmailTemplateOnlyResponse
	(*email.EmailTemplate)(nil),          // 6: notif.manager.template.email.v1.EmailTemplate
	(*email.Conds)(nil),                  // 7: notif.manager.template.email.v1.Conds
}
var file_npool_notif_mw_v1_template_email_email_proto_depIdxs = []int32{
	6, // 0: notif.middleware.email1.v1.GetEmailTemplateResponse.Info:type_name -> notif.manager.template.email.v1.EmailTemplate
	7, // 1: notif.middleware.email1.v1.GetEmailTemplatesRequest.Conds:type_name -> notif.manager.template.email.v1.Conds
	6, // 2: notif.middleware.email1.v1.GetEmailTemplatesResponse.Infos:type_name -> notif.manager.template.email.v1.EmailTemplate
	7, // 3: notif.middleware.email1.v1.GetEmailTemplateOnlyRequest.Conds:type_name -> notif.manager.template.email.v1.Conds
	6, // 4: notif.middleware.email1.v1.GetEmailTemplateOnlyResponse.Info:type_name -> notif.manager.template.email.v1.EmailTemplate
	0, // 5: notif.middleware.email1.v1.Middleware.GetEmailTemplate:input_type -> notif.middleware.email1.v1.GetEmailTemplateRequest
	2, // 6: notif.middleware.email1.v1.Middleware.GetEmailTemplates:input_type -> notif.middleware.email1.v1.GetEmailTemplatesRequest
	4, // 7: notif.middleware.email1.v1.Middleware.GetEmailTemplateOnly:input_type -> notif.middleware.email1.v1.GetEmailTemplateOnlyRequest
	1, // 8: notif.middleware.email1.v1.Middleware.GetEmailTemplate:output_type -> notif.middleware.email1.v1.GetEmailTemplateResponse
	3, // 9: notif.middleware.email1.v1.Middleware.GetEmailTemplates:output_type -> notif.middleware.email1.v1.GetEmailTemplatesResponse
	5, // 10: notif.middleware.email1.v1.Middleware.GetEmailTemplateOnly:output_type -> notif.middleware.email1.v1.GetEmailTemplateOnlyResponse
