...
type CoinSetting struct {
	...
	ID                    string `protobuf:"bytes,10,opt,name=ID,proto3" json:"ID,omitempty"`
	CoinTypeID            string `protobuf:"bytes,20,opt,name=CoinTypeID,proto3" json:"CoinTypeID,omitempty"`
	WarmAccountCoinAmount string `protobuf:"bytes,30,opt,name=WarmAccountCoinAmount,proto3" json:"WarmAccountCoinAmount,omitempty"`
}
...
func (x *CoinSetting) GetWarmAccountCoinAmount() string {
	if x != nil {
...
var file_npool_cloud_hashing_billing_cloud_hashing_billing_proto_rawDesc = []byte{
	...
	0x18, 0x1e, 0x20, 0x01, 0x28, 0x09, 0x52, 0x15, 0x57, 0x61, 0x72, 0x6d, 0x41, 0x63, 0x63, 0x6f,
