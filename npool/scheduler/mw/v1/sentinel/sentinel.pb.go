...
type BenefitWait struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	GoodIDs  []string `protobuf:"bytes,10,rep,name=GoodIDs,proto3" json:"GoodIDs,omitempty"`
	RewardAt uint32   `protobuf:"varint,20,opt,name=RewardAt,proto3" json:"RewardAt,omitempty"`
}

func (x *BenefitWait) Reset() {
	*x = BenefitWait{}
...
func (x *BenefitWait) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BenefitWait) ProtoMessage() {}

func (x *BenefitWait) ProtoReflect() protoreflect.Message {
	mi := &file_npool_scheduler_mw_v1_sentinel_sentinel_proto_msgTypes[0]
...
// Deprecated: Use BenefitWait.ProtoReflect.Descriptor instead.
func (*BenefitWait) Descriptor() ([]byte, []int) {
	return file_npool_scheduler_mw_v1_sentinel_sentinel_proto_rawDescGZIP(), []int{0}
}

func (x *BenefitWait) GetGoodIDs() []string {
	if x != nil {
		return x.GoodIDs
	}
	return nil
...
func (x *BenefitWait) GetRewardAt() uint32 {
	if x != nil {
		return x.RewardAt
	}
	return 0
...
func (x *TriggerRequest) GetBenefitWait() *BenefitWait {
	if x, ok := x.GetCond().(*TriggerRequest_BenefitWait); ok {
		return x.BenefitWait
	}
	return nil
}
...
type TriggerRequest_BenefitWait struct {
	BenefitWait *BenefitWait `protobuf:"bytes,20,opt,name=BenefitWait,proto3,oneof"`
}

func (*TriggerRequest_BenefitWait) isTriggerRequest_Cond() {}
...
func (*TriggerResponse) Descriptor() ([]byte, []int) {
	return file_npool_scheduler_mw_v1_sentinel_sentinel_proto_rawDescGZIP(), []int{2}
}
...
var file_npool_scheduler_mw_v1_sentinel_sentinel_proto_rawDesc = []byte{
	...
	,
...
var file_npool_scheduler_mw_v1_sentinel_sentinel_proto_goTypes = []interface{}{
	...
	(*TriggerRequest)(nil),  // 1: scheduler.middleware.sentinel.v1.TriggerRequest
	(*TriggerResponse)(nil), // 2: scheduler.middleware.sentinel.v1.TriggerResponse
}
var file_npool_scheduler_mw_v1_sentinel_sentinel_proto_depIdxs = []int32{
	0, // 0: scheduler.middleware.sentinel.v1.TriggerRequest.BenefitWait:type_name -> scheduler.middleware.sentinel.v1.BenefitWait
	1, // 1: scheduler.middleware.sentinel.v1.Middleware.Trigger:input_type -> scheduler.middleware.sentinel.v1.TriggerRequest
	2, // 2: scheduler.middleware.sentinel.v1.Middleware.Trigger:output_type -> scheduler.middleware.sentinel.v1.TriggerResponse
...
func file_npool_scheduler_mw_v1_sentinel_sentinel_proto_init() {
	...
	file_npool_scheduler_mw_v1_sentinel_sentinel_proto_msgTypes[1].OneofWrappers = []interface{}{
		(*TriggerRequest_BenefitWait)(nil),
	}
	type x struct{}
