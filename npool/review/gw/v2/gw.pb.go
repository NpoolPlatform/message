...
var file_npool_review_gw_v2_gw_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x22, 0x89, 0x01, 0x0a, 0x13, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x52, 0x65, 0x76,
	...
	0x65, 0x77, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x05, 0x53, 0x74, 0x61, 0x74, 0x65, 0x22, 0x45,
	...
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x72, 0x65, 0x76, 0x69, 0x65, 0x77, 0x2e, 0x67, 0x61,
	0x74, 0x65, 0x77, 0x61, 0x79, 0x2e, 0x76, 0x32, 0x2e, 0x52, 0x65, 0x76, 0x69, 0x65, 0x77, 0x52,
	0x04, 0x49, 0x6e, 0x66, 0x6f, 0x22, 0x98, 0x01, 0x0a, 0x16, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65,
	0x41, 0x70, 0x70, 0x52, 0x65, 0x76, 0x69, 0x65, 0x77, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	...
	0x28, 0x09, 0x52, 0x06, 0x55, 0x73, 0x65, 0x72, 0x49, 0x44, 0x12, 0x34, 0x0a, 0x05, 0x53, 0x74,
	0x61, 0x74, 0x65, 0x18, 0x28, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1e, 0x2e, 0x72, 0x65, 0x76, 0x69,
	...
	0x22, 0x48, 0x0a, 0x17, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x41, 0x70, 0x70, 0x52, 0x65, 0x76,
	...
	0x65, 0x77, 0x2e, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2e, 0x76, 0x32, 0x2e, 0x52, 0x65,
	0x76, 0x69, 0x65, 0x77, 0x52, 0x04, 0x49, 0x6e, 0x66, 0x6f, 0x32, 0x95, 0x02, 0x0a, 0x07, 0x47,
	0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x12, 0x7d, 0x0a, 0x0c, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65,
	...
	0x69, 0x65, 0x77, 0x2f, 0x67, 0x77, 0x2f, 0x76, 0x32, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
...
var file_npool_review_gw_v2_gw_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_npool_review_gw_v2_gw_proto_goTypes = []interface{}{
	...
	(v2.ReviewState)(0),             // 5: review.manager.v2.ReviewState
	(v2.ReviewTriggerType)(0),       // 6: review.manager.v2.ReviewTriggerType
}
var file_npool_review_gw_v2_gw_proto_depIdxs = []int32{
	5, // 0: review.gateway.v2.Review.State:type_name -> review.manager.v2.ReviewState
	6, // 1: review.gateway.v2.Review.Trigger:type_name -> review.manager.v2.ReviewTriggerType
	5, // 2: review.gateway.v2.UpdateReviewRequest.State:type_name -> review.manager.v2.ReviewState
	0, // 3: review.gateway.v2.UpdateReviewResponse.Info:type_name -> review.gateway.v2.Review
	5, // 4: review.gateway.v2.UpdateAppReviewRequest.State:type_name -> review.manager.v2.ReviewState
	...
	2, // 8: review.gateway.v2.Gateway.UpdateReview:output_type -> review.gateway.v2.UpdateReviewResponse
	4, // 9: review.gateway.v2.Gateway.UpdateAppReview:output_type -> review.gateway.v2.UpdateAppReviewResponse
