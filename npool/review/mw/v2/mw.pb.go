...
var file_npool_review_mw_v2_mw_proto_depIdxs = []int32{
	0, // 0: review.middleware.v2.Middleware.Version:input_type -> google.protobuf.Empty
	1, // 1: review.middleware.v2.Middleware.Version:output_type -> npool.v1.VersionResponse
