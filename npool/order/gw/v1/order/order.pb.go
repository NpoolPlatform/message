...
var file_npool_order_gw_v1_order_order_proto_goTypes = []interface{}{
	...
	(v12.OrderState)(0),                  // 31: basetypes.order.v1.OrderState
	(v12.OrderType)(0),                   // 32: basetypes.order.v1.OrderType
	(v12.PaymentType)(0),                 // 33: basetypes.order.v1.PaymentType
	(v12.PaymentState)(0),                // 34: basetypes.order.v1.PaymentState
	(v12.InvestmentType)(0),              // 35: basetypes.order.v1.InvestmentType
}
var file_npool_order_gw_v1_order_order_proto_depIdxs = []int32{
	...
	31, // 2: order.gateway.order1.v1.Order.OrderState:type_name -> basetypes.order.v1.OrderState
	31, // 3: order.gateway.order1.v1.Order.CancelState:type_name -> basetypes.order.v1.OrderState
	32, // 4: order.gateway.order1.v1.Order.OrderType:type_name -> basetypes.order.v1.OrderType
	33, // 5: order.gateway.order1.v1.Order.PaymentType:type_name -> basetypes.order.v1.PaymentType
	34, // 6: order.gateway.order1.v1.Order.PaymentState:type_name -> basetypes.order.v1.PaymentState
	35, // 7: order.gateway.order1.v1.Order.InvestmentType:type_name -> basetypes.order.v1.InvestmentType
	0,  // 8: order.gateway.order1.v1.Order.Coupons:type_name -> order.gateway.order1.v1.Coupon
	35, // 9: order.gateway.order1.v1.CreateOrderRequest.InvestmentType:type_name -> basetypes.order.v1.InvestmentType
	1,  // 10: order.gateway.order1.v1.CreateOrderResponse.Info:type_name -> order.gateway.order1.v1.Order
	35, // 11: order.gateway.order1.v1.CreateOrdersRequest.InvestmentType:type_name -> basetypes.order.v1.InvestmentType
	28, // 12: order.gateway.order1.v1.CreateOrdersRequest.Orders:type_name -> order.gateway.order1.v1.CreateOrdersRequest.OrderReq
	...
	32, // 20: order.gateway.order1.v1.CreateUserOrderRequest.OrderType:type_name -> basetypes.order.v1.OrderType
	35, // 21: order.gateway.order1.v1.CreateUserOrderRequest.InvestmentType:type_name -> basetypes.order.v1.InvestmentType
	1,  // 22: order.gateway.order1.v1.CreateUserOrderResponse.Info:type_name -> order.gateway.order1.v1.Order
	32, // 23: order.gateway.order1.v1.CreateAppUserOrderRequest.OrderType:type_name -> basetypes.order.v1.OrderType
	35, // 24: order.gateway.order1.v1.CreateAppUserOrderRequest.InvestmentType:type_name -> basetypes.order.v1.InvestmentType
	...
	2,  // 29: order.gateway.order1.v1.Gateway.CreateOrder:input_type -> order.gateway.order1.v1.CreateOrderRequest
	4,  // 30: order.gateway.order1.v1.Gateway.CreateOrders:input_type -> order.gateway.order1.v1.CreateOrdersRequest
	6,  // 31: order.gateway.order1.v1.Gateway.UpdateOrder:input_type -> order.gateway.order1.v1.UpdateOrderRequest
	8,  // 32: order.gateway.order1.v1.Gateway.UpdateUserOrder:input_type -> order.gateway.order1.v1.UpdateUserOrderRequest
	10, // 33: order.gateway.order1.v1.Gateway.UpdateAppUserOrder:input_type -> order.gateway.order1.v1.UpdateAppUserOrderRequest
	12, // 34: order.gateway.order1.v1.Gateway.GetOrder:input_type -> order.gateway.order1.v1.GetOrderRequest
	14, // 35: order.gateway.order1.v1.Gateway.GetOrders:input_type -> order.gateway.order1.v1.GetOrdersRequest
	18, // 36: order.gateway.order1.v1.Gateway.CreateUserOrder:input_type -> order.gateway.order1.v1.CreateUserOrderRequest
	20, // 37: order.gateway.order1.v1.Gateway.CreateAppUserOrder:input_type -> order.gateway.order1.v1.CreateAppUserOrderRequest
	16, // 38: order.gateway.order1.v1.Gateway.GetUserOrders:input_type -> order.gateway.order1.v1.GetUserOrdersRequest
	22, // 39: order.gateway.order1.v1.Gateway.GetAppUserOrders:input_type -> order.gateway.order1.v1.GetAppUserOrdersRequest
	24, // 40: order.gateway.order1.v1.Gateway.GetAppOrders:input_type -> order.gateway.order1.v1.GetAppOrdersRequest
	26, // 41: order.gateway.order1.v1.Gateway.GetNAppOrders:input_type -> order.gateway.order1.v1.GetNAppOrdersRequest
	3,  // 42: order.gateway.order1.v1.Gateway.CreateOrder:output_type -> order.gateway.order1.v1.CreateOrderResponse
	5,  // 43: order.gateway.order1.v1.Gateway.CreateOrders:output_type -> order.gateway.order1.v1.CreateOrdersResponse
	7,  // 44: order.gateway.order1.v1.Gateway.UpdateOrder:output_type -> order.gateway.order1.v1.UpdateOrderResponse
	9,  // 45: order.gateway.order1.v1.Gateway.UpdateUserOrder:output_type -> order.gateway.order1.v1.UpdateUserOrderResponse
	11, // 46: order.gateway.order1.v1.Gateway.UpdateAppUserOrder:output_type -> order.gateway.order1.v1.UpdateAppUserOrderResponse
	13, // 47: order.gateway.order1.v1.Gateway.GetOrder:output_type -> order.gateway.order1.v1.GetOrderResponse
	15, // 48: order.gateway.order1.v1.Gateway.GetOrders:output_type -> order.gateway.order1.v1.GetOrdersResponse
	19, // 49: order.gateway.order1.v1.Gateway.CreateUserOrder:output_type -> order.gateway.order1.v1.CreateUserOrderResponse
	21, // 50: order.gateway.order1.v1.Gateway.CreateAppUserOrder:output_type -> order.gateway.order1.v1.CreateAppUserOrderResponse
	17, // 51: order.gateway.order1.v1.Gateway.GetUserOrders:output_type -> order.gateway.order1.v1.GetUserOrdersResponse
	23, // 52: order.gateway.order1.v1.Gateway.GetAppUserOrders:output_type -> order.gateway.order1.v1.GetAppUserOrdersResponse
	25, // 53: order.gateway.order1.v1.Gateway.GetAppOrders:output_type -> order.gateway.order1.v1.GetAppOrdersResponse
	27, // 54: order.gateway.order1.v1.Gateway.GetNAppOrders:output_type -> order.gateway.order1.v1.GetNAppOrdersResponse
