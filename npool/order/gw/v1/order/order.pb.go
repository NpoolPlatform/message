...
var file_npool_order_gw_v1_order_order_proto_rawDesc = []byte{
	...
	0x22, 0xf8, 0x04, 0x0a, 0x12, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x4f, 0x72, 0x64, 0x65, 0x72,
	...
	0x79, 0x70, 0x65, 0x12, 0x1c, 0x0a, 0x09, 0x43, 0x6f, 0x75, 0x70, 0x6f, 0x6e, 0x49, 0x44, 0x73,
	0x18, 0x78, 0x20, 0x03, 0x28, 0x09, 0x52, 0x09, 0x43, 0x6f, 0x75, 0x70, 0x6f, 0x6e, 0x49, 0x44,
	0x73, 0x12, 0x4b, 0x0a, 0x0e, 0x49, 0x6e, 0x76, 0x65, 0x73, 0x74, 0x6d, 0x65, 0x6e, 0x74, 0x54,
	0x79, 0x70, 0x65, 0x18, 0x82, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x22, 0x2e, 0x62, 0x61, 0x73,
	...
	0x2f, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x3a, 0x01, 0x2a, 0x12, 0x85, 0x01, 0x0a, 0x0b, 0x55, 0x70,
	...
	0x31, 0x2f, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x2f, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x3a, 0x01,
	0x2a, 0x12, 0x96, 0x01, 0x0a, 0x0f, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x55, 0x73, 0x65, 0x72,
	...
	0x72, 0x2f, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x3a, 0x01, 0x2a, 0x12, 0xa3, 0x01, 0x0a, 0x12, 0x55,
	...
	0x70, 0x70, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x2f, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x3a, 0x01, 0x2a,
	...
	0x65, 0x74, 0x2f, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x3a, 0x01, 0x2a, 0x12, 0x7d, 0x0a, 0x09, 0x47,
	...
	0x2f, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x73, 0x3a, 0x01, 0x2a, 0x12, 0x96, 0x01, 0x0a, 0x0f, 0x43,
	...
	0x3a, 0x01, 0x2a, 0x12, 0xa3, 0x01, 0x0a, 0x12, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x41, 0x70,
	...
	0x2f, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x3a, 0x01, 0x2a, 0x12, 0x8e, 0x01, 0x0a, 0x0d, 0x47, 0x65,
	...
	0x02, 0x18, 0x22, 0x13, 0x2f, 0x76, 0x31, 0x2f, 0x67, 0x65, 0x74, 0x2f, 0x75, 0x73, 0x65, 0x72,
	0x2f, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x73, 0x3a, 0x01, 0x2a, 0x12, 0x9b, 0x01, 0x0a, 0x10, 0x47,
	...
	0x72, 0x64, 0x65, 0x72, 0x73, 0x3a, 0x01, 0x2a, 0x12, 0x8a, 0x01, 0x0a, 0x0c, 0x47, 0x65, 0x74,
	...
	0x72, 0x73, 0x3a, 0x01, 0x2a, 0x12, 0x8f, 0x01, 0x0a, 0x0d, 0x47, 0x65, 0x74, 0x4e, 0x41, 0x70,
	...
	0x64, 0x65, 0x72, 0x73, 0x3a, 0x01, 0x2a, 0x42, 0x3a, 0x5a, 0x38, 0x67, 0x69, 0x74, 0x68, 0x75,
...
var file_npool_order_gw_v1_order_order_proto_depIdxs = []int32{
	...
	29, // 3: order.gateway.order1.v1.Order.InvestmentType:type_name -> basetypes.order.v1.InvestmentType
	0,  // 4: order.gateway.order1.v1.Order.Coupons:type_name -> order.gateway.order1.v1.Coupon
	28, // 5: order.gateway.order1.v1.CreateOrderRequest.OrderType:type_name -> basetypes.order.v1.OrderType
	29, // 6: order.gateway.order1.v1.CreateOrderRequest.InvestmentType:type_name -> basetypes.order.v1.InvestmentType
	1,  // 7: order.gateway.order1.v1.CreateOrderResponse.Info:type_name -> order.gateway.order1.v1.Order
	1,  // 8: order.gateway.order1.v1.UpdateOrderResponse.Info:type_name -> order.gateway.order1.v1.Order
	1,  // 9: order.gateway.order1.v1.UpdateUserOrderResponse.Info:type_name -> order.gateway.order1.v1.Order
	1,  // 10: order.gateway.order1.v1.UpdateAppUserOrderResponse.Info:type_name -> order.gateway.order1.v1.Order
	1,  // 11: order.gateway.order1.v1.GetOrderResponse.Info:type_name -> order.gateway.order1.v1.Order
	1,  // 12: order.gateway.order1.v1.GetOrdersResponse.Infos:type_name -> order.gateway.order1.v1.Order
	28, // 13: order.gateway.order1.v1.CreateUserOrderRequest.OrderType:type_name -> basetypes.order.v1.OrderType
	29, // 14: order.gateway.order1.v1.CreateUserOrderRequest.InvestmentType:type_name -> basetypes.order.v1.InvestmentType
	1,  // 15: order.gateway.order1.v1.CreateUserOrderResponse.Info:type_name -> order.gateway.order1.v1.Order
	28, // 16: order.gateway.order1.v1.CreateAppUserOrderRequest.OrderType:type_name -> basetypes.order.v1.OrderType
	29, // 17: order.gateway.order1.v1.CreateAppUserOrderRequest.InvestmentType:type_name -> basetypes.order.v1.InvestmentType
	1,  // 18: order.gateway.order1.v1.CreateAppUserOrderResponse.Info:type_name -> order.gateway.order1.v1.Order
	1,  // 19: order.gateway.order1.v1.GetUserOrdersResponse.Infos:type_name -> order.gateway.order1.v1.Order
	1,  // 20: order.gateway.order1.v1.GetAppUserOrdersResponse.Infos:type_name -> order.gateway.order1.v1.Order
	1,  // 21: order.gateway.order1.v1.GetAppOrdersResponse.Infos:type_name -> order.gateway.order1.v1.Order
	1,  // 22: order.gateway.order1.v1.GetNAppOrdersResponse.Infos:type_name -> order.gateway.order1.v1.Order
	2,  // 23: order.gateway.order1.v1.Gateway.CreateOrder:input_type -> order.gateway.order1.v1.CreateOrderRequest
	4,  // 24: order.gateway.order1.v1.Gateway.UpdateOrder:input_type -> order.gateway.order1.v1.UpdateOrderRequest
	6,  // 25: order.gateway.order1.v1.Gateway.UpdateUserOrder:input_type -> order.gateway.order1.v1.UpdateUserOrderRequest
	8,  // 26: order.gateway.order1.v1.Gateway.UpdateAppUserOrder:input_type -> order.gateway.order1.v1.UpdateAppUserOrderRequest
	10, // 27: order.gateway.order1.v1.Gateway.GetOrder:input_type -> order.gateway.order1.v1.GetOrderRequest
	12, // 28: order.gateway.order1.v1.Gateway.GetOrders:input_type -> order.gateway.order1.v1.GetOrdersRequest
	15, // 29: order.gateway.order1.v1.Gateway.CreateUserOrder:input_type -> order.gateway.order1.v1.CreateUserOrderRequest
	17, // 30: order.gateway.order1.v1.Gateway.CreateAppUserOrder:input_type -> order.gateway.order1.v1.CreateAppUserOrderRequest
	14, // 31: order.gateway.order1.v1.Gateway.GetUserOrders:input_type -> order.gateway.order1.v1.GetUserOrdersRequest
	20, // 32: order.gateway.order1.v1.Gateway.GetAppUserOrders:input_type -> order.gateway.order1.v1.GetAppUserOrdersRequest
	22, // 33: order.gateway.order1.v1.Gateway.GetAppOrders:input_type -> order.gateway.order1.v1.GetAppOrdersRequest
	24, // 34: order.gateway.order1.v1.Gateway.GetNAppOrders:input_type -> order.gateway.order1.v1.GetNAppOrdersRequest
	3,  // 35: order.gateway.order1.v1.Gateway.CreateOrder:output_type -> order.gateway.order1.v1.CreateOrderResponse
	5,  // 36: order.gateway.order1.v1.Gateway.UpdateOrder:output_type -> order.gateway.order1.v1.UpdateOrderResponse
	7,  // 37: order.gateway.order1.v1.Gateway.UpdateUserOrder:output_type -> order.gateway.order1.v1.UpdateUserOrderResponse
	9,  // 38: order.gateway.order1.v1.Gateway.UpdateAppUserOrder:output_type -> order.gateway.order1.v1.UpdateAppUserOrderResponse
	11, // 39: order.gateway.order1.v1.Gateway.GetOrder:output_type -> order.gateway.order1.v1.GetOrderResponse
	13, // 40: order.gateway.order1.v1.Gateway.GetOrders:output_type -> order.gateway.order1.v1.GetOrdersResponse
	16, // 41: order.gateway.order1.v1.Gateway.CreateUserOrder:output_type -> order.gateway.order1.v1.CreateUserOrderResponse
	18, // 42: order.gateway.order1.v1.Gateway.CreateAppUserOrder:output_type -> order.gateway.order1.v1.CreateAppUserOrderResponse
	19, // 43: order.gateway.order1.v1.Gateway.GetUserOrders:output_type -> order.gateway.order1.v1.GetUserOrdersResponse
	21, // 44: order.gateway.order1.v1.Gateway.GetAppUserOrders:output_type -> order.gateway.order1.v1.GetAppUserOrdersResponse
	23, // 45: order.gateway.order1.v1.Gateway.GetAppOrders:output_type -> order.gateway.order1.v1.GetAppOrdersResponse
	25, // 46: order.gateway.order1.v1.Gateway.GetNAppOrders:output_type -> order.gateway.order1.v1.GetNAppOrdersResponse
