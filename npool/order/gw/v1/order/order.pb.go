...
var file_npool_order_gw_v1_order_order_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x0d, 0x52, 0x03, 0x45, 0x6e, 0x64, 0x22, 0xd0, 0x03, 0x0a, 0x12, 0x43, 0x72,
	...
	0x65, 0x63, 0x69, 0x61, 0x6c, 0x4f, 0x66, 0x66, 0x65, 0x72, 0x49, 0x44, 0x88, 0x01, 0x01, 0x42,
	...
	0x65, 0x63, 0x69, 0x61, 0x6c, 0x4f, 0x66, 0x66, 0x65, 0x72, 0x49, 0x44, 0x22, 0x49, 0x0a, 0x13,
	...
	0x52, 0x05, 0x4c, 0x69, 0x6d, 0x69, 0x74, 0x22, 0x49, 0x0a, 0x11, 0x47, 0x65, 0x74, 0x4f, 0x72,
	...
	0x6f, 0x73, 0x22, 0x7e, 0x0a, 0x14, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x4f, 0x72, 0x64,
	...
	0x69, 0x74, 0x22, 0xa7, 0x04, 0x0a, 0x16, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x55, 0x73, 0x65,
	...
	0x69, 0x78, 0x41, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x49, 0x44, 0x42, 0x0d, 0x0a, 0x0b, 0x5f, 0x44,
	0x69, 0x73, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x49, 0x44, 0x42, 0x11, 0x0a, 0x0f, 0x5f, 0x53, 0x70,
	0x65, 0x63, 0x69, 0x61, 0x6c, 0x4f, 0x66, 0x66, 0x65, 0x72, 0x49, 0x44, 0x22, 0x4d, 0x0a, 0x17,
	...
	0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x04, 0x49, 0x6e, 0x66, 0x6f, 0x22, 0xb6, 0x04, 0x0a, 0x19,
	...
	0x65, 0x72, 0x49, 0x44, 0x22, 0x50, 0x0a, 0x1a, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x41, 0x70,
	...
	0x52, 0x04, 0x49, 0x6e, 0x66, 0x6f, 0x22, 0x4d, 0x0a, 0x15, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65,
	...
	0x49, 0x6e, 0x66, 0x6f, 0x73, 0x22, 0x8d, 0x01, 0x0a, 0x17, 0x47, 0x65, 0x74, 0x41, 0x70, 0x70,
	...
	0x4c, 0x69, 0x6d, 0x69, 0x74, 0x22, 0x50, 0x0a, 0x18, 0x47, 0x65, 0x74, 0x41, 0x70, 0x70, 0x55,
	...
	0x32, 0x1e, 0x2e, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x2e, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79,
	0x2e, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x31, 0x2e, 0x76, 0x31, 0x2e, 0x4f, 0x72, 0x64, 0x65, 0x72,
	0x52, 0x05, 0x49, 0x6e, 0x66, 0x6f, 0x73, 0x32, 0xfe, 0x06, 0x0a, 0x07, 0x47, 0x61, 0x74, 0x65,
	...
	0x74, 0x65, 0x2f, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x3a, 0x01, 0x2a, 0x12, 0x7d, 0x0a, 0x09, 0x47,
...
var file_npool_order_gw_v1_order_order_proto_depIdxs = []int32{
	...
	0,  // 2: order.gateway.order1.v1.CreateOrderResponse.Info:type_name -> order.gateway.order1.v1.Order
	0,  // 3: order.gateway.order1.v1.GetOrdersResponse.Infos:type_name -> order.gateway.order1.v1.Order
	14, // 4: order.gateway.order1.v1.CreateUserOrderRequest.OrderType:type_name -> order.manager.order.order.v1.OrderType
	0,  // 5: order.gateway.order1.v1.CreateUserOrderResponse.Info:type_name -> order.gateway.order1.v1.Order
	14, // 6: order.gateway.order1.v1.CreateAppUserOrderRequest.OrderType:type_name -> order.manager.order.order.v1.OrderType
	0,  // 7: order.gateway.order1.v1.CreateAppUserOrderResponse.Info:type_name -> order.gateway.order1.v1.Order
	0,  // 8: order.gateway.order1.v1.GetUserOrdersResponse.Infos:type_name -> order.gateway.order1.v1.Order
	0,  // 9: order.gateway.order1.v1.GetAppUserOrdersResponse.Infos:type_name -> order.gateway.order1.v1.Order
	1,  // 10: order.gateway.order1.v1.Gateway.CreateOrder:input_type -> order.gateway.order1.v1.CreateOrderRequest
	3,  // 11: order.gateway.order1.v1.Gateway.GetOrders:input_type -> order.gateway.order1.v1.GetOrdersRequest
	6,  // 12: order.gateway.order1.v1.Gateway.CreateUserOrder:input_type -> order.gateway.order1.v1.CreateUserOrderRequest
	8,  // 13: order.gateway.order1.v1.Gateway.CreateAppUserOrder:input_type -> order.gateway.order1.v1.CreateAppUserOrderRequest
	5,  // 14: order.gateway.order1.v1.Gateway.GetUserOrders:input_type -> order.gateway.order1.v1.GetUserOrdersRequest
	11, // 15: order.gateway.order1.v1.Gateway.GetAppUserOrders:input_type -> order.gateway.order1.v1.GetAppUserOrdersRequest
	2,  // 16: order.gateway.order1.v1.Gateway.CreateOrder:output_type -> order.gateway.order1.v1.CreateOrderResponse
	4,  // 17: order.gateway.order1.v1.Gateway.GetOrders:output_type -> order.gateway.order1.v1.GetOrdersResponse
	7,  // 18: order.gateway.order1.v1.Gateway.CreateUserOrder:output_type -> order.gateway.order1.v1.CreateUserOrderResponse
	9,  // 19: order.gateway.order1.v1.Gateway.CreateAppUserOrder:output_type -> order.gateway.order1.v1.CreateAppUserOrderResponse
	10, // 20: order.gateway.order1.v1.Gateway.GetUserOrders:output_type -> order.gateway.order1.v1.GetUserOrdersResponse
	12, // 21: order.gateway.order1.v1.Gateway.GetAppUserOrders:output_type -> order.gateway.order1.v1.GetAppUserOrdersResponse
