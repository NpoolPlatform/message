...
const (
	Manager_CreateOrder_FullMethodName     = "/order.manager.order.v1.Manager/CreateOrder"
	Manager_CreateOrders_FullMethodName    = "/order.manager.order.v1.Manager/CreateOrders"
	Manager_UpdateOrder_FullMethodName     = "/order.manager.order.v1.Manager/UpdateOrder"
	Manager_GetOrder_FullMethodName        = "/order.manager.order.v1.Manager/GetOrder"
	Manager_GetOrderOnly_FullMethodName    = "/order.manager.order.v1.Manager/GetOrderOnly"
	Manager_GetOrders_FullMethodName       = "/order.manager.order.v1.Manager/GetOrders"
	Manager_ExistOrder_FullMethodName      = "/order.manager.order.v1.Manager/ExistOrder"
	Manager_ExistOrderConds_FullMethodName = "/order.manager.order.v1.Manager/ExistOrderConds"
	Manager_CountOrders_FullMethodName     = "/order.manager.order.v1.Manager/CountOrders"
	Manager_DeleteOrder_FullMethodName     = "/order.manager.order.v1.Manager/DeleteOrder"
)
