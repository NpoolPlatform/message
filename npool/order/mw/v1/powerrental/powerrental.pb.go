...
var file_npool_order_mw_v1_powerrental_powerrental_proto_rawDesc = []byte{
	...
	0x64, 0x64, 0x6c, 0x65, 0x77, 0x61, 0x72, 0x65, 0x2e, 0x70, 0x6f, 0x77, 0x65, 0x72, 0x72, 0x65,
	0x6e, 0x74, 0x61, 0x6c, 0x2e, 0x76, 0x31, 0x2e, 0x50, 0x6f, 0x77, 0x65, 0x72, 0x52, 0x65, 0x6e,
	0x74, 0x61, 0x6c, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x04, 0x49, 0x6e, 0x66, 0x6f, 0x32, 0xcd,
	0x0c, 0x0a, 0x0a, 0x4d, 0x69, 0x64, 0x64, 0x6c, 0x65, 0x77, 0x61, 0x72, 0x65, 0x12, 0x9b, 0x01,
	...
	0x9e, 0x01, 0x0a, 0x17, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x50, 0x6f, 0x77, 0x65, 0x72, 0x52,
	0x65, 0x6e, 0x74, 0x61, 0x6c, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x73, 0x12, 0x3f, 0x2e, 0x6f, 0x72,
	...
	0x72, 0x64, 0x65, 0x72, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x40, 0x2e, 0x6f,
	0x72, 0x64, 0x65, 0x72, 0x2e, 0x6d, 0x69, 0x64, 0x64, 0x6c, 0x65, 0x77, 0x61, 0x72, 0x65, 0x2e,
	0x70, 0x6f, 0x77, 0x65, 0x72, 0x72, 0x65, 0x6e, 0x74, 0x61, 0x6c, 0x2e, 0x76, 0x31, 0x2e, 0x55,
	0x70, 0x64, 0x61, 0x74, 0x65, 0x50, 0x6f, 0x77, 0x65, 0x72, 0x52, 0x65, 0x6e, 0x74, 0x61, 0x6c,
...
var file_npool_order_mw_v1_powerrental_powerrental_proto_goTypes = []interface{}{
	...
	(*ExistPowerRentalOrderRequest)(nil),           // 17: order.middleware.powerrental.v1.ExistPowerRentalOrderRequest
	(*ExistPowerRentalOrderResponse)(nil),          // 18: order.middleware.powerrental.v1.ExistPowerRentalOrderResponse
	(*ExistPowerRentalOrderCondsRequest)(nil),      // 19: order.middleware.powerrental.v1.ExistPowerRentalOrderCondsRequest
	(*ExistPowerRentalOrderCondsResponse)(nil),     // 20: order.middleware.powerrental.v1.ExistPowerRentalOrderCondsResponse
	(*DeletePowerRentalOrderRequest)(nil),          // 21: order.middleware.powerrental.v1.DeletePowerRentalOrderRequest
	(*DeletePowerRentalOrderResponse)(nil),         // 22: order.middleware.powerrental.v1.DeletePowerRentalOrderResponse
	...
	(v11.InvestmentType)(0),                        // 27: basetypes.order.v1.InvestmentType
	...
	(v11.PaymentState)(0),                          // 31: basetypes.order.v1.PaymentState
	(v11.OrderRenewState)(0),                       // 32: basetypes.order.v1.OrderRenewState
	(*payment.PaymentBalanceReq)(nil),              // 33: order.middleware.payment.v1.PaymentBalanceReq
	(*payment.PaymentTransferReq)(nil),             // 34: order.middleware.payment.v1.PaymentTransferReq
	(*coupon.OrderCouponInfo)(nil),                 // 35: order.middleware.order1.coupon.v1.OrderCouponInfo
	(*payment.PaymentBalanceInfo)(nil),             // 36: order.middleware.payment.v1.PaymentBalanceInfo
	(*payment.PaymentTransferInfo)(nil),            // 37: order.middleware.payment.v1.PaymentTransferInfo
	(*fee.FeeDuration)(nil),                        // 38: order.middleware.fee.v1.FeeDuration
	(*v12.Uint32Val)(nil),                          // 39: basetypes.v1.Uint32Val
	(*v12.Uint32SliceVal)(nil),                     // 40: basetypes.v1.Uint32SliceVal
	(*v12.StringVal)(nil),                          // 41: basetypes.v1.StringVal
	(*v12.StringSliceVal)(nil),                     // 42: basetypes.v1.StringSliceVal
	(*v12.BoolVal)(nil),                            // 43: basetypes.v1.BoolVal
	(*fee.FeeOrderReq)(nil),                        // 44: order.middleware.fee.v1.FeeOrderReq
}
var file_npool_order_mw_v1_powerrental_powerrental_proto_depIdxs = []int32{
	23, // 0: order.middleware.powerrental.v1.PowerRentalOrderReq.GoodType:type_name -> basetypes.good.v1.GoodType
	24, // 1: order.middleware.powerrental.v1.PowerRentalOrderReq.OrderType:type_name -> basetypes.order.v1.OrderType
	...
	27, // 4: order.middleware.powerrental.v1.PowerRentalOrderReq.InvestmentType:type_name -> basetypes.order.v1.InvestmentType
	28, // 5: order.middleware.powerrental.v1.PowerRentalOrderReq.OrderState:type_name -> basetypes.order.v1.OrderState
	29, // 6: order.middleware.powerrental.v1.PowerRentalOrderReq.StartMode:type_name -> basetypes.order.v1.OrderStartMode
	30, // 7: order.middleware.powerrental.v1.PowerRentalOrderReq.BenefitState:type_name -> basetypes.order.v1.BenefitState
	31, // 8: order.middleware.powerrental.v1.PowerRentalOrderReq.PaymentState:type_name -> basetypes.order.v1.PaymentState
	32, // 9: order.middleware.powerrental.v1.PowerRentalOrderReq.RenewState:type_name -> basetypes.order.v1.OrderRenewState
	33, // 10: order.middleware.powerrental.v1.PowerRentalOrderReq.PaymentBalances:type_name -> order.middleware.payment.v1.PaymentBalanceReq
	34, // 11: order.middleware.powerrental.v1.PowerRentalOrderReq.PaymentTransfers:type_name -> order.middleware.payment.v1.PaymentTransferReq
	23, // 12: order.middleware.powerrental.v1.PowerRentalOrder.GoodType:type_name -> basetypes.good.v1.GoodType
	24, // 13: order.middleware.powerrental.v1.PowerRentalOrder.OrderType:type_name -> basetypes.order.v1.OrderType
	25, // 14: order.middleware.powerrental.v1.PowerRentalOrder.PaymentType:type_name -> basetypes.order.v1.PaymentType
	26, // 15: order.middleware.powerrental.v1.PowerRentalOrder.CreateMethod:type_name -> basetypes.order.v1.OrderCreateMethod
	28, // 16: order.middleware.powerrental.v1.PowerRentalOrder.OrderState:type_name -> basetypes.order.v1.OrderState
	29, // 17: order.middleware.powerrental.v1.PowerRentalOrder.StartMode:type_name -> basetypes.order.v1.OrderStartMode
	30, // 18: order.middleware.powerrental.v1.PowerRentalOrder.BenefitState:type_name -> basetypes.order.v1.BenefitState
	27, // 19: order.middleware.powerrental.v1.PowerRentalOrder.InvestmentType:type_name -> basetypes.order.v1.InvestmentType
	28, // 20: order.middleware.powerrental.v1.PowerRentalOrder.CancelState:type_name -> basetypes.order.v1.OrderState
	31, // 21: order.middleware.powerrental.v1.PowerRentalOrder.PaymentState:type_name -> basetypes.order.v1.PaymentState
	32, // 22: order.middleware.powerrental.v1.PowerRentalOrder.RenewState:type_name -> basetypes.order.v1.OrderRenewState
	35, // 23: order.middleware.powerrental.v1.PowerRentalOrder.Coupons:type_name -> order.middleware.order1.coupon.v1.OrderCouponInfo
	36, // 24: order.middleware.powerrental.v1.PowerRentalOrder.PaymentBalances:type_name -> order.middleware.payment.v1.PaymentBalanceInfo
	37, // 25: order.middleware.powerrental.v1.PowerRentalOrder.PaymentTransfers:type_name -> order.middleware.payment.v1.PaymentTransferInfo
	38, // 26: order.middleware.powerrental.v1.PowerRentalOrder.FeeDurations:type_name -> order.middleware.fee.v1.FeeDuration
	39, // 27: order.middleware.powerrental.v1.Conds.ID:type_name -> basetypes.v1.Uint32Val
	40, // 28: order.middleware.powerrental.v1.Conds.IDs:type_name -> basetypes.v1.Uint32SliceVal
	41, // 29: order.middleware.powerrental.v1.Conds.EntID:type_name -> basetypes.v1.StringVal
	42, // 30: order.middleware.powerrental.v1.Conds.EntIDs:type_name -> basetypes.v1.StringSliceVal
	41, // 31: order.middleware.powerrental.v1.Conds.AppID:type_name -> basetypes.v1.StringVal
	41, // 32: order.middleware.powerrental.v1.Conds.UserID:type_name -> basetypes.v1.StringVal
	41, // 33: order.middleware.powerrental.v1.Conds.GoodID:type_name -> basetypes.v1.StringVal
	42, // 34: order.middleware.powerrental.v1.Conds.GoodIDs:type_name -> basetypes.v1.StringSliceVal
	41, // 35: order.middleware.powerrental.v1.Conds.AppGoodID:type_name -> basetypes.v1.StringVal
	42, // 36: order.middleware.powerrental.v1.Conds.AppGoodIDs:type_name -> basetypes.v1.StringSliceVal
	41, // 37: order.middleware.powerrental.v1.Conds.OrderID:type_name -> basetypes.v1.StringVal
	42, // 38: order.middleware.powerrental.v1.Conds.OrderIDs:type_name -> basetypes.v1.StringSliceVal
	39, // 39: order.middleware.powerrental.v1.Conds.OrderType:type_name -> basetypes.v1.Uint32Val
	39, // 40: order.middleware.powerrental.v1.Conds.PaymentType:type_name -> basetypes.v1.Uint32Val
	40, // 41: order.middleware.powerrental.v1.Conds.PaymentTypes:type_name -> basetypes.v1.Uint32SliceVal
	43, // 42: order.middleware.powerrental.v1.Conds.Simulate:type_name -> basetypes.v1.BoolVal
	40, // 43: order.middleware.powerrental.v1.Conds.OrderTypes:type_name -> basetypes.v1.Uint32SliceVal
	39, // 44: order.middleware.powerrental.v1.Conds.OrderState:type_name -> basetypes.v1.Uint32Val
	40, // 45: order.middleware.powerrental.v1.Conds.OrderStates:type_name -> basetypes.v1.Uint32SliceVal
	39, // 46: order.middleware.powerrental.v1.Conds.StartMode:type_name -> basetypes.v1.Uint32Val
	39, // 47: order.middleware.powerrental.v1.Conds.LastBenefitAt:type_name -> basetypes.v1.Uint32Val
	39, // 48: order.middleware.powerrental.v1.Conds.BenefitState:type_name -> basetypes.v1.Uint32Val
	43, // 49: order.middleware.powerrental.v1.Conds.AdminSetCanceled:type_name -> basetypes.v1.BoolVal
	43, // 50: order.middleware.powerrental.v1.Conds.UserSetCanceled:type_name -> basetypes.v1.BoolVal
	39, // 51: order.middleware.powerrental.v1.Conds.RenewState:type_name -> basetypes.v1.Uint32Val
	39, // 52: order.middleware.powerrental.v1.Conds.RenewNotifyAt:type_name -> basetypes.v1.Uint32Val
	39, // 53: order.middleware.powerrental.v1.Conds.PaymentState:type_name -> basetypes.v1.Uint32Val
	40, // 54: order.middleware.powerrental.v1.Conds.PaymentStates:type_name -> basetypes.v1.Uint32SliceVal
	41, // 55: order.middleware.powerrental.v1.Conds.CouponID:type_name -> basetypes.v1.StringVal
	42, // 56: order.middleware.powerrental.v1.Conds.CouponIDs:type_name -> basetypes.v1.StringSliceVal
	41, // 57: order.middleware.powerrental.v1.Conds.TransactionID:type_name -> basetypes.v1.StringVal
	42, // 58: order.middleware.powerrental.v1.Conds.TransactionIDs:type_name -> basetypes.v1.StringSliceVal
	39, // 59: order.middleware.powerrental.v1.Conds.CreatedAt:type_name -> basetypes.v1.Uint32Val
	39, // 60: order.middleware.powerrental.v1.Conds.UpdatedAt:type_name -> basetypes.v1.Uint32Val
	39, // 61: order.middleware.powerrental.v1.Conds.PaidAt:type_name -> basetypes.v1.Uint32Val
	...
	44, // 65: order.middleware.powerrental.v1.CreatePowerRentalOrderWithFeesRequest.FeeOrders:type_name -> order.middleware.fee.v1.FeeOrderReq
	...
	2,  // 74: order.middleware.powerrental.v1.ExistPowerRentalOrderCondsRequest.Conds:type_name -> order.middleware.powerrental.v1.Conds
	0,  // 75: order.middleware.powerrental.v1.DeletePowerRentalOrderRequest.Info:type_name -> order.middleware.powerrental.v1.PowerRentalOrderReq
	1,  // 76: order.middleware.powerrental.v1.DeletePowerRentalOrderResponse.Info:type_name -> order.middleware.powerrental.v1.PowerRentalOrder
	3,  // 77: order.middleware.powerrental.v1.Middleware.CreatePowerRentalOrder:input_type -> order.middleware.powerrental.v1.CreatePowerRentalOrderRequest
	5,  // 78: order.middleware.powerrental.v1.Middleware.CreatePowerRentalOrderWithFees:input_type -> order.middleware.powerrental.v1.CreatePowerRentalOrderWithFeesRequest
	7,  // 79: order.middleware.powerrental.v1.Middleware.UpdatePowerRentalOrder:input_type -> order.middleware.powerrental.v1.UpdatePowerRentalOrderRequest
	9,  // 80: order.middleware.powerrental.v1.Middleware.UpdatePowerRentalOrders:input_type -> order.middleware.powerrental.v1.UpdatePowerRentalOrdersRequest
	11, // 81: order.middleware.powerrental.v1.Middleware.GetPowerRentalOrder:input_type -> order.middleware.powerrental.v1.GetPowerRentalOrderRequest
	13, // 82: order.middleware.powerrental.v1.Middleware.GetPowerRentalOrders:input_type -> order.middleware.powerrental.v1.GetPowerRentalOrdersRequest
	15, // 83: order.middleware.powerrental.v1.Middleware.CountPowerRentalOrders:input_type -> order.middleware.powerrental.v1.CountPowerRentalOrdersRequest
	17, // 84: order.middleware.powerrental.v1.Middleware.ExistPowerRentalOrder:input_type -> order.middleware.powerrental.v1.ExistPowerRentalOrderRequest
	19, // 85: order.middleware.powerrental.v1.Middleware.ExistPowerRentalOrderConds:input_type -> order.middleware.powerrental.v1.ExistPowerRentalOrderCondsRequest
	21, // 86: order.middleware.powerrental.v1.Middleware.DeletePowerRentalOrder:input_type -> order.middleware.powerrental.v1.DeletePowerRentalOrderRequest
	4,  // 87: order.middleware.powerrental.v1.Middleware.CreatePowerRentalOrder:output_type -> order.middleware.powerrental.v1.CreatePowerRentalOrderResponse
	6,  // 88: order.middleware.powerrental.v1.Middleware.CreatePowerRentalOrderWithFees:output_type -> order.middleware.powerrental.v1.CreatePowerRentalOrderWithFeesResponse
	8,  // 89: order.middleware.powerrental.v1.Middleware.UpdatePowerRentalOrder:output_type -> order.middleware.powerrental.v1.UpdatePowerRentalOrderResponse
	10, // 90: order.middleware.powerrental.v1.Middleware.UpdatePowerRentalOrders:output_type -> order.middleware.powerrental.v1.UpdatePowerRentalOrdersResponse
	12, // 91: order.middleware.powerrental.v1.Middleware.GetPowerRentalOrder:output_type -> order.middleware.powerrental.v1.GetPowerRentalOrderResponse
	14, // 92: order.middleware.powerrental.v1.Middleware.GetPowerRentalOrders:output_type -> order.middleware.powerrental.v1.GetPowerRentalOrdersResponse
	16, // 93: order.middleware.powerrental.v1.Middleware.CountPowerRentalOrders:output_type -> order.middleware.powerrental.v1.CountPowerRentalOrdersResponse
	18, // 94: order.middleware.powerrental.v1.Middleware.ExistPowerRentalOrder:output_type -> order.middleware.powerrental.v1.ExistPowerRentalOrderResponse
	20, // 95: order.middleware.powerrental.v1.Middleware.ExistPowerRentalOrderConds:output_type -> order.middleware.powerrental.v1.ExistPowerRentalOrderCondsResponse
	22, // 96: order.middleware.powerrental.v1.Middleware.DeletePowerRentalOrder:output_type -> order.middleware.powerrental.v1.DeletePowerRentalOrderResponse
	87, // [87:97] is the sub-list for method output_type
	77, // [77:87] is the sub-list for method input_type
