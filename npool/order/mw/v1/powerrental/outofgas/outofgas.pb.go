...
var file_npool_order_mw_v1_powerrental_outofgas_outofgas_proto_rawDesc = []byte{
	...
	0x04, 0x49, 0x6e, 0x66, 0x6f, 0x22, 0x62, 0x0a, 0x15, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x4f,
	...
	0x52, 0x65, 0x71, 0x52, 0x04, 0x49, 0x6e, 0x66, 0x6f, 0x22, 0x54, 0x0a, 0x16, 0x44, 0x65, 0x6c,
	...
	0xa0, 0x03, 0x0a, 0x0a, 0x4d, 0x69, 0x64, 0x64, 0x6c, 0x65, 0x77, 0x61, 0x72, 0x65, 0x12, 0xc7,
	...
	0x4f, 0x75, 0x74, 0x4f, 0x66, 0x47, 0x61, 0x73, 0x12, 0xc7, 0x01, 0x0a, 0x0e, 0x44, 0x65, 0x6c,
	0x65, 0x74, 0x65, 0x4f, 0x75, 0x74, 0x4f, 0x66, 0x47, 0x61, 0x73, 0x12, 0x3f, 0x2e, 0x6f, 0x72,
	...
	0x67, 0x61, 0x73, 0x5f, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x4f, 0x75, 0x74, 0x4f, 0x66, 0x47,
	0x61, 0x73, 0x42, 0x49, 0x5a, 0x47, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d,
	...
	0x6e, 0x74, 0x61, 0x6c, 0x2f, 0x6f, 0x75, 0x74, 0x6f, 0x66, 0x67, 0x61, 0x73, 0x62, 0x06, 0x70,
...
var file_npool_order_mw_v1_powerrental_outofgas_outofgas_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_npool_order_mw_v1_powerrental_outofgas_outofgas_proto_goTypes = []interface{}{
	...
	(*DeleteOutOfGasRequest)(nil),  // 3: order.middleware.powerrental.outofgas.v1.DeleteOutOfGasRequest
	(*DeleteOutOfGasResponse)(nil), // 4: order.middleware.powerrental.outofgas.v1.DeleteOutOfGasResponse
	(*outofgas.OutOfGas)(nil),      // 5: order.middleware.outofgas.v1.OutOfGas
}
var file_npool_order_mw_v1_powerrental_outofgas_outofgas_proto_depIdxs = []int32{
	...
	5, // 1: order.middleware.powerrental.outofgas.v1.CreateOutOfGasResponse.Info:type_name -> order.middleware.outofgas.v1.OutOfGas
	0, // 2: order.middleware.powerrental.outofgas.v1.DeleteOutOfGasRequest.Info:type_name -> order.middleware.powerrental.outofgas.v1.OutOfGasReq
	5, // 3: order.middleware.powerrental.outofgas.v1.DeleteOutOfGasResponse.Info:type_name -> order.middleware.outofgas.v1.OutOfGas
	1, // 4: order.middleware.powerrental.outofgas.v1.Middleware.CreateOutOfGas:input_type -> order.middleware.powerrental.outofgas.v1.CreateOutOfGasRequest
	3, // 5: order.middleware.powerrental.outofgas.v1.Middleware.DeleteOutOfGas:input_type -> order.middleware.powerrental.outofgas.v1.DeleteOutOfGasRequest
	2, // 6: order.middleware.powerrental.outofgas.v1.Middleware.CreateOutOfGas:output_type -> order.middleware.powerrental.outofgas.v1.CreateOutOfGasResponse
	4, // 7: order.middleware.powerrental.outofgas.v1.Middleware.DeleteOutOfGas:output_type -> order.middleware.powerrental.outofgas.v1.DeleteOutOfGasResponse
