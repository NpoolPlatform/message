...
const (
	Middleware_CreateAppConfig_FullMethodName     = "/order.middleware.app.config.v1.Middleware/CreateAppConfig"
	Middleware_UpdateAppConfig_FullMethodName     = "/order.middleware.app.config.v1.Middleware/UpdateAppConfig"
	Middleware_GetAppConfig_FullMethodName        = "/order.middleware.app.config.v1.Middleware/GetAppConfig"
	Middleware_GetAppConfigs_FullMethodName       = "/order.middleware.app.config.v1.Middleware/GetAppConfigs"
	Middleware_ExistAppConfig_FullMethodName      = "/order.middleware.app.config.v1.Middleware/ExistAppConfig"
	Middleware_ExistAppConfigConds_FullMethodName = "/order.middleware.app.config.v1.Middleware/ExistAppConfigConds"
	Middleware_DeleteAppConfig_FullMethodName     = "/order.middleware.app.config.v1.Middleware/DeleteAppConfig"
)
...
func (c *middlewareClient) ExistAppConfig(ctx context.Context, in *ExistAppConfigRequest, opts ...grpc.CallOption) (*ExistAppConfigResponse, error) {
	...
	err := c.cc.Invoke(ctx, Middleware_ExistAppConfig_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Middleware_ExistAppConfig_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Middleware_ExistAppConfig_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
