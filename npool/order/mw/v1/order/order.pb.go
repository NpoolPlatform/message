...
var file_npool_order_mw_v1_order_order_proto_rawDesc = []byte{
	...
	0x64, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x22, 0xec, 0x07, 0x0a, 0x05, 0x43, 0x6f, 0x6e, 0x64,
	...
	,
	...
	0x49, 0x44, 0x12, 0x3b, 0x0a, 0x09, 0x43, 0x6f, 0x75, 0x70, 0x6f, 0x6e, 0x49, 0x44, 0x73, 0x18,
	...
	0x65, 0x56, 0x61, 0x6c, 0x52, 0x09, 0x43, 0x6f, 0x75, 0x70, 0x6f, 0x6e, 0x49, 0x44, 0x73, 0x12,
	0x35, 0x0a, 0x06, 0x53, 0x74, 0x61, 0x74, 0x65, 0x73, 0x18, 0xc8, 0x01, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x1c, 0x2e, 0x62, 0x61, 0x73, 0x65, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2e, 0x76, 0x31, 0x2e,
	0x55, 0x69, 0x6e, 0x74, 0x33, 0x32, 0x53, 0x6c, 0x69, 0x63, 0x65, 0x56, 0x61, 0x6c, 0x52, 0x06,
	...
	0x64, 0x6c, 0x65, 0x77, 0x61, 0x72, 0x65, 0x2e, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x31, 0x2e, 0x76,
	0x31, 0x2e, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x04, 0x49, 0x6e, 0x66, 0x6f, 0x32, 0xed, 0x0a,
...
var file_npool_order_mw_v1_order_order_proto_depIdxs = []int32{
	...
	30, // 19: order.middleware.order1.v1.Conds.UserSpecialReductionID:type_name -> basetypes.v1.StringVal
	32, // 20: order.middleware.order1.v1.Conds.LastBenefitAt:type_name -> basetypes.v1.Uint32Val
	30, // 21: order.middleware.order1.v1.Conds.CouponID:type_name -> basetypes.v1.StringVal
	31, // 22: order.middleware.order1.v1.Conds.CouponIDs:type_name -> basetypes.v1.StringSliceVal
	33, // 23: order.middleware.order1.v1.Conds.States:type_name -> basetypes.v1.Uint32SliceVal
	0,  // 24: order.middleware.order1.v1.CreateOrderRequest.Info:type_name -> order.middleware.order1.v1.OrderReq
	1,  // 25: order.middleware.order1.v1.CreateOrderResponse.Info:type_name -> order.middleware.order1.v1.Order
	0,  // 26: order.middleware.order1.v1.CreateOrdersRequest.Infos:type_name -> order.middleware.order1.v1.OrderReq
	1,  // 27: order.middleware.order1.v1.CreateOrdersResponse.Infos:type_name -> order.middleware.order1.v1.Order
	...
	2,  // 39: order.middleware.order1.v1.ExistOrderCondsRequest.Conds:type_name -> order.middleware.order1.v1.Conds
	0,  // 40: order.middleware.order1.v1.DeleteOrderRequest.Info:type_name -> order.middleware.order1.v1.OrderReq
	1,  // 41: order.middleware.order1.v1.DeleteOrderResponse.Info:type_name -> order.middleware.order1.v1.Order
	3,  // 42: order.middleware.order1.v1.Middleware.CreateOrder:input_type -> order.middleware.order1.v1.CreateOrderRequest
	5,  // 43: order.middleware.order1.v1.Middleware.CreateOrders:input_type -> order.middleware.order1.v1.CreateOrdersRequest
	7,  // 44: order.middleware.order1.v1.Middleware.UpdateOrder:input_type -> order.middleware.order1.v1.UpdateOrderRequest
	9,  // 45: order.middleware.order1.v1.Middleware.UpdateOrders:input_type -> order.middleware.order1.v1.UpdateOrdersRequest
	11, // 46: order.middleware.order1.v1.Middleware.GetOrder:input_type -> order.middleware.order1.v1.GetOrderRequest
	13, // 47: order.middleware.order1.v1.Middleware.GetOrders:input_type -> order.middleware.order1.v1.GetOrdersRequest
	15, // 48: order.middleware.order1.v1.Middleware.GetOrderOnly:input_type -> order.middleware.order1.v1.GetOrderOnlyRequest
	17, // 49: order.middleware.order1.v1.Middleware.CountOrders:input_type -> order.middleware.order1.v1.CountOrdersRequest
	19, // 50: order.middleware.order1.v1.Middleware.SumOrderUnits:input_type -> order.middleware.order1.v1.SumOrderUnitsRequest
	21, // 51: order.middleware.order1.v1.Middleware.ExistOrder:input_type -> order.middleware.order1.v1.ExistOrderRequest
	23, // 52: order.middleware.order1.v1.Middleware.ExistOrderConds:input_type -> order.middleware.order1.v1.ExistOrderCondsRequest
	25, // 53: order.middleware.order1.v1.Middleware.DeleteOrder:input_type -> order.middleware.order1.v1.DeleteOrderRequest
	4,  // 54: order.middleware.order1.v1.Middleware.CreateOrder:output_type -> order.middleware.order1.v1.CreateOrderResponse
	6,  // 55: order.middleware.order1.v1.Middleware.CreateOrders:output_type -> order.middleware.order1.v1.CreateOrdersResponse
	8,  // 56: order.middleware.order1.v1.Middleware.UpdateOrder:output_type -> order.middleware.order1.v1.UpdateOrderResponse
	10, // 57: order.middleware.order1.v1.Middleware.UpdateOrders:output_type -> order.middleware.order1.v1.UpdateOrdersResponse
	12, // 58: order.middleware.order1.v1.Middleware.GetOrder:output_type -> order.middleware.order1.v1.GetOrderResponse
	14, // 59: order.middleware.order1.v1.Middleware.GetOrders:output_type -> order.middleware.order1.v1.GetOrdersResponse
	16, // 60: order.middleware.order1.v1.Middleware.GetOrderOnly:output_type -> order.middleware.order1.v1.GetOrderOnlyResponse
	18, // 61: order.middleware.order1.v1.Middleware.CountOrders:output_type -> order.middleware.order1.v1.CountOrdersResponse
	20, // 62: order.middleware.order1.v1.Middleware.SumOrderUnits:output_type -> order.middleware.order1.v1.SumOrderUnitsResponse
	22, // 63: order.middleware.order1.v1.Middleware.ExistOrder:output_type -> order.middleware.order1.v1.ExistOrderResponse
	24, // 64: order.middleware.order1.v1.Middleware.ExistOrderConds:output_type -> order.middleware.order1.v1.ExistOrderCondsResponse
	26, // 65: order.middleware.order1.v1.Middleware.DeleteOrder:output_type -> order.middleware.order1.v1.DeleteOrderResponse
