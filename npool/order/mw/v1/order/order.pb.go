...
var file_npool_order_mw_v1_order_order_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x22, 0x27, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x4f, 0x72, 0x64,
	...
	0x04, 0x49, 0x6e, 0x66, 0x6f, 0x32, 0xe1, 0x05, 0x0a, 0x0a, 0x4d, 0x69, 0x64, 0x64, 0x6c, 0x65,
	0x77, 0x61, 0x72, 0x65, 0x12, 0x67, 0x0a, 0x08, 0x47, 0x65, 0x74, 0x4f, 0x72, 0x64, 0x65, 0x72,
	...
	0x44, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x7c, 0x0a, 0x0f, 0x45,
...
var file_npool_order_mw_v1_order_order_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
var file_npool_order_mw_v1_order_order_proto_goTypes = []interface{}{
	...
	(*ExistOrderCondsRequest)(nil),      // 12: order.middleware.order1.v1.ExistOrderCondsRequest
	(*ExistOrderCondsResponse)(nil),     // 13: order.middleware.order1.v1.ExistOrderCondsResponse
	(v1.GoodType)(0),                    // 14: basetypes.good.v1.GoodType
	(v11.OrderType)(0),                  // 15: basetypes.order.v1.OrderType
	(v11.PaymentType)(0),                // 16: basetypes.order.v1.PaymentType
	(v11.OrderCreateMethod)(0),          // 17: basetypes.order.v1.OrderCreateMethod
	(v11.OrderState)(0),                 // 18: basetypes.order.v1.OrderState
	(v11.OrderStartMode)(0),             // 19: basetypes.order.v1.OrderStartMode
	(v11.BenefitState)(0),               // 20: basetypes.order.v1.BenefitState
	(*v12.Uint32Val)(nil),               // 21: basetypes.v1.Uint32Val
	(*v12.Uint32SliceVal)(nil),          // 22: basetypes.v1.Uint32SliceVal
	(*v12.StringVal)(nil),               // 23: basetypes.v1.StringVal
	(*v12.StringSliceVal)(nil),          // 24: basetypes.v1.StringSliceVal
	(*v12.BoolVal)(nil),                 // 25: basetypes.v1.BoolVal
}
var file_npool_order_mw_v1_order_order_proto_depIdxs = []int32{
	14, // 0: order.middleware.order1.v1.Order.GoodType:type_name -> basetypes.good.v1.GoodType
	15, // 1: order.middleware.order1.v1.Order.OrderType:type_name -> basetypes.order.v1.OrderType
	16, // 2: order.middleware.order1.v1.Order.PaymentType:type_name -> basetypes.order.v1.PaymentType
	17, // 3: order.middleware.order1.v1.Order.CreateMethod:type_name -> basetypes.order.v1.OrderCreateMethod
	18, // 4: order.middleware.order1.v1.Order.OrderState:type_name -> basetypes.order.v1.OrderState
	19, // 5: order.middleware.order1.v1.Order.StartMode:type_name -> basetypes.order.v1.OrderStartMode
	20, // 6: order.middleware.order1.v1.Order.BenefitState:type_name -> basetypes.order.v1.BenefitState
	21, // 7: order.middleware.order1.v1.Conds.ID:type_name -> basetypes.v1.Uint32Val
	22, // 8: order.middleware.order1.v1.Conds.IDs:type_name -> basetypes.v1.Uint32SliceVal
	23, // 9: order.middleware.order1.v1.Conds.EntID:type_name -> basetypes.v1.StringVal
	24, // 10: order.middleware.order1.v1.Conds.EntIDs:type_name -> basetypes.v1.StringSliceVal
	23, // 11: order.middleware.order1.v1.Conds.AppID:type_name -> basetypes.v1.StringVal
	23, // 12: order.middleware.order1.v1.Conds.UserID:type_name -> basetypes.v1.StringVal
	23, // 13: order.middleware.order1.v1.Conds.GoodID:type_name -> basetypes.v1.StringVal
	24, // 14: order.middleware.order1.v1.Conds.GoodIDs:type_name -> basetypes.v1.StringSliceVal
	23, // 15: order.middleware.order1.v1.Conds.AppGoodID:type_name -> basetypes.v1.StringVal
	24, // 16: order.middleware.order1.v1.Conds.AppGoodIDs:type_name -> basetypes.v1.StringSliceVal
	23, // 17: order.middleware.order1.v1.Conds.ParentOrderID:type_name -> basetypes.v1.StringVal
	24, // 18: order.middleware.order1.v1.Conds.ParentOrderIDs:type_name -> basetypes.v1.StringSliceVal
	21, // 19: order.middleware.order1.v1.Conds.OrderType:type_name -> basetypes.v1.Uint32Val
	21, // 20: order.middleware.order1.v1.Conds.PaymentType:type_name -> basetypes.v1.Uint32Val
	22, // 21: order.middleware.order1.v1.Conds.PaymentTypes:type_name -> basetypes.v1.Uint32SliceVal
	25, // 22: order.middleware.order1.v1.Conds.Simulate:type_name -> basetypes.v1.BoolVal
	21, // 23: order.middleware.order1.v1.Conds.OrderState:type_name -> basetypes.v1.Uint32Val
	22, // 24: order.middleware.order1.v1.Conds.OrderStates:type_name -> basetypes.v1.Uint32SliceVal
	21, // 25: order.middleware.order1.v1.Conds.StartMode:type_name -> basetypes.v1.Uint32Val
	21, // 26: order.middleware.order1.v1.Conds.LastBenefitAt:type_name -> basetypes.v1.Uint32Val
	21, // 27: order.middleware.order1.v1.Conds.BenefitState:type_name -> basetypes.v1.Uint32Val
	21, // 28: order.middleware.order1.v1.Conds.CreatedAt:type_name -> basetypes.v1.Uint32Val
	21, // 29: order.middleware.order1.v1.Conds.UpdatedAt:type_name -> basetypes.v1.Uint32Val
	0,  // 30: order.middleware.order1.v1.GetOrderResponse.Info:type_name -> order.middleware.order1.v1.Order
	1,  // 31: order.middleware.order1.v1.GetOrdersRequest.Conds:type_name -> order.middleware.order1.v1.Conds
	0,  // 32: order.middleware.order1.v1.GetOrdersResponse.Infos:type_name -> order.middleware.order1.v1.Order
	1,  // 33: order.middleware.order1.v1.CountOrdersRequest.Conds:type_name -> order.middleware.order1.v1.Conds
	1,  // 34: order.middleware.order1.v1.SumOrdersPaymentUSDRequest.Conds:type_name -> order.middleware.order1.v1.Conds
	1,  // 35: order.middleware.order1.v1.SumOrdersValueUSDRequest.Conds:type_name -> order.middleware.order1.v1.Conds
	1,  // 36: order.middleware.order1.v1.ExistOrderCondsRequest.Conds:type_name -> order.middleware.order1.v1.Conds
	2,  // 37: order.middleware.order1.v1.Middleware.GetOrder:input_type -> order.middleware.order1.v1.GetOrderRequest
	4,  // 38: order.middleware.order1.v1.Middleware.GetOrders:input_type -> order.middleware.order1.v1.GetOrdersRequest
	6,  // 39: order.middleware.order1.v1.Middleware.CountOrders:input_type -> order.middleware.order1.v1.CountOrdersRequest
	8,  // 40: order.middleware.order1.v1.Middleware.SumOrdersPaymentUSD:input_type -> order.middleware.order1.v1.SumOrdersPaymentUSDRequest
	10, // 41: order.middleware.order1.v1.Middleware.SumOrdersValueUSD:input_type -> order.middleware.order1.v1.SumOrdersValueUSDRequest
	12, // 42: order.middleware.order1.v1.Middleware.ExistOrderConds:input_type -> order.middleware.order1.v1.ExistOrderCondsRequest
	3,  // 43: order.middleware.order1.v1.Middleware.GetOrder:output_type -> order.middleware.order1.v1.GetOrderResponse
	5,  // 44: order.middleware.order1.v1.Middleware.GetOrders:output_type -> order.middleware.order1.v1.GetOrdersResponse
	7,  // 45: order.middleware.order1.v1.Middleware.CountOrders:output_type -> order.middleware.order1.v1.CountOrdersResponse
	9,  // 46: order.middleware.order1.v1.Middleware.SumOrdersPaymentUSD:output_type -> order.middleware.order1.v1.SumOrdersPaymentUSDResponse
	11, // 47: order.middleware.order1.v1.Middleware.SumOrdersValueUSD:output_type -> order.middleware.order1.v1.SumOrdersValueUSDResponse
	13, // 48: order.middleware.order1.v1.Middleware.ExistOrderConds:output_type -> order.middleware.order1.v1.ExistOrderCondsResponse
