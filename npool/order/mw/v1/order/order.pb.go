...
var file_npool_order_mw_v1_order_order_proto_rawDesc = []byte{
	...
	0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x22, 0x8a, 0x0a, 0x0a, 0x05, 0x43, 0x6f,
	...
	0x53, 0x74, 0x61, 0x74, 0x65, 0x73, 0x22, 0x4e, 0x0a, 0x12, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65,
	...
	0x64, 0x65, 0x72, 0x2e, 0x6d, 0x69, 0x64, 0x64, 0x6c, 0x65, 0x77, 0x61, 0x72, 0x65, 0x2e, 0x6f,
	0x72, 0x64, 0x65, 0x72, 0x31, 0x2e, 0x76, 0x31, 0x2e, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x04,
	0x49, 0x6e, 0x66, 0x6f, 0x32, 0x86, 0x09, 0x0a, 0x0a, 0x4d, 0x69, 0x64, 0x64, 0x6c, 0x65, 0x77,
	...
	0x6e, 0x69, 0x74, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x6d,
	...
	0x65, 0x72, 0x2e, 0x6d, 0x69, 0x64, 0x64, 0x6c, 0x65, 0x77, 0x61, 0x72, 0x65, 0x2e, 0x6f, 0x72,
	0x64, 0x65, 0x72, 0x31, 0x2e, 0x76, 0x31, 0x2e, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x4f, 0x72,
	0x64, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x3a, 0x5a,
...
var file_npool_order_mw_v1_order_order_proto_depIdxs = []int32{
	...
	2,  // 47: order.middleware.order1.v1.SumOrderUnitsRequest.Conds:type_name -> order.middleware.order1.v1.Conds
	2,  // 48: order.middleware.order1.v1.ExistOrderCondsRequest.Conds:type_name -> order.middleware.order1.v1.Conds
	0,  // 49: order.middleware.order1.v1.DeleteOrderRequest.Info:type_name -> order.middleware.order1.v1.OrderReq
	1,  // 50: order.middleware.order1.v1.DeleteOrderResponse.Info:type_name -> order.middleware.order1.v1.Order
	3,  // 51: order.middleware.order1.v1.Middleware.CreateOrder:input_type -> order.middleware.order1.v1.CreateOrderRequest
	5,  // 52: order.middleware.order1.v1.Middleware.CreateOrders:input_type -> order.middleware.order1.v1.CreateOrdersRequest
	7,  // 53: order.middleware.order1.v1.Middleware.UpdateOrder:input_type -> order.middleware.order1.v1.UpdateOrderRequest
	9,  // 54: order.middleware.order1.v1.Middleware.UpdateOrders:input_type -> order.middleware.order1.v1.UpdateOrdersRequest
	11, // 55: order.middleware.order1.v1.Middleware.GetOrder:input_type -> order.middleware.order1.v1.GetOrderRequest
	13, // 56: order.middleware.order1.v1.Middleware.GetOrders:input_type -> order.middleware.order1.v1.GetOrdersRequest
	15, // 57: order.middleware.order1.v1.Middleware.SumOrderUnits:input_type -> order.middleware.order1.v1.SumOrderUnitsRequest
	17, // 58: order.middleware.order1.v1.Middleware.ExistOrder:input_type -> order.middleware.order1.v1.ExistOrderRequest
	19, // 59: order.middleware.order1.v1.Middleware.ExistOrderConds:input_type -> order.middleware.order1.v1.ExistOrderCondsRequest
	21, // 60: order.middleware.order1.v1.Middleware.DeleteOrder:input_type -> order.middleware.order1.v1.DeleteOrderRequest
	4,  // 61: order.middleware.order1.v1.Middleware.CreateOrder:output_type -> order.middleware.order1.v1.CreateOrderResponse
	6,  // 62: order.middleware.order1.v1.Middleware.CreateOrders:output_type -> order.middleware.order1.v1.CreateOrdersResponse
	8,  // 63: order.middleware.order1.v1.Middleware.UpdateOrder:output_type -> order.middleware.order1.v1.UpdateOrderResponse
	10, // 64: order.middleware.order1.v1.Middleware.UpdateOrders:output_type -> order.middleware.order1.v1.UpdateOrdersResponse
	12, // 65: order.middleware.order1.v1.Middleware.GetOrder:output_type -> order.middleware.order1.v1.GetOrderResponse
	14, // 66: order.middleware.order1.v1.Middleware.GetOrders:output_type -> order.middleware.order1.v1.GetOrdersResponse
	16, // 67: order.middleware.order1.v1.Middleware.SumOrderUnits:output_type -> order.middleware.order1.v1.SumOrderUnitsResponse
	18, // 68: order.middleware.order1.v1.Middleware.ExistOrder:output_type -> order.middleware.order1.v1.ExistOrderResponse
	20, // 69: order.middleware.order1.v1.Middleware.ExistOrderConds:output_type -> order.middleware.order1.v1.ExistOrderCondsResponse
	22, // 70: order.middleware.order1.v1.Middleware.DeleteOrder:output_type -> order.middleware.order1.v1.DeleteOrderResponse
