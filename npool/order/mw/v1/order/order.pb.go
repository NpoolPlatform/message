...
var file_npool_order_mw_v1_order_order_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x0b, 0x32, 0x21, 0x2e, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x2e, 0x6d, 0x69, 0x64, 0x64,
	0x6c, 0x65, 0x77, 0x61, 0x72, 0x65, 0x2e, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x31, 0x2e, 0x76, 0x31,
	0x2e, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x04, 0x49, 0x6e, 0x66, 0x6f, 0x22, 0x4f, 0x0a, 0x14,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x49, 0x6e, 0x66, 0x6f, 0x22, 0x23, 0x0a, 0x11, 0x45, 0x78,
	...
	0x28, 0x0a, 0x12, 0x45, 0x78, 0x69, 0x73, 0x74, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x49, 0x6e, 0x66, 0x6f, 0x18, 0x0a, 0x20,
	0x01, 0x28, 0x08, 0x52, 0x04, 0x49, 0x6e, 0x66, 0x6f, 0x22, 0x51, 0x0a, 0x16, 0x45, 0x78, 0x69,
	...
	0x0a, 0x20, 0x01, 0x28, 0x08, 0x52, 0x04, 0x49, 0x6e, 0x66, 0x6f, 0x22, 0x4e, 0x0a, 0x12, 0x44,
	...
	0x65, 0x72, 0x52, 0x65, 0x71, 0x52, 0x04, 0x49, 0x6e, 0x66, 0x6f, 0x22, 0x4c, 0x0a, 0x13, 0x44,
	...
	0x61, 0x72, 0x65, 0x2e, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x31, 0x2e, 0x76, 0x31, 0x2e, 0x4f, 0x72,
	0x64, 0x65, 0x72, 0x52, 0x04, 0x49, 0x6e, 0x66, 0x6f, 0x32, 0xfb, 0x09, 0x0a, 0x0a, 0x4d, 0x69,
	...
	,
	...
	0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x70, 0x0a, 0x0b, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x4f,
...
var file_npool_order_mw_v1_order_order_proto_goTypes = []interface{}{
	...
	(*SumOrderUnitsRequest)(nil),    // 17: order.middleware.order1.v1.SumOrderUnitsRequest
	(*SumOrderUnitsResponse)(nil),   // 18: order.middleware.order1.v1.SumOrderUnitsResponse
...
var file_npool_order_mw_v1_order_order_proto_depIdxs = []int32{
	...
	25, // 7: order.middleware.order1.v1.Order.OrderType:type_name -> basetypes.order.v1.OrderType
	26, // 8: order.middleware.order1.v1.Order.InvestmentType:type_name -> basetypes.order.v1.InvestmentType
	27, // 9: order.middleware.order1.v1.Order.PaymentType:type_name -> basetypes.order.v1.PaymentType
	28, // 10: order.middleware.order1.v1.Order.OrderState:type_name -> basetypes.order.v1.OrderState
	29, // 11: order.middleware.order1.v1.Order.StartMode:type_name -> basetypes.order.v1.OrderStartMode
	30, // 12: order.middleware.order1.v1.Order.BenefitState:type_name -> basetypes.order.v1.BenefitState
	31, // 13: order.middleware.order1.v1.Order.PaymentState:type_name -> basetypes.order.v1.PaymentState
	32, // 14: order.middleware.order1.v1.Conds.ID:type_name -> basetypes.v1.StringVal
	32, // 15: order.middleware.order1.v1.Conds.AppID:type_name -> basetypes.v1.StringVal
	32, // 16: order.middleware.order1.v1.Conds.UserID:type_name -> basetypes.v1.StringVal
	32, // 17: order.middleware.order1.v1.Conds.GoodID:type_name -> basetypes.v1.StringVal
	32, // 18: order.middleware.order1.v1.Conds.AppGoodID:type_name -> basetypes.v1.StringVal
	32, // 19: order.middleware.order1.v1.Conds.ParentOrderID:type_name -> basetypes.v1.StringVal
	32, // 20: order.middleware.order1.v1.Conds.PaymentAmount:type_name -> basetypes.v1.StringVal
	33, // 21: order.middleware.order1.v1.Conds.OrderType:type_name -> basetypes.v1.Uint32Val
	33, // 22: order.middleware.order1.v1.Conds.InvestmentType:type_name -> basetypes.v1.Uint32Val
	34, // 23: order.middleware.order1.v1.Conds.CouponIDs:type_name -> basetypes.v1.StringSliceVal
	33, // 24: order.middleware.order1.v1.Conds.PaymentType:type_name -> basetypes.v1.Uint32Val
	33, // 25: order.middleware.order1.v1.Conds.CreatedAt:type_name -> basetypes.v1.Uint32Val
	32, // 26: order.middleware.order1.v1.Conds.PaymentCoinTypeID:type_name -> basetypes.v1.StringVal
	33, // 27: order.middleware.order1.v1.Conds.OrderState:type_name -> basetypes.v1.Uint32Val
	33, // 28: order.middleware.order1.v1.Conds.StartMode:type_name -> basetypes.v1.Uint32Val
	33, // 29: order.middleware.order1.v1.Conds.LastBenefitAt:type_name -> basetypes.v1.Uint32Val
	33, // 30: order.middleware.order1.v1.Conds.BenefitState:type_name -> basetypes.v1.Uint32Val
	32, // 31: order.middleware.order1.v1.Conds.PaymentTransactionID:type_name -> basetypes.v1.StringVal
	33, // 32: order.middleware.order1.v1.Conds.PaymentState:type_name -> basetypes.v1.Uint32Val
	34, // 33: order.middleware.order1.v1.Conds.IDs:type_name -> basetypes.v1.StringSliceVal
	32, // 34: order.middleware.order1.v1.Conds.CouponID:type_name -> basetypes.v1.StringVal
	35, // 35: order.middleware.order1.v1.Conds.OrderStates:type_name -> basetypes.v1.Uint32SliceVal
	...
	2,  // 50: order.middleware.order1.v1.ExistOrderCondsRequest.Conds:type_name -> order.middleware.order1.v1.Conds
	0,  // 51: order.middleware.order1.v1.DeleteOrderRequest.Info:type_name -> order.middleware.order1.v1.OrderReq
	1,  // 52: order.middleware.order1.v1.DeleteOrderResponse.Info:type_name -> order.middleware.order1.v1.Order
	3,  // 53: order.middleware.order1.v1.Middleware.CreateOrder:input_type -> order.middleware.order1.v1.CreateOrderRequest
	5,  // 54: order.middleware.order1.v1.Middleware.CreateOrders:input_type -> order.middleware.order1.v1.CreateOrdersRequest
	7,  // 55: order.middleware.order1.v1.Middleware.UpdateOrder:input_type -> order.middleware.order1.v1.UpdateOrderRequest
	9,  // 56: order.middleware.order1.v1.Middleware.UpdateOrders:input_type -> order.middleware.order1.v1.UpdateOrdersRequest
	11, // 57: order.middleware.order1.v1.Middleware.GetOrder:input_type -> order.middleware.order1.v1.GetOrderRequest
	13, // 58: order.middleware.order1.v1.Middleware.GetOrders:input_type -> order.middleware.order1.v1.GetOrdersRequest
	15, // 59: order.middleware.order1.v1.Middleware.GetOrderOnly:input_type -> order.middleware.order1.v1.GetOrderOnlyRequest
	17, // 60: order.middleware.order1.v1.Middleware.SumOrderUnits:input_type -> order.middleware.order1.v1.SumOrderUnitsRequest
	19, // 61: order.middleware.order1.v1.Middleware.ExistOrder:input_type -> order.middleware.order1.v1.ExistOrderRequest
	21, // 62: order.middleware.order1.v1.Middleware.ExistOrderConds:input_type -> order.middleware.order1.v1.ExistOrderCondsRequest
	23, // 63: order.middleware.order1.v1.Middleware.DeleteOrder:input_type -> order.middleware.order1.v1.DeleteOrderRequest
	4,  // 64: order.middleware.order1.v1.Middleware.CreateOrder:output_type -> order.middleware.order1.v1.CreateOrderResponse
	6,  // 65: order.middleware.order1.v1.Middleware.CreateOrders:output_type -> order.middleware.order1.v1.CreateOrdersResponse
	8,  // 66: order.middleware.order1.v1.Middleware.UpdateOrder:output_type -> order.middleware.order1.v1.UpdateOrderResponse
	10, // 67: order.middleware.order1.v1.Middleware.UpdateOrders:output_type -> order.middleware.order1.v1.UpdateOrdersResponse
	12, // 68: order.middleware.order1.v1.Middleware.GetOrder:output_type -> order.middleware.order1.v1.GetOrderResponse
	14, // 69: order.middleware.order1.v1.Middleware.GetOrders:output_type -> order.middleware.order1.v1.GetOrdersResponse
	16, // 70: order.middleware.order1.v1.Middleware.GetOrderOnly:output_type -> order.middleware.order1.v1.GetOrderOnlyResponse
	18, // 71: order.middleware.order1.v1.Middleware.SumOrderUnits:output_type -> order.middleware.order1.v1.SumOrderUnitsResponse
	20, // 72: order.middleware.order1.v1.Middleware.ExistOrder:output_type -> order.middleware.order1.v1.ExistOrderResponse
	22, // 73: order.middleware.order1.v1.Middleware.ExistOrderConds:output_type -> order.middleware.order1.v1.ExistOrderCondsResponse
	24, // 74: order.middleware.order1.v1.Middleware.DeleteOrder:output_type -> order.middleware.order1.v1.DeleteOrderResponse
