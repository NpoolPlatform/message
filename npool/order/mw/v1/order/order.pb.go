...
var file_npool_order_mw_v1_order_order_proto_rawDesc = []byte{
	...
	0x72, 0x2e, 0x6d, 0x69, 0x64, 0x64, 0x6c, 0x65, 0x77, 0x61, 0x72, 0x65, 0x2e, 0x6f, 0x72, 0x64,
	0x65, 0x72, 0x31, 0x2e, 0x76, 0x31, 0x2e, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x04, 0x49, 0x6e,
	0x66, 0x6f, 0x32, 0x86, 0x09, 0x0a, 0x0a, 0x4d, 0x69, 0x64, 0x64, 0x6c, 0x65, 0x77, 0x61, 0x72,
...
var file_npool_order_mw_v1_order_order_proto_depIdxs = []int32{
	...
	26, // 7: order.middleware.order1.v1.OrderReq.CancelState:type_name -> basetypes.order.v1.OrderState
	23, // 8: order.middleware.order1.v1.Order.OrderType:type_name -> basetypes.order.v1.OrderType
	24, // 9: order.middleware.order1.v1.Order.InvestmentType:type_name -> basetypes.order.v1.InvestmentType
	25, // 10: order.middleware.order1.v1.Order.PaymentType:type_name -> basetypes.order.v1.PaymentType
	26, // 11: order.middleware.order1.v1.Order.OrderState:type_name -> basetypes.order.v1.OrderState
	27, // 12: order.middleware.order1.v1.Order.StartMode:type_name -> basetypes.order.v1.OrderStartMode
	28, // 13: order.middleware.order1.v1.Order.BenefitState:type_name -> basetypes.order.v1.BenefitState
	29, // 14: order.middleware.order1.v1.Order.PaymentState:type_name -> basetypes.order.v1.PaymentState
	26, // 15: order.middleware.order1.v1.Order.CancelState:type_name -> basetypes.order.v1.OrderState
	30, // 16: order.middleware.order1.v1.Conds.ID:type_name -> basetypes.v1.StringVal
	30, // 17: order.middleware.order1.v1.Conds.AppID:type_name -> basetypes.v1.StringVal
	30, // 18: order.middleware.order1.v1.Conds.UserID:type_name -> basetypes.v1.StringVal
	30, // 19: order.middleware.order1.v1.Conds.GoodID:type_name -> basetypes.v1.StringVal
	30, // 20: order.middleware.order1.v1.Conds.AppGoodID:type_name -> basetypes.v1.StringVal
	30, // 21: order.middleware.order1.v1.Conds.ParentOrderID:type_name -> basetypes.v1.StringVal
	30, // 22: order.middleware.order1.v1.Conds.PaymentAmount:type_name -> basetypes.v1.StringVal
	31, // 23: order.middleware.order1.v1.Conds.OrderType:type_name -> basetypes.v1.Uint32Val
	31, // 24: order.middleware.order1.v1.Conds.InvestmentType:type_name -> basetypes.v1.Uint32Val
	32, // 25: order.middleware.order1.v1.Conds.CouponIDs:type_name -> basetypes.v1.StringSliceVal
	31, // 26: order.middleware.order1.v1.Conds.PaymentType:type_name -> basetypes.v1.Uint32Val
	30, // 27: order.middleware.order1.v1.Conds.CoinTypeID:type_name -> basetypes.v1.StringVal
	30, // 28: order.middleware.order1.v1.Conds.PaymentCoinTypeID:type_name -> basetypes.v1.StringVal
	31, // 29: order.middleware.order1.v1.Conds.OrderState:type_name -> basetypes.v1.Uint32Val
	31, // 30: order.middleware.order1.v1.Conds.StartMode:type_name -> basetypes.v1.Uint32Val
	31, // 31: order.middleware.order1.v1.Conds.LastBenefitAt:type_name -> basetypes.v1.Uint32Val
	31, // 32: order.middleware.order1.v1.Conds.BenefitState:type_name -> basetypes.v1.Uint32Val
	30, // 33: order.middleware.order1.v1.Conds.PaymentTransactionID:type_name -> basetypes.v1.StringVal
	31, // 34: order.middleware.order1.v1.Conds.PaymentState:type_name -> basetypes.v1.Uint32Val
	32, // 35: order.middleware.order1.v1.Conds.IDs:type_name -> basetypes.v1.StringSliceVal
	30, // 36: order.middleware.order1.v1.Conds.CouponID:type_name -> basetypes.v1.StringVal
	33, // 37: order.middleware.order1.v1.Conds.OrderStates:type_name -> basetypes.v1.Uint32SliceVal
	33, // 38: order.middleware.order1.v1.Conds.PaymentTypes:type_name -> basetypes.v1.Uint32SliceVal
	...
	16, // 70: order.middleware.order1.v1.Middleware.SumOrderUnits:output_type -> order.middleware.order1.v1.SumOrderUnitsResponse
	18, // 71: order.middleware.order1.v1.Middleware.ExistOrder:output_type -> order.middleware.order1.v1.ExistOrderResponse
	20, // 72: order.middleware.order1.v1.Middleware.ExistOrderConds:output_type -> order.middleware.order1.v1.ExistOrderCondsResponse
	22, // 73: order.middleware.order1.v1.Middleware.DeleteOrder:output_type -> order.middleware.order1.v1.DeleteOrderResponse
