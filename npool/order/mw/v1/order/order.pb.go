...
var file_npool_order_mw_v1_order_order_proto_depIdxs = []int32{
	...
	2,  // 36: order.middleware.order1.v1.CountOrdersRequest.Conds:type_name -> order.middleware.order1.v1.Conds
	3,  // 37: order.middleware.order1.v1.Middleware.CreateOrder:input_type -> order.middleware.order1.v1.CreateOrderRequest
	5,  // 38: order.middleware.order1.v1.Middleware.UpdateOrder:input_type -> order.middleware.order1.v1.UpdateOrderRequest
	7,  // 39: order.middleware.order1.v1.Middleware.UpdateOrders:input_type -> order.middleware.order1.v1.UpdateOrdersRequest
	9,  // 40: order.middleware.order1.v1.Middleware.GetOrder:input_type -> order.middleware.order1.v1.GetOrderRequest
	11, // 41: order.middleware.order1.v1.Middleware.GetOrders:input_type -> order.middleware.order1.v1.GetOrdersRequest
	13, // 42: order.middleware.order1.v1.Middleware.GetOrderOnly:input_type -> order.middleware.order1.v1.GetOrderOnlyRequest
	15, // 43: order.middleware.order1.v1.Middleware.CountOrders:input_type -> order.middleware.order1.v1.CountOrdersRequest
	4,  // 44: order.middleware.order1.v1.Middleware.CreateOrder:output_type -> order.middleware.order1.v1.CreateOrderResponse
	6,  // 45: order.middleware.order1.v1.Middleware.UpdateOrder:output_type -> order.middleware.order1.v1.UpdateOrderResponse
	8,  // 46: order.middleware.order1.v1.Middleware.UpdateOrders:output_type -> order.middleware.order1.v1.UpdateOrdersResponse
	10, // 47: order.middleware.order1.v1.Middleware.GetOrder:output_type -> order.middleware.order1.v1.GetOrderResponse
	12, // 48: order.middleware.order1.v1.Middleware.GetOrders:output_type -> order.middleware.order1.v1.GetOrdersResponse
	14, // 49: order.middleware.order1.v1.Middleware.GetOrderOnly:output_type -> order.middleware.order1.v1.GetOrderOnlyResponse
	16, // 50: order.middleware.order1.v1.Middleware.CountOrders:output_type -> order.middleware.order1.v1.CountOrdersResponse
