...
var file_npool_order_mw_v1_order_order_proto_rawDesc = []byte{
	...
	0x0b, 0x32, 0x21, 0x2e, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x2e, 0x6d, 0x69, 0x64, 0x64, 0x6c, 0x65,
	0x77, 0x61, 0x72, 0x65, 0x2e, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x31, 0x2e, 0x76, 0x31, 0x2e, 0x4f,
	0x72, 0x64, 0x65, 0x72, 0x52, 0x05, 0x49, 0x6e, 0x66, 0x6f, 0x73, 0x32, 0xfb, 0x09, 0x0a, 0x0a,
...
var file_npool_order_mw_v1_order_order_proto_depIdxs = []int32{
	...
	32, // 25: order.middleware.order1.v1.Conds.CoinTypeID:type_name -> basetypes.v1.StringVal
	...
	35, // 36: order.middleware.order1.v1.Conds.PaymentTypes:type_name -> basetypes.v1.Uint32SliceVal
	...
	0,  // 52: order.middleware.order1.v1.DeleteOrdersRequest.Infos:type_name -> order.middleware.order1.v1.OrderReq
	1,  // 53: order.middleware.order1.v1.DeleteOrdersResponse.Infos:type_name -> order.middleware.order1.v1.Order
	...
	15, // 60: order.middleware.order1.v1.Middleware.SumOrderUnits:input_type -> order.middleware.order1.v1.SumOrderUnitsRequest
	17, // 61: order.middleware.order1.v1.Middleware.ExistOrder:input_type -> order.middleware.order1.v1.ExistOrderRequest
	19, // 62: order.middleware.order1.v1.Middleware.ExistOrderConds:input_type -> order.middleware.order1.v1.ExistOrderCondsRequest
	21, // 63: order.middleware.order1.v1.Middleware.DeleteOrder:input_type -> order.middleware.order1.v1.DeleteOrderRequest
	23, // 64: order.middleware.order1.v1.Middleware.DeleteOrders:input_type -> order.middleware.order1.v1.DeleteOrdersRequest
	4,  // 65: order.middleware.order1.v1.Middleware.CreateOrder:output_type -> order.middleware.order1.v1.CreateOrderResponse
	6,  // 66: order.middleware.order1.v1.Middleware.CreateOrders:output_type -> order.middleware.order1.v1.CreateOrdersResponse
	8,  // 67: order.middleware.order1.v1.Middleware.UpdateOrder:output_type -> order.middleware.order1.v1.UpdateOrderResponse
	10, // 68: order.middleware.order1.v1.Middleware.UpdateOrders:output_type -> order.middleware.order1.v1.UpdateOrdersResponse
	12, // 69: order.middleware.order1.v1.Middleware.GetOrder:output_type -> order.middleware.order1.v1.GetOrderResponse
	14, // 70: order.middleware.order1.v1.Middleware.GetOrders:output_type -> order.middleware.order1.v1.GetOrdersResponse
	16, // 71: order.middleware.order1.v1.Middleware.SumOrderUnits:output_type -> order.middleware.order1.v1.SumOrderUnitsResponse
	18, // 72: order.middleware.order1.v1.Middleware.ExistOrder:output_type -> order.middleware.order1.v1.ExistOrderResponse
	20, // 73: order.middleware.order1.v1.Middleware.ExistOrderConds:output_type -> order.middleware.order1.v1.ExistOrderCondsResponse
	22, // 74: order.middleware.order1.v1.Middleware.DeleteOrder:output_type -> order.middleware.order1.v1.DeleteOrderResponse
	24, // 75: order.middleware.order1.v1.Middleware.DeleteOrders:output_type -> order.middleware.order1.v1.DeleteOrdersResponse
