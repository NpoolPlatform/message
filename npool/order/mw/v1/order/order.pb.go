...
type Conds struct {
	...
	GoodID        *npool.Uint32Val      `protobuf:"bytes,110,opt,name=GoodID,proto3,oneof" json:"GoodID,omitempty"`
}
...
func (x *Conds) GetGoodID() *npool.Uint32Val {
	if x != nil {
		return x.GoodID
	}
	return nil
...
var file_npool_order_mw_v1_order_order_proto_rawDesc = []byte{
	...
	0x72, 0x65, 0x6e, 0x74, 0x22, 0xed, 0x05, 0x0a, 0x05, 0x43, 0x6f, 0x6e, 0x64, 0x73, 0x12, 0x28,
	...
	0x69, 0x6e, 0x74, 0x33, 0x32, 0x56, 0x61, 0x6c, 0x48, 0x0a, 0x52, 0x06, 0x47, 0x6f, 0x6f, 0x64,
	...
	0x6f, 0x64, 0x49, 0x44, 0x22, 0x4e, 0x0a, 0x12, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x4f, 0x72,
	...
	0x66, 0x6f, 0x22, 0x4e, 0x0a, 0x12, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x4f, 0x72, 0x64, 0x65,
	...
	0x01, 0x28, 0x0b, 0x32, 0x21, 0x2e, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x2e, 0x6d, 0x69, 0x64, 0x64,
	0x6c, 0x65, 0x77, 0x61, 0x72, 0x65, 0x2e, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x31, 0x2e, 0x76, 0x31,
	0x2e, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x04, 0x49, 0x6e, 0x66, 0x6f, 0x32, 0xba, 0x04, 0x0a,
	...
	0x65, 0x72, 0x2e, 0x6d, 0x69, 0x64, 0x64, 0x6c, 0x65, 0x77, 0x61, 0x72, 0x65, 0x2e, 0x6f, 0x72,
	0x64, 0x65, 0x72, 0x31, 0x2e, 0x76, 0x31, 0x2e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x4f, 0x72,
	0x64, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x70, 0x0a,
	...
	0x73, 0x65, 0x22, 0x00, 0x12, 0x73, 0x0a, 0x0c, 0x47, 0x65, 0x74, 0x4f, 0x72, 0x64, 0x65, 0x72,
	0x4f, 0x6e, 0x6c, 0x79, 0x12, 0x2f, 0x2e, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x2e, 0x6d, 0x69, 0x64,
	0x64, 0x6c, 0x65, 0x77, 0x61, 0x72, 0x65, 0x2e, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x31, 0x2e, 0x76,
...
var file_npool_order_mw_v1_order_order_proto_depIdxs = []int32{
	...
	18, // 16: order.middleware.order1.v1.Conds.GoodID:type_name -> npool.v1.Uint32Val
	0,  // 17: order.middleware.order1.v1.CreateOrderRequest.Info:type_name -> order.middleware.order1.v1.OrderReq
	1,  // 18: order.middleware.order1.v1.CreateOrderResponse.Info:type_name -> order.middleware.order1.v1.Order
	0,  // 19: order.middleware.order1.v1.UpdateOrderRequest.Info:type_name -> order.middleware.order1.v1.OrderReq
	1,  // 20: order.middleware.order1.v1.UpdateOrderResponse.Info:type_name -> order.middleware.order1.v1.Order
	1,  // 21: order.middleware.order1.v1.GetOrderResponse.Info:type_name -> order.middleware.order1.v1.Order
	2,  // 22: order.middleware.order1.v1.GetOrdersRequest.Conds:type_name -> order.middleware.order1.v1.Conds
	1,  // 23: order.middleware.order1.v1.GetOrdersResponse.Infos:type_name -> order.middleware.order1.v1.Order
	2,  // 24: order.middleware.order1.v1.GetOrderOnlyRequest.Conds:type_name -> order.middleware.order1.v1.Conds
	1,  // 25: order.middleware.order1.v1.GetOrderOnlyResponse.Info:type_name -> order.middleware.order1.v1.Order
	3,  // 26: order.middleware.order1.v1.Middleware.CreateOrder:input_type -> order.middleware.order1.v1.CreateOrderRequest
	5,  // 27: order.middleware.order1.v1.Middleware.UpdateOrder:input_type -> order.middleware.order1.v1.UpdateOrderRequest
	7,  // 28: order.middleware.order1.v1.Middleware.GetOrder:input_type -> order.middleware.order1.v1.GetOrderRequest
	9,  // 29: order.middleware.order1.v1.Middleware.GetOrders:input_type -> order.middleware.order1.v1.GetOrdersRequest
	11, // 30: order.middleware.order1.v1.Middleware.GetOrderOnly:input_type -> order.middleware.order1.v1.GetOrderOnlyRequest
	4,  // 31: order.middleware.order1.v1.Middleware.CreateOrder:output_type -> order.middleware.order1.v1.CreateOrderResponse
	6,  // 32: order.middleware.order1.v1.Middleware.UpdateOrder:output_type -> order.middleware.order1.v1.UpdateOrderResponse
	8,  // 33: order.middleware.order1.v1.Middleware.GetOrder:output_type -> order.middleware.order1.v1.GetOrderResponse
	10, // 34: order.middleware.order1.v1.Middleware.GetOrders:output_type -> order.middleware.order1.v1.GetOrdersResponse
	12, // 35: order.middleware.order1.v1.Middleware.GetOrderOnly:output_type -> order.middleware.order1.v1.GetOrderOnlyResponse
