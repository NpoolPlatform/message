...
var file_npool_miningpool_gw_v1_pool_pool_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x61, 0x6c, 0x32, 0xa0, 0x01, 0x0a, 0x07, 0x47, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79,
	0x12, 0x94, 0x01, 0x0a, 0x0d, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x47, 0x65, 0x74, 0x50, 0x6f, 0x6f,
	0x6c, 0x73, 0x12, 0x30, 0x2e, 0x6d, 0x69, 0x6e, 0x69, 0x6e, 0x67, 0x70, 0x6f, 0x6f, 0x6c, 0x2e,
	...
	0x01, 0x2a, 0x22, 0x13, 0x2f, 0x76, 0x31, 0x2f, 0x61, 0x64, 0x6d, 0x69, 0x6e, 0x2f, 0x67, 0x65,
	0x74, 0x2f, 0x70, 0x6f, 0x6f, 0x6c, 0x73, 0x42, 0x3e, 0x5a, 0x3c, 0x67, 0x69, 0x74, 0x68, 0x75,
...
var file_npool_miningpool_gw_v1_pool_pool_proto_depIdxs = []int32{
	...
	6,  // 3: miningpool.gateway.pool.v1.Coin.CoinType:type_name -> basetypes.miningpool.v1.CoinType
	7,  // 4: miningpool.gateway.pool.v1.Coin.RevenueType:type_name -> basetypes.miningpool.v1.RevenueType
	5,  // 5: miningpool.gateway.pool.v1.Coin.MiningpoolType:type_name -> basetypes.miningpool.v1.MiningpoolType
	5,  // 6: miningpool.gateway.pool.v1.FractionRule.MiningpoolType:type_name -> basetypes.miningpool.v1.MiningpoolType
	6,  // 7: miningpool.gateway.pool.v1.FractionRule.CoinType:type_name -> basetypes.miningpool.v1.CoinType
	0,  // 8: miningpool.gateway.pool.v1.AdminGetPoolsResponse.Infos:type_name -> miningpool.gateway.pool.v1.Pool
	3,  // 9: miningpool.gateway.pool.v1.Gateway.AdminGetPools:input_type -> miningpool.gateway.pool.v1.AdminGetPoolsRequest
	4,  // 10: miningpool.gateway.pool.v1.Gateway.AdminGetPools:output_type -> miningpool.gateway.pool.v1.AdminGetPoolsResponse
