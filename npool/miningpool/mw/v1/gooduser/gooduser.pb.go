...
type GetGoodUserHashRateResponse struct {
	...
	HashRate float64 `protobuf:"fixed64,10,opt,name=HashRate,proto3" json:"HashRate,omitempty"`
}
...
func (x *GetGoodUserHashRateResponse) GetHashRate() float64 {
	if x != nil {
		return x.HashRate
	}
	return 0
...
var file_npool_miningpool_mw_v1_gooduser_gooduser_proto_rawDesc = []byte{
	...
	0x61, 0x73, 0x68, 0x52, 0x61, 0x74, 0x65, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x01, 0x52, 0x08, 0x48,
