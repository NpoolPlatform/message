...
var file_npool_miningpool_mw_v1_orderuser_orderuser_proto_rawDesc = []byte{
	...
	0x72, 0x52, 0x04, 0x49, 0x6e, 0x66, 0x6f, 0x32, 0xf5, 0x07, 0x0a, 0x0a, 0x4d, 0x69, 0x64, 0x64,
	0x6c, 0x65, 0x77, 0x61, 0x72, 0x65, 0x12, 0x8c, 0x01, 0x0a, 0x0f, 0x43, 0x72, 0x65, 0x61, 0x74,
	...
	0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x8f, 0x01, 0x0a, 0x10, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65,
	0x4f, 0x72, 0x64, 0x65, 0x72, 0x55, 0x73, 0x65, 0x72, 0x73, 0x12, 0x3b, 0x2e, 0x6d, 0x69, 0x6e,
	0x69, 0x6e, 0x67, 0x70, 0x6f, 0x6f, 0x6c, 0x2e, 0x6d, 0x69, 0x64, 0x64, 0x6c, 0x65, 0x77, 0x61,
	0x72, 0x65, 0x2e, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x2e,
	0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x55, 0x73, 0x65, 0x72, 0x73,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x3c, 0x2e, 0x6d, 0x69, 0x6e, 0x69, 0x6e, 0x67,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x83, 0x01, 0x0a, 0x0c, 0x47, 0x65, 0x74, 0x4f,
	...
	0x12, 0x8c, 0x01, 0x0a, 0x0f, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x4f, 0x72, 0x64, 0x65, 0x72,
...
var file_npool_miningpool_mw_v1_orderuser_orderuser_proto_depIdxs = []int32{
	17, // 0: miningpool.middleware.orderuser.v1.OrderUserReq.MiningpoolType:type_name -> basetypes.miningpool.v1.MiningpoolType
	18, // 1: miningpool.middleware.orderuser.v1.OrderUserReq.CoinType:type_name -> basetypes.miningpool.v1.CoinType
	17, // 2: miningpool.middleware.orderuser.v1.OrderUser.MiningpoolType:type_name -> basetypes.miningpool.v1.MiningpoolType
	18, // 3: miningpool.middleware.orderuser.v1.OrderUser.CoinType:type_name -> basetypes.miningpool.v1.CoinType
	19, // 4: miningpool.middleware.orderuser.v1.Conds.EntID:type_name -> basetypes.v1.StringVal
	19, // 5: miningpool.middleware.orderuser.v1.Conds.Name:type_name -> basetypes.v1.StringVal
	19, // 6: miningpool.middleware.orderuser.v1.Conds.RootUserID:type_name -> basetypes.v1.StringVal
	19, // 7: miningpool.middleware.orderuser.v1.Conds.GoodUserID:type_name -> basetypes.v1.StringVal
	19, // 8: miningpool.middleware.orderuser.v1.Conds.OrderID:type_name -> basetypes.v1.StringVal
	20, // 9: miningpool.middleware.orderuser.v1.Conds.MiningpoolType:type_name -> basetypes.v1.Uint32Val
	20, // 10: miningpool.middleware.orderuser.v1.Conds.CoinType:type_name -> basetypes.v1.Uint32Val
	19, // 11: miningpool.middleware.orderuser.v1.Conds.RevenueAddress:type_name -> basetypes.v1.StringVal
	21, // 12: miningpool.middleware.orderuser.v1.Conds.AutoPay:type_name -> basetypes.v1.BoolVal
	22, // 13: miningpool.middleware.orderuser.v1.Conds.EntIDs:type_name -> basetypes.v1.StringSliceVal
	...
	3,  // 26: miningpool.middleware.orderuser.v1.Middleware.CreateOrderUser:input_type -> miningpool.middleware.orderuser.v1.CreateOrderUserRequest
	5,  // 27: miningpool.middleware.orderuser.v1.Middleware.CreateOrderUsers:input_type -> miningpool.middleware.orderuser.v1.CreateOrderUsersRequest
	7,  // 28: miningpool.middleware.orderuser.v1.Middleware.GetOrderUser:input_type -> miningpool.middleware.orderuser.v1.GetOrderUserRequest
	9,  // 29: miningpool.middleware.orderuser.v1.Middleware.GetOrderUsers:input_type -> miningpool.middleware.orderuser.v1.GetOrderUsersRequest
	11, // 30: miningpool.middleware.orderuser.v1.Middleware.ExistOrderUserConds:input_type -> miningpool.middleware.orderuser.v1.ExistOrderUserCondsRequest
	13, // 31: miningpool.middleware.orderuser.v1.Middleware.UpdateOrderUser:input_type -> miningpool.middleware.orderuser.v1.UpdateOrderUserRequest
	15, // 32: miningpool.middleware.orderuser.v1.Middleware.DeleteOrderUser:input_type -> miningpool.middleware.orderuser.v1.DeleteOrderUserRequest
	4,  // 33: miningpool.middleware.orderuser.v1.Middleware.CreateOrderUser:output_type -> miningpool.middleware.orderuser.v1.CreateOrderUserResponse
	6,  // 34: miningpool.middleware.orderuser.v1.Middleware.CreateOrderUsers:output_type -> miningpool.middleware.orderuser.v1.CreateOrderUsersResponse
	8,  // 35: miningpool.middleware.orderuser.v1.Middleware.GetOrderUser:output_type -> miningpool.middleware.orderuser.v1.GetOrderUserResponse
	10, // 36: miningpool.middleware.orderuser.v1.Middleware.GetOrderUsers:output_type -> miningpool.middleware.orderuser.v1.GetOrderUsersResponse
	12, // 37: miningpool.middleware.orderuser.v1.Middleware.ExistOrderUserConds:output_type -> miningpool.middleware.orderuser.v1.ExistOrderUserCondsResponse
	14, // 38: miningpool.middleware.orderuser.v1.Middleware.UpdateOrderUser:output_type -> miningpool.middleware.orderuser.v1.UpdateOrderUserResponse
	16, // 39: miningpool.middleware.orderuser.v1.Middleware.DeleteOrderUser:output_type -> miningpool.middleware.orderuser.v1.DeleteOrderUserResponse
