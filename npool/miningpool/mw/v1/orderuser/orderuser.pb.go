...
type GetOrderUserProportionResponse struct {
	...
	Proportion *string `protobuf:"bytes,10,opt,name=Proportion,proto3,oneof" json:"Proportion,omitempty"`
}
...
func (x *GetOrderUserProportionResponse) GetProportion() string {
	if x != nil && x.Proportion != nil {
		return *x.Proportion
	}
	return ""
...
var file_npool_miningpool_mw_v1_orderuser_orderuser_proto_rawDesc = []byte{
	...
	0x0a, 0x20, 0x01, 0x28, 0x09, 0x48, 0x00, 0x52, 0x0a, 0x50, 0x72, 0x6f, 0x70, 0x6f, 0x72, 0x74,
