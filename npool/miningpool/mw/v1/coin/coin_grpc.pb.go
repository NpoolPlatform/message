...
const (
	...
	Middleware_CreateCoins_FullMethodName    = "/miningpool.middleware.coin.v1.Middleware/CreateCoins"
...
func (c *middlewareClient) CreateCoins(ctx context.Context, in *CreateCoinsRequest, opts ...grpc.CallOption) (*CreateCoinsResponse, error) {
	out := new(CreateCoinsResponse)
	err := c.cc.Invoke(ctx, Middleware_CreateCoins_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMiddlewareServer) CreateCoins(context.Context, *CreateCoinsRequest) (*CreateCoinsResponse, error) {
...
func _Middleware_CreateCoins_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateCoinsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MiddlewareServer).CreateCoins(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Middleware_CreateCoins_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MiddlewareServer).CreateCoins(ctx, req.(*CreateCoinsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Middleware_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Middleware_CreateCoins_Handler,
		},
		{
			MethodName: "GetCoin",
