...
type CoinReq struct {
	...
	Threshold        *string            `protobuf:"bytes,70,opt,name=Threshold,proto3,oneof" json:"Threshold,omitempty"`
...
func (x *CoinReq) GetFeeRate() string {
...
func (x *CoinReq) GetThreshold() string {
...
type Coin struct {
	...
	Threshold string `protobuf:"bytes,80,opt,name=Threshold,proto3" json:"Threshold,omitempty" sql:"threshold"`
...
var file_npool_miningpool_mw_v1_coin_coin_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x48, 0x04, 0x52, 0x07, 0x46, 0x65, 0x65, 0x52, 0x61, 0x74, 0x65, 0x88, 0x01,
	...
	0x46, 0x20, 0x01, 0x28, 0x09, 0x48, 0x06, 0x52, 0x09, 0x54, 0x68, 0x72, 0x65, 0x73, 0x68, 0x6f,
	...
	0x09, 0x52, 0x07, 0x46, 0x65, 0x65, 0x52, 0x61, 0x74, 0x65, 0x12, 0x2a, 0x0a, 0x10, 0x46, 0x69,
	...
	0x6f, 0x6c, 0x64, 0x18, 0x50, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x54, 0x68, 0x72, 0x65, 0x73,
