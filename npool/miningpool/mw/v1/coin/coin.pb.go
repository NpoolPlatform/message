...
var file_npool_miningpool_mw_v1_coin_coin_proto_rawDesc = []byte{
	...
	0x52, 0x09, 0x54, 0x68, 0x72, 0x65, 0x73, 0x68, 0x6f, 0x6c, 0x64, 0x22, 0x11, 0x0a, 0x0f, 0x47,
	0x65, 0x74, 0x43, 0x6f, 0x69, 0x6e, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x4d,
	...
	0x31, 0x2e, 0x43, 0x6f, 0x69, 0x6e, 0x52, 0x05, 0x49, 0x6e, 0x66, 0x6f, 0x73, 0x32, 0x7b, 0x0a,
	0x0a, 0x4d, 0x69, 0x64, 0x64, 0x6c, 0x65, 0x77, 0x61, 0x72, 0x65, 0x12, 0x6d, 0x0a, 0x08, 0x47,
...
var file_npool_miningpool_mw_v1_coin_coin_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_npool_miningpool_mw_v1_coin_coin_proto_goTypes = []interface{}{
	(*Coin)(nil),             // 0: miningpool.middleware.coin.v1.Coin
	(*GetCoinsRequest)(nil),  // 1: miningpool.middleware.coin.v1.GetCoinsRequest
	(*GetCoinsResponse)(nil), // 2: miningpool.middleware.coin.v1.GetCoinsResponse
...
var file_npool_miningpool_mw_v1_coin_coin_proto_depIdxs = []int32{
	3, // 0: miningpool.middleware.coin.v1.Coin.MiningpoolType:type_name -> basetypes.miningpool.v1.MiningpoolType
	4, // 1: miningpool.middleware.coin.v1.Coin.CoinType:type_name -> basetypes.miningpool.v1.CoinType
	5, // 2: miningpool.middleware.coin.v1.Coin.RevenueType:type_name -> basetypes.miningpool.v1.RevenueType
	0, // 3: miningpool.middleware.coin.v1.GetCoinsResponse.Infos:type_name -> miningpool.middleware.coin.v1.Coin
	1, // 4: miningpool.middleware.coin.v1.Middleware.GetCoins:input_type -> miningpool.middleware.coin.v1.GetCoinsRequest
	2, // 5: miningpool.middleware.coin.v1.Middleware.GetCoins:output_type -> miningpool.middleware.coin.v1.GetCoinsResponse
