...
func (c *middlewareClient) CreateRootUser(ctx context.Context, in *CreateRootUserRequest, opts ...grpc.CallOption) (*CreateRootUserResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/miningpool.middleware.rootuser.v1.Middleware/CreateRootUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *middlewareClient) GetRootUser(ctx context.Context, in *GetRootUserRequest, opts ...grpc.CallOption) (*GetRootUserResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/miningpool.middleware.rootuser.v1.Middleware/GetRootUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *middlewareClient) GetRootUsers(ctx context.Context, in *GetRootUsersRequest, opts ...grpc.CallOption) (*GetRootUsersResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/miningpool.middleware.rootuser.v1.Middleware/GetRootUsers", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *middlewareClient) ExistRootUser(ctx context.Context, in *ExistRootUserRequest, opts ...grpc.CallOption) (*ExistRootUserResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/miningpool.middleware.rootuser.v1.Middleware/ExistRootUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *middlewareClient) ExistRootUserConds(ctx context.Context, in *ExistRootUserCondsRequest, opts ...grpc.CallOption) (*ExistRootUserCondsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/miningpool.middleware.rootuser.v1.Middleware/ExistRootUserConds", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *middlewareClient) UpdateRootUser(ctx context.Context, in *UpdateRootUserRequest, opts ...grpc.CallOption) (*UpdateRootUserResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/miningpool.middleware.rootuser.v1.Middleware/UpdateRootUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *middlewareClient) DeleteRootUser(ctx context.Context, in *DeleteRootUserRequest, opts ...grpc.CallOption) (*DeleteRootUserResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/miningpool.middleware.rootuser.v1.Middleware/DeleteRootUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Middleware_CreateRootUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/miningpool.middleware.rootuser.v1.Middleware/CreateRootUser",
	}
...
func _Middleware_GetRootUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/miningpool.middleware.rootuser.v1.Middleware/GetRootUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Middleware_GetRootUsers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/miningpool.middleware.rootuser.v1.Middleware/GetRootUsers",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Middleware_ExistRootUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/miningpool.middleware.rootuser.v1.Middleware/ExistRootUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Middleware_ExistRootUserConds_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/miningpool.middleware.rootuser.v1.Middleware/ExistRootUserConds",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Middleware_UpdateRootUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/miningpool.middleware.rootuser.v1.Middleware/UpdateRootUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Middleware_DeleteRootUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/miningpool.middleware.rootuser.v1.Middleware/DeleteRootUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
