...
var file_npool_miningpool_mw_v1_rootuser_rootuser_proto_rawDesc = []byte{
	...
	0x64, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x2e, 0x52, 0x6f, 0x6f, 0x74, 0x55, 0x73, 0x65,
	...
	0x6c, 0x2e, 0x6d, 0x69, 0x64, 0x64, 0x6c, 0x65, 0x77, 0x61, 0x72, 0x65, 0x2e, 0x67, 0x6f, 0x6f,
	0x64, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x2e, 0x45, 0x78, 0x69, 0x73, 0x74, 0x52, 0x6f,
...
var file_npool_miningpool_mw_v1_rootuser_rootuser_proto_goTypes = []interface{}{
	...
	(*DeleteRootUserRequest)(nil),      // 15: miningpool.middleware.gooduser.v1.DeleteRootUserRequest
	(*DeleteRootUserResponse)(nil),     // 16: miningpool.middleware.gooduser.v1.DeleteRootUserResponse
...
var file_npool_miningpool_mw_v1_rootuser_rootuser_proto_depIdxs = []int32{
	17, // 0: miningpool.middleware.gooduser.v1.RootUserReq.MiningpoolType:type_name -> basetypes.miningpool.v1.MiningpoolType
	17, // 1: miningpool.middleware.gooduser.v1.RootUser.MiningpoolType:type_name -> basetypes.miningpool.v1.MiningpoolType
	18, // 2: miningpool.middleware.gooduser.v1.Conds.EntID:type_name -> basetypes.v1.StringVal
	18, // 3: miningpool.middleware.gooduser.v1.Conds.Name:type_name -> basetypes.v1.StringVal
	19, // 4: miningpool.middleware.gooduser.v1.Conds.MiningpoolType:type_name -> basetypes.v1.Uint32Val
	18, // 5: miningpool.middleware.gooduser.v1.Conds.Email:type_name -> basetypes.v1.StringVal
	20, // 6: miningpool.middleware.gooduser.v1.Conds.Authed:type_name -> basetypes.v1.BoolVal
	21, // 7: miningpool.middleware.gooduser.v1.Conds.EntIDs:type_name -> basetypes.v1.StringSliceVal
	...
	0,  // 18: miningpool.middleware.gooduser.v1.DeleteRootUserRequest.Info:type_name -> miningpool.middleware.gooduser.v1.RootUserReq
	1,  // 19: miningpool.middleware.gooduser.v1.DeleteRootUserResponse.Info:type_name -> miningpool.middleware.gooduser.v1.RootUser
	3,  // 20: miningpool.middleware.gooduser.v1.Middleware.CreateRootUser:input_type -> miningpool.middleware.gooduser.v1.CreateRootUserRequest
	5,  // 21: miningpool.middleware.gooduser.v1.Middleware.CreateRootUsers:input_type -> miningpool.middleware.gooduser.v1.CreateRootUsersRequest
	7,  // 22: miningpool.middleware.gooduser.v1.Middleware.GetRootUser:input_type -> miningpool.middleware.gooduser.v1.GetRootUserRequest
	9,  // 23: miningpool.middleware.gooduser.v1.Middleware.GetRootUsers:input_type -> miningpool.middleware.gooduser.v1.GetRootUsersRequest
	11, // 24: miningpool.middleware.gooduser.v1.Middleware.ExistRootUserConds:input_type -> miningpool.middleware.gooduser.v1.ExistRootUserCondsRequest
	13, // 25: miningpool.middleware.gooduser.v1.Middleware.UpdateRootUser:input_type -> miningpool.middleware.gooduser.v1.UpdateRootUserRequest
	15, // 26: miningpool.middleware.gooduser.v1.Middleware.DeleteRootUser:input_type -> miningpool.middleware.gooduser.v1.DeleteRootUserRequest
	4,  // 27: miningpool.middleware.gooduser.v1.Middleware.CreateRootUser:output_type -> miningpool.middleware.gooduser.v1.CreateRootUserResponse
	6,  // 28: miningpool.middleware.gooduser.v1.Middleware.CreateRootUsers:output_type -> miningpool.middleware.gooduser.v1.CreateRootUsersResponse
	8,  // 29: miningpool.middleware.gooduser.v1.Middleware.GetRootUser:output_type -> miningpool.middleware.gooduser.v1.GetRootUserResponse
	10, // 30: miningpool.middleware.gooduser.v1.Middleware.GetRootUsers:output_type -> miningpool.middleware.gooduser.v1.GetRootUsersResponse
	12, // 31: miningpool.middleware.gooduser.v1.Middleware.ExistRootUserConds:output_type -> miningpool.middleware.gooduser.v1.ExistRootUserCondsResponse
	14, // 32: miningpool.middleware.gooduser.v1.Middleware.UpdateRootUser:output_type -> miningpool.middleware.gooduser.v1.UpdateRootUserResponse
	16, // 33: miningpool.middleware.gooduser.v1.Middleware.DeleteRootUser:output_type -> miningpool.middleware.gooduser.v1.DeleteRootUserResponse
