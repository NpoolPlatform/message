...
func (c *middlewareClient) ContactViaEmail(ctx context.Context, in *ContactViaEmailRequest, opts ...grpc.CallOption) (*ContactViaEmailResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/third.middleware.contact.v1.Middleware/ContactViaEmail", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Middleware_ContactViaEmail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/third.middleware.contact.v1.Middleware/ContactViaEmail",
	}
...
var Middleware_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "third.middleware.contact.v1.Middleware",
	...
	Metadata: "npool/third/mw/v1/contact/contact.proto",
}
