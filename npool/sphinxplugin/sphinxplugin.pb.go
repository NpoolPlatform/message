...
var file_npool_sphinxplugin_sphinxplugin_proto_rawDesc = []byte{
	...
	0x04, 0x44, 0x61, 0x74, 0x61, 0x22, 0x99, 0x01, 0x0a, 0x05, 0x4d, 0x73, 0x67, 0x54, 0x78, 0x12,
	...
	0x72, 0x69, 0x70, 0x74, 0x2a, 0x68, 0x0a, 0x08, 0x43, 0x6f, 0x69, 0x6e, 0x54, 0x79, 0x70, 0x65,
	...
	0x65, 0x42, 0x54, 0x43, 0x10, 0x02, 0x12, 0x0f, 0x0a, 0x0b, 0x43, 0x6f, 0x69, 0x6e, 0x54, 0x79,
	0x70, 0x65, 0x45, 0x54, 0x48, 0x10, 0x03, 0x12, 0x15, 0x0a, 0x11, 0x43, 0x6f, 0x69, 0x6e, 0x54,
	0x79, 0x70, 0x65, 0x53, 0x70, 0x61, 0x63, 0x65, 0x4d, 0x65, 0x73, 0x68, 0x10, 0x04, 0x42, 0x35,
...
var file_npool_sphinxplugin_sphinxplugin_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_npool_sphinxplugin_sphinxplugin_proto_goTypes = []interface{}{
	...
	(*MsgTx)(nil),           // 3: sphinx.plugin.v1.MsgTx
	(*TxIn)(nil),            // 4: sphinx.plugin.v1.TxIn
	(*OutPoint)(nil),        // 5: sphinx.plugin.v1.OutPoint
	(*TxOut)(nil),           // 6: sphinx.plugin.v1.TxOut
}
var file_npool_sphinxplugin_sphinxplugin_proto_depIdxs = []int32{
	4, // 0: sphinx.plugin.v1.MsgTx.TxIn:type_name -> sphinx.plugin.v1.TxIn
	6, // 1: sphinx.plugin.v1.MsgTx.TxOut:type_name -> sphinx.plugin.v1.TxOut
	5, // 2: sphinx.plugin.v1.TxIn.PreviousOutPoint:type_name -> sphinx.plugin.v1.OutPoint
