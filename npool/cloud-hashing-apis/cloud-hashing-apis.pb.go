...
var file_npool_cloud_hashing_apis_cloud_hashing_apis_proto_rawDesc = []byte{
	...
	0x04, 0x49, 0x6e, 0x66, 0x6f, 0x32, 0x9a, 0x1c, 0x0a, 0x10, 0x43, 0x6c, 0x6f, 0x75, 0x64, 0x48,
...
var file_npool_cloud_hashing_apis_cloud_hashing_apis_proto_msgTypes = make([]protoimpl.MessageInfo, 62)
var file_npool_cloud_hashing_apis_cloud_hashing_apis_proto_goTypes = []interface{}{
	...
	nil,                                                 // 58: cloud.hashing.apis.v1.InvitationUserInfo.SummarysEntry
	nil,                                                 // 59: cloud.hashing.apis.v1.InvitationUserInfo.MySummarysEntry
	nil,                                                 // 60: cloud.hashing.apis.v1.GetMyInvitationsResponse.InfosEntry
	nil,                                                 // 61: cloud.hashing.apis.v1.GetMyDirectInvitationsResponse.InfosEntry
	(*cloud_hashing_goods.GoodDetail)(nil),              // 62: cloud.hashing.goods.v1.GoodDetail
	(*coininfo.CoinInfo)(nil),                           // 63: sphinx.coininfo.v1.CoinInfo
	(*review_service.Review)(nil),                       // 64: review.service.v1.Review
	(*cloud_hashing_goods.Recommend)(nil),               // 65: cloud.hashing.goods.v1.Recommend
	(*cloud_hashing_goods.GoodInfo)(nil),                // 66: cloud.hashing.goods.v1.GoodInfo
	(*npool.PageInfo)(nil),                              // 67: npool.v1.PageInfo
	(*cloud_hashing_order.OrderDetail)(nil),             // 68: cloud.hashing.order.v1.OrderDetail
	(*cloud_hashing_billing.CoinAccountInfo)(nil),       // 69: cloud.hashing.billing.v1.CoinAccountInfo
	(*cloud_hashing_inspire.CouponAllocatedDetail)(nil), // 70: cloud.hashing.inspire.v1.CouponAllocatedDetail
	(*cloud_hashing_inspire.UserSpecialReduction)(nil),  // 71: cloud.hashing.inspire.v1.UserSpecialReduction
	(*appusermgr.AppUser)(nil),                          // 72: app.user.manager.v1.AppUser
	(*appusermgr.AppUserSecret)(nil),                    // 73: app.user.manager.v1.AppUserSecret
	(*appusermgr.AppUserInfo)(nil),                      // 74: app.user.manager.v1.AppUserInfo
	(*kyc.KycInfo)(nil),                                 // 75: kyc.management.v1.KycInfo
	(*emptypb.Empty)(nil),                               // 76: google.protobuf.Empty
	(*npool.VersionResponse)(nil),                       // 77: npool.v1.VersionResponse
}
var file_npool_cloud_hashing_apis_cloud_hashing_apis_proto_depIdxs = []int32{
	62, // 0: cloud.hashing.apis.v1.Good.Good:type_name -> cloud.hashing.goods.v1.GoodDetail
	63, // 1: cloud.hashing.apis.v1.Good.Main:type_name -> sphinx.coininfo.v1.CoinInfo
	63, // 2: cloud.hashing.apis.v1.Good.SupportCoins:type_name -> sphinx.coininfo.v1.CoinInfo
	64, // 3: cloud.hashing.apis.v1.Good.Reviews:type_name -> review.service.v1.Review
	0,  // 4: cloud.hashing.apis.v1.RecommendGood.Good:type_name -> cloud.hashing.apis.v1.Good
	65, // 5: cloud.hashing.apis.v1.RecommendGood.Recommend:type_name -> cloud.hashing.goods.v1.Recommend
	66, // 6: cloud.hashing.apis.v1.CreateGoodRequest.Info:type_name -> cloud.hashing.goods.v1.GoodInfo
	...
	67, // 9: cloud.hashing.apis.v1.GetGoodsRequest.PageInfo:type_name -> npool.v1.PageInfo
	...
	68, // 12: cloud.hashing.apis.v1.Order.Order:type_name -> cloud.hashing.order.v1.OrderDetail
	69, // 13: cloud.hashing.apis.v1.Order.PayToAccount:type_name -> cloud.hashing.billing.v1.CoinAccountInfo
	0,  // 14: cloud.hashing.apis.v1.Order.Good:type_name -> cloud.hashing.apis.v1.Good
	63, // 15: cloud.hashing.apis.v1.Order.PayWithCoin:type_name -> sphinx.coininfo.v1.CoinInfo
	70, // 16: cloud.hashing.apis.v1.Order.FixAmountCoupon:type_name -> cloud.hashing.inspire.v1.CouponAllocatedDetail
	70, // 17: cloud.hashing.apis.v1.Order.DiscountCoupon:type_name -> cloud.hashing.inspire.v1.CouponAllocatedDetail
	71, // 18: cloud.hashing.apis.v1.Order.UserSpecialReduction:type_name -> cloud.hashing.inspire.v1.UserSpecialReduction
	...
	72, // 26: cloud.hashing.apis.v1.SignupResponse.Info:type_name -> app.user.manager.v1.AppUser
	73, // 27: cloud.hashing.apis.v1.UpdatePasswordResponse.Info:type_name -> app.user.manager.v1.AppUserSecret
	73, // 28: cloud.hashing.apis.v1.UpdatePasswordByAppUserResponse.Info:type_name -> app.user.manager.v1.AppUserSecret
	74, // 29: cloud.hashing.apis.v1.UpdateEmailAddressResponse.Info:type_name -> app.user.manager.v1.AppUserInfo
	74, // 30: cloud.hashing.apis.v1.UpdatePhoneNOResponse.Info:type_name -> app.user.manager.v1.AppUserInfo
	58, // 31: cloud.hashing.apis.v1.InvitationUserInfo.Summarys:type_name -> cloud.hashing.apis.v1.InvitationUserInfo.SummarysEntry
	59, // 32: cloud.hashing.apis.v1.InvitationUserInfo.MySummarys:type_name -> cloud.hashing.apis.v1.InvitationUserInfo.MySummarysEntry
	...
	60, // 35: cloud.hashing.apis.v1.GetMyInvitationsResponse.Infos:type_name -> cloud.hashing.apis.v1.GetMyInvitationsResponse.InfosEntry
	35, // 36: cloud.hashing.apis.v1.GetMyDirectInvitationsResponse.MySelf:type_name -> cloud.hashing.apis.v1.InvitationUserInfo
	61, // 37: cloud.hashing.apis.v1.GetMyDirectInvitationsResponse.Infos:type_name -> cloud.hashing.apis.v1.GetMyDirectInvitationsResponse.InfosEntry
	64, // 38: cloud.hashing.apis.v1.KycReview.Review:type_name -> review.service.v1.Review
	74, // 39: cloud.hashing.apis.v1.KycReview.User:type_name -> app.user.manager.v1.AppUserInfo
	75, // 40: cloud.hashing.apis.v1.KycReview.Kyc:type_name -> kyc.management.v1.KycInfo
	...
	64, // 44: cloud.hashing.apis.v1.GoodReview.Review:type_name -> review.service.v1.Review
	74, // 45: cloud.hashing.apis.v1.GoodReview.CreatedBy:type_name -> app.user.manager.v1.AppUserInfo
	62, // 46: cloud.hashing.apis.v1.GoodReview.Good:type_name -> cloud.hashing.goods.v1.GoodDetail
	48, // 47: cloud.hashing.apis.v1.GetGoodReviewsResponse.Infos:type_name -> cloud.hashing.apis.v1.GoodReview
	75, // 48: cloud.hashing.apis.v1.Kyc.Kyc:type_name -> kyc.management.v1.KycInfo
	51, // 49: cloud.hashing.apis.v1.GetKycByAppUserResponse.Info:type_name -> cloud.hashing.apis.v1.Kyc
	75, // 50: cloud.hashing.apis.v1.CreateKycRequest.Info:type_name -> kyc.management.v1.KycInfo
	51, // 51: cloud.hashing.apis.v1.CreateKycResponse.Info:type_name -> cloud.hashing.apis.v1.Kyc
	75, // 52: cloud.hashing.apis.v1.UpdateKycRequest.Info:type_name -> kyc.management.v1.KycInfo
	51, // 53: cloud.hashing.apis.v1.UpdateKycResponse.Info:type_name -> cloud.hashing.apis.v1.Kyc
	34, // 54: cloud.hashing.apis.v1.InvitationUserInfo.SummarysEntry.value:type_name -> cloud.hashing.apis.v1.InvitationSummary
	34, // 55: cloud.hashing.apis.v1.InvitationUserInfo.MySummarysEntry.value:type_name -> cloud.hashing.apis.v1.InvitationSummary
	36, // 56: cloud.hashing.apis.v1.GetMyInvitationsResponse.InfosEntry.value:type_name -> cloud.hashing.apis.v1.Invitation
	36, // 57: cloud.hashing.apis.v1.GetMyDirectInvitationsResponse.InfosEntry.value:type_name -> cloud.hashing.apis.v1.Invitation
	76, // 58: cloud.hashing.apis.v1.CloudHashingApis.Version:input_type -> google.protobuf.Empty
	6,  // 59: cloud.hashing.apis.v1.CloudHashingApis.GetGoods:input_type -> cloud.hashing.apis.v1.GetGoodsRequest
	2,  // 60: cloud.hashing.apis.v1.CloudHashingApis.CreateGood:input_type -> cloud.hashing.apis.v1.CreateGoodRequest
	4,  // 61: cloud.hashing.apis.v1.CloudHashingApis.GetGood:input_type -> cloud.hashing.apis.v1.GetGoodRequest
	8,  // 62: cloud.hashing.apis.v1.CloudHashingApis.GetRecommendGoodsByApp:input_type -> cloud.hashing.apis.v1.GetRecommendGoodsByAppRequest
	20, // 63: cloud.hashing.apis.v1.CloudHashingApis.SubmitOrder:input_type -> cloud.hashing.apis.v1.SubmitOrderRequest
	22, // 64: cloud.hashing.apis.v1.CloudHashingApis.CreateOrderPayment:input_type -> cloud.hashing.apis.v1.CreateOrderPaymentRequest
	11, // 65: cloud.hashing.apis.v1.CloudHashingApis.GetOrder:input_type -> cloud.hashing.apis.v1.GetOrderRequest
	13, // 66: cloud.hashing.apis.v1.CloudHashingApis.GetOrdersByAppUser:input_type -> cloud.hashing.apis.v1.GetOrdersByAppUserRequest
	15, // 67: cloud.hashing.apis.v1.CloudHashingApis.GetOrdersByApp:input_type -> cloud.hashing.apis.v1.GetOrdersByAppRequest
	17, // 68: cloud.hashing.apis.v1.CloudHashingApis.GetOrdersByGood:input_type -> cloud.hashing.apis.v1.GetOrdersByGoodRequest
	24, // 69: cloud.hashing.apis.v1.CloudHashingApis.Signup:input_type -> cloud.hashing.apis.v1.SignupRequest
	26, // 70: cloud.hashing.apis.v1.CloudHashingApis.UpdatePassword:input_type -> cloud.hashing.apis.v1.UpdatePasswordRequest
	28, // 71: cloud.hashing.apis.v1.CloudHashingApis.UpdatePasswordByAppUser:input_type -> cloud.hashing.apis.v1.UpdatePasswordByAppUserRequest
	30, // 72: cloud.hashing.apis.v1.CloudHashingApis.UpdateEmailAddress:input_type -> cloud.hashing.apis.v1.UpdateEmailAddressRequest
	32, // 73: cloud.hashing.apis.v1.CloudHashingApis.UpdatePhoneNO:input_type -> cloud.hashing.apis.v1.UpdatePhoneNORequest
	37, // 74: cloud.hashing.apis.v1.CloudHashingApis.GetMyInvitations:input_type -> cloud.hashing.apis.v1.GetMyInvitationsRequest
	39, // 75: cloud.hashing.apis.v1.CloudHashingApis.GetMyDirectInvitations:input_type -> cloud.hashing.apis.v1.GetMyDirectInvitationsRequest
	42, // 76: cloud.hashing.apis.v1.CloudHashingApis.GetKycReviews:input_type -> cloud.hashing.apis.v1.GetKycReviewsRequest
	44, // 77: cloud.hashing.apis.v1.CloudHashingApis.GetKycReviewsByApp:input_type -> cloud.hashing.apis.v1.GetKycReviewsByAppRequest
	46, // 78: cloud.hashing.apis.v1.CloudHashingApis.GetKycReviewsByOtherApp:input_type -> cloud.hashing.apis.v1.GetKycReviewsByOtherAppRequest
	49, // 79: cloud.hashing.apis.v1.CloudHashingApis.GetGoodReviews:input_type -> cloud.hashing.apis.v1.GetGoodReviewsRequest
	54, // 80: cloud.hashing.apis.v1.CloudHashingApis.CreateKyc:input_type -> cloud.hashing.apis.v1.CreateKycRequest
	56, // 81: cloud.hashing.apis.v1.CloudHashingApis.UpdateKyc:input_type -> cloud.hashing.apis.v1.UpdateKycRequest
	52, // 82: cloud.hashing.apis.v1.CloudHashingApis.GetKycByAppUser:input_type -> cloud.hashing.apis.v1.GetKycByAppUserRequest
	77, // 83: cloud.hashing.apis.v1.CloudHashingApis.Version:output_type -> npool.v1.VersionResponse
	7,  // 84: cloud.hashing.apis.v1.CloudHashingApis.GetGoods:output_type -> cloud.hashing.apis.v1.GetGoodsResponse
	3,  // 85: cloud.hashing.apis.v1.CloudHashingApis.CreateGood:output_type -> cloud.hashing.apis.v1.CreateGoodResponse
	5,  // 86: cloud.hashing.apis.v1.CloudHashingApis.GetGood:output_type -> cloud.hashing.apis.v1.GetGoodResponse
	9,  // 87: cloud.hashing.apis.v1.CloudHashingApis.GetRecommendGoodsByApp:output_type -> cloud.hashing.apis.v1.GetRecommendGoodsByAppResponse
	21, // 88: cloud.hashing.apis.v1.CloudHashingApis.SubmitOrder:output_type -> cloud.hashing.apis.v1.SubmitOrderResponse
	23, // 89: cloud.hashing.apis.v1.CloudHashingApis.CreateOrderPayment:output_type -> cloud.hashing.apis.v1.CreateOrderPaymentResponse
	12, // 90: cloud.hashing.apis.v1.CloudHashingApis.GetOrder:output_type -> cloud.hashing.apis.v1.GetOrderResponse
	14, // 91: cloud.hashing.apis.v1.CloudHashingApis.GetOrdersByAppUser:output_type -> cloud.hashing.apis.v1.GetOrdersByAppUserResponse
	16, // 92: cloud.hashing.apis.v1.CloudHashingApis.GetOrdersByApp:output_type -> cloud.hashing.apis.v1.GetOrdersByAppResponse
	18, // 93: cloud.hashing.apis.v1.CloudHashingApis.GetOrdersByGood:output_type -> cloud.hashing.apis.v1.GetOrdersByGoodResponse
	25, // 94: cloud.hashing.apis.v1.CloudHashingApis.Signup:output_type -> cloud.hashing.apis.v1.SignupResponse
	27, // 95: cloud.hashing.apis.v1.CloudHashingApis.UpdatePassword:output_type -> cloud.hashing.apis.v1.UpdatePasswordResponse
	29, // 96: cloud.hashing.apis.v1.CloudHashingApis.UpdatePasswordByAppUser:output_type -> cloud.hashing.apis.v1.UpdatePasswordByAppUserResponse
	31, // 97: cloud.hashing.apis.v1.CloudHashingApis.UpdateEmailAddress:output_type -> cloud.hashing.apis.v1.UpdateEmailAddressResponse
	33, // 98: cloud.hashing.apis.v1.CloudHashingApis.UpdatePhoneNO:output_type -> cloud.hashing.apis.v1.UpdatePhoneNOResponse
	38, // 99: cloud.hashing.apis.v1.CloudHashingApis.GetMyInvitations:output_type -> cloud.hashing.apis.v1.GetMyInvitationsResponse
	40, // 100: cloud.hashing.apis.v1.CloudHashingApis.GetMyDirectInvitations:output_type -> cloud.hashing.apis.v1.GetMyDirectInvitationsResponse
	43, // 101: cloud.hashing.apis.v1.CloudHashingApis.GetKycReviews:output_type -> cloud.hashing.apis.v1.GetKycReviewsResponse
	45, // 102: cloud.hashing.apis.v1.CloudHashingApis.GetKycReviewsByApp:output_type -> cloud.hashing.apis.v1.GetKycReviewsByAppResponse
	47, // 103: cloud.hashing.apis.v1.CloudHashingApis.GetKycReviewsByOtherApp:output_type -> cloud.hashing.apis.v1.GetKycReviewsByOtherAppResponse
	50, // 104: cloud.hashing.apis.v1.CloudHashingApis.GetGoodReviews:output_type -> cloud.hashing.apis.v1.GetGoodReviewsResponse
	55, // 105: cloud.hashing.apis.v1.CloudHashingApis.CreateKyc:output_type -> cloud.hashing.apis.v1.CreateKycResponse
	57, // 106: cloud.hashing.apis.v1.CloudHashingApis.UpdateKyc:output_type -> cloud.hashing.apis.v1.UpdateKycResponse
	53, // 107: cloud.hashing.apis.v1.CloudHashingApis.GetKycByAppUser:output_type -> cloud.hashing.apis.v1.GetKycByAppUserResponse
