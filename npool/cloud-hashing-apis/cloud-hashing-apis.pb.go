...
var file_npool_cloud_hashing_apis_cloud_hashing_apis_proto_rawDesc = []byte{
	...
	0x2e, 0x68, 0x61, 0x73, 0x68, 0x69, 0x6e, 0x67, 0x2e, 0x61, 0x70, 0x69, 0x73, 0x2e, 0x76, 0x31,
	0x2e, 0x57, 0x69, 0x74, 0x68, 0x64, 0x72, 0x61, 0x77, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73,
	0x52, 0x65, 0x76, 0x69, 0x65, 0x77, 0x52, 0x05, 0x49, 0x6e, 0x66, 0x6f, 0x73, 0x32, 0xb4, 0x32,
...
var file_npool_cloud_hashing_apis_cloud_hashing_apis_proto_goTypes = []interface{}{
	...
	(*cloud_hashing_goods.AppGoodPromotion)(nil),        // 107: cloud.hashing.goods.v1.AppGoodPromotion
	(*appusermgr.AppUser)(nil),                          // 108: app.user.manager.v1.AppUser
	(*appusermgr.AppUserSecret)(nil),                    // 109: app.user.manager.v1.AppUserSecret
	(*appusermgr.AppUserInfo)(nil),                      // 110: app.user.manager.v1.AppUserInfo
	(*kyc.KycInfo)(nil),                                 // 111: kyc.management.v1.KycInfo
	(*cloud_hashing_billing.UserWithdrawItem)(nil),      // 112: cloud.hashing.billing.v1.UserWithdrawItem
	(*cloud_hashing_billing.UserWithdraw)(nil),          // 113: cloud.hashing.billing.v1.UserWithdraw
	(*emptypb.Empty)(nil),                               // 114: google.protobuf.Empty
	(*npool.VersionResponse)(nil),                       // 115: npool.v1.VersionResponse
}
var file_npool_cloud_hashing_apis_cloud_hashing_apis_proto_depIdxs = []int32{
	...
	107, // 22: cloud.hashing.apis.v1.Order.Promotion:type_name -> cloud.hashing.goods.v1.AppGoodPromotion
	...
	108, // 30: cloud.hashing.apis.v1.SignupResponse.Info:type_name -> app.user.manager.v1.AppUser
	109, // 31: cloud.hashing.apis.v1.UpdatePasswordResponse.Info:type_name -> app.user.manager.v1.AppUserSecret
	109, // 32: cloud.hashing.apis.v1.UpdatePasswordByAppUserResponse.Info:type_name -> app.user.manager.v1.AppUserSecret
	110, // 33: cloud.hashing.apis.v1.UpdateEmailAddressResponse.Info:type_name -> app.user.manager.v1.AppUserInfo
	110, // 34: cloud.hashing.apis.v1.UpdatePhoneNOResponse.Info:type_name -> app.user.manager.v1.AppUserInfo
	92,  // 35: cloud.hashing.apis.v1.InvitationUserInfo.Summarys:type_name -> cloud.hashing.apis.v1.InvitationUserInfo.SummarysEntry
	93,  // 36: cloud.hashing.apis.v1.InvitationUserInfo.MySummarys:type_name -> cloud.hashing.apis.v1.InvitationUserInfo.MySummarysEntry
	...
	94,  // 39: cloud.hashing.apis.v1.GetMyInvitationsResponse.Infos:type_name -> cloud.hashing.apis.v1.GetMyInvitationsResponse.InfosEntry
	37,  // 40: cloud.hashing.apis.v1.GetMyDirectInvitationsResponse.MySelf:type_name -> cloud.hashing.apis.v1.InvitationUserInfo
	95,  // 41: cloud.hashing.apis.v1.GetMyDirectInvitationsResponse.Infos:type_name -> cloud.hashing.apis.v1.GetMyDirectInvitationsResponse.InfosEntry
	98,  // 42: cloud.hashing.apis.v1.KycReview.Review:type_name -> review.service.v1.Review
	110, // 43: cloud.hashing.apis.v1.KycReview.User:type_name -> app.user.manager.v1.AppUserInfo
	111, // 44: cloud.hashing.apis.v1.KycReview.Kyc:type_name -> kyc.management.v1.KycInfo
	...
	98,  // 48: cloud.hashing.apis.v1.GoodReview.Review:type_name -> review.service.v1.Review
	110, // 49: cloud.hashing.apis.v1.GoodReview.CreatedBy:type_name -> app.user.manager.v1.AppUserInfo
	96,  // 50: cloud.hashing.apis.v1.GoodReview.Good:type_name -> cloud.hashing.goods.v1.GoodDetail
	50,  // 51: cloud.hashing.apis.v1.GetGoodReviewsResponse.Infos:type_name -> cloud.hashing.apis.v1.GoodReview
	111, // 52: cloud.hashing.apis.v1.Kyc.Kyc:type_name -> kyc.management.v1.KycInfo
	53,  // 53: cloud.hashing.apis.v1.GetKycByAppUserResponse.Info:type_name -> cloud.hashing.apis.v1.Kyc
	111, // 54: cloud.hashing.apis.v1.CreateKycRequest.Info:type_name -> kyc.management.v1.KycInfo
	53,  // 55: cloud.hashing.apis.v1.CreateKycResponse.Info:type_name -> cloud.hashing.apis.v1.Kyc
	111, // 56: cloud.hashing.apis.v1.UpdateKycRequest.Info:type_name -> kyc.management.v1.KycInfo
	53,  // 57: cloud.hashing.apis.v1.UpdateKycResponse.Info:type_name -> cloud.hashing.apis.v1.Kyc
	103, // 58: cloud.hashing.apis.v1.CreatePlatformCoinAccountResponse.Info:type_name -> cloud.hashing.billing.v1.CoinAccountInfo
	103, // 59: cloud.hashing.apis.v1.CreateUserCoinAccountRequest.Info:type_name -> cloud.hashing.billing.v1.CoinAccountInfo
	103, // 60: cloud.hashing.apis.v1.CreateUserCoinAccountResponse.Info:type_name -> cloud.hashing.billing.v1.CoinAccountInfo
	112, // 61: cloud.hashing.apis.v1.SubmitUserWithdrawRequest.Info:type_name -> cloud.hashing.billing.v1.UserWithdrawItem
	112, // 62: cloud.hashing.apis.v1.UserWithdraw.Withdraw:type_name -> cloud.hashing.billing.v1.UserWithdrawItem
	98,  // 63: cloud.hashing.apis.v1.WithdrawReview.Review:type_name -> review.service.v1.Review
	110, // 64: cloud.hashing.apis.v1.WithdrawReview.User:type_name -> app.user.manager.v1.AppUserInfo
	112, // 65: cloud.hashing.apis.v1.WithdrawReview.Withdraw:type_name -> cloud.hashing.billing.v1.UserWithdrawItem
	65,  // 66: cloud.hashing.apis.v1.SubmitUserWithdrawResponse.Info:type_name -> cloud.hashing.apis.v1.UserWithdraw
	98,  // 67: cloud.hashing.apis.v1.UpdateUserWithdrawReviewRequest.Info:type_name -> review.service.v1.Review
	66,  // 68: cloud.hashing.apis.v1.UpdateUserWithdrawReviewResponse.Info:type_name -> cloud.hashing.apis.v1.WithdrawReview
	98,  // 69: cloud.hashing.apis.v1.UpdateUserWithdrawReviewForOtherAppUserRequest.Info:type_name -> review.service.v1.Review
	...
	113, // 75: cloud.hashing.apis.v1.WithdrawAddress.Address:type_name -> cloud.hashing.billing.v1.UserWithdraw
	103, // 76: cloud.hashing.apis.v1.WithdrawAddress.Account:type_name -> cloud.hashing.billing.v1.CoinAccountInfo
	...
	98,  // 79: cloud.hashing.apis.v1.WithdrawAddressReview.Review:type_name -> review.service.v1.Review
	110, // 80: cloud.hashing.apis.v1.WithdrawAddressReview.User:type_name -> app.user.manager.v1.AppUserInfo
	113, // 81: cloud.hashing.apis.v1.WithdrawAddressReview.Address:type_name -> cloud.hashing.billing.v1.UserWithdraw
	103, // 82: cloud.hashing.apis.v1.WithdrawAddressReview.Account:type_name -> cloud.hashing.billing.v1.CoinAccountInfo
	...
	36,  // 86: cloud.hashing.apis.v1.InvitationUserInfo.SummarysEntry.value:type_name -> cloud.hashing.apis.v1.InvitationSummary
	36,  // 87: cloud.hashing.apis.v1.InvitationUserInfo.MySummarysEntry.value:type_name -> cloud.hashing.apis.v1.InvitationSummary
	38,  // 88: cloud.hashing.apis.v1.GetMyInvitationsResponse.InfosEntry.value:type_name -> cloud.hashing.apis.v1.Invitation
	38,  // 89: cloud.hashing.apis.v1.GetMyDirectInvitationsResponse.InfosEntry.value:type_name -> cloud.hashing.apis.v1.Invitation
	114, // 90: cloud.hashing.apis.v1.CloudHashingApis.Version:input_type -> google.protobuf.Empty
	6,   // 91: cloud.hashing.apis.v1.CloudHashingApis.GetGoods:input_type -> cloud.hashing.apis.v1.GetGoodsRequest
	8,   // 92: cloud.hashing.apis.v1.CloudHashingApis.GetGoodsByApp:input_type -> cloud.hashing.apis.v1.GetGoodsByAppRequest
	2,   // 93: cloud.hashing.apis.v1.CloudHashingApis.CreateGood:input_type -> cloud.hashing.apis.v1.CreateGoodRequest
	4,   // 94: cloud.hashing.apis.v1.CloudHashingApis.GetGood:input_type -> cloud.hashing.apis.v1.GetGoodRequest
	10,  // 95: cloud.hashing.apis.v1.CloudHashingApis.GetRecommendGoodsByApp:input_type -> cloud.hashing.apis.v1.GetRecommendGoodsByAppRequest
	22,  // 96: cloud.hashing.apis.v1.CloudHashingApis.SubmitOrder:input_type -> cloud.hashing.apis.v1.SubmitOrderRequest
	24,  // 97: cloud.hashing.apis.v1.CloudHashingApis.CreateOrderPayment:input_type -> cloud.hashing.apis.v1.CreateOrderPaymentRequest
	13,  // 98: cloud.hashing.apis.v1.CloudHashingApis.GetOrder:input_type -> cloud.hashing.apis.v1.GetOrderRequest
	15,  // 99: cloud.hashing.apis.v1.CloudHashingApis.GetOrdersByAppUser:input_type -> cloud.hashing.apis.v1.GetOrdersByAppUserRequest
	17,  // 100: cloud.hashing.apis.v1.CloudHashingApis.GetOrdersByApp:input_type -> cloud.hashing.apis.v1.GetOrdersByAppRequest
	19,  // 101: cloud.hashing.apis.v1.CloudHashingApis.GetOrdersByGood:input_type -> cloud.hashing.apis.v1.GetOrdersByGoodRequest
	26,  // 102: cloud.hashing.apis.v1.CloudHashingApis.Signup:input_type -> cloud.hashing.apis.v1.SignupRequest
	28,  // 103: cloud.hashing.apis.v1.CloudHashingApis.UpdatePassword:input_type -> cloud.hashing.apis.v1.UpdatePasswordRequest
	30,  // 104: cloud.hashing.apis.v1.CloudHashingApis.UpdatePasswordByAppUser:input_type -> cloud.hashing.apis.v1.UpdatePasswordByAppUserRequest
	32,  // 105: cloud.hashing.apis.v1.CloudHashingApis.UpdateEmailAddress:input_type -> cloud.hashing.apis.v1.UpdateEmailAddressRequest
	34,  // 106: cloud.hashing.apis.v1.CloudHashingApis.UpdatePhoneNO:input_type -> cloud.hashing.apis.v1.UpdatePhoneNORequest
	39,  // 107: cloud.hashing.apis.v1.CloudHashingApis.GetMyInvitations:input_type -> cloud.hashing.apis.v1.GetMyInvitationsRequest
	41,  // 108: cloud.hashing.apis.v1.CloudHashingApis.GetMyDirectInvitations:input_type -> cloud.hashing.apis.v1.GetMyDirectInvitationsRequest
	44,  // 109: cloud.hashing.apis.v1.CloudHashingApis.GetKycReviews:input_type -> cloud.hashing.apis.v1.GetKycReviewsRequest
	46,  // 110: cloud.hashing.apis.v1.CloudHashingApis.GetKycReviewsByApp:input_type -> cloud.hashing.apis.v1.GetKycReviewsByAppRequest
	48,  // 111: cloud.hashing.apis.v1.CloudHashingApis.GetKycReviewsByOtherApp:input_type -> cloud.hashing.apis.v1.GetKycReviewsByOtherAppRequest
	51,  // 112: cloud.hashing.apis.v1.CloudHashingApis.GetGoodReviews:input_type -> cloud.hashing.apis.v1.GetGoodReviewsRequest
	74,  // 113: cloud.hashing.apis.v1.CloudHashingApis.GetWithdrawReviews:input_type -> cloud.hashing.apis.v1.GetWithdrawReviewsRequest
	76,  // 114: cloud.hashing.apis.v1.CloudHashingApis.GetWithdrawReviewsByApp:input_type -> cloud.hashing.apis.v1.GetWithdrawReviewsByAppRequest
	78,  // 115: cloud.hashing.apis.v1.CloudHashingApis.GetWithdrawReviewsByOtherApp:input_type -> cloud.hashing.apis.v1.GetWithdrawReviewsByOtherAppRequest
	86,  // 116: cloud.hashing.apis.v1.CloudHashingApis.GetWithdrawAddressReviews:input_type -> cloud.hashing.apis.v1.GetWithdrawAddressReviewsRequest
	88,  // 117: cloud.hashing.apis.v1.CloudHashingApis.GetWithdrawAddressReviewsByApp:input_type -> cloud.hashing.apis.v1.GetWithdrawAddressReviewsByAppRequest
	90,  // 118: cloud.hashing.apis.v1.CloudHashingApis.GetWithdrawAddressReviewsByOtherApp:input_type -> cloud.hashing.apis.v1.GetWithdrawAddressReviewsByOtherAppRequest
	56,  // 119: cloud.hashing.apis.v1.CloudHashingApis.CreateKyc:input_type -> cloud.hashing.apis.v1.CreateKycRequest
	58,  // 120: cloud.hashing.apis.v1.CloudHashingApis.UpdateKyc:input_type -> cloud.hashing.apis.v1.UpdateKycRequest
	54,  // 121: cloud.hashing.apis.v1.CloudHashingApis.GetKycByAppUser:input_type -> cloud.hashing.apis.v1.GetKycByAppUserRequest
	60,  // 122: cloud.hashing.apis.v1.CloudHashingApis.CreatePlatformCoinAccount:input_type -> cloud.hashing.apis.v1.CreatePlatformCoinAccountRequest
	62,  // 123: cloud.hashing.apis.v1.CloudHashingApis.CreateUserCoinAccount:input_type -> cloud.hashing.apis.v1.CreateUserCoinAccountRequest
	64,  // 124: cloud.hashing.apis.v1.CloudHashingApis.SubmitUserWithdraw:input_type -> cloud.hashing.apis.v1.SubmitUserWithdrawRequest
	68,  // 125: cloud.hashing.apis.v1.CloudHashingApis.UpdateUserWithdrawReview:input_type -> cloud.hashing.apis.v1.UpdateUserWithdrawReviewRequest
	70,  // 126: cloud.hashing.apis.v1.CloudHashingApis.UpdateUserWithdrawReviewForOtherAppUser:input_type -> cloud.hashing.apis.v1.UpdateUserWithdrawReviewForOtherAppUserRequest
	72,  // 127: cloud.hashing.apis.v1.CloudHashingApis.GetUserWithdrawsByAppUser:input_type -> cloud.hashing.apis.v1.GetUserWithdrawsByAppUserRequest
	81,  // 128: cloud.hashing.apis.v1.CloudHashingApis.SetWithdrawAddress:input_type -> cloud.hashing.apis.v1.SetWithdrawAddressRequest
	83,  // 129: cloud.hashing.apis.v1.CloudHashingApis.GetWithdrawAddressesByAppUser:input_type -> cloud.hashing.apis.v1.GetWithdrawAddressesByAppUserRequest
	115, // 130: cloud.hashing.apis.v1.CloudHashingApis.Version:output_type -> npool.v1.VersionResponse
	7,   // 131: cloud.hashing.apis.v1.CloudHashingApis.GetGoods:output_type -> cloud.hashing.apis.v1.GetGoodsResponse
	9,   // 132: cloud.hashing.apis.v1.CloudHashingApis.GetGoodsByApp:output_type -> cloud.hashing.apis.v1.GetGoodsByAppResponse
	3,   // 133: cloud.hashing.apis.v1.CloudHashingApis.CreateGood:output_type -> cloud.hashing.apis.v1.CreateGoodResponse
	5,   // 134: cloud.hashing.apis.v1.CloudHashingApis.GetGood:output_type -> cloud.hashing.apis.v1.GetGoodResponse
	11,  // 135: cloud.hashing.apis.v1.CloudHashingApis.GetRecommendGoodsByApp:output_type -> cloud.hashing.apis.v1.GetRecommendGoodsByAppResponse
	23,  // 136: cloud.hashing.apis.v1.CloudHashingApis.SubmitOrder:output_type -> cloud.hashing.apis.v1.SubmitOrderResponse
	25,  // 137: cloud.hashing.apis.v1.CloudHashingApis.CreateOrderPayment:output_type -> cloud.hashing.apis.v1.CreateOrderPaymentResponse
	14,  // 138: cloud.hashing.apis.v1.CloudHashingApis.GetOrder:output_type -> cloud.hashing.apis.v1.GetOrderResponse
	16,  // 139: cloud.hashing.apis.v1.CloudHashingApis.GetOrdersByAppUser:output_type -> cloud.hashing.apis.v1.GetOrdersByAppUserResponse
	18,  // 140: cloud.hashing.apis.v1.CloudHashingApis.GetOrdersByApp:output_type -> cloud.hashing.apis.v1.GetOrdersByAppResponse
	20,  // 141: cloud.hashing.apis.v1.CloudHashingApis.GetOrdersByGood:output_type -> cloud.hashing.apis.v1.GetOrdersByGoodResponse
	27,  // 142: cloud.hashing.apis.v1.CloudHashingApis.Signup:output_type -> cloud.hashing.apis.v1.SignupResponse
	29,  // 143: cloud.hashing.apis.v1.CloudHashingApis.UpdatePassword:output_type -> cloud.hashing.apis.v1.UpdatePasswordResponse
	31,  // 144: cloud.hashing.apis.v1.CloudHashingApis.UpdatePasswordByAppUser:output_type -> cloud.hashing.apis.v1.UpdatePasswordByAppUserResponse
	33,  // 145: cloud.hashing.apis.v1.CloudHashingApis.UpdateEmailAddress:output_type -> cloud.hashing.apis.v1.UpdateEmailAddressResponse
	35,  // 146: cloud.hashing.apis.v1.CloudHashingApis.UpdatePhoneNO:output_type -> cloud.hashing.apis.v1.UpdatePhoneNOResponse
	40,  // 147: cloud.hashing.apis.v1.CloudHashingApis.GetMyInvitations:output_type -> cloud.hashing.apis.v1.GetMyInvitationsResponse
	42,  // 148: cloud.hashing.apis.v1.CloudHashingApis.GetMyDirectInvitations:output_type -> cloud.hashing.apis.v1.GetMyDirectInvitationsResponse
	45,  // 149: cloud.hashing.apis.v1.CloudHashingApis.GetKycReviews:output_type -> cloud.hashing.apis.v1.GetKycReviewsResponse
	47,  // 150: cloud.hashing.apis.v1.CloudHashingApis.GetKycReviewsByApp:output_type -> cloud.hashing.apis.v1.GetKycReviewsByAppResponse
	49,  // 151: cloud.hashing.apis.v1.CloudHashingApis.GetKycReviewsByOtherApp:output_type -> cloud.hashing.apis.v1.GetKycReviewsByOtherAppResponse
	52,  // 152: cloud.hashing.apis.v1.CloudHashingApis.GetGoodReviews:output_type -> cloud.hashing.apis.v1.GetGoodReviewsResponse
	75,  // 153: cloud.hashing.apis.v1.CloudHashingApis.GetWithdrawReviews:output_type -> cloud.hashing.apis.v1.GetWithdrawReviewsResponse
	77,  // 154: cloud.hashing.apis.v1.CloudHashingApis.GetWithdrawReviewsByApp:output_type -> cloud.hashing.apis.v1.GetWithdrawReviewsByAppResponse
	79,  // 155: cloud.hashing.apis.v1.CloudHashingApis.GetWithdrawReviewsByOtherApp:output_type -> cloud.hashing.apis.v1.GetWithdrawReviewsByOtherAppResponse
	87,  // 156: cloud.hashing.apis.v1.CloudHashingApis.GetWithdrawAddressReviews:output_type -> cloud.hashing.apis.v1.GetWithdrawAddressReviewsResponse
	89,  // 157: cloud.hashing.apis.v1.CloudHashingApis.GetWithdrawAddressReviewsByApp:output_type -> cloud.hashing.apis.v1.GetWithdrawAddressReviewsByAppResponse
	91,  // 158: cloud.hashing.apis.v1.CloudHashingApis.GetWithdrawAddressReviewsByOtherApp:output_type -> cloud.hashing.apis.v1.GetWithdrawAddressReviewsByOtherAppResponse
	57,  // 159: cloud.hashing.apis.v1.CloudHashingApis.CreateKyc:output_type -> cloud.hashing.apis.v1.CreateKycResponse
	59,  // 160: cloud.hashing.apis.v1.CloudHashingApis.UpdateKyc:output_type -> cloud.hashing.apis.v1.UpdateKycResponse
	55,  // 161: cloud.hashing.apis.v1.CloudHashingApis.GetKycByAppUser:output_type -> cloud.hashing.apis.v1.GetKycByAppUserResponse
	61,  // 162: cloud.hashing.apis.v1.CloudHashingApis.CreatePlatformCoinAccount:output_type -> cloud.hashing.apis.v1.CreatePlatformCoinAccountResponse
	63,  // 163: cloud.hashing.apis.v1.CloudHashingApis.CreateUserCoinAccount:output_type -> cloud.hashing.apis.v1.CreateUserCoinAccountResponse
	67,  // 164: cloud.hashing.apis.v1.CloudHashingApis.SubmitUserWithdraw:output_type -> cloud.hashing.apis.v1.SubmitUserWithdrawResponse
	69,  // 165: cloud.hashing.apis.v1.CloudHashingApis.UpdateUserWithdrawReview:output_type -> cloud.hashing.apis.v1.UpdateUserWithdrawReviewResponse
	71,  // 166: cloud.hashing.apis.v1.CloudHashingApis.UpdateUserWithdrawReviewForOtherAppUser:output_type -> cloud.hashing.apis.v1.UpdateUserWithdrawReviewForOtherAppUserResponse
	73,  // 167: cloud.hashing.apis.v1.CloudHashingApis.GetUserWithdrawsByAppUser:output_type -> cloud.hashing.apis.v1.GetUserWithdrawsByAppUserResponse
	82,  // 168: cloud.hashing.apis.v1.CloudHashingApis.SetWithdrawAddress:output_type -> cloud.hashing.apis.v1.SetWithdrawAddressResponse
	84,  // 169: cloud.hashing.apis.v1.CloudHashingApis.GetWithdrawAddressesByAppUser:output_type -> cloud.hashing.apis.v1.GetWithdrawAddressesByAppUserResponse
