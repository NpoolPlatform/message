...
var file_npool_cloud_hashing_apis_cloud_hashing_apis_proto_rawDesc = []byte{
	...
	0x49, 0x6e, 0x66, 0x6f, 0x73, 0x22, 0x83, 0x01, 0x0a, 0x0f, 0x57, 0x69, 0x74, 0x68, 0x64, 0x72,
	...
	0x28, 0x09, 0x52, 0x07, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0xb1, 0x01, 0x0a, 0x19,
	...
	0x65, 0x73, 0x73, 0x52, 0x04, 0x49, 0x6e, 0x66, 0x6f, 0x22, 0xc2, 0x01, 0x0a, 0x15, 0x57, 0x69,
	...
	0x68, 0x64, 0x72, 0x61, 0x77, 0x52, 0x07, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x22, 0x54,
	...
	0x65, 0x72, 0x49, 0x44, 0x22, 0x6b, 0x0a, 0x25, 0x47, 0x65, 0x74, 0x57, 0x69, 0x74, 0x68, 0x64,
	0x72, 0x61, 0x77, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x65, 0x73, 0x42, 0x79, 0x41, 0x70,
	0x70, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x42, 0x0a,
	...
	0x73, 0x32, 0xb3, 0x2a, 0x0a, 0x10, 0x43, 0x6c, 0x6f, 0x75, 0x64, 0x48, 0x61, 0x73, 0x68, 0x69,
	...
	0x72, 0x65, 0x76, 0x69, 0x65, 0x77, 0x3a, 0x01, 0x2a, 0x12, 0xbd, 0x01, 0x0a, 0x19, 0x47, 0x65,
	...
	0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x3a, 0x01, 0x2a, 0x12, 0xca, 0x01, 0x0a, 0x1d, 0x47,
	...
	0x70, 0x70, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x42, 0x3b, 0x5a, 0x39, 0x67, 0x69, 0x74, 0x68, 0x75,
...
var file_npool_cloud_hashing_apis_cloud_hashing_apis_proto_depIdxs = []int32{
	...
	76,  // 70: cloud.hashing.apis.v1.SetWithdrawAddressResponse.Info:type_name -> cloud.hashing.apis.v1.WithdrawAddress
	88,  // 71: cloud.hashing.apis.v1.WithdrawAddressReview.Review:type_name -> review.service.v1.Review
	98,  // 72: cloud.hashing.apis.v1.WithdrawAddressReview.User:type_name -> app.user.manager.v1.AppUserInfo
	101, // 73: cloud.hashing.apis.v1.WithdrawAddressReview.Address:type_name -> cloud.hashing.billing.v1.UserWithdraw
	79,  // 74: cloud.hashing.apis.v1.GetWithdrawAddressesByAppUserResponse.Infos:type_name -> cloud.hashing.apis.v1.WithdrawAddressReview
	34,  // 75: cloud.hashing.apis.v1.InvitationUserInfo.SummarysEntry.value:type_name -> cloud.hashing.apis.v1.InvitationSummary
	34,  // 76: cloud.hashing.apis.v1.InvitationUserInfo.MySummarysEntry.value:type_name -> cloud.hashing.apis.v1.InvitationSummary
	36,  // 77: cloud.hashing.apis.v1.GetMyInvitationsResponse.InfosEntry.value:type_name -> cloud.hashing.apis.v1.Invitation
	36,  // 78: cloud.hashing.apis.v1.GetMyDirectInvitationsResponse.InfosEntry.value:type_name -> cloud.hashing.apis.v1.Invitation
	102, // 79: cloud.hashing.apis.v1.CloudHashingApis.Version:input_type -> google.protobuf.Empty
	6,   // 80: cloud.hashing.apis.v1.CloudHashingApis.GetGoods:input_type -> cloud.hashing.apis.v1.GetGoodsRequest
	2,   // 81: cloud.hashing.apis.v1.CloudHashingApis.CreateGood:input_type -> cloud.hashing.apis.v1.CreateGoodRequest
	4,   // 82: cloud.hashing.apis.v1.CloudHashingApis.GetGood:input_type -> cloud.hashing.apis.v1.GetGoodRequest
	8,   // 83: cloud.hashing.apis.v1.CloudHashingApis.GetRecommendGoodsByApp:input_type -> cloud.hashing.apis.v1.GetRecommendGoodsByAppRequest
	20,  // 84: cloud.hashing.apis.v1.CloudHashingApis.SubmitOrder:input_type -> cloud.hashing.apis.v1.SubmitOrderRequest
	22,  // 85: cloud.hashing.apis.v1.CloudHashingApis.CreateOrderPayment:input_type -> cloud.hashing.apis.v1.CreateOrderPaymentRequest
	11,  // 86: cloud.hashing.apis.v1.CloudHashingApis.GetOrder:input_type -> cloud.hashing.apis.v1.GetOrderRequest
	13,  // 87: cloud.hashing.apis.v1.CloudHashingApis.GetOrdersByAppUser:input_type -> cloud.hashing.apis.v1.GetOrdersByAppUserRequest
	15,  // 88: cloud.hashing.apis.v1.CloudHashingApis.GetOrdersByApp:input_type -> cloud.hashing.apis.v1.GetOrdersByAppRequest
	17,  // 89: cloud.hashing.apis.v1.CloudHashingApis.GetOrdersByGood:input_type -> cloud.hashing.apis.v1.GetOrdersByGoodRequest
	24,  // 90: cloud.hashing.apis.v1.CloudHashingApis.Signup:input_type -> cloud.hashing.apis.v1.SignupRequest
	26,  // 91: cloud.hashing.apis.v1.CloudHashingApis.UpdatePassword:input_type -> cloud.hashing.apis.v1.UpdatePasswordRequest
	28,  // 92: cloud.hashing.apis.v1.CloudHashingApis.UpdatePasswordByAppUser:input_type -> cloud.hashing.apis.v1.UpdatePasswordByAppUserRequest
	30,  // 93: cloud.hashing.apis.v1.CloudHashingApis.UpdateEmailAddress:input_type -> cloud.hashing.apis.v1.UpdateEmailAddressRequest
	32,  // 94: cloud.hashing.apis.v1.CloudHashingApis.UpdatePhoneNO:input_type -> cloud.hashing.apis.v1.UpdatePhoneNORequest
	37,  // 95: cloud.hashing.apis.v1.CloudHashingApis.GetMyInvitations:input_type -> cloud.hashing.apis.v1.GetMyInvitationsRequest
	39,  // 96: cloud.hashing.apis.v1.CloudHashingApis.GetMyDirectInvitations:input_type -> cloud.hashing.apis.v1.GetMyDirectInvitationsRequest
	42,  // 97: cloud.hashing.apis.v1.CloudHashingApis.GetKycReviews:input_type -> cloud.hashing.apis.v1.GetKycReviewsRequest
	44,  // 98: cloud.hashing.apis.v1.CloudHashingApis.GetKycReviewsByApp:input_type -> cloud.hashing.apis.v1.GetKycReviewsByAppRequest
	46,  // 99: cloud.hashing.apis.v1.CloudHashingApis.GetKycReviewsByOtherApp:input_type -> cloud.hashing.apis.v1.GetKycReviewsByOtherAppRequest
	49,  // 100: cloud.hashing.apis.v1.CloudHashingApis.GetGoodReviews:input_type -> cloud.hashing.apis.v1.GetGoodReviewsRequest
	70,  // 101: cloud.hashing.apis.v1.CloudHashingApis.GetWithdrawReviews:input_type -> cloud.hashing.apis.v1.GetWithdrawReviewsRequest
	72,  // 102: cloud.hashing.apis.v1.CloudHashingApis.GetWithdrawReviewsByApp:input_type -> cloud.hashing.apis.v1.GetWithdrawReviewsByAppRequest
	74,  // 103: cloud.hashing.apis.v1.CloudHashingApis.GetWithdrawReviewsByOtherApp:input_type -> cloud.hashing.apis.v1.GetWithdrawReviewsByOtherAppRequest
	54,  // 104: cloud.hashing.apis.v1.CloudHashingApis.CreateKyc:input_type -> cloud.hashing.apis.v1.CreateKycRequest
	56,  // 105: cloud.hashing.apis.v1.CloudHashingApis.UpdateKyc:input_type -> cloud.hashing.apis.v1.UpdateKycRequest
	52,  // 106: cloud.hashing.apis.v1.CloudHashingApis.GetKycByAppUser:input_type -> cloud.hashing.apis.v1.GetKycByAppUserRequest
	58,  // 107: cloud.hashing.apis.v1.CloudHashingApis.CreatePlatformCoinAccount:input_type -> cloud.hashing.apis.v1.CreatePlatformCoinAccountRequest
	60,  // 108: cloud.hashing.apis.v1.CloudHashingApis.CreateUserCoinAccount:input_type -> cloud.hashing.apis.v1.CreateUserCoinAccountRequest
	62,  // 109: cloud.hashing.apis.v1.CloudHashingApis.SubmitUserWithdraw:input_type -> cloud.hashing.apis.v1.SubmitUserWithdrawRequest
	65,  // 110: cloud.hashing.apis.v1.CloudHashingApis.UpdateUserWithdrawReview:input_type -> cloud.hashing.apis.v1.UpdateUserWithdrawReviewRequest
	67,  // 111: cloud.hashing.apis.v1.CloudHashingApis.GetUserWithdrawsByAppUser:input_type -> cloud.hashing.apis.v1.GetUserWithdrawsByAppUserRequest
	77,  // 112: cloud.hashing.apis.v1.CloudHashingApis.SetWithdrawAddress:input_type -> cloud.hashing.apis.v1.SetWithdrawAddressRequest
	80,  // 113: cloud.hashing.apis.v1.CloudHashingApis.GetWithdrawAddressesByAppUser:input_type -> cloud.hashing.apis.v1.GetWithdrawAddressesByAppUserRequest
	103, // 114: cloud.hashing.apis.v1.CloudHashingApis.Version:output_type -> npool.v1.VersionResponse
	7,   // 115: cloud.hashing.apis.v1.CloudHashingApis.GetGoods:output_type -> cloud.hashing.apis.v1.GetGoodsResponse
	3,   // 116: cloud.hashing.apis.v1.CloudHashingApis.CreateGood:output_type -> cloud.hashing.apis.v1.CreateGoodResponse
	5,   // 117: cloud.hashing.apis.v1.CloudHashingApis.GetGood:output_type -> cloud.hashing.apis.v1.GetGoodResponse
	9,   // 118: cloud.hashing.apis.v1.CloudHashingApis.GetRecommendGoodsByApp:output_type -> cloud.hashing.apis.v1.GetRecommendGoodsByAppResponse
	21,  // 119: cloud.hashing.apis.v1.CloudHashingApis.SubmitOrder:output_type -> cloud.hashing.apis.v1.SubmitOrderResponse
	23,  // 120: cloud.hashing.apis.v1.CloudHashingApis.CreateOrderPayment:output_type -> cloud.hashing.apis.v1.CreateOrderPaymentResponse
	12,  // 121: cloud.hashing.apis.v1.CloudHashingApis.GetOrder:output_type -> cloud.hashing.apis.v1.GetOrderResponse
	14,  // 122: cloud.hashing.apis.v1.CloudHashingApis.GetOrdersByAppUser:output_type -> cloud.hashing.apis.v1.GetOrdersByAppUserResponse
	16,  // 123: cloud.hashing.apis.v1.CloudHashingApis.GetOrdersByApp:output_type -> cloud.hashing.apis.v1.GetOrdersByAppResponse
	18,  // 124: cloud.hashing.apis.v1.CloudHashingApis.GetOrdersByGood:output_type -> cloud.hashing.apis.v1.GetOrdersByGoodResponse
	25,  // 125: cloud.hashing.apis.v1.CloudHashingApis.Signup:output_type -> cloud.hashing.apis.v1.SignupResponse
	27,  // 126: cloud.hashing.apis.v1.CloudHashingApis.UpdatePassword:output_type -> cloud.hashing.apis.v1.UpdatePasswordResponse
	29,  // 127: cloud.hashing.apis.v1.CloudHashingApis.UpdatePasswordByAppUser:output_type -> cloud.hashing.apis.v1.UpdatePasswordByAppUserResponse
	31,  // 128: cloud.hashing.apis.v1.CloudHashingApis.UpdateEmailAddress:output_type -> cloud.hashing.apis.v1.UpdateEmailAddressResponse
	33,  // 129: cloud.hashing.apis.v1.CloudHashingApis.UpdatePhoneNO:output_type -> cloud.hashing.apis.v1.UpdatePhoneNOResponse
	38,  // 130: cloud.hashing.apis.v1.CloudHashingApis.GetMyInvitations:output_type -> cloud.hashing.apis.v1.GetMyInvitationsResponse
	40,  // 131: cloud.hashing.apis.v1.CloudHashingApis.GetMyDirectInvitations:output_type -> cloud.hashing.apis.v1.GetMyDirectInvitationsResponse
	43,  // 132: cloud.hashing.apis.v1.CloudHashingApis.GetKycReviews:output_type -> cloud.hashing.apis.v1.GetKycReviewsResponse
	45,  // 133: cloud.hashing.apis.v1.CloudHashingApis.GetKycReviewsByApp:output_type -> cloud.hashing.apis.v1.GetKycReviewsByAppResponse
	47,  // 134: cloud.hashing.apis.v1.CloudHashingApis.GetKycReviewsByOtherApp:output_type -> cloud.hashing.apis.v1.GetKycReviewsByOtherAppResponse
	50,  // 135: cloud.hashing.apis.v1.CloudHashingApis.GetGoodReviews:output_type -> cloud.hashing.apis.v1.GetGoodReviewsResponse
	71,  // 136: cloud.hashing.apis.v1.CloudHashingApis.GetWithdrawReviews:output_type -> cloud.hashing.apis.v1.GetWithdrawReviewsResponse
	73,  // 137: cloud.hashing.apis.v1.CloudHashingApis.GetWithdrawReviewsByApp:output_type -> cloud.hashing.apis.v1.GetWithdrawReviewsByAppResponse
	75,  // 138: cloud.hashing.apis.v1.CloudHashingApis.GetWithdrawReviewsByOtherApp:output_type -> cloud.hashing.apis.v1.GetWithdrawReviewsByOtherAppResponse
	55,  // 139: cloud.hashing.apis.v1.CloudHashingApis.CreateKyc:output_type -> cloud.hashing.apis.v1.CreateKycResponse
	57,  // 140: cloud.hashing.apis.v1.CloudHashingApis.UpdateKyc:output_type -> cloud.hashing.apis.v1.UpdateKycResponse
	53,  // 141: cloud.hashing.apis.v1.CloudHashingApis.GetKycByAppUser:output_type -> cloud.hashing.apis.v1.GetKycByAppUserResponse
	59,  // 142: cloud.hashing.apis.v1.CloudHashingApis.CreatePlatformCoinAccount:output_type -> cloud.hashing.apis.v1.CreatePlatformCoinAccountResponse
	61,  // 143: cloud.hashing.apis.v1.CloudHashingApis.CreateUserCoinAccount:output_type -> cloud.hashing.apis.v1.CreateUserCoinAccountResponse
	64,  // 144: cloud.hashing.apis.v1.CloudHashingApis.SubmitUserWithdraw:output_type -> cloud.hashing.apis.v1.SubmitUserWithdrawResponse
	66,  // 145: cloud.hashing.apis.v1.CloudHashingApis.UpdateUserWithdrawReview:output_type -> cloud.hashing.apis.v1.UpdateUserWithdrawReviewResponse
	68,  // 146: cloud.hashing.apis.v1.CloudHashingApis.GetUserWithdrawsByAppUser:output_type -> cloud.hashing.apis.v1.GetUserWithdrawsByAppUserResponse
	78,  // 147: cloud.hashing.apis.v1.CloudHashingApis.SetWithdrawAddress:output_type -> cloud.hashing.apis.v1.SetWithdrawAddressResponse
	81,  // 148: cloud.hashing.apis.v1.CloudHashingApis.GetWithdrawAddressesByAppUser:output_type -> cloud.hashing.apis.v1.GetWithdrawAddressesByAppUserResponse
