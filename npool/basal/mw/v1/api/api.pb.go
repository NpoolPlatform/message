...
var file_npool_basal_mw_v1_api_api_proto_rawDesc = []byte{
	...
	0x62, 0x61, 0x73, 0x61, 0x6c, 0x2e, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x72, 0x2e, 0x61, 0x70,
	0x69, 0x2e, 0x76, 0x31, 0x2e, 0x41, 0x50, 0x49, 0x52, 0x04, 0x49, 0x6e, 0x66, 0x6f, 0x32, 0xf3,
	0x04, 0x0a, 0x0a, 0x4d, 0x69, 0x64, 0x64, 0x6c, 0x65, 0x77, 0x61, 0x72, 0x65, 0x12, 0x64, 0x0a,
	...
	0x61, 0x73, 0x61, 0x6c, 0x2f, 0x6d, 0x77, 0x2f, 0x76, 0x31, 0x2f, 0x61, 0x70, 0x69, 0x62, 0x06,
...
var file_npool_basal_mw_v1_api_api_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_npool_basal_mw_v1_api_api_proto_goTypes = []interface{}{
	...
	(*api.APIReq)(nil),         // 12: basal.manager.api.v1.APIReq
	(*api.API)(nil),            // 13: basal.manager.api.v1.API
	(*api.Conds)(nil),          // 14: basal.manager.api.v1.Conds
}
var file_npool_basal_mw_v1_api_api_proto_depIdxs = []int32{
	12, // 0: basal.middleware.api.v1.CreateAPIRequest.Info:type_name -> basal.manager.api.v1.APIReq
	13, // 1: basal.middleware.api.v1.CreateAPIResponse.Info:type_name -> basal.manager.api.v1.API
	12, // 2: basal.middleware.api.v1.CreateAPIsRequest.Infos:type_name -> basal.manager.api.v1.APIReq
	13, // 3: basal.middleware.api.v1.CreateAPIsResponse.Infos:type_name -> basal.manager.api.v1.API
	12, // 4: basal.middleware.api.v1.UpdateAPIRequest.Info:type_name -> basal.manager.api.v1.APIReq
	13, // 5: basal.middleware.api.v1.UpdateAPIResponse.Info:type_name -> basal.manager.api.v1.API
	14, // 6: basal.middleware.api.v1.GetAPIsRequest.Conds:type_name -> basal.manager.api.v1.Conds
	13, // 7: basal.middleware.api.v1.GetAPIsResponse.Infos:type_name -> basal.manager.api.v1.API
	14, // 8: basal.middleware.api.v1.GetAPIOnlyRequest.Conds:type_name -> basal.manager.api.v1.Conds
	13, // 9: basal.middleware.api.v1.GetAPIOnlyResponse.Info:type_name -> basal.manager.api.v1.API
	...
	1,  // 16: basal.middleware.api.v1.Middleware.CreateAPI:output_type -> basal.middleware.api.v1.CreateAPIResponse
	3,  // 17: basal.middleware.api.v1.Middleware.CreateAPIs:output_type -> basal.middleware.api.v1.CreateAPIsResponse
	5,  // 18: basal.middleware.api.v1.Middleware.UpdateAPI:output_type -> basal.middleware.api.v1.UpdateAPIResponse
	7,  // 19: basal.middleware.api.v1.Middleware.GetAPIs:output_type -> basal.middleware.api.v1.GetAPIsResponse
	9,  // 20: basal.middleware.api.v1.Middleware.GetDomains:output_type -> basal.middleware.api.v1.GetDomainsResponse
	11, // 21: basal.middleware.api.v1.Middleware.GetAPIOnly:output_type -> basal.middleware.api.v1.GetAPIOnlyResponse
