...
func (x *CreateAPIsReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CreateAPIsReq) ProtoMessage() {}

func (x *CreateAPIsReq) ProtoReflect() protoreflect.Message {
	mi := &file_npool_basal_mw_v1_event_event_proto_msgTypes[0]
...
// Deprecated: Use CreateAPIsReq.ProtoReflect.Descriptor instead.
func (*CreateAPIsReq) Descriptor() ([]byte, []int) {
	return file_npool_basal_mw_v1_event_event_proto_rawDescGZIP(), []int{0}
}

func (x *CreateAPIsReq) GetProtocol() api.Protocol {
	if x != nil {
		return x.Protocol
	}
...
func (x *CreateAPIsReq) GetServiceName() string {
	if x != nil {
...
func (x *CreateAPIsReq) GetMethod() api.Method {
	if x != nil {
		return x.Method
	}
	return api.Method(0)
...
func (x *CreateAPIsReq) GetMethodName() string {
	if x != nil {
		return x.MethodName
	}
	return ""
...
func (x *CreateAPIsReq) GetPath() string {
	if x != nil {
		return x.Path
	}
	return ""
...
func (x *CreateAPIsReq) GetPathPrefix() string {
	if x != nil {
		return x.PathPrefix
	}
	return ""
...
func (x *CreateAPIsReq) GetDomains() []string {
	if x != nil {
		return x.Domains
	}
	return nil
...
func (x *CreateAPIsReq) GetExported() bool {
...
var file_npool_basal_mw_v1_event_event_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0xc5, 0x02, 0x0a, 0x0d, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x41, 0x50, 0x49, 0x73,
	0x52, 0x65, 0x71, 0x12, 0x3d, 0x0a, 0x08, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x18,
	0x0a, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x21, 0x2e, 0x62, 0x61, 0x73, 0x61, 0x6c, 0x2e, 0x6d, 0x69,
	...
	0x65, 0x18, 0x14, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	0x4e, 0x61, 0x6d, 0x65, 0x12, 0x37, 0x0a, 0x06, 0x4d, 0x65, 0x74, 0x68, 0x6f, 0x64, 0x18, 0x1e,
	...
	0x0a, 0x4d, 0x65, 0x74, 0x68, 0x6f, 0x64, 0x4e, 0x61, 0x6d, 0x65, 0x18, 0x28, 0x20, 0x01, 0x28,
	...
	0x68, 0x12, 0x1e, 0x0a, 0x0a, 0x50, 0x61, 0x74, 0x68, 0x50, 0x72, 0x65, 0x66, 0x69, 0x78, 0x18,
	0x3c, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x50, 0x61, 0x74, 0x68, 0x50, 0x72, 0x65, 0x66, 0x69,
	0x78, 0x12, 0x18, 0x0a, 0x07, 0x44, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x73, 0x18, 0x46, 0x20, 0x03,
	0x28, 0x09, 0x52, 0x07, 0x44, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x73, 0x12, 0x1f, 0x0a, 0x08, 0x45,
	0x78, 0x70, 0x6f, 0x72, 0x74, 0x65, 0x64, 0x18, 0x50, 0x20, 0x01, 0x28, 0x08, 0x48, 0x00, 0x52,
	0x08, 0x45, 0x78, 0x70, 0x6f, 0x72, 0x74, 0x65, 0x64, 0x88, 0x01, 0x01, 0x42, 0x0b, 0x0a, 0x09,
	0x5f, 0x45, 0x78, 0x70, 0x6f, 0x72, 0x74, 0x65, 0x64, 0x22, 0x48, 0x0a, 0x12, 0x43, 0x72, 0x65,
	...
	0x66, 0x6f, 0x73, 0x42, 0x3a, 0x5a, 0x38, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
	...
	0x73, 0x61, 0x6c, 0x2f, 0x6d, 0x77, 0x2f, 0x76, 0x31, 0x2f, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x62,
...
var file_npool_basal_mw_v1_event_event_proto_goTypes = []interface{}{
	(*CreateAPIsReq)(nil),      // 0: basal.middleware.event.v1.CreateAPIsReq
	(*CreateAPIsResponse)(nil), // 1: basal.middleware.event.v1.CreateAPIsResponse
...
var file_npool_basal_mw_v1_event_event_proto_depIdxs = []int32{
	2, // 0: basal.middleware.event.v1.CreateAPIsReq.Protocol:type_name -> basal.middleware.api.v1.Protocol
	3, // 1: basal.middleware.event.v1.CreateAPIsReq.Method:type_name -> basal.middleware.api.v1.Method
	4, // 2: basal.middleware.event.v1.CreateAPIsResponse.Infos:type_name -> basal.middleware.api.v1.API
