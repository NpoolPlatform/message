...
func (x *Conds) Reset() {
	*x = Conds{}
	if protoimpl.UnsafeEnabled {
		mi := &file_npool_miningmgr_profit_unsold_unsold_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Conds) Descriptor() ([]byte, []int) {
	return file_npool_miningmgr_profit_unsold_unsold_proto_rawDescGZIP(), []int{2}
}
...
var File_npool_miningmgr_profit_unsold_unsold_proto protoreflect.FileDescriptor

var file_npool_miningmgr_profit_unsold_unsold_proto_rawDesc = []byte{
	0x0a, 0x2a, 0x6e, 0x70, 0x6f, 0x6f, 0x6c, 0x2f, 0x6d, 0x69, 0x6e, 0x69, 0x6e, 0x67, 0x6d, 0x67,
	0x72, 0x2f, 0x70, 0x72, 0x6f, 0x66, 0x69, 0x74, 0x2f, 0x75, 0x6e, 0x73, 0x6f, 0x6c, 0x64, 0x2f,
	0x75, 0x6e, 0x73, 0x6f, 0x6c, 0x64, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x1f, 0x6d, 0x69,
	0x6e, 0x69, 0x6e, 0x67, 0x2e, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f,
	0x66, 0x69, 0x74, 0x2e, 0x75, 0x6e, 0x73, 0x6f, 0x6c, 0x64, 0x2e, 0x76, 0x31, 0x1a, 0x1b, 0x67,
	...
	0x70, 0x72, 0x6f, 0x66, 0x69, 0x74, 0x2f, 0x75, 0x6e, 0x73, 0x6f, 0x6c, 0x64, 0x62, 0x06, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_npool_miningmgr_profit_unsold_unsold_proto_rawDescOnce sync.Once
	file_npool_miningmgr_profit_unsold_unsold_proto_rawDescData = file_npool_miningmgr_profit_unsold_unsold_proto_rawDesc
)

func file_npool_miningmgr_profit_unsold_unsold_proto_rawDescGZIP() []byte {
	file_npool_miningmgr_profit_unsold_unsold_proto_rawDescOnce.Do(func() {
		file_npool_miningmgr_profit_unsold_unsold_proto_rawDescData = protoimpl.X.CompressGZIP(file_npool_miningmgr_profit_unsold_unsold_proto_rawDescData)
	})
	return file_npool_miningmgr_profit_unsold_unsold_proto_rawDescData
}
...
var file_npool_miningmgr_profit_unsold_unsold_proto_depIdxs = []int32{
...
func init() { file_npool_miningmgr_profit_unsold_unsold_proto_init() }
func file_npool_miningmgr_profit_unsold_unsold_proto_init() {
	if File_npool_miningmgr_profit_unsold_unsold_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		...
		file_npool_miningmgr_profit_unsold_unsold_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Conds); i {
			case 0:
				return &v.state
			case 1:
	...
	file_npool_miningmgr_profit_unsold_unsold_proto_msgTypes[0].OneofWrappers = []interface{}{}
	file_npool_miningmgr_profit_unsold_unsold_proto_msgTypes[2].OneofWrappers = []interface{}{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_npool_miningmgr_profit_unsold_unsold_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   19,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_npool_miningmgr_profit_unsold_unsold_proto_goTypes,
		DependencyIndexes: file_npool_miningmgr_profit_unsold_unsold_proto_depIdxs,
		MessageInfos:      file_npool_miningmgr_profit_unsold_unsold_proto_msgTypes,
	}.Build()
	File_npool_miningmgr_profit_unsold_unsold_proto = out.File
	file_npool_miningmgr_profit_unsold_unsold_proto_rawDesc = nil
	file_npool_miningmgr_profit_unsold_unsold_proto_goTypes = nil
	file_npool_miningmgr_profit_unsold_unsold_proto_depIdxs = nil
}
