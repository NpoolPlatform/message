...
const (
	Manager_CreateCountry_FullMethodName     = "/g11n.manager.appcountry.v1.Manager/CreateCountry"
	Manager_CreateCountries_FullMethodName   = "/g11n.manager.appcountry.v1.Manager/CreateCountries"
	Manager_UpdateCountry_FullMethodName     = "/g11n.manager.appcountry.v1.Manager/UpdateCountry"
	Manager_GetCountry_FullMethodName        = "/g11n.manager.appcountry.v1.Manager/GetCountry"
	Manager_GetCountryOnly_FullMethodName    = "/g11n.manager.appcountry.v1.Manager/GetCountryOnly"
	Manager_GetCountries_FullMethodName      = "/g11n.manager.appcountry.v1.Manager/GetCountries"
	Manager_ExistCountry_FullMethodName      = "/g11n.manager.appcountry.v1.Manager/ExistCountry"
	Manager_ExistCountryConds_FullMethodName = "/g11n.manager.appcountry.v1.Manager/ExistCountryConds"
	Manager_CountCountries_FullMethodName    = "/g11n.manager.appcountry.v1.Manager/CountCountries"
	Manager_DeleteCountry_FullMethodName     = "/g11n.manager.appcountry.v1.Manager/DeleteCountry"
)
...
func (c *managerClient) ExistCountry(ctx context.Context, in *ExistCountryRequest, opts ...grpc.CallOption) (*ExistCountryResponse, error) {
	...
	err := c.cc.Invoke(ctx, Manager_ExistCountry_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *managerClient) ExistCountryConds(ctx context.Context, in *ExistCountryCondsRequest, opts ...grpc.CallOption) (*ExistCountryCondsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Manager_ExistCountryConds_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *managerClient) CountCountries(ctx context.Context, in *CountCountriesRequest, opts ...grpc.CallOption) (*CountCountriesResponse, error) {
	...
	err := c.cc.Invoke(ctx, Manager_CountCountries_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Manager_ExistCountry_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Manager_ExistCountry_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Manager_ExistCountryConds_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Manager_ExistCountryConds_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Manager_CountCountries_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Manager_CountCountries_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
