...
const (
	Gateway_CreateLang_FullMethodName  = "/g11n.gateway.applang.v1.Gateway/CreateLang"
	Gateway_UpdateLang_FullMethodName  = "/g11n.gateway.applang.v1.Gateway/UpdateLang"
	Gateway_GetLangs_FullMethodName    = "/g11n.gateway.applang.v1.Gateway/GetLangs"
	Gateway_GetAppLangs_FullMethodName = "/g11n.gateway.applang.v1.Gateway/GetAppLangs"
	Gateway_DeleteLang_FullMethodName  = "/g11n.gateway.applang.v1.Gateway/DeleteLang"
)
...
func (c *gatewayClient) GetAppLangs(ctx context.Context, in *GetAppLangsRequest, opts ...grpc.CallOption) (*GetAppLangsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Gateway_GetAppLangs_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gatewayClient) DeleteLang(ctx context.Context, in *DeleteLangRequest, opts ...grpc.CallOption) (*DeleteLangResponse, error) {
	...
	err := c.cc.Invoke(ctx, Gateway_DeleteLang_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Gateway_GetAppLangs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Gateway_GetAppLangs_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Gateway_DeleteLang_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Gateway_DeleteLang_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
