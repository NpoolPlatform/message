...
const (
	Gateway_CreateCountry_FullMethodName   = "/g11n.gateway.country.v1.Gateway/CreateCountry"
	Gateway_CreateCountries_FullMethodName = "/g11n.gateway.country.v1.Gateway/CreateCountries"
	Gateway_UpdateCountry_FullMethodName   = "/g11n.gateway.country.v1.Gateway/UpdateCountry"
	Gateway_GetCountries_FullMethodName    = "/g11n.gateway.country.v1.Gateway/GetCountries"
)
...
func (c *gatewayClient) CreateCountries(ctx context.Context, in *CreateCountriesRequest, opts ...grpc.CallOption) (*CreateCountriesResponse, error) {
	...
	err := c.cc.Invoke(ctx, Gateway_CreateCountries_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gatewayClient) UpdateCountry(ctx context.Context, in *UpdateCountryRequest, opts ...grpc.CallOption) (*UpdateCountryResponse, error) {
	...
	err := c.cc.Invoke(ctx, Gateway_UpdateCountry_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Gateway_CreateCountries_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Gateway_CreateCountries_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Gateway_UpdateCountry_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Gateway_UpdateCountry_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
