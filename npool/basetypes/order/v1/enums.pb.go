...
const (
	...
	OrderState_OrderStateAchievementBookKept        OrderState = 90 // -> OrderStatePaid
	// Paid
	OrderState_OrderStatePaid                       OrderState = 100 // -> OrderStatePreCancel || OrderStateTransferGoodStockWaitStart
	OrderState_OrderStateTransferGoodStockWaitStart OrderState = 110 // -> OrderStateInService
	OrderState_OrderStateInService                  OrderState = 120 // -> OrderStatePreCancel || OrderStateTransferGoodStockInService
	OrderState_OrderStateTransferGoodStockInService OrderState = 130 // -> OrderStatePreExpired
	// Timeout of order
	...
	OrderState_OrderStateRestoreCanceledStock  OrderState = 180 // -> OrderStateCancelAchievement
	OrderState_OrderStateCancelAchievement     OrderState = 190 // -> OrderStateReturnCanceledBalance
	OrderState_OrderStateReturnCanceledBalance OrderState = 200 // -> OrderStateCanceled
	// End state
	OrderState_OrderStateCanceled OrderState = 210
	OrderState_OrderStateExpired  OrderState = 220
)
...
var (
	OrderState_name = map[int32]string{
		...
		90:  "OrderStateAchievementBookKept",
		100: "OrderStatePaid",
		110: "OrderStateTransferGoodStockWaitStart",
		120: "OrderStateInService",
		130: "OrderStateTransferGoodStockInService",
		...
		190: "OrderStateCancelAchievement",
		200: "OrderStateReturnCanceledBalance",
		210: "OrderStateCanceled",
		220: "OrderStateExpired",
	}
	OrderState_value = map[string]int32{
		...
		"OrderStateAchievementBookKept":        90,
		"OrderStatePaid":                       100,
		"OrderStateTransferGoodStockWaitStart": 110,
		"OrderStateInService":                  120,
		"OrderStateTransferGoodStockInService": 130,
		...
		"OrderStateCancelAchievement":          190,
		"OrderStateReturnCanceledBalance":      200,
		"OrderStateCanceled":                   210,
		"OrderStateExpired":                    220,
	}
)
...
var file_npool_basetypes_order_v1_enums_proto_rawDesc = []byte{
	...
	0x70, 0x10, 0x1e, 0x2a, 0xee, 0x05, 0x0a, 0x0a, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x53, 0x74, 0x61,
	...
	,
	...
	0x10, 0xc8, 0x01, 0x12, 0x17, 0x0a, 0x12, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x53, 0x74, 0x61, 0x74,
	0x65, 0x43, 0x61, 0x6e, 0x63, 0x65, 0x6c, 0x65, 0x64, 0x10, 0xd2, 0x01, 0x12, 0x16, 0x0a, 0x11,
	0x4f, 0x72, 0x64, 0x65, 0x72, 0x53, 0x74, 0x61, 0x74, 0x65, 0x45, 0x78, 0x70, 0x69, 0x72, 0x65,
	0x64, 0x10, 0xdc, 0x01, 0x2a, 0xa2, 0x01, 0x0a, 0x0c, 0x50, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74,
