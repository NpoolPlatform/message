...
const (
	...
	OrderState_OrderStateGoodStockTransferredCheck    OrderState = 100 // -> OrderStateAchievementBookKept (bookkeep purchase achievement)
	OrderState_OrderStateAchievementBookKept          OrderState = 110 // -> OrderStateAchievementBookKeptCheck
	OrderState_OrderStateAchievementBookKeptCheck     OrderState = 120 // -> OrderStatePaid
	// Paid
	OrderState_OrderStatePaid      OrderState = 130
	OrderState_OrderStateInService OrderState = 140
	// Timeout of order
	OrderState_OrderStatePaymentTimeout OrderState = 150 // -> OrderStatePreCancel
	// End or order
	OrderState_OrderStatePreCancel       OrderState = 160 // -> OrderStatePreCancelCheck
	OrderState_OrderStatePreCancelCheck  OrderState = 170 // -> OrderStateRestoreCanceledStock
	OrderState_OrderStatePreExpired      OrderState = 180 // -> OrderStatePreExpired
	OrderState_OrderStatePreExpiredCheck OrderState = 190 // -> OrderStateRestoreExpiredStock
	// Calculation
	OrderState_OrderStateRestoreExpiredStock        OrderState = 200 // -> OrderStateRestoreExpiredStockCheck
	OrderState_OrderStateRestoreExpiredStockCheck   OrderState = 210 // -> OrderStateExpired
	OrderState_OrderStateRestoreCanceledStock       OrderState = 220 // -> OrderStateRestoreCanceledStockCheck
	OrderState_OrderStateRestoreCanceledStockCheck  OrderState = 230 // -> OrderStateReturnCanceledBalance
	OrderState_OrderStateReturnCanceledBalance      OrderState = 240 // -> OrderStateReturnCanceledBalanceCheck
	OrderState_OrderStateReturnCanceledBalanceCheck OrderState = 250 // -> OrderStateCanceled
	// End state
...
var (
	OrderState_name = map[int32]string{
		...
		110: "OrderStateAchievementBookKept",
		120: "OrderStateAchievementBookKeptCheck",
		130: "OrderStatePaid",
		140: "OrderStateInService",
		150: "OrderStatePaymentTimeout",
		160: "OrderStatePreCancel",
		170: "OrderStatePreCancelCheck",
		180: "OrderStatePreExpired",
		190: "OrderStatePreExpiredCheck",
		200: "OrderStateRestoreExpiredStock",
		210: "OrderStateRestoreExpiredStockCheck",
		220: "OrderStateRestoreCanceledStock",
		230: "OrderStateRestoreCanceledStockCheck",
		240: "OrderStateReturnCanceledBalance",
		250: "OrderStateReturnCanceledBalanceCheck",
	...
	OrderState_value = map[string]int32{
		...
		"OrderStateAchievementBookKept":          110,
		"OrderStateAchievementBookKeptCheck":     120,
		"OrderStatePaid":                         130,
		"OrderStateInService":                    140,
		"OrderStatePaymentTimeout":               150,
		"OrderStatePreCancel":                    160,
		"OrderStatePreCancelCheck":               170,
		"OrderStatePreExpired":                   180,
		"OrderStatePreExpiredCheck":              190,
		"OrderStateRestoreExpiredStock":          200,
		"OrderStateRestoreExpiredStockCheck":     210,
		"OrderStateRestoreCanceledStock":         220,
		"OrderStateRestoreCanceledStockCheck":    230,
		"OrderStateReturnCanceledBalance":        240,
		"OrderStateReturnCanceledBalanceCheck":   250,
...
var file_npool_basetypes_order_v1_enums_proto_rawDesc = []byte{
	...
	0x70, 0x10, 0x1e, 0x2a, 0xc3, 0x07, 0x0a, 0x0a, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x53, 0x74, 0x61,
	...
	,
	...
	0x43, 0x68, 0x65, 0x63, 0x6b, 0x10, 0xfa, 0x01, 0x12, 0x17, 0x0a, 0x12, 0x4f, 0x72, 0x64, 0x65,
	0x72, 0x53, 0x74, 0x61, 0x74, 0x65, 0x43, 0x61, 0x6e, 0x63, 0x65, 0x6c, 0x65, 0x64, 0x10, 0x84,
	0x02, 0x12, 0x16, 0x0a, 0x11, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x53, 0x74, 0x61, 0x74, 0x65, 0x45,
	0x78, 0x70, 0x69, 0x72, 0x65, 0x64, 0x10, 0x8e, 0x02, 0x2a, 0xa2, 0x01, 0x0a, 0x0c, 0x50, 0x61,
