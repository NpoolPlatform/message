...
const (
	...
	OrderState_OrderStateUpdateWaitPaymentChilds    OrderState = 90 // -> OrderStatePaid
	// Paid
	...
	OrderState_OrderStateUpdatePaidChilds           OrderState = 120 // -> OrderStateInService
	OrderState_OrderStateInService                  OrderState = 130 // -> OrderStatePreCancel || OrderStateTransferGoodStockInService
	OrderState_OrderStateTransferGoodStockInService OrderState = 140 // -> OrderStateUpdateInServiceChilds
	OrderState_OrderStateUpdateInServiceChilds      OrderState = 150 // -> OrderStatePreExpired
	// Timeout of order
	OrderState_OrderStatePaymentTimeout OrderState = 160 // -> OrderStatePreCancel
	// End or order
	OrderState_OrderStatePreCancel  OrderState = 170 // -> OrderStateRestoreCanceledStock
	OrderState_OrderStatePreExpired OrderState = 180 // -> OrderStateRestoreExpiredStock
	// Calculation
	OrderState_OrderStateRestoreExpiredStock   OrderState = 190 // -> OrderStateExpired
	OrderState_OrderStateRestoreCanceledStock  OrderState = 200 // -> OrderStateCancelAchievement
	OrderState_OrderStateCancelAchievement     OrderState = 210 // -> OrderStateReturnCanceledBalance
...
var (
	OrderState_name = map[int32]string{
		...
		90:  "OrderStateUpdateWaitPaymentChilds",
		100: "OrderStatePaid",
		110: "OrderStateTransferGoodStockWaitStart",
		120: "OrderStateUpdatePaidChilds",
		130: "OrderStateInService",
		140: "OrderStateTransferGoodStockInService",
		150: "OrderStateUpdateInServiceChilds",
		160: "OrderStatePaymentTimeout",
		170: "OrderStatePreCancel",
		180: "OrderStatePreExpired",
		190: "OrderStateRestoreExpiredStock",
		200: "OrderStateRestoreCanceledStock",
		210: "OrderStateCancelAchievement",
		220: "OrderStateReturnCanceledBalance",
	...
	OrderState_value = map[string]int32{
		...
		"OrderStateUpdateWaitPaymentChilds":    90,
		"OrderStatePaid":                       100,
		"OrderStateTransferGoodStockWaitStart": 110,
		"OrderStateUpdatePaidChilds":           120,
		"OrderStateInService":                  130,
		"OrderStateTransferGoodStockInService": 140,
		"OrderStateUpdateInServiceChilds":      150,
		"OrderStatePaymentTimeout":             160,
		"OrderStatePreCancel":                  170,
		"OrderStatePreExpired":                 180,
		"OrderStateRestoreExpiredStock":        190,
		"OrderStateRestoreCanceledStock":       200,
		"OrderStateCancelAchievement":          210,
		"OrderStateReturnCanceledBalance":      220,
...
var file_npool_basetypes_order_v1_enums_proto_rawDesc = []byte{
	...
	0x70, 0x10, 0x1e, 0x2a, 0xb9, 0x06, 0x0a, 0x0a, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x53, 0x74, 0x61,
	...
	,
	...
	0x74, 0x10, 0xe8, 0x07, 0x2a, 0x4d, 0x0a, 0x0e, 0x49, 0x6e, 0x76, 0x65, 0x73, 0x74, 0x6d, 0x65,
	...
	0x74, 0x10, 0x14, 0x2a, 0xb9, 0x01, 0x0a, 0x0b, 0x50, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x54,
	...
	,
	...
	0x6e, 0x66, 0x69, 0x72, 0x6d, 0x65, 0x64, 0x10, 0x14, 0x2a, 0x5d, 0x0a, 0x0d, 0x4f, 0x72, 0x64,
	...
	0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x10, 0x1e, 0x42, 0x3b, 0x5a, 0x39, 0x67, 0x69, 0x74, 0x68,
