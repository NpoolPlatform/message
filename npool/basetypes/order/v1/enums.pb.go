...
const (
	...
	OrderState_OrderStatePaymentBalanceSpentCheck     OrderState = 80 // -> OrderStatePaid (achievement and stock (dtm))
	// Paid
	OrderState_OrderStatePaid      OrderState = 90
	OrderState_OrderStateInService OrderState = 100
	// Timeout of order
	OrderState_OrderStatePaymentTimeout OrderState = 110 // -> OrderStatePreCancel
	// End or order
	OrderState_OrderStatePreCancel       OrderState = 120 // -> OrderStatePreCancelCheck
	OrderState_OrderStatePreCancelCheck  OrderState = 130 // -> OrderStateRestoreCanceledStock
	OrderState_OrderStatePreExpired      OrderState = 140 // -> OrderStatePreExpired
	OrderState_OrderStatePreExpiredCheck OrderState = 150 // -> OrderStateRestoreExpiredStock
	// Calculation
	OrderState_OrderStateRestoreExpiredStock        OrderState = 160 // -> OrderStateRestoreExpiredStockCheck
	OrderState_OrderStateRestoreExpiredStockCheck   OrderState = 170 // -> OrderStateExpired
	OrderState_OrderStateRestoreCanceledStock       OrderState = 180 // -> OrderStateRestoreCanceledStockCheck
	OrderState_OrderStateRestoreCanceledStockCheck  OrderState = 190 // -> OrderStateReturnCanceledBalance
	OrderState_OrderStateReturnCanceledBalance      OrderState = 200 // -> OrderStateReturnCanceledBalanceCheck
	OrderState_OrderStateReturnCanceledBalanceCheck OrderState = 210 // -> OrderStateCanceled
	// End state
	OrderState_OrderStateCanceled OrderState = 220
	OrderState_OrderStateExpired  OrderState = 230
)
...
var (
	OrderState_name = map[int32]string{
		...
		130: "OrderStatePreCancelCheck",
		140: "OrderStatePreExpired",
		150: "OrderStatePreExpiredCheck",
		160: "OrderStateRestoreExpiredStock",
		170: "OrderStateRestoreExpiredStockCheck",
		180: "OrderStateRestoreCanceledStock",
		190: "OrderStateRestoreCanceledStockCheck",
		200: "OrderStateReturnCanceledBalance",
		210: "OrderStateReturnCanceledBalanceCheck",
		220: "OrderStateCanceled",
		230: "OrderStateExpired",
	}
	OrderState_value = map[string]int32{
		...
		"OrderStatePreCancelCheck":               130,
		"OrderStatePreExpired":                   140,
		"OrderStatePreExpiredCheck":              150,
		"OrderStateRestoreExpiredStock":          160,
		"OrderStateRestoreExpiredStockCheck":     170,
		"OrderStateRestoreCanceledStock":         180,
		"OrderStateRestoreCanceledStockCheck":    190,
		"OrderStateReturnCanceledBalance":        200,
		"OrderStateReturnCanceledBalanceCheck":   210,
...
var file_npool_basetypes_order_v1_enums_proto_rawDesc = []byte{
	...
	0x70, 0x10, 0x1e, 0x2a, 0xa7, 0x06, 0x0a, 0x0a, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x53, 0x74, 0x61,
	...
	,
	...
	,
	...
	0x10, 0x0a, 0x12, 0x15, 0x0a, 0x11, 0x42, 0x65, 0x6e, 0x65, 0x66, 0x69, 0x74, 0x43, 0x61, 0x6c,
	0x63, 0x75, 0x6c, 0x61, 0x74, 0x65, 0x64, 0x10, 0x14, 0x12, 0x0f, 0x0a, 0x0b, 0x42, 0x65, 0x6e,
	0x65, 0x66, 0x69, 0x74, 0x44, 0x6f, 0x6e, 0x65, 0x10, 0x1e, 0x2a, 0x57, 0x0a, 0x0e, 0x4f, 0x72,
	...
	0x64, 0x10, 0x14, 0x42, 0x3b, 0x5a, 0x39, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
