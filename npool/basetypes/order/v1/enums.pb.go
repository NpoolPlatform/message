...
const (
	...
	OrderState_OrderStateTransferGoodStockWaitStart OrderState = 110 // -> OrderStateUpdatePaidChilds
	OrderState_OrderStateUpdateInServiceChilds      OrderState = 120 // -> OrderStateInService
	OrderState_OrderStateInService                  OrderState = 130 // -> OrderStatePreCancel || OrderStatePreExpired
	// Timeout of order
	OrderState_OrderStatePaymentTimeout OrderState = 140 // -> OrderStatePreCancel
	// End or order
	...
	OrderState_OrderStateRestoreCanceldStock   OrderState = 190 // -> OrderStateCancelAchievement
	OrderState_OrderStateCancelAchievement     OrderState = 200 // -> OrderStateReturnCanceledBalance
	OrderState_OrderStateReturnCanceledBalance OrderState = 210 // -> OrderStateCanceled
	OrderState_OrderStateUpdateCanceledChilds  OrderState = 220 // -> OrderStatePreExpired
	// End state
	OrderState_OrderStateCanceled OrderState = 230
	OrderState_OrderStateExpired  OrderState = 240
)
...
var (
	OrderState_name = map[int32]string{
		...
		90:  "OrderStateUpdatePaidChilds",
		100: "OrderStatePaid",
		110: "OrderStateTransferGoodStockWaitStart",
		120: "OrderStateUpdateInServiceChilds",
		130: "OrderStateInService",
		140: "OrderStatePaymentTimeout",
		150: "OrderStatePreCancel",
		160: "OrderStatePreExpired",
		170: "OrderStateRestoreExpiredStock",
		180: "OrderStateUpdateExpiredChilds",
		190: "OrderStateRestoreCanceldStock",
		200: "OrderStateCancelAchievement",
		210: "OrderStateReturnCanceledBalance",
		220: "OrderStateUpdateCanceledChilds",
		230: "OrderStateCanceled",
		240: "OrderStateExpired",
	}
	OrderState_value = map[string]int32{
		...
		"OrderStateUpdatePaidChilds":           90,
		"OrderStatePaid":                       100,
		"OrderStateTransferGoodStockWaitStart": 110,
		"OrderStateUpdateInServiceChilds":      120,
		"OrderStateInService":                  130,
		"OrderStatePaymentTimeout":             140,
		"OrderStatePreCancel":                  150,
		"OrderStatePreExpired":                 160,
		"OrderStateRestoreExpiredStock":        170,
		"OrderStateUpdateExpiredChilds":        180,
		"OrderStateRestoreCanceldStock":        190,
		"OrderStateCancelAchievement":          200,
		"OrderStateReturnCanceledBalance":      210,
		"OrderStateUpdateCanceledChilds":       220,
		"OrderStateCanceled":                   230,
		"OrderStateExpired":                    240,
	}
)
...
var file_npool_basetypes_order_v1_enums_proto_rawDesc = []byte{
	...
	0x70, 0x10, 0x1e, 0x2a, 0xae, 0x06, 0x0a, 0x0a, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x53, 0x74, 0x61,
	...
	,
