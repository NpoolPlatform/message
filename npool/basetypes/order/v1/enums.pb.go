...
const (
	...
	// Paid
	OrderState_OrderStatePaid                       OrderState = 90  // -> OrderStatePreCancel || OrderStateTransferGoodStockWaitStart
	OrderState_OrderStateTransferGoodStockWaitStart OrderState = 100 // -> OrderStateInService
	OrderState_OrderStateInService                  OrderState = 110 // -> OrderStatePreCancel || OrderStateTransferGoodStockInService
	OrderState_OrderStateTransferGoodStockInService OrderState = 120 // -> OrderStatePreExpired
	// Timeout of order
	OrderState_OrderStatePaymentTimeout OrderState = 130 // -> OrderStatePreCancel
	// End or order
	OrderState_OrderStatePreCancel  OrderState = 140 // -> OrderStateRestoreCanceledStock
	OrderState_OrderStatePreExpired OrderState = 150 // -> OrderStateRestoreExpiredStock
	// Calculation
	OrderState_OrderStateRestoreExpiredStock   OrderState = 160 // -> OrderStateExpired
	OrderState_OrderStateRestoreCanceledStock  OrderState = 170 // -> OrderStateCancelAchievement
	OrderState_OrderStateCancelAchievement     OrderState = 180 // -> OrderStateReturnCanceledBalance
	OrderState_OrderStateReturnCanceledBalance OrderState = 190 // -> OrderStateCanceled
	// End state
	OrderState_OrderStateCanceled OrderState = 200
	OrderState_OrderStateExpired  OrderState = 210
)
...
var (
	OrderState_name = map[int32]string{
		...
		90:  "OrderStatePaid",
		100: "OrderStateTransferGoodStockWaitStart",
		110: "OrderStateInService",
		120: "OrderStateTransferGoodStockInService",
		130: "OrderStatePaymentTimeout",
		140: "OrderStatePreCancel",
		150: "OrderStatePreExpired",
		160: "OrderStateRestoreExpiredStock",
		170: "OrderStateRestoreCanceledStock",
		180: "OrderStateCancelAchievement",
		190: "OrderStateReturnCanceledBalance",
		200: "OrderStateCanceled",
		210: "OrderStateExpired",
	}
	OrderState_value = map[string]int32{
		...
		"OrderStatePaid":                       90,
		"OrderStateTransferGoodStockWaitStart": 100,
		"OrderStateInService":                  110,
		"OrderStateTransferGoodStockInService": 120,
		"OrderStatePaymentTimeout":             130,
		"OrderStatePreCancel":                  140,
		"OrderStatePreExpired":                 150,
		"OrderStateRestoreExpiredStock":        160,
		"OrderStateRestoreCanceledStock":       170,
		"OrderStateCancelAchievement":          180,
		"OrderStateReturnCanceledBalance":      190,
		"OrderStateCanceled":                   200,
		"OrderStateExpired":                    210,
	}
)
...
var file_npool_basetypes_order_v1_enums_proto_rawDesc = []byte{
	...
	0x70, 0x10, 0x1e, 0x2a, 0xca, 0x05, 0x0a, 0x0a, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x53, 0x74, 0x61,
	...
	0x4b, 0x65, 0x65, 0x70, 0x69, 0x6e, 0x67, 0x10, 0x50, 0x12, 0x12, 0x0a, 0x0e, 0x4f, 0x72, 0x64,
	0x65, 0x72, 0x53, 0x74, 0x61, 0x74, 0x65, 0x50, 0x61, 0x69, 0x64, 0x10, 0x5a, 0x12, 0x28, 0x0a,
	...
	,
	...
	,
	...
	,
