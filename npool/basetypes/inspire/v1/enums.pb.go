...
type CashControlType int32

const (
	CashControlType_DefaultCashControlType CashControlType = 0
	CashControlType_KycApproved            CashControlType = 10
	CashControlType_CreditsThreshold       CashControlType = 20 // 积分达到一定数量
	CashControlType_OrderThreshold         CashControlType = 30 // 成单数达到一定数量
	CashControlType_PaymentAmountThreshold CashControlType = 40 // 已花费的美金达到一定数量
)

// Enum value maps for CashControlType.
var (
	CashControlType_name = map[int32]string{
		0:  "DefaultCashControlType",
		10: "KycApproved",
		20: "CreditsThreshold",
		30: "OrderThreshold",
		40: "PaymentAmountThreshold",
	}
	CashControlType_value = map[string]int32{
		"DefaultCashControlType": 0,
		"KycApproved":            10,
		"CreditsThreshold":       20,
		"OrderThreshold":         30,
...
func (x CashControlType) Enum() *CashControlType {
	p := new(CashControlType)
	*p = x
	return p
}

func (x CashControlType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (CashControlType) Descriptor() protoreflect.EnumDescriptor {
	return file_npool_basetypes_inspire_v1_enums_proto_enumTypes[7].Descriptor()
}

func (CashControlType) Type() protoreflect.EnumType {
	return &file_npool_basetypes_inspire_v1_enums_proto_enumTypes[7]
}

func (x CashControlType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use CashControlType.Descriptor instead.
func (CashControlType) EnumDescriptor() ([]byte, []int) {
...
var file_npool_basetypes_inspire_v1_enums_proto_rawDesc = []byte{
	...
	,
...
var file_npool_basetypes_inspire_v1_enums_proto_enumTypes = make([]protoimpl.EnumInfo, 8)
var file_npool_basetypes_inspire_v1_enums_proto_goTypes = []interface{}{
	...
	(CashControlType)(0),  // 7: basetypes.inspire.v1.CashControlType
}
