...
type GoodUnitDurationType int32

const (
	GoodUnitDurationType_DefaultGoodUnitDurationType GoodUnitDurationType = 0
	GoodUnitDurationType_GoodUnitDurationByHour      GoodUnitDurationType = 10
	GoodUnitDurationType_GoodUnitDurationByDay       GoodUnitDurationType = 20
	GoodUnitDurationType_GoodUnitDurationByMonth     GoodUnitDurationType = 30
	GoodUnitDurationType_GoodUnitDurationByYear      GoodUnitDurationType = 40
)

// Enum value maps for GoodUnitDurationType.
var (
	GoodUnitDurationType_name = map[int32]string{
		0:  "DefaultGoodUnitDurationType",
		10: "GoodUnitDurationByHour",
		20: "GoodUnitDurationByDay",
		30: "GoodUnitDurationByMonth",
		40: "GoodUnitDurationByYear",
	}
	GoodUnitDurationType_value = map[string]int32{
		"DefaultGoodUnitDurationType": 0,
		"GoodUnitDurationByHour":      10,
		"GoodUnitDurationByDay":       20,
		"GoodUnitDurationByMonth":     30,
		"GoodUnitDurationByYear":      40,
	}
)

func (x GoodUnitDurationType) Enum() *GoodUnitDurationType {
	p := new(GoodUnitDurationType)
	*p = x
	return p
}

func (x GoodUnitDurationType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (GoodUnitDurationType) Descriptor() protoreflect.EnumDescriptor {
	return file_npool_basetypes_good_v1_enums_proto_enumTypes[10].Descriptor()
}

func (GoodUnitDurationType) Type() protoreflect.EnumType {
	return &file_npool_basetypes_good_v1_enums_proto_enumTypes[10]
}

func (x GoodUnitDurationType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use GoodUnitDurationType.Descriptor instead.
func (GoodUnitDurationType) EnumDescriptor() ([]byte, []int) {
...
var file_npool_basetypes_good_v1_enums_proto_rawDesc = []byte{
	...
	,
...
var file_npool_basetypes_good_v1_enums_proto_goTypes = []interface{}{
	...
	(GoodUnitDurationType)(0),  // 10: basetypes.good.v1.GoodUnitDurationType
}
