...
const (
	Middleware_CreateAccount_FullMethodName     = "/account.middleware.platform.v1.Middleware/CreateAccount"
	Middleware_UpdateAccount_FullMethodName     = "/account.middleware.platform.v1.Middleware/UpdateAccount"
	Middleware_GetAccount_FullMethodName        = "/account.middleware.platform.v1.Middleware/GetAccount"
	Middleware_GetAccounts_FullMethodName       = "/account.middleware.platform.v1.Middleware/GetAccounts"
	Middleware_ExistAccount_FullMethodName      = "/account.middleware.platform.v1.Middleware/ExistAccount"
	Middleware_ExistAccountConds_FullMethodName = "/account.middleware.platform.v1.Middleware/ExistAccountConds"
	Middleware_DeleteAccount_FullMethodName     = "/account.middleware.platform.v1.Middleware/DeleteAccount"
)
