...
func RegisterMiddlewareHandlerServer(ctx context.Context, mux *runtime.ServeMux, server MiddlewareServer) error {
	...
	mux.Handle("POST", pattern_Middleware_DeleteAccount_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/account.middleware.platform.v1.Middleware/DeleteAccount", runtime.WithHTTPPathPattern("/v1/platform_DeleteAccount"))
		if err != nil {
...
func RegisterMiddlewareHandlerClient(ctx context.Context, mux *runtime.ServeMux, client MiddlewareClient) error {
	...
	mux.Handle("POST", pattern_Middleware_DeleteAccount_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/account.middleware.platform.v1.Middleware/DeleteAccount", runtime.WithHTTPPathPattern("/v1/platform_DeleteAccount"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
