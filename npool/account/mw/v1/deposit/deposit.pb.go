...
var file_npool_account_mw_v1_deposit_deposit_proto_rawDesc = []byte{
	...
	0x52, 0x05, 0x54, 0x6f, 0x74, 0x61, 0x6c, 0x32, 0xf5, 0x03, 0x0a, 0x0a, 0x4d, 0x69, 0x64, 0x64,
	...
	0x65, 0x2e, 0x64, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x2e, 0x76, 0x31, 0x2e, 0x43, 0x72, 0x65,
	0x61, 0x74, 0x65, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x22, 0x00, 0x12, 0x7c, 0x0a, 0x0d, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x41, 0x63,
	...
	0x22, 0x00, 0x12, 0x73, 0x0a, 0x0a, 0x47, 0x65, 0x74, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x76, 0x0a, 0x0b, 0x47, 0x65, 0x74, 0x41, 0x63,
	...
	0x74, 0x2f, 0x6d, 0x77, 0x2f, 0x76, 0x31, 0x2f, 0x64, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x62,
...
var file_npool_account_mw_v1_deposit_deposit_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_npool_account_mw_v1_deposit_deposit_proto_goTypes = []interface{}{
	...
	(v1.AccountLockedBy)(0),       // 11: basetypes.v1.AccountLockedBy
...
var file_npool_account_mw_v1_deposit_deposit_proto_depIdxs = []int32{
	11, // 0: account.middleware.deposit.v1.AccountReq.LockedBy:type_name -> basetypes.v1.AccountLockedBy
	11, // 1: account.middleware.deposit.v1.Account.LockedBy:type_name -> basetypes.v1.AccountLockedBy
	12, // 2: account.middleware.deposit.v1.Conds.ID:type_name -> basetypes.v1.StringVal
	12, // 3: account.middleware.deposit.v1.Conds.AppID:type_name -> basetypes.v1.StringVal
	12, // 4: account.middleware.deposit.v1.Conds.UserID:type_name -> basetypes.v1.StringVal
	12, // 5: account.middleware.deposit.v1.Conds.CoinTypeID:type_name -> basetypes.v1.StringVal
	12, // 6: account.middleware.deposit.v1.Conds.AccountID:type_name -> basetypes.v1.StringVal
	12, // 7: account.middleware.deposit.v1.Conds.Address:type_name -> basetypes.v1.StringVal
	13, // 8: account.middleware.deposit.v1.Conds.Active:type_name -> basetypes.v1.BoolVal
	13, // 9: account.middleware.deposit.v1.Conds.Locked:type_name -> basetypes.v1.BoolVal
	14, // 10: account.middleware.deposit.v1.Conds.LockedBy:type_name -> basetypes.v1.Uint32Val
	13, // 11: account.middleware.deposit.v1.Conds.Blocked:type_name -> basetypes.v1.BoolVal
	14, // 12: account.middleware.deposit.v1.Conds.ScannableAt:type_name -> basetypes.v1.Uint32Val
	...
	3,  // 20: account.middleware.deposit.v1.Middleware.CreateAccount:input_type -> account.middleware.deposit.v1.CreateAccountRequest
	5,  // 21: account.middleware.deposit.v1.Middleware.UpdateAccount:input_type -> account.middleware.deposit.v1.UpdateAccountRequest
	7,  // 22: account.middleware.deposit.v1.Middleware.GetAccount:input_type -> account.middleware.deposit.v1.GetAccountRequest
	9,  // 23: account.middleware.deposit.v1.Middleware.GetAccounts:input_type -> account.middleware.deposit.v1.GetAccountsRequest
	4,  // 24: account.middleware.deposit.v1.Middleware.CreateAccount:output_type -> account.middleware.deposit.v1.CreateAccountResponse
	6,  // 25: account.middleware.deposit.v1.Middleware.UpdateAccount:output_type -> account.middleware.deposit.v1.UpdateAccountResponse
	8,  // 26: account.middleware.deposit.v1.Middleware.GetAccount:output_type -> account.middleware.deposit.v1.GetAccountResponse
	10, // 27: account.middleware.deposit.v1.Middleware.GetAccounts:output_type -> account.middleware.deposit.v1.GetAccountsResponse
