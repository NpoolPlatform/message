...
var file_npool_account_mw_v1_deposit_deposit_proto_rawDesc = []byte{
	...
	0x22, 0x52, 0x0a, 0x11, 0x41, 0x64, 0x64, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x52, 0x65,
	...
	0x49, 0x6e, 0x66, 0x6f, 0x22, 0x50, 0x0a, 0x12, 0x41, 0x64, 0x64, 0x41, 0x63, 0x63, 0x6f, 0x75,
	...
	0x6e, 0x66, 0x6f, 0x32, 0xeb, 0x05, 0x0a, 0x0a, 0x4d, 0x69, 0x64, 0x64, 0x6c, 0x65, 0x77, 0x61,
	...
	0x0a, 0x0a, 0x41, 0x64, 0x64, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x30, 0x2e, 0x61,
	0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x2e, 0x6d, 0x69, 0x64, 0x64, 0x6c, 0x65, 0x77, 0x61, 0x72,
	0x65, 0x2e, 0x64, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x2e, 0x76, 0x31, 0x2e, 0x41, 0x64, 0x64,
	...
	0x74, 0x12, 0x30, 0x2e, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x2e, 0x6d, 0x69, 0x64, 0x64,
	0x6c, 0x65, 0x77, 0x61, 0x72, 0x65, 0x2e, 0x64, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x2e, 0x76,
	...
	0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x4f, 0x6e, 0x6c, 0x79, 0x12, 0x34, 0x2e, 0x61, 0x63, 0x63,
	0x6f, 0x75, 0x6e, 0x74, 0x2e, 0x6d, 0x69, 0x64, 0x64, 0x6c, 0x65, 0x77, 0x61, 0x72, 0x65, 0x2e,
	...
	0x75, 0x6e, 0x74, 0x2f, 0x6d, 0x77, 0x2f, 0x76, 0x31, 0x2f, 0x64, 0x65, 0x70, 0x6f, 0x73, 0x69,
...
var file_npool_account_mw_v1_deposit_deposit_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
var file_npool_account_mw_v1_deposit_deposit_proto_goTypes = []interface{}{
	...
	(*AddAccountRequest)(nil),      // 7: account.middleware.deposit.v1.AddAccountRequest
	(*AddAccountResponse)(nil),     // 8: account.middleware.deposit.v1.AddAccountResponse
	(*GetAccountRequest)(nil),      // 9: account.middleware.deposit.v1.GetAccountRequest
	(*GetAccountResponse)(nil),     // 10: account.middleware.deposit.v1.GetAccountResponse
	(*GetAccountsRequest)(nil),     // 11: account.middleware.deposit.v1.GetAccountsRequest
	(*GetAccountsResponse)(nil),    // 12: account.middleware.deposit.v1.GetAccountsResponse
	(*GetAccountOnlyRequest)(nil),  // 13: account.middleware.deposit.v1.GetAccountOnlyRequest
	(*GetAccountOnlyResponse)(nil), // 14: account.middleware.deposit.v1.GetAccountOnlyResponse
...
var file_npool_account_mw_v1_deposit_deposit_proto_depIdxs = []int32{
	15, // 0: account.middleware.deposit.v1.AccountReq.LockedBy:type_name -> account.manager.account1.v1.LockedBy
	15, // 1: account.middleware.deposit.v1.Account.LockedBy:type_name -> account.manager.account1.v1.LockedBy
	16, // 2: account.middleware.deposit.v1.Account.UsedFor:type_name -> account.manager.account1.v1.AccountUsedFor
	17, // 3: account.middleware.deposit.v1.Conds.ID:type_name -> npool.v1.StringVal
	17, // 4: account.middleware.deposit.v1.Conds.AppID:type_name -> npool.v1.StringVal
	17, // 5: account.middleware.deposit.v1.Conds.UserID:type_name -> npool.v1.StringVal
	17, // 6: account.middleware.deposit.v1.Conds.CoinTypeID:type_name -> npool.v1.StringVal
	17, // 7: account.middleware.deposit.v1.Conds.AccountID:type_name -> npool.v1.StringVal
	17, // 8: account.middleware.deposit.v1.Conds.Address:type_name -> npool.v1.StringVal
	18, // 9: account.middleware.deposit.v1.Conds.Active:type_name -> npool.v1.BoolVal
	18, // 10: account.middleware.deposit.v1.Conds.Locked:type_name -> npool.v1.BoolVal
	19, // 11: account.middleware.deposit.v1.Conds.LockedBy:type_name -> npool.v1.Int32Val
	18, // 12: account.middleware.deposit.v1.Conds.Blocked:type_name -> npool.v1.BoolVal
	...
	0,  // 17: account.middleware.deposit.v1.AddAccountRequest.Info:type_name -> account.middleware.deposit.v1.AccountReq
	1,  // 18: account.middleware.deposit.v1.AddAccountResponse.Info:type_name -> account.middleware.deposit.v1.Account
	1,  // 19: account.middleware.deposit.v1.GetAccountResponse.Info:type_name -> account.middleware.deposit.v1.Account
	2,  // 20: account.middleware.deposit.v1.GetAccountsRequest.Conds:type_name -> account.middleware.deposit.v1.Conds
	1,  // 21: account.middleware.deposit.v1.GetAccountsResponse.Infos:type_name -> account.middleware.deposit.v1.Account
	2,  // 22: account.middleware.deposit.v1.GetAccountOnlyRequest.Conds:type_name -> account.middleware.deposit.v1.Conds
	1,  // 23: account.middleware.deposit.v1.GetAccountOnlyResponse.Info:type_name -> account.middleware.deposit.v1.Account
	3,  // 24: account.middleware.deposit.v1.Middleware.CreateAccount:input_type -> account.middleware.deposit.v1.CreateAccountRequest
	5,  // 25: account.middleware.deposit.v1.Middleware.UpdateAccount:input_type -> account.middleware.deposit.v1.UpdateAccountRequest
	7,  // 26: account.middleware.deposit.v1.Middleware.AddAccount:input_type -> account.middleware.deposit.v1.AddAccountRequest
	9,  // 27: account.middleware.deposit.v1.Middleware.GetAccount:input_type -> account.middleware.deposit.v1.GetAccountRequest
	13, // 28: account.middleware.deposit.v1.Middleware.GetAccountOnly:input_type -> account.middleware.deposit.v1.GetAccountOnlyRequest
	11, // 29: account.middleware.deposit.v1.Middleware.GetAccounts:input_type -> account.middleware.deposit.v1.GetAccountsRequest
	4,  // 30: account.middleware.deposit.v1.Middleware.CreateAccount:output_type -> account.middleware.deposit.v1.CreateAccountResponse
	6,  // 31: account.middleware.deposit.v1.Middleware.UpdateAccount:output_type -> account.middleware.deposit.v1.UpdateAccountResponse
	8,  // 32: account.middleware.deposit.v1.Middleware.AddAccount:output_type -> account.middleware.deposit.v1.AddAccountResponse
	10, // 33: account.middleware.deposit.v1.Middleware.GetAccount:output_type -> account.middleware.deposit.v1.GetAccountResponse
	14, // 34: account.middleware.deposit.v1.Middleware.GetAccountOnly:output_type -> account.middleware.deposit.v1.GetAccountOnlyResponse
	12, // 35: account.middleware.deposit.v1.Middleware.GetAccounts:output_type -> account.middleware.deposit.v1.GetAccountsResponse
