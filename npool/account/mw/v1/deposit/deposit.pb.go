...
var file_npool_account_mw_v1_deposit_deposit_proto_rawDesc = []byte{
	...
	0x65, 0x2e, 0x64, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x2e, 0x76, 0x31, 0x2e, 0x43, 0x6f, 0x6e,
	...
	0x61, 0x6c, 0x32, 0x82, 0x02, 0x0a, 0x0a, 0x4d, 0x69, 0x64, 0x64, 0x6c, 0x65, 0x77, 0x61, 0x72,
...
var file_npool_account_mw_v1_deposit_deposit_proto_depIdxs = []int32{
	...
	2,  // 15: account.middleware.deposit.v1.GetAccountsRequest.Conds:type_name -> account.middleware.deposit.v1.Conds
	1,  // 16: account.middleware.deposit.v1.GetAccountsResponse.Infos:type_name -> account.middleware.deposit.v1.Account
	3,  // 17: account.middleware.deposit.v1.Middleware.CreateAccount:input_type -> account.middleware.deposit.v1.CreateAccountRequest
	5,  // 18: account.middleware.deposit.v1.Middleware.GetAccounts:input_type -> account.middleware.deposit.v1.GetAccountsRequest
	4,  // 19: account.middleware.deposit.v1.Middleware.CreateAccount:output_type -> account.middleware.deposit.v1.CreateAccountResponse
	6,  // 20: account.middleware.deposit.v1.Middleware.GetAccounts:output_type -> account.middleware.deposit.v1.GetAccountsResponse
