...
func (c *middlewareClient) AddBalance(ctx context.Context, in *AddBalanceRequest, opts ...grpc.CallOption) (*AddBalanceResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/account.middleware.deposit.v1.Middleware/AddBalance", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *middlewareClient) SubBalance(ctx context.Context, in *SubBalanceRequest, opts ...grpc.CallOption) (*SubBalanceResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/account.middleware.deposit.v1.Middleware/SubBalance", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *middlewareClient) DeleteAccount(ctx context.Context, in *DeleteAccountRequest, opts ...grpc.CallOption) (*DeleteAccountResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/account.middleware.deposit.v1.Middleware/DeleteAccount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Middleware_AddBalance_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/account.middleware.deposit.v1.Middleware/AddBalance",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Middleware_SubBalance_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/account.middleware.deposit.v1.Middleware/SubBalance",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Middleware_DeleteAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/account.middleware.deposit.v1.Middleware/DeleteAccount",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
