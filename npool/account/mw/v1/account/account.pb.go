...
var file_npool_account_mw_v1_account_account_proto_rawDesc = []byte{
	...
	0x5f, 0x45, 0x6e, 0x74, 0x49, 0x44, 0x73, 0x22, 0x29, 0x0a, 0x11, 0x47, 0x65, 0x74, 0x41, 0x63,
	...
	0x65, 0x2e, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x31, 0x2e, 0x76, 0x31, 0x2e, 0x41, 0x63,
	...
	0x61, 0x6c, 0x32, 0xfd, 0x01, 0x0a, 0x0a, 0x4d, 0x69, 0x64, 0x64, 0x6c, 0x65, 0x77, 0x61, 0x72,
	0x65, 0x12, 0x75, 0x0a, 0x0a, 0x47, 0x65, 0x74, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x12,
	...
	0x6f, 0x75, 0x6e, 0x74, 0x2f, 0x6d, 0x77, 0x2f, 0x76, 0x31, 0x2f, 0x61, 0x63, 0x63, 0x6f, 0x75,
...
var file_npool_account_mw_v1_account_account_proto_depIdxs = []int32{
	...
	8,  // 2: account.middleware.account1.v1.Conds.ID:type_name -> basetypes.v1.Uint32Val
	9,  // 3: account.middleware.account1.v1.Conds.EntID:type_name -> basetypes.v1.StringVal
	9,  // 4: account.middleware.account1.v1.Conds.CoinTypeID:type_name -> basetypes.v1.StringVal
	9,  // 5: account.middleware.account1.v1.Conds.Address:type_name -> basetypes.v1.StringVal
	8,  // 6: account.middleware.account1.v1.Conds.UsedFor:type_name -> basetypes.v1.Uint32Val
	10, // 7: account.middleware.account1.v1.Conds.PlatformHoldPrivateKey:type_name -> basetypes.v1.BoolVal
	10, // 8: account.middleware.account1.v1.Conds.Active:type_name -> basetypes.v1.BoolVal
	10, // 9: account.middleware.account1.v1.Conds.Locked:type_name -> basetypes.v1.BoolVal
	8,  // 10: account.middleware.account1.v1.Conds.LockedBy:type_name -> basetypes.v1.Uint32Val
	10, // 11: account.middleware.account1.v1.Conds.Blocked:type_name -> basetypes.v1.BoolVal
	8,  // 12: account.middleware.account1.v1.Conds.CreatedAt:type_name -> basetypes.v1.Uint32Val
	11, // 13: account.middleware.account1.v1.Conds.EntIDs:type_name -> basetypes.v1.StringSliceVal
	0,  // 14: account.middleware.account1.v1.GetAccountResponse.Info:type_name -> account.middleware.account1.v1.Account
	1,  // 15: account.middleware.account1.v1.GetAccountsRequest.Conds:type_name -> account.middleware.account1.v1.Conds
	0,  // 16: account.middleware.account1.v1.GetAccountsResponse.Infos:type_name -> account.middleware.account1.v1.Account
	2,  // 17: account.middleware.account1.v1.Middleware.GetAccount:input_type -> account.middleware.account1.v1.GetAccountRequest
	4,  // 18: account.middleware.account1.v1.Middleware.GetAccounts:input_type -> account.middleware.account1.v1.GetAccountsRequest
	3,  // 19: account.middleware.account1.v1.Middleware.GetAccount:output_type -> account.middleware.account1.v1.GetAccountResponse
	5,  // 20: account.middleware.account1.v1.Middleware.GetAccounts:output_type -> account.middleware.account1.v1.GetAccountsResponse
