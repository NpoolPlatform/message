...
var file_npool_account_mw_v1_account_account_proto_rawDesc = []byte{
	...
	0x6c, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x7c, 0x0a, 0x12, 0x47, 0x65, 0x74, 0x41, 0x63,
	...
	0x01, 0x0a, 0x0a, 0x4d, 0x69, 0x64, 0x64, 0x6c, 0x65, 0x77, 0x61, 0x72, 0x65, 0x12, 0x78, 0x0a,
...
var file_npool_account_mw_v1_account_account_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_npool_account_mw_v1_account_account_proto_goTypes = []interface{}{
	(*GetAccountsRequest)(nil),  // 0: account.middleware.account1.v1.GetAccountsRequest
	(*GetAccountsResponse)(nil), // 1: account.middleware.account1.v1.GetAccountsResponse
	(*account.Conds)(nil),       // 2: account.manager.account1.v1.Conds
	(*account.Account)(nil),     // 3: account.manager.account1.v1.Account
}
var file_npool_account_mw_v1_account_account_proto_depIdxs = []int32{
	2, // 0: account.middleware.account1.v1.GetAccountsRequest.Conds:type_name -> account.manager.account1.v1.Conds
	3, // 1: account.middleware.account1.v1.GetAccountsResponse.Infos:type_name -> account.manager.account1.v1.Account
	0, // 2: account.middleware.account1.v1.Middleware.GetAccounts:input_type -> account.middleware.account1.v1.GetAccountsRequest
	1, // 3: account.middleware.account1.v1.Middleware.GetAccounts:output_type -> account.middleware.account1.v1.GetAccountsResponse
