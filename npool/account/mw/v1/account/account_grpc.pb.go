...
const (
	Middleware_GetAccount_FullMethodName  = "/account.middleware.account1.v1.Middleware/GetAccount"
	Middleware_GetAccounts_FullMethodName = "/account.middleware.account1.v1.Middleware/GetAccounts"
)
