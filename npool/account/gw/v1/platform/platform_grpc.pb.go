...
const (
	Gateway_CreateAccount_FullMethodName = "/account.gateway.platform.v1.Gateway/CreateAccount"
	Gateway_UpdateAccount_FullMethodName = "/account.gateway.platform.v1.Gateway/UpdateAccount"
	Gateway_GetAccounts_FullMethodName   = "/account.gateway.platform.v1.Gateway/GetAccounts"
)
