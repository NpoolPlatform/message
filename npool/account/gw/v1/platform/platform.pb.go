...
var file_npool_account_gw_v1_platform_platform_proto_rawDesc = []byte{
	...
	0x6c, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xdc, 0x02, 0x0a, 0x07, 0x41, 0x63, 0x63, 0x6f,
	...
	0x52, 0x06, 0x42, 0x61, 0x63, 0x6b, 0x75, 0x70, 0x12, 0x1c, 0x0a, 0x09, 0x43, 0x72, 0x65, 0x61,
	0x74, 0x65, 0x64, 0x41, 0x74, 0x18, 0x6e, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x09, 0x43, 0x72, 0x65,
	0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x22, 0x97, 0x01, 0x0a, 0x14, 0x43, 0x72, 0x65, 0x61, 0x74,
	...
	0x18, 0x0a, 0x07, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x14, 0x20, 0x01, 0x28, 0x09,
	...
	0x05, 0x54, 0x6f, 0x74, 0x61, 0x6c, 0x32, 0xcd, 0x02, 0x0a, 0x07, 0x47, 0x61, 0x74, 0x65, 0x77,
	0x61, 0x79, 0x12, 0xa3, 0x01, 0x0a, 0x0d, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x41, 0x63, 0x63,
	...
	0x63, 0x6f, 0x75, 0x6e, 0x74, 0x3a, 0x01, 0x2a, 0x12, 0x9b, 0x01, 0x0a, 0x0b, 0x47, 0x65, 0x74,
	...
	0x65, 0x74, 0x2f, 0x70, 0x6c, 0x61, 0x74, 0x66, 0x6f, 0x72, 0x6d, 0x61, 0x63, 0x63, 0x6f, 0x75,
	0x6e, 0x74, 0x73, 0x3a, 0x01, 0x2a, 0x42, 0x3f, 0x5a, 0x3d, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
	...
	0x2f, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x2f, 0x67, 0x77, 0x2f, 0x76, 0x31, 0x2f, 0x70,
...
var file_npool_account_gw_v1_platform_platform_proto_depIdxs = []int32{
	...
	5, // 1: account.middleware.platform.v1.CreateAccountRequest.UsedFor:type_name -> account.manager.account1.v1.AccountUsedFor
	0, // 2: account.middleware.platform.v1.CreateAccountResponse.Info:type_name -> account.middleware.platform.v1.Account
	0, // 3: account.middleware.platform.v1.GetAccountsResponse.Infos:type_name -> account.middleware.platform.v1.Account
	1, // 4: account.middleware.platform.v1.Gateway.CreateAccount:input_type -> account.middleware.platform.v1.CreateAccountRequest
	3, // 5: account.middleware.platform.v1.Gateway.GetAccounts:input_type -> account.middleware.platform.v1.GetAccountsRequest
	2, // 6: account.middleware.platform.v1.Gateway.CreateAccount:output_type -> account.middleware.platform.v1.CreateAccountResponse
	4, // 7: account.middleware.platform.v1.Gateway.GetAccounts:output_type -> account.middleware.platform.v1.GetAccountsResponse
