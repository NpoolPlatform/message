...
var file_npool_account_gw_v1_platform_platform_proto_rawDesc = []byte{
	...
	0x54, 0x6f, 0x74, 0x61, 0x6c, 0x32, 0xc1, 0x02, 0x0a, 0x07, 0x47, 0x61, 0x74, 0x65, 0x77, 0x61,
	0x79, 0x12, 0x9d, 0x01, 0x0a, 0x0d, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x41, 0x63, 0x63, 0x6f,
	0x75, 0x6e, 0x74, 0x12, 0x31, 0x2e, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x2e, 0x67, 0x61,
	...
	0x02, 0x1f, 0x22, 0x1a, 0x2f, 0x76, 0x31, 0x2f, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x2f, 0x70,
	0x6c, 0x61, 0x74, 0x66, 0x6f, 0x72, 0x6d, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x3a, 0x01,
	0x2a, 0x12, 0x95, 0x01, 0x0a, 0x0b, 0x47, 0x65, 0x74, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74,
	...
	0x31, 0x2f, 0x67, 0x65, 0x74, 0x2f, 0x70, 0x6c, 0x61, 0x74, 0x66, 0x6f, 0x72, 0x6d, 0x61, 0x63,
	0x63, 0x6f, 0x75, 0x6e, 0x74, 0x73, 0x3a, 0x01, 0x2a, 0x42, 0x3f, 0x5a, 0x3d, 0x67, 0x69, 0x74,
...
var file_npool_account_gw_v1_platform_platform_proto_goTypes = []interface{}{
	...
	(*GetAccountsRequest)(nil),    // 3: account.gateway.platform.v1.GetAccountsRequest
	(*GetAccountsResponse)(nil),   // 4: account.gateway.platform.v1.GetAccountsResponse
...
var file_npool_account_gw_v1_platform_platform_proto_depIdxs = []int32{
	5, // 0: account.gateway.platform.v1.Account.UsedFor:type_name -> account.manager.account1.v1.AccountUsedFor
	6, // 1: account.gateway.platform.v1.Account.LockedBy:type_name -> account.manager.account1.v1.LockedBy
	5, // 2: account.gateway.platform.v1.CreateAccountRequest.UsedFor:type_name -> account.manager.account1.v1.AccountUsedFor
	0, // 3: account.gateway.platform.v1.CreateAccountResponse.Info:type_name -> account.gateway.platform.v1.Account
	0, // 4: account.gateway.platform.v1.GetAccountsResponse.Infos:type_name -> account.gateway.platform.v1.Account
	1, // 5: account.gateway.platform.v1.Gateway.CreateAccount:input_type -> account.gateway.platform.v1.CreateAccountRequest
	3, // 6: account.gateway.platform.v1.Gateway.GetAccounts:input_type -> account.gateway.platform.v1.GetAccountsRequest
	2, // 7: account.gateway.platform.v1.Gateway.CreateAccount:output_type -> account.gateway.platform.v1.CreateAccountResponse
	4, // 8: account.gateway.platform.v1.Gateway.GetAccounts:output_type -> account.gateway.platform.v1.GetAccountsResponse
