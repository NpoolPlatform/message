...
const (
	Gateway_AdminGetAccounts_FullMethodName = "/account.gateway.contract.v1.Gateway/AdminGetAccounts"
)
...
func _Gateway_AdminGetAccounts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(GatewayServer).AdminGetAccounts(ctx, in)
	}
...
var Gateway_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "account.gateway.contract.v1.Gateway",
	HandlerType: (*GatewayServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "AdminGetAccounts",
			Handler:    _Gateway_AdminGetAccounts_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "npool/account/gw/v1/contract/contract.proto",
}
