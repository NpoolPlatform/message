...
var file_npool_account_gw_v1_contract_contract_proto_rawDesc = []byte{
	...
	0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x22, 0x42, 0x0a, 0x12, 0x47, 0x65, 0x74, 0x41,
	...
	0x54, 0x6f, 0x74, 0x61, 0x6c, 0x32, 0xac, 0x01, 0x0a, 0x07, 0x47, 0x61, 0x74, 0x65, 0x77, 0x61,
	0x79, 0x12, 0xa0, 0x01, 0x0a, 0x10, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x47, 0x65, 0x74, 0x41, 0x63,
	...
	0x74, 0x2e, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2e, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x61,
...
var file_npool_account_gw_v1_contract_contract_proto_goTypes = []interface{}{
	...
	(*GetAccountsRequest)(nil),  // 1: account.gateway.contract.v1.GetAccountsRequest
	(*GetAccountsResponse)(nil), // 2: account.gateway.contract.v1.GetAccountsResponse
...
var file_npool_account_gw_v1_contract_contract_proto_depIdxs = []int32{
	...
	0, // 3: account.gateway.contract.v1.GetAccountsResponse.Infos:type_name -> account.gateway.contract.v1.Account
	1, // 4: account.gateway.contract.v1.Gateway.AdminGetAccounts:input_type -> account.gateway.contract.v1.GetAccountsRequest
	2, // 5: account.gateway.contract.v1.Gateway.AdminGetAccounts:output_type -> account.gateway.contract.v1.GetAccountsResponse
