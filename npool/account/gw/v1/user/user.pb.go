...
var file_npool_account_gw_v1_user_user_proto_rawDesc = []byte{
	...
	0x61, 0x6c, 0x32, 0xde, 0x03, 0x0a, 0x07, 0x47, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x12, 0xad,
	0x01, 0x0a, 0x15, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x57, 0x69, 0x74, 0x68, 0x64, 0x72, 0x61,
	0x77, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x35, 0x2e, 0x61, 0x63, 0x63, 0x6f, 0x75,
	...
	0x36, 0x2e, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x2e, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61,
	...
	0x1a, 0x2f, 0x76, 0x31, 0x2f, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x2f, 0x77, 0x69, 0x74, 0x68,
	0x64, 0x72, 0x61, 0x77, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x3a, 0x01, 0x2a, 0x12, 0x89,
...
var file_npool_account_gw_v1_user_user_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_npool_account_gw_v1_user_user_proto_goTypes = []interface{}{
	...
	(*GetAccountsRequest)(nil),            // 3: account.gateway.user.v1.GetAccountsRequest
	(*GetAccountsResponse)(nil),           // 4: account.gateway.user.v1.GetAccountsResponse
	(*GetAppAccountsRequest)(nil),         // 5: account.gateway.user.v1.GetAppAccountsRequest
	(*GetAppAccountsResponse)(nil),        // 6: account.gateway.user.v1.GetAppAccountsResponse
	(account.AccountUsedFor)(0),           // 7: account.manager.account1.v1.AccountUsedFor
}
var file_npool_account_gw_v1_user_user_proto_depIdxs = []int32{
	7, // 0: account.gateway.user.v1.Account.UsedFor:type_name -> account.manager.account1.v1.AccountUsedFor
	0, // 1: account.gateway.user.v1.CreateWithdrawAccountResponse.Info:type_name -> account.gateway.user.v1.Account
	7, // 2: account.gateway.user.v1.GetAccountsRequest.UsedFor:type_name -> account.manager.account1.v1.AccountUsedFor
	0, // 3: account.gateway.user.v1.GetAccountsResponse.Infos:type_name -> account.gateway.user.v1.Account
	0, // 4: account.gateway.user.v1.GetAppAccountsResponse.Infos:type_name -> account.gateway.user.v1.Account
	1, // 5: account.gateway.user.v1.Gateway.CreateWithdrawAccount:input_type -> account.gateway.user.v1.CreateWithdrawAccountRequest
	3, // 6: account.gateway.user.v1.Gateway.GetAccounts:input_type -> account.gateway.user.v1.GetAccountsRequest
	5, // 7: account.gateway.user.v1.Gateway.GetAppAccounts:input_type -> account.gateway.user.v1.GetAppAccountsRequest
	2, // 8: account.gateway.user.v1.Gateway.CreateWithdrawAccount:output_type -> account.gateway.user.v1.CreateWithdrawAccountResponse
	4, // 9: account.gateway.user.v1.Gateway.GetAccounts:output_type -> account.gateway.user.v1.GetAccountsResponse
	6, // 10: account.gateway.user.v1.Gateway.GetAppAccounts:output_type -> account.gateway.user.v1.GetAppAccountsResponse
