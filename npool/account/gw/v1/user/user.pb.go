...
var file_npool_account_gw_v1_user_user_proto_rawDesc = []byte{
	...
	0x6f, 0x6c, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xcb, 0x03, 0x0a, 0x07, 0x41, 0x63, 0x63,
	...
	0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x22, 0x9e, 0x01, 0x0a, 0x1c, 0x43, 0x72, 0x65, 0x61, 0x74,
	...
	0x6c, 0x18, 0x14, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x05, 0x54, 0x6f, 0x74, 0x61, 0x6c, 0x32, 0xaf,
	0x06, 0x0a, 0x07, 0x47, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x12, 0xad, 0x01, 0x0a, 0x15, 0x43,
	...
	0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x3a, 0x01, 0x2a, 0x12, 0x9d, 0x01, 0x0a, 0x11, 0x47,
	0x65, 0x74, 0x44, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74,
	0x12, 0x31, 0x2e, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x2e, 0x67, 0x61, 0x74, 0x65, 0x77,
	...
	0x65, 0x73, 0x74, 0x1a, 0x32, 0x2e, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x2e, 0x67, 0x61,
	...
	0x16, 0x2f, 0x76, 0x31, 0x2f, 0x67, 0x65, 0x74, 0x2f, 0x64, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74,
	0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x3a, 0x01, 0x2a, 0x12, 0xae, 0x01, 0x0a, 0x15, 0x47,
	0x65, 0x74, 0x41, 0x70, 0x70, 0x44, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x41, 0x63, 0x63, 0x6f,
	...
	0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x73, 0x3a, 0x01, 0x2a, 0x12, 0x89, 0x01, 0x0a, 0x0b,
...
var file_npool_account_gw_v1_user_user_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_npool_account_gw_v1_user_user_proto_goTypes = []interface{}{
	...
	(*GetAppDepositAccountsRequest)(nil),  // 5: account.gateway.user.v1.GetAppDepositAccountsRequest
	(*GetAppDepositAccountsResponse)(nil), // 6: account.gateway.user.v1.GetAppDepositAccountsResponse
	(*GetAccountsRequest)(nil),            // 7: account.gateway.user.v1.GetAccountsRequest
	(*GetAccountsResponse)(nil),           // 8: account.gateway.user.v1.GetAccountsResponse
	(*GetAppAccountsRequest)(nil),         // 9: account.gateway.user.v1.GetAppAccountsRequest
	(*GetAppAccountsResponse)(nil),        // 10: account.gateway.user.v1.GetAppAccountsResponse
...
var file_npool_account_gw_v1_user_user_proto_depIdxs = []int32{
	11, // 0: account.gateway.user.v1.Account.UsedFor:type_name -> account.manager.account1.v1.AccountUsedFor
	...
	11, // 4: account.gateway.user.v1.GetAccountsRequest.UsedFor:type_name -> account.manager.account1.v1.AccountUsedFor
	0,  // 5: account.gateway.user.v1.GetAccountsResponse.Infos:type_name -> account.gateway.user.v1.Account
	0,  // 6: account.gateway.user.v1.GetAppAccountsResponse.Infos:type_name -> account.gateway.user.v1.Account
	1,  // 7: account.gateway.user.v1.Gateway.CreateWithdrawAccount:input_type -> account.gateway.user.v1.CreateWithdrawAccountRequest
	3,  // 8: account.gateway.user.v1.Gateway.GetDepositAccount:input_type -> account.gateway.user.v1.GetDepositAccountRequest
	5,  // 9: account.gateway.user.v1.Gateway.GetAppDepositAccounts:input_type -> account.gateway.user.v1.GetAppDepositAccountsRequest
	7,  // 10: account.gateway.user.v1.Gateway.GetAccounts:input_type -> account.gateway.user.v1.GetAccountsRequest
	9,  // 11: account.gateway.user.v1.Gateway.GetAppAccounts:input_type -> account.gateway.user.v1.GetAppAccountsRequest
	2,  // 12: account.gateway.user.v1.Gateway.CreateWithdrawAccount:output_type -> account.gateway.user.v1.CreateWithdrawAccountResponse
	4,  // 13: account.gateway.user.v1.Gateway.GetDepositAccount:output_type -> account.gateway.user.v1.GetDepositAccountResponse
	6,  // 14: account.gateway.user.v1.Gateway.GetAppDepositAccounts:output_type -> account.gateway.user.v1.GetAppDepositAccountsResponse
	8,  // 15: account.gateway.user.v1.Gateway.GetAccounts:output_type -> account.gateway.user.v1.GetAccountsResponse
	10, // 16: account.gateway.user.v1.Gateway.GetAppAccounts:output_type -> account.gateway.user.v1.GetAppAccountsResponse
