...
const (
	Manager_CreateAccount_FullMethodName     = "/account.manager.goodbenefit.v1.Manager/CreateAccount"
	Manager_CreateAccounts_FullMethodName    = "/account.manager.goodbenefit.v1.Manager/CreateAccounts"
	Manager_UpdateAccount_FullMethodName     = "/account.manager.goodbenefit.v1.Manager/UpdateAccount"
	Manager_GetAccount_FullMethodName        = "/account.manager.goodbenefit.v1.Manager/GetAccount"
	Manager_GetAccountOnly_FullMethodName    = "/account.manager.goodbenefit.v1.Manager/GetAccountOnly"
	Manager_GetAccounts_FullMethodName       = "/account.manager.goodbenefit.v1.Manager/GetAccounts"
	Manager_ExistAccount_FullMethodName      = "/account.manager.goodbenefit.v1.Manager/ExistAccount"
	Manager_ExistAccountConds_FullMethodName = "/account.manager.goodbenefit.v1.Manager/ExistAccountConds"
	Manager_CountAccounts_FullMethodName     = "/account.manager.goodbenefit.v1.Manager/CountAccounts"
	Manager_DeleteAccount_FullMethodName     = "/account.manager.goodbenefit.v1.Manager/DeleteAccount"
)
