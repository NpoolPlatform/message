...
const (
	Manager_CreateTransfer_FullMethodName     = "/account.manager.transfer.v1.Manager/CreateTransfer"
	Manager_CreateTransfers_FullMethodName    = "/account.manager.transfer.v1.Manager/CreateTransfers"
	Manager_GetTransfer_FullMethodName        = "/account.manager.transfer.v1.Manager/GetTransfer"
	Manager_GetTransferOnly_FullMethodName    = "/account.manager.transfer.v1.Manager/GetTransferOnly"
	Manager_GetTransfers_FullMethodName       = "/account.manager.transfer.v1.Manager/GetTransfers"
	Manager_ExistTransfer_FullMethodName      = "/account.manager.transfer.v1.Manager/ExistTransfer"
	Manager_ExistTransferConds_FullMethodName = "/account.manager.transfer.v1.Manager/ExistTransferConds"
	Manager_CountTransfers_FullMethodName     = "/account.manager.transfer.v1.Manager/CountTransfers"
	Manager_DeleteTransfer_FullMethodName     = "/account.manager.transfer.v1.Manager/DeleteTransfer"
)
