...
type AccountingV2Request struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	GoodID                 string                `protobuf:"bytes,30,opt,name=GoodID,proto3" json:"GoodID,omitempty"`
	OrderID                string                `protobuf:"bytes,40,opt,name=OrderID,proto3" json:"OrderID,omitempty"`
	OrderCreatedAt         uint32                `protobuf:"varint,50,opt,name=OrderCreatedAt,proto3" json:"OrderCreatedAt,omitempty"`
	...
	GoodValue              string                `protobuf:"bytes,120,opt,name=GoodValue,proto3" json:"GoodValue,omitempty"`
	SettleType             commission.SettleType `protobuf:"varint,130,opt,name=SettleType,proto3,enum=inspire.manager.commission.v1.SettleType" json:"SettleType,omitempty"`
	HasCommission          bool                  `protobuf:"varint,140,opt,name=HasCommission,proto3" json:"HasCommission,omitempty"`
}

func (x *AccountingV2Request) Reset() {
	*x = AccountingV2Request{}
	if protoimpl.UnsafeEnabled {
		mi := &file_npool_inspire_mw_v1_accounting_accounting_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *AccountingV2Request) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AccountingV2Request) ProtoMessage() {}

func (x *AccountingV2Request) ProtoReflect() protoreflect.Message {
	mi := &file_npool_inspire_mw_v1_accounting_accounting_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AccountingV2Request.ProtoReflect.Descriptor instead.
func (*AccountingV2Request) Descriptor() ([]byte, []int) {
	return file_npool_inspire_mw_v1_accounting_accounting_proto_rawDescGZIP(), []int{3}
}

func (x *AccountingV2Request) GetAppID() string {
	if x != nil {
		return x.AppID
	}
	return ""
...
func (x *AccountingV2Request) GetUserID() string {
	if x != nil {
		return x.UserID
	}
	return ""
...
func (x *AccountingV2Request) GetGoodID() string {
	if x != nil {
		return x.GoodID
	}
	return ""
...
func (x *AccountingV2Request) GetOrderID() string {
	if x != nil {
		return x.OrderID
	}
	return ""
...
func (x *AccountingV2Request) GetOrderCreatedAt() uint32 {
	if x != nil {
...
func (x *AccountingV2Request) GetPaymentID() string {
	if x != nil {
		return x.PaymentID
	}
	return ""
...
func (x *AccountingV2Request) GetCoinTypeID() string {
	if x != nil {
		return x.CoinTypeID
	}
	return ""
...
func (x *AccountingV2Request) GetPaymentCoinTypeID() string {
	if x != nil {
		return x.PaymentCoinTypeID
	}
	return ""
...
func (x *AccountingV2Request) GetPaymentCoinUSDCurrency() string {
	if x != nil {
		return x.PaymentCoinUSDCurrency
	}
	return ""
...
func (x *AccountingV2Request) GetUnits() string {
	if x != nil {
		return x.Units
	}
	return ""
...
func (x *AccountingV2Request) GetPaymentAmount() string {
	if x != nil {
		return x.PaymentAmount
	}
	return ""
...
func (x *AccountingV2Request) GetGoodValue() string {
	if x != nil {
		return x.GoodValue
	}
	return ""
...
func (x *AccountingV2Request) GetSettleType() commission.SettleType {
	if x != nil {
		return x.SettleType
	}
	return commission.SettleType(0)
...
func (x *AccountingV2Request) GetHasCommission() bool {
	if x != nil {
		return x.HasCommission
	}
	return false
...
type AccountingV2Response struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *AccountingV2Response) Reset() {
	*x = AccountingV2Response{}
	if protoimpl.UnsafeEnabled {
		mi := &file_npool_inspire_mw_v1_accounting_accounting_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *AccountingV2Response) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AccountingV2Response) ProtoMessage() {}

func (x *AccountingV2Response) ProtoReflect() protoreflect.Message {
	mi := &file_npool_inspire_mw_v1_accounting_accounting_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AccountingV2Response.ProtoReflect.Descriptor instead.
func (*AccountingV2Response) Descriptor() ([]byte, []int) {
	return file_npool_inspire_mw_v1_accounting_accounting_proto_rawDescGZIP(), []int{4}
}

func (x *AccountingV2Response) GetInfos() []*Commission {
	if x != nil {
		return x.Infos
	}
	return nil
...
var file_npool_inspire_mw_v1_accounting_accounting_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x72, 0x49, 0x44, 0x22, 0xe3, 0x03, 0x0a, 0x11, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e,
	...
	0x73, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x22, 0x58, 0x0a, 0x12, 0x41,
	...
	0x49, 0x6e, 0x66, 0x6f, 0x73, 0x22, 0x8e, 0x04, 0x0a, 0x13, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e,
	0x74, 0x69, 0x6e, 0x67, 0x56, 0x32, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x14, 0x0a,
	...
	0x0e, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x18,
	0x32, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0e, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x43, 0x72, 0x65, 0x61,
	0x74, 0x65, 0x64, 0x41, 0x74, 0x12, 0x1c, 0x0a, 0x09, 0x50, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74,
	...
	0x18, 0x6e, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x50, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x41,
	0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x1c, 0x0a, 0x09, 0x47, 0x6f, 0x6f, 0x64, 0x56, 0x61, 0x6c,
	0x75, 0x65, 0x18, 0x78, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x47, 0x6f, 0x6f, 0x64, 0x56, 0x61,
	0x6c, 0x75, 0x65, 0x12, 0x4a, 0x0a, 0x0a, 0x53, 0x65, 0x74, 0x74, 0x6c, 0x65, 0x54, 0x79, 0x70,
	...
	0x25, 0x0a, 0x0d, 0x48, 0x61, 0x73, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e,
	0x18, 0x8c, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0d, 0x48, 0x61, 0x73, 0x43, 0x6f, 0x6d, 0x6d,
	0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x22, 0x5a, 0x0a, 0x14, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e,
	0x74, 0x69, 0x6e, 0x67, 0x56, 0x32, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x42,
	...
	0x6f, 0x73, 0x32, 0x88, 0x02, 0x0a, 0x0a, 0x4d, 0x69, 0x64, 0x64, 0x6c, 0x65, 0x77, 0x61, 0x72,
	...
	,
...
var file_npool_inspire_mw_v1_accounting_accounting_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_npool_inspire_mw_v1_accounting_accounting_proto_goTypes = []interface{}{
	...
	(*AccountingV2Request)(nil),  // 3: inspire.middleware.accounting.v1.AccountingV2Request
	(*AccountingV2Response)(nil), // 4: inspire.middleware.accounting.v1.AccountingV2Response
...
var file_npool_inspire_mw_v1_accounting_accounting_proto_depIdxs = []int32{
	5, // 0: inspire.middleware.accounting.v1.AccountingRequest.SettleType:type_name -> inspire.manager.commission.v1.SettleType
	0, // 1: inspire.middleware.accounting.v1.AccountingResponse.Infos:type_name -> inspire.middleware.accounting.v1.Commission
	5, // 2: inspire.middleware.accounting.v1.AccountingV2Request.SettleType:type_name -> inspire.manager.commission.v1.SettleType
	0, // 3: inspire.middleware.accounting.v1.AccountingV2Response.Infos:type_name -> inspire.middleware.accounting.v1.Commission
	1, // 4: inspire.middleware.accounting.v1.Middleware.Accounting:input_type -> inspire.middleware.accounting.v1.AccountingRequest
	3, // 5: inspire.middleware.accounting.v1.Middleware.AccountingV2:input_type -> inspire.middleware.accounting.v1.AccountingV2Request
	2, // 6: inspire.middleware.accounting.v1.Middleware.Accounting:output_type -> inspire.middleware.accounting.v1.AccountingResponse
	4, // 7: inspire.middleware.accounting.v1.Middleware.AccountingV2:output_type -> inspire.middleware.accounting.v1.AccountingV2Response
...
func file_npool_inspire_mw_v1_accounting_accounting_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_npool_inspire_mw_v1_accounting_accounting_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AccountingV2Request); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_npool_inspire_mw_v1_accounting_accounting_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AccountingV2Response); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
