...
var file_npool_inspire_mw_v1_invitation_invitationcode_invitationcode_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0x69, 0x0a, 0x1c, 0x47, 0x65, 0x74, 0x49, 0x6e, 0x76, 0x69, 0x74, 0x61, 0x74, 0x69,
	...
	0xe6, 0x05, 0x0a, 0x0a, 0x4d, 0x69, 0x64, 0x64, 0x6c, 0x65, 0x77, 0x61, 0x72, 0x65, 0x12, 0xb5,
	...
	0x6f, 0x64, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0xb8, 0x01,
	0x0a, 0x15, 0x47, 0x65, 0x74, 0x49, 0x6e, 0x76, 0x69, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x43,
	0x6f, 0x64, 0x65, 0x4f, 0x6e, 0x6c, 0x79, 0x12, 0x4d, 0x2e, 0x69, 0x6e, 0x73, 0x70, 0x69, 0x72,
	0x65, 0x2e, 0x6d, 0x69, 0x64, 0x64, 0x6c, 0x65, 0x77, 0x61, 0x72, 0x65, 0x2e, 0x69, 0x6e, 0x76,
	0x69, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x69, 0x6e, 0x76, 0x69, 0x74, 0x61, 0x74, 0x69,
...
var file_npool_inspire_mw_v1_invitation_invitationcode_invitationcode_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_npool_inspire_mw_v1_invitation_invitationcode_invitationcode_proto_goTypes = []interface{}{
	...
	(*GetInvitationCodeOnlyRequest)(nil),     // 6: inspire.middleware.invitation.invitationcode.v1.GetInvitationCodeOnlyRequest
	(*GetInvitationCodeOnlyResponse)(nil),    // 7: inspire.middleware.invitation.invitationcode.v1.GetInvitationCodeOnlyResponse
	(*invitationcode.InvitationCodeReq)(nil), // 8: inspire.manager.invitation.invitationcode.v1.InvitationCodeReq
	(*invitationcode.InvitationCode)(nil),    // 9: inspire.manager.invitation.invitationcode.v1.InvitationCode
	(*invitationcode.Conds)(nil),             // 10: inspire.manager.invitation.invitationcode.v1.Conds
}
var file_npool_inspire_mw_v1_invitation_invitationcode_invitationcode_proto_depIdxs = []int32{
	8,  // 0: inspire.middleware.invitation.invitationcode.v1.CreateInvitationCodeRequest.Info:type_name -> inspire.manager.invitation.invitationcode.v1.InvitationCodeReq
	9,  // 1: inspire.middleware.invitation.invitationcode.v1.CreateInvitationCodeResponse.Info:type_name -> inspire.manager.invitation.invitationcode.v1.InvitationCode
	8,  // 2: inspire.middleware.invitation.invitationcode.v1.UpdateInvitationCodeRequest.Info:type_name -> inspire.manager.invitation.invitationcode.v1.InvitationCodeReq
	9,  // 3: inspire.middleware.invitation.invitationcode.v1.UpdateInvitationCodeResponse.Info:type_name -> inspire.manager.invitation.invitationcode.v1.InvitationCode
	9,  // 4: inspire.middleware.invitation.invitationcode.v1.GetInvitationCodeResponse.Info:type_name -> inspire.manager.invitation.invitationcode.v1.InvitationCode
	10, // 5: inspire.middleware.invitation.invitationcode.v1.GetInvitationCodeOnlyRequest.Conds:type_name -> inspire.manager.invitation.invitationcode.v1.Conds
	9,  // 6: inspire.middleware.invitation.invitationcode.v1.GetInvitationCodeOnlyResponse.Info:type_name -> inspire.manager.invitation.invitationcode.v1.InvitationCode
	0,  // 7: inspire.middleware.invitation.invitationcode.v1.Middleware.CreateInvitationCode:input_type -> inspire.middleware.invitation.invitationcode.v1.CreateInvitationCodeRequest
	2,  // 8: inspire.middleware.invitation.invitationcode.v1.Middleware.UpdateInvitationCode:input_type -> inspire.middleware.invitation.invitationcode.v1.UpdateInvitationCodeRequest
	4,  // 9: inspire.middleware.invitation.invitationcode.v1.Middleware.GetInvitationCode:input_type -> inspire.middleware.invitation.invitationcode.v1.GetInvitationCodeRequest
	6,  // 10: inspire.middleware.invitation.invitationcode.v1.Middleware.GetInvitationCodeOnly:input_type -> inspire.middleware.invitation.invitationcode.v1.GetInvitationCodeOnlyRequest
	1,  // 11: inspire.middleware.invitation.invitationcode.v1.Middleware.CreateInvitationCode:output_type -> inspire.middleware.invitation.invitationcode.v1.CreateInvitationCodeResponse
	3,  // 12: inspire.middleware.invitation.invitationcode.v1.Middleware.UpdateInvitationCode:output_type -> inspire.middleware.invitation.invitationcode.v1.UpdateInvitationCodeResponse
	5,  // 13: inspire.middleware.invitation.invitationcode.v1.Middleware.GetInvitationCode:output_type -> inspire.middleware.invitation.invitationcode.v1.GetInvitationCodeResponse
	7,  // 14: inspire.middleware.invitation.invitationcode.v1.Middleware.GetInvitationCodeOnly:output_type -> inspire.middleware.invitation.invitationcode.v1.GetInvitationCodeOnlyResponse
