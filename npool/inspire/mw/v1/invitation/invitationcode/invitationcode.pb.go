...
var file_npool_inspire_mw_v1_invitation_invitationcode_invitationcode_proto_rawDesc = []byte{
	...
	0x6f, 0x64, 0x65, 0x52, 0x04, 0x49, 0x6e, 0x66, 0x6f, 0x22, 0x48, 0x0a, 0x18, 0x47, 0x65, 0x74,
	...
	0x72, 0x49, 0x44, 0x22, 0x6d, 0x0a, 0x19, 0x47, 0x65, 0x74, 0x49, 0x6e, 0x76, 0x69, 0x74, 0x61,
	...
	0x66, 0x6f, 0x32, 0xf3, 0x02, 0x0a, 0x0a, 0x4d, 0x69, 0x64, 0x64, 0x6c, 0x65, 0x77, 0x61, 0x72,
...
var file_npool_inspire_mw_v1_invitation_invitationcode_invitationcode_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_npool_inspire_mw_v1_invitation_invitationcode_invitationcode_proto_goTypes = []interface{}{
	...
	(*GetInvitationCodeRequest)(nil),      // 2: inspire.middleware.invitation.invitationcode.v1.GetInvitationCodeRequest
	(*GetInvitationCodeResponse)(nil),     // 3: inspire.middleware.invitation.invitationcode.v1.GetInvitationCodeResponse
	(*invitationcode.InvitationCode)(nil), // 4: inspire.manager.invitation.invitationcode.v1.InvitationCode
}
var file_npool_inspire_mw_v1_invitation_invitationcode_invitationcode_proto_depIdxs = []int32{
	4, // 0: inspire.middleware.invitation.invitationcode.v1.CreateInvitationCodeResponse.Info:type_name -> inspire.manager.invitation.invitationcode.v1.InvitationCode
	4, // 1: inspire.middleware.invitation.invitationcode.v1.GetInvitationCodeResponse.Info:type_name -> inspire.manager.invitation.invitationcode.v1.InvitationCode
	0, // 2: inspire.middleware.invitation.invitationcode.v1.Middleware.CreateInvitationCode:input_type -> inspire.middleware.invitation.invitationcode.v1.CreateInvitationCodeRequest
	2, // 3: inspire.middleware.invitation.invitationcode.v1.Middleware.GetInvitationCode:input_type -> inspire.middleware.invitation.invitationcode.v1.GetInvitationCodeRequest
	1, // 4: inspire.middleware.invitation.invitationcode.v1.Middleware.CreateInvitationCode:output_type -> inspire.middleware.invitation.invitationcode.v1.CreateInvitationCodeResponse
	3, // 5: inspire.middleware.invitation.invitationcode.v1.Middleware.GetInvitationCode:output_type -> inspire.middleware.invitation.invitationcode.v1.GetInvitationCodeResponse
