...
var file_npool_inspire_mw_v1_invitation_registration_registration_proto_rawDesc = []byte{
	...
	0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x04, 0x49, 0x6e, 0x66, 0x6f, 0x32, 0xc1, 0x05, 0x0a,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0xa5, 0x01, 0x0a, 0x10, 0x47, 0x65, 0x74, 0x52,
	...
	0xae, 0x01, 0x0a, 0x13, 0x47, 0x65, 0x74, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x72, 0x61, 0x74,
	0x69, 0x6f, 0x6e, 0x4f, 0x6e, 0x6c, 0x79, 0x12, 0x49, 0x2e, 0x69, 0x6e, 0x73, 0x70, 0x69, 0x72,
...
var file_npool_inspire_mw_v1_invitation_registration_registration_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_npool_inspire_mw_v1_invitation_registration_registration_proto_goTypes = []interface{}{
	...
	(*registration.RegistrationReq)(nil), // 8: inspire.manager.invitation.registration.v1.RegistrationReq
	(*registration.Registration)(nil),    // 9: inspire.manager.invitation.registration.v1.Registration
	(*registration.Conds)(nil),           // 10: inspire.manager.invitation.registration.v1.Conds
}
var file_npool_inspire_mw_v1_invitation_registration_registration_proto_depIdxs = []int32{
	8,  // 0: inspire.middleware.invitation.registration.v1.CreateRegistrationRequest.Info:type_name -> inspire.manager.invitation.registration.v1.RegistrationReq
	9,  // 1: inspire.middleware.invitation.registration.v1.CreateRegistrationResponse.Info:type_name -> inspire.manager.invitation.registration.v1.Registration
	8,  // 2: inspire.middleware.invitation.registration.v1.UpdateRegistrationRequest.Info:type_name -> inspire.manager.invitation.registration.v1.RegistrationReq
	9,  // 3: inspire.middleware.invitation.registration.v1.UpdateRegistrationResponse.Info:type_name -> inspire.manager.invitation.registration.v1.Registration
	10, // 4: inspire.middleware.invitation.registration.v1.GetRegistrationsRequest.Conds:type_name -> inspire.manager.invitation.registration.v1.Conds
	9,  // 5: inspire.middleware.invitation.registration.v1.GetRegistrationsResponse.Infos:type_name -> inspire.manager.invitation.registration.v1.Registration
	10, // 6: inspire.middleware.invitation.registration.v1.GetRegistrationOnlyRequest.Conds:type_name -> inspire.manager.invitation.registration.v1.Conds
	9,  // 7: inspire.middleware.invitation.registration.v1.GetRegistrationOnlyResponse.Info:type_name -> inspire.manager.invitation.registration.v1.Registration
	0,  // 8: inspire.middleware.invitation.registration.v1.Middleware.CreateRegistration:input_type -> inspire.middleware.invitation.registration.v1.CreateRegistrationRequest
	2,  // 9: inspire.middleware.invitation.registration.v1.Middleware.UpdateRegistration:input_type -> inspire.middleware.invitation.registration.v1.UpdateRegistrationRequest
	4,  // 10: inspire.middleware.invitation.registration.v1.Middleware.GetRegistrations:input_type -> inspire.middleware.invitation.registration.v1.GetRegistrationsRequest
	6,  // 11: inspire.middleware.invitation.registration.v1.Middleware.GetRegistrationOnly:input_type -> inspire.middleware.invitation.registration.v1.GetRegistrationOnlyRequest
	1,  // 12: inspire.middleware.invitation.registration.v1.Middleware.CreateRegistration:output_type -> inspire.middleware.invitation.registration.v1.CreateRegistrationResponse
	3,  // 13: inspire.middleware.invitation.registration.v1.Middleware.UpdateRegistration:output_type -> inspire.middleware.invitation.registration.v1.UpdateRegistrationResponse
	5,  // 14: inspire.middleware.invitation.registration.v1.Middleware.GetRegistrations:output_type -> inspire.middleware.invitation.registration.v1.GetRegistrationsResponse
	7,  // 15: inspire.middleware.invitation.registration.v1.Middleware.GetRegistrationOnly:output_type -> inspire.middleware.invitation.registration.v1.GetRegistrationOnlyResponse
