...
func (c *middlewareClient) Calculate(ctx context.Context, in *CalculateRequest, opts ...grpc.CallOption) (*CalculateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/inspire.middleware.calculate.v1.Middleware/Calculate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *middlewareClient) ReconcileCalculate(ctx context.Context, in *ReconcileCalculateRequest, opts ...grpc.CallOption) (*ReconcileCalculateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/inspire.middleware.calculate.v1.Middleware/ReconcileCalculate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Middleware_Calculate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/inspire.middleware.calculate.v1.Middleware/Calculate",
	}
...
func _Middleware_ReconcileCalculate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/inspire.middleware.calculate.v1.Middleware/ReconcileCalculate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
