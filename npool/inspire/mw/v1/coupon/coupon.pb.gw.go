...
func RegisterMiddlewareHandlerServer(ctx context.Context, mux *runtime.ServeMux, server MiddlewareServer) error {
	...
	mux.Handle("POST", pattern_Middleware_DeleteCoupon_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/inspire.middleware.coupon.v1.Middleware/DeleteCoupon", runtime.WithHTTPPathPattern("/v1/coupon_DeleteCoupon"))
		if err != nil {
...
func RegisterMiddlewareHandlerClient(ctx context.Context, mux *runtime.ServeMux, client MiddlewareClient) error {
	...
	mux.Handle("POST", pattern_Middleware_DeleteCoupon_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/inspire.middleware.coupon.v1.Middleware/DeleteCoupon", runtime.WithHTTPPathPattern("/v1/coupon_DeleteCoupon"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_Middleware_DeleteCoupon_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "coupon_DeleteCoupon"}, ""))
)
