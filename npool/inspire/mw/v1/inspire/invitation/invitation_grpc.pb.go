...
func (c *middlewareClient) GetInvitees(ctx context.Context, in *GetInviteesRequest, opts ...grpc.CallOption) (*GetInviteesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/inspire.middleware.inspire.invitation.v1.Middleware/GetInvitees", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *middlewareClient) GetInviters(ctx context.Context, in *GetInvitersRequest, opts ...grpc.CallOption) (*GetInvitersResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/inspire.middleware.inspire.invitation.v1.Middleware/GetInviters", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Middleware_GetInvitees_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/inspire.middleware.inspire.invitation.v1.Middleware/GetInvitees",
	}
...
func _Middleware_GetInviters_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/inspire.middleware.inspire.invitation.v1.Middleware/GetInviters",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Middleware_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "inspire.middleware.inspire.invitation.v1.Middleware",
	...
	Metadata: "npool/inspire/mw/v1/inspire/invitation/invitation.proto",
}
