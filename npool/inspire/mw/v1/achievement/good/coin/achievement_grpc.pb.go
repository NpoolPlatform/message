...
func (c *middlewareClient) GetAchievements(ctx context.Context, in *GetAchievementsRequest, opts ...grpc.CallOption) (*GetAchievementsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/inspire.middleware.achievement.good.coin.v1.Middleware/GetAchievements", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *middlewareClient) DeleteAchievement(ctx context.Context, in *DeleteAchievementRequest, opts ...grpc.CallOption) (*DeleteAchievementResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/inspire.middleware.achievement.good.coin.v1.Middleware/DeleteAchievement", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Middleware_GetAchievements_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/inspire.middleware.achievement.good.coin.v1.Middleware/GetAchievements",
	}
...
func _Middleware_DeleteAchievement_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/inspire.middleware.achievement.good.coin.v1.Middleware/DeleteAchievement",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Middleware_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "inspire.middleware.achievement.good.coin.v1.Middleware",
	...
	Metadata: "npool/inspire/mw/v1/achievement/good/coin/achievement.proto",
}
