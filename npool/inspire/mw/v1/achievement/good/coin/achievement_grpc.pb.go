...
const (
	Middleware_GetAchievements_FullMethodName   = "/inspire.middleware.achievement.good.coin.v1.Middleware/GetAchievements"
	Middleware_DeleteAchievement_FullMethodName = "/inspire.middleware.achievement.good.coin.v1.Middleware/DeleteAchievement"
)
