...
type Conds struct {
	...
	PaymentCoinTypeID *v11.StringVal `protobuf:"bytes,20,opt,name=PaymentCoinTypeID,proto3,oneof" json:"PaymentCoinTypeID,omitempty"`
}
...
var file_npool_inspire_mw_v1_achievement_statement_order_payment_statement_proto_rawDesc = []byte{
	...
	0x64, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x22, 0xa7, 0x01, 0x0a, 0x05, 0x43, 0x6f, 0x6e, 0x64,
	...
	0x49, 0x44, 0x88, 0x01, 0x01, 0x12, 0x4a, 0x0a, 0x11, 0x50, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74,
	0x43, 0x6f, 0x69, 0x6e, 0x54, 0x79, 0x70, 0x65, 0x49, 0x44, 0x18, 0x14, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x17, 0x2e, 0x62, 0x61, 0x73, 0x65, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2e, 0x76, 0x31, 0x2e,
	0x53, 0x74, 0x72, 0x69, 0x6e, 0x67, 0x56, 0x61, 0x6c, 0x48, 0x01, 0x52, 0x11, 0x50, 0x61, 0x79,
	0x6d, 0x65, 0x6e, 0x74, 0x43, 0x6f, 0x69, 0x6e, 0x54, 0x79, 0x70, 0x65, 0x49, 0x44, 0x88, 0x01,
...
var file_npool_inspire_mw_v1_achievement_statement_order_payment_statement_proto_depIdxs = []int32{
	...
	6, // 2: inspire.middleware.achievement.statement.order.payment.v1.Conds.PaymentCoinTypeID:type_name -> basetypes.v1.StringVal
	2, // 3: inspire.middleware.achievement.statement.order.payment.v1.GetStatementsRequest.Conds:type_name -> inspire.middleware.achievement.statement.order.payment.v1.Conds
	1, // 4: inspire.middleware.achievement.statement.order.payment.v1.GetStatementsResponse.Infos:type_name -> inspire.middleware.achievement.statement.order.payment.v1.Statement
	3, // 5: inspire.middleware.achievement.statement.order.payment.v1.Middleware.GetStatements:input_type -> inspire.middleware.achievement.statement.order.payment.v1.GetStatementsRequest
	4, // 6: inspire.middleware.achievement.statement.order.payment.v1.Middleware.GetStatements:output_type -> inspire.middleware.achievement.statement.order.payment.v1.GetStatementsResponse
