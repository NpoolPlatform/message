...
func (c *middlewareClient) GetStatements(ctx context.Context, in *GetStatementsRequest, opts ...grpc.CallOption) (*GetStatementsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/inspire.middleware.achievement.statement.order.payment.v1.Middleware/GetStatements", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Middleware_GetStatements_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/inspire.middleware.achievement.statement.order.payment.v1.Middleware/GetStatements",
	}
...
var Middleware_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "inspire.middleware.achievement.statement.order.payment.v1.Middleware",
	...
	Metadata: "npool/inspire/mw/v1/achievement/statement/order/payment/statement.proto",
}
