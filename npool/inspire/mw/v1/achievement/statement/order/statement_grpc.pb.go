...
type MiddlewareClient interface {
	...
	UpdateStatements(ctx context.Context, in *UpdateStatementsRequest, opts ...grpc.CallOption) (*UpdateStatementsResponse, error)
...
func (c *middlewareClient) CreateStatement(ctx context.Context, in *CreateStatementRequest, opts ...grpc.CallOption) (*CreateStatementResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/inspire.middleware.achievement.statement.order.v1.Middleware/CreateStatement", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *middlewareClient) CreateStatements(ctx context.Context, in *CreateStatementsRequest, opts ...grpc.CallOption) (*CreateStatementsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/inspire.middleware.achievement.statement.order.v1.Middleware/CreateStatements", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *middlewareClient) UpdateStatements(ctx context.Context, in *UpdateStatementsRequest, opts ...grpc.CallOption) (*UpdateStatementsResponse, error) {
	out := new(UpdateStatementsResponse)
	err := c.cc.Invoke(ctx, "/inspire.middleware.achievement.statement.order.v1.Middleware/UpdateStatements", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *middlewareClient) DeleteStatements(ctx context.Context, in *DeleteStatementsRequest, opts ...grpc.CallOption) (*DeleteStatementsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/inspire.middleware.achievement.statement.order.v1.Middleware/DeleteStatements", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *middlewareClient) GetStatements(ctx context.Context, in *GetStatementsRequest, opts ...grpc.CallOption) (*GetStatementsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/inspire.middleware.achievement.statement.order.v1.Middleware/GetStatements", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *middlewareClient) ExistStatementConds(ctx context.Context, in *ExistStatementCondsRequest, opts ...grpc.CallOption) (*ExistStatementCondsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/inspire.middleware.achievement.statement.order.v1.Middleware/ExistStatementConds", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *middlewareClient) DeleteStatement(ctx context.Context, in *DeleteStatementRequest, opts ...grpc.CallOption) (*DeleteStatementResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/inspire.middleware.achievement.statement.order.v1.Middleware/DeleteStatement", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MiddlewareServer interface {
	...
	UpdateStatements(context.Context, *UpdateStatementsRequest) (*UpdateStatementsResponse, error)
...
func (UnimplementedMiddlewareServer) UpdateStatements(context.Context, *UpdateStatementsRequest) (*UpdateStatementsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateStatements not implemented")
}
...
func _Middleware_CreateStatement_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/inspire.middleware.achievement.statement.order.v1.Middleware/CreateStatement",
	}
...
func _Middleware_CreateStatements_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/inspire.middleware.achievement.statement.order.v1.Middleware/CreateStatements",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Middleware_UpdateStatements_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateStatementsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MiddlewareServer).UpdateStatements(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/inspire.middleware.achievement.statement.order.v1.Middleware/UpdateStatements",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MiddlewareServer).UpdateStatements(ctx, req.(*UpdateStatementsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Middleware_DeleteStatements_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/inspire.middleware.achievement.statement.order.v1.Middleware/DeleteStatements",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Middleware_GetStatements_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/inspire.middleware.achievement.statement.order.v1.Middleware/GetStatements",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Middleware_ExistStatementConds_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/inspire.middleware.achievement.statement.order.v1.Middleware/ExistStatementConds",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Middleware_DeleteStatement_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/inspire.middleware.achievement.statement.order.v1.Middleware/DeleteStatement",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Middleware_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "inspire.middleware.achievement.statement.order.v1.Middleware",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpdateStatements",
			Handler:    _Middleware_UpdateStatements_Handler,
		},
		{
	...
	Metadata: "npool/inspire/mw/v1/achievement/statement/order/statement.proto",
}
