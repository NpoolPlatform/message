...
type Conds struct {
	...
	GoodIDs    *npool.StringSliceVal `protobuf:"bytes,80,opt,name=GoodIDs,proto3,oneof" json:"GoodIDs,omitempty"`
	StartAt    *npool.Uint32Val      `protobuf:"bytes,90,opt,name=StartAt,proto3,oneof" json:"StartAt,omitempty"`
}
...
type GetCommissionRequest struct {
	...
	ID         string                `protobuf:"bytes,10,opt,name=ID,proto3" json:"ID,omitempty"`
	SettleType commission.SettleType `protobuf:"varint,20,opt,name=SettleType,proto3,enum=inspire.manager.commission.v1.SettleType" json:"SettleType,omitempty"`
}
...
func (x *GetCommissionRequest) GetSettleType() commission.SettleType {
	if x != nil {
		return x.SettleType
	}
	return commission.SettleType(0)
...
var file_npool_inspire_mw_v1_commission_commission_proto_depIdxs = []int32{
	...
	20, // 14: inspire.middleware.commission.v1.Conds.StartAt:type_name -> npool.v1.Uint32Val
	...
	15, // 25: inspire.middleware.commission.v1.CloneCommissionsRequest.SettleType:type_name -> inspire.manager.commission.v1.SettleType
	...
	9,  // 29: inspire.middleware.commission.v1.Middleware.GetCommissionOnly:input_type -> inspire.middleware.commission.v1.GetCommissionOnlyRequest
	11, // 30: inspire.middleware.commission.v1.Middleware.GetCommissions:input_type -> inspire.middleware.commission.v1.GetCommissionsRequest
	13, // 31: inspire.middleware.commission.v1.Middleware.CloneCommissions:input_type -> inspire.middleware.commission.v1.CloneCommissionsRequest
	...
	10, // 35: inspire.middleware.commission.v1.Middleware.GetCommissionOnly:output_type -> inspire.middleware.commission.v1.GetCommissionOnlyResponse
	12, // 36: inspire.middleware.commission.v1.Middleware.GetCommissions:output_type -> inspire.middleware.commission.v1.GetCommissionsResponse
	14, // 37: inspire.middleware.commission.v1.Middleware.CloneCommissions:output_type -> inspire.middleware.commission.v1.CloneCommissionsResponse
