...
var file_npool_inspire_mw_v1_commission_commission_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x0d, 0x52, 0x05, 0x54, 0x6f, 0x74, 0x61, 0x6c, 0x32, 0xc6, 0x05, 0x0a, 0x0a, 0x4d,
...
var file_npool_inspire_mw_v1_commission_commission_proto_depIdxs = []int32{
	...
	1,  // 18: inspire.middleware.commission.v1.GetCommissionResponse.Info:type_name -> inspire.middleware.commission.v1.Commission
	2,  // 19: inspire.middleware.commission.v1.GetCommissionOnlyRequest.Conds:type_name -> inspire.middleware.commission.v1.Conds
	1,  // 20: inspire.middleware.commission.v1.GetCommissionOnlyResponse.Info:type_name -> inspire.middleware.commission.v1.Commission
	2,  // 21: inspire.middleware.commission.v1.GetCommissionsRequest.Conds:type_name -> inspire.middleware.commission.v1.Conds
	1,  // 22: inspire.middleware.commission.v1.GetCommissionsResponse.Infos:type_name -> inspire.middleware.commission.v1.Commission
	3,  // 23: inspire.middleware.commission.v1.Middleware.CreateCommission:input_type -> inspire.middleware.commission.v1.CreateCommissionRequest
	5,  // 24: inspire.middleware.commission.v1.Middleware.UpdateCommission:input_type -> inspire.middleware.commission.v1.UpdateCommissionRequest
	7,  // 25: inspire.middleware.commission.v1.Middleware.GetCommission:input_type -> inspire.middleware.commission.v1.GetCommissionRequest
	9,  // 26: inspire.middleware.commission.v1.Middleware.GetCommissionOnly:input_type -> inspire.middleware.commission.v1.GetCommissionOnlyRequest
	11, // 27: inspire.middleware.commission.v1.Middleware.GetCommissions:input_type -> inspire.middleware.commission.v1.GetCommissionsRequest
	4,  // 28: inspire.middleware.commission.v1.Middleware.CreateCommission:output_type -> inspire.middleware.commission.v1.CreateCommissionResponse
	6,  // 29: inspire.middleware.commission.v1.Middleware.UpdateCommission:output_type -> inspire.middleware.commission.v1.UpdateCommissionResponse
	8,  // 30: inspire.middleware.commission.v1.Middleware.GetCommission:output_type -> inspire.middleware.commission.v1.GetCommissionResponse
	10, // 31: inspire.middleware.commission.v1.Middleware.GetCommissionOnly:output_type -> inspire.middleware.commission.v1.GetCommissionOnlyResponse
	12, // 32: inspire.middleware.commission.v1.Middleware.GetCommissions:output_type -> inspire.middleware.commission.v1.GetCommissionsResponse
