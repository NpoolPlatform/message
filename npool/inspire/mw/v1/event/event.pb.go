...
var file_npool_inspire_mw_v1_event_event_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x07, 0x43, 0x72, 0x65, 0x64, 0x69, 0x74, 0x73, 0x22, 0xd9, 0x01, 0x0a, 0x12,
	...
	0x5f, 0x47, 0x6f, 0x6f, 0x64, 0x49, 0x44, 0x22, 0x50, 0x0a, 0x13, 0x52, 0x65, 0x77, 0x61, 0x72,
	...
	0x69, 0x74, 0x52, 0x05, 0x49, 0x6e, 0x66, 0x6f, 0x73, 0x32, 0xf7, 0x01, 0x0a, 0x0a, 0x4d, 0x69,
	0x64, 0x64, 0x6c, 0x65, 0x77, 0x61, 0x72, 0x65, 0x12, 0x75, 0x0a, 0x0c, 0x47, 0x65, 0x74, 0x45,
...
var file_npool_inspire_mw_v1_event_event_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_npool_inspire_mw_v1_event_event_proto_goTypes = []interface{}{
	...
	(*Credit)(nil),               // 2: inspire.middleware.event.v1.Credit
	(*RewardEventRequest)(nil),   // 3: inspire.middleware.event.v1.RewardEventRequest
	(*RewardEventResponse)(nil),  // 4: inspire.middleware.event.v1.RewardEventResponse
	(*event.Conds)(nil),          // 5: inspire.manager.event.v1.Conds
	(*event.Event)(nil),          // 6: inspire.manager.event.v1.Event
	(v1.UsedFor)(0),              // 7: basetypes.v1.UsedFor
}
var file_npool_inspire_mw_v1_event_event_proto_depIdxs = []int32{
	5, // 0: inspire.middleware.event.v1.GetEventOnlyRequest.Conds:type_name -> inspire.manager.event.v1.Conds
	6, // 1: inspire.middleware.event.v1.GetEventOnlyResponse.Info:type_name -> inspire.manager.event.v1.Event
	7, // 2: inspire.middleware.event.v1.RewardEventRequest.EventType:type_name -> basetypes.v1.UsedFor
	2, // 3: inspire.middleware.event.v1.RewardEventResponse.Infos:type_name -> inspire.middleware.event.v1.Credit
	0, // 4: inspire.middleware.event.v1.Middleware.GetEventOnly:input_type -> inspire.middleware.event.v1.GetEventOnlyRequest
	3, // 5: inspire.middleware.event.v1.Middleware.RewardEvent:input_type -> inspire.middleware.event.v1.RewardEventRequest
	1, // 6: inspire.middleware.event.v1.Middleware.GetEventOnly:output_type -> inspire.middleware.event.v1.GetEventOnlyResponse
	4, // 7: inspire.middleware.event.v1.Middleware.RewardEvent:output_type -> inspire.middleware.event.v1.RewardEventResponse
...
func file_npool_inspire_mw_v1_event_event_proto_init() {
	...
	file_npool_inspire_mw_v1_event_event_proto_msgTypes[3].OneofWrappers = []interface{}{}
	type x struct{}
