...
func (c *middlewareClient) Version(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*v1.VersionResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/inspire.middleware.v1.Middleware/Version", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Middleware_Version_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/inspire.middleware.v1.Middleware/Version",
	}
...
var Middleware_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "inspire.middleware.v1.Middleware",
	...
	Metadata: "npool/inspire/mw/v1/mw.proto",
}
