...
type DeleteAchivementRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Info *AchivementReq `protobuf:"bytes,10,opt,name=Info,proto3" json:"Info,omitempty"`
}

func (x *DeleteAchivementRequest) Reset() {
	*x = DeleteAchivementRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_npool_inspire_mw_v1_achivement_achivement_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *DeleteAchivementRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DeleteAchivementRequest) ProtoMessage() {}

func (x *DeleteAchivementRequest) ProtoReflect() protoreflect.Message {
	mi := &file_npool_inspire_mw_v1_achivement_achivement_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DeleteAchivementRequest.ProtoReflect.Descriptor instead.
func (*DeleteAchivementRequest) Descriptor() ([]byte, []int) {
	return file_npool_inspire_mw_v1_achivement_achivement_proto_rawDescGZIP(), []int{7}
}

func (x *DeleteAchivementRequest) GetInfo() *AchivementReq {
	if x != nil {
		return x.Info
	}
	return nil
...
type DeleteAchivementResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Info *Achivement `protobuf:"bytes,10,opt,name=Info,proto3" json:"Info,omitempty"`
}

func (x *DeleteAchivementResponse) Reset() {
	*x = DeleteAchivementResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_npool_inspire_mw_v1_achivement_achivement_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *DeleteAchivementResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DeleteAchivementResponse) ProtoMessage() {}

func (x *DeleteAchivementResponse) ProtoReflect() protoreflect.Message {
	mi := &file_npool_inspire_mw_v1_achivement_achivement_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DeleteAchivementResponse.ProtoReflect.Descriptor instead.
func (*DeleteAchivementResponse) Descriptor() ([]byte, []int) {
	return file_npool_inspire_mw_v1_achivement_achivement_proto_rawDescGZIP(), []int{8}
}

func (x *DeleteAchivementResponse) GetInfo() *Achivement {
	if x != nil {
		return x.Info
	}
	return nil
...
var file_npool_inspire_mw_v1_achivement_achivement_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x0d, 0x52, 0x05, 0x54, 0x6f, 0x74, 0x61, 0x6c, 0x22, 0x5e, 0x0a, 0x17, 0x44, 0x65,
	0x6c, 0x65, 0x74, 0x65, 0x41, 0x63, 0x68, 0x69, 0x76, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x52, 0x65,
	...
	0x65, 0x6e, 0x74, 0x2e, 0x76, 0x31, 0x2e, 0x41, 0x63, 0x68, 0x69, 0x76, 0x65, 0x6d, 0x65, 0x6e,
	0x74, 0x52, 0x65, 0x71, 0x52, 0x04, 0x49, 0x6e, 0x66, 0x6f, 0x22, 0x5c, 0x0a, 0x18, 0x44, 0x65,
	0x6c, 0x65, 0x74, 0x65, 0x41, 0x63, 0x68, 0x69, 0x76, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x52, 0x65,
	...
	0x69, 0x64, 0x64, 0x6c, 0x65, 0x77, 0x61, 0x72, 0x65, 0x2e, 0x61, 0x63, 0x68, 0x69, 0x76, 0x65,
	0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x76, 0x31, 0x2e, 0x41, 0x63, 0x68, 0x69, 0x76, 0x65, 0x6d, 0x65,
	0x6e, 0x74, 0x52, 0x04, 0x49, 0x6e, 0x66, 0x6f, 0x32, 0xbf, 0x03, 0x0a, 0x0a, 0x4d, 0x69, 0x64,
	0x64, 0x6c, 0x65, 0x77, 0x61, 0x72, 0x65, 0x12, 0x9a, 0x01, 0x0a, 0x15, 0x45, 0x78, 0x70, 0x72,
	0x6f, 0x70, 0x72, 0x69, 0x61, 0x74, 0x65, 0x41, 0x63, 0x68, 0x69, 0x76, 0x65, 0x6d, 0x65, 0x6e,
	0x74, 0x12, 0x3e, 0x2e, 0x69, 0x6e, 0x73, 0x70, 0x69, 0x72, 0x65, 0x2e, 0x6d, 0x69, 0x64, 0x64,
	...
	,
	...
	0x76, 0x31, 0x2f, 0x61, 0x63, 0x68, 0x69, 0x76, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x62, 0x06, 0x70,
...
var file_npool_inspire_mw_v1_achivement_achivement_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_npool_inspire_mw_v1_achivement_achivement_proto_goTypes = []interface{}{
	...
	(*DeleteAchivementRequest)(nil),       // 7: inspire.middleware.achivement.v1.DeleteAchivementRequest
	(*DeleteAchivementResponse)(nil),      // 8: inspire.middleware.achivement.v1.DeleteAchivementResponse
...
var file_npool_inspire_mw_v1_achivement_achivement_proto_depIdxs = []int32{
	9,  // 0: inspire.middleware.achivement.v1.Conds.ID:type_name -> basetypes.v1.StringVal
	9,  // 1: inspire.middleware.achivement.v1.Conds.AppID:type_name -> basetypes.v1.StringVal
	9,  // 2: inspire.middleware.achivement.v1.Conds.UserID:type_name -> basetypes.v1.StringVal
	9,  // 3: inspire.middleware.achivement.v1.Conds.GoodID:type_name -> basetypes.v1.StringVal
	9,  // 4: inspire.middleware.achivement.v1.Conds.CoinTypeID:type_name -> basetypes.v1.StringVal
	10, // 5: inspire.middleware.achivement.v1.Conds.UserIDs:type_name -> basetypes.v1.StringSliceVal
	...
	0,  // 8: inspire.middleware.achivement.v1.DeleteAchivementRequest.Info:type_name -> inspire.middleware.achivement.v1.AchivementReq
	1,  // 9: inspire.middleware.achivement.v1.DeleteAchivementResponse.Info:type_name -> inspire.middleware.achivement.v1.Achivement
	3,  // 10: inspire.middleware.achivement.v1.Middleware.ExpropriateAchivement:input_type -> inspire.middleware.achivement.v1.ExpropriateAchivementRequest
	5,  // 11: inspire.middleware.achivement.v1.Middleware.GetAchivements:input_type -> inspire.middleware.achivement.v1.GetAchivementsRequest
	7,  // 12: inspire.middleware.achivement.v1.Middleware.DeleteAchivement:input_type -> inspire.middleware.achivement.v1.DeleteAchivementRequest
	4,  // 13: inspire.middleware.achivement.v1.Middleware.ExpropriateAchivement:output_type -> inspire.middleware.achivement.v1.ExpropriateAchivementResponse
	6,  // 14: inspire.middleware.achivement.v1.Middleware.GetAchivements:output_type -> inspire.middleware.achivement.v1.GetAchivementsResponse
	8,  // 15: inspire.middleware.achivement.v1.Middleware.DeleteAchivement:output_type -> inspire.middleware.achivement.v1.DeleteAchivementResponse
...
func file_npool_inspire_mw_v1_achivement_achivement_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_npool_inspire_mw_v1_achivement_achivement_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DeleteAchivementRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_npool_inspire_mw_v1_achivement_achivement_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DeleteAchivementResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
