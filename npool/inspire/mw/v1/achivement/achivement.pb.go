...
type Achivement struct {
	...
	// @inject_tag: sql:"total_untis"
	TotalUnits string `protobuf:"bytes,80,opt,name=TotalUnits,proto3" json:"TotalUnits,omitempty" sql:"total_untis"`
	// @inject_tag: sql:"self_units"
	SelfUnits string `protobuf:"bytes,90,opt,name=SelfUnits,proto3" json:"SelfUnits,omitempty" sql:"self_units"`
