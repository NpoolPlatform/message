...
func (c *gatewayClient) CreateAppConfig(ctx context.Context, in *CreateAppConfigRequest, opts ...grpc.CallOption) (*CreateAppConfigResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/inspire.gateway.app.config.v1.Gateway/CreateAppConfig", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gatewayClient) AdminCreateAppConfig(ctx context.Context, in *AdminCreateAppConfigRequest, opts ...grpc.CallOption) (*AdminCreateAppConfigResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/inspire.gateway.app.config.v1.Gateway/AdminCreateAppConfig", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gatewayClient) UpdateAppConfig(ctx context.Context, in *UpdateAppConfigRequest, opts ...grpc.CallOption) (*UpdateAppConfigResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/inspire.gateway.app.config.v1.Gateway/UpdateAppConfig", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gatewayClient) AdminUpdateAppConfig(ctx context.Context, in *AdminUpdateAppConfigRequest, opts ...grpc.CallOption) (*AdminUpdateAppConfigResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/inspire.gateway.app.config.v1.Gateway/AdminUpdateAppConfig", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gatewayClient) GetAppConfigs(ctx context.Context, in *GetAppConfigsRequest, opts ...grpc.CallOption) (*GetAppConfigsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/inspire.gateway.app.config.v1.Gateway/GetAppConfigs", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gatewayClient) AdminGetAppConfigs(ctx context.Context, in *AdminGetAppConfigsRequest, opts ...grpc.CallOption) (*AdminGetAppConfigsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/inspire.gateway.app.config.v1.Gateway/AdminGetAppConfigs", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Gateway_CreateAppConfig_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/inspire.gateway.app.config.v1.Gateway/CreateAppConfig",
	}
...
func _Gateway_AdminCreateAppConfig_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/inspire.gateway.app.config.v1.Gateway/AdminCreateAppConfig",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Gateway_UpdateAppConfig_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/inspire.gateway.app.config.v1.Gateway/UpdateAppConfig",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Gateway_AdminUpdateAppConfig_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/inspire.gateway.app.config.v1.Gateway/AdminUpdateAppConfig",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Gateway_GetAppConfigs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/inspire.gateway.app.config.v1.Gateway/GetAppConfigs",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Gateway_AdminGetAppConfigs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/inspire.gateway.app.config.v1.Gateway/AdminGetAppConfigs",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
