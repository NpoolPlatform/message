...
const (
	Gateway_GetCouponCoins_FullMethodName   = "/inspire.gateway.coupon.app.scope.v1.Gateway/GetCouponCoins"
	Gateway_CreateCouponCoin_FullMethodName = "/inspire.gateway.coupon.app.scope.v1.Gateway/CreateCouponCoin"
	Gateway_DeleteCouponCoin_FullMethodName = "/inspire.gateway.coupon.app.scope.v1.Gateway/DeleteCouponCoin"
)
