...
func (c *gatewayClient) GetCashControls(ctx context.Context, in *GetCashControlsRequest, opts ...grpc.CallOption) (*GetCashControlsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/inspire.gateway.coupon.app.cashcontrol.v1.Gateway/GetCashControls", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gatewayClient) CreateCashControl(ctx context.Context, in *CreateCashControlRequest, opts ...grpc.CallOption) (*CreateCashControlResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/inspire.gateway.coupon.app.cashcontrol.v1.Gateway/CreateCashControl", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gatewayClient) UpdateCashControl(ctx context.Context, in *UpdateCashControlRequest, opts ...grpc.CallOption) (*UpdateCashControlResponse, error) {
	out := new(UpdateCashControlResponse)
	err := c.cc.Invoke(ctx, "/inspire.gateway.coupon.app.cashcontrol.v1.Gateway/UpdateCashControl", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gatewayClient) DeleteCashControl(ctx context.Context, in *DeleteCashControlRequest, opts ...grpc.CallOption) (*DeleteCashControlResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/inspire.gateway.coupon.app.cashcontrol.v1.Gateway/DeleteCashControl", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gatewayClient) GetAppCashControls(ctx context.Context, in *GetAppCashControlsRequest, opts ...grpc.CallOption) (*GetAppCashControlsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/inspire.gateway.coupon.app.cashcontrol.v1.Gateway/GetAppCashControls", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Gateway_GetCashControls_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/inspire.gateway.coupon.app.cashcontrol.v1.Gateway/GetCashControls",
	}
...
func _Gateway_CreateCashControl_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/inspire.gateway.coupon.app.cashcontrol.v1.Gateway/CreateCashControl",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Gateway_UpdateCashControl_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateCashControlRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GatewayServer).UpdateCashControl(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/inspire.gateway.coupon.app.cashcontrol.v1.Gateway/UpdateCashControl",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GatewayServer).UpdateCashControl(ctx, req.(*UpdateCashControlRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Gateway_DeleteCashControl_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/inspire.gateway.coupon.app.cashcontrol.v1.Gateway/DeleteCashControl",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Gateway_GetAppCashControls_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/inspire.gateway.coupon.app.cashcontrol.v1.Gateway/GetAppCashControls",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Gateway_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Gateway_UpdateCashControl_Handler,
		},
		{
