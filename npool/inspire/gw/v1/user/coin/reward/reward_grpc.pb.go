...
func (c *gatewayClient) AdminGetUserCoinRewards(ctx context.Context, in *AdminGetUserCoinRewardsRequest, opts ...grpc.CallOption) (*AdminGetUserCoinRewardsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/inspire.gateway.user.coin.reward.v1.Gateway/AdminGetUserCoinRewards", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gatewayClient) GetMyCoinRewards(ctx context.Context, in *GetMyCoinRewardsRequest, opts ...grpc.CallOption) (*GetMyCoinRewardsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/inspire.gateway.user.coin.reward.v1.Gateway/GetMyCoinRewards", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Gateway_AdminGetUserCoinRewards_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/inspire.gateway.user.coin.reward.v1.Gateway/AdminGetUserCoinRewards",
	}
...
func _Gateway_GetMyCoinRewards_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/inspire.gateway.user.coin.reward.v1.Gateway/GetMyCoinRewards",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
