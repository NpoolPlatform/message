...
type CreateTestPlanTestCaseRequest struct {
	...
	TestCaseResult testcase.TestCaseResult `protobuf:"varint,70,opt,name=TestCaseResult,proto3,enum=smoketest.manager.testplan.testcase.v1.TestCaseResult" json:"TestCaseResult,omitempty"`
...
func (x *CreateTestPlanTestCaseRequest) GetTestCaseResult() testcase.TestCaseResult {
	if x != nil {
...
var file_npool_smoketest_gw_v1_testplan_testcase_testcase_proto_rawDesc = []byte{
	...
	0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xc6, 0x03, 0x0a, 0x1d, 0x43, 0x72, 0x65, 0x61,
	...
	0x55, 0x73, 0x65, 0x72, 0x49, 0x44, 0x88, 0x01, 0x01, 0x12, 0x5e, 0x0a, 0x0e, 0x54, 0x65, 0x73,
	0x74, 0x43, 0x61, 0x73, 0x65, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x18, 0x46, 0x20, 0x01, 0x28,
	...
	0x61, 0x73, 0x65, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x12, 0x19, 0x0a, 0x05, 0x49, 0x6e, 0x64,
...
var file_npool_smoketest_gw_v1_testplan_testcase_testcase_proto_depIdxs = []int32{
	10, // 0: smoketest.gateway.testplan.testcase.v1.CreateTestPlanTestCaseRequest.TestCaseResult:type_name -> smoketest.manager.testplan.testcase.v1.TestCaseResult
