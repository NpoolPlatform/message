...
var file_npool_smoketest_gw_v1_testplan_testplan_proto_depIdxs = []int32{
	...
	10, // 6: smoketest.gateway.testplan.v1.UpdateTestPlanRequest.Result:type_name -> smoketest.middleware.testplan.v1.TestResultState
	0,  // 7: smoketest.gateway.testplan.v1.UpdateTestPlanResponse.Info:type_name -> smoketest.gateway.testplan.v1.TestPlan
	0,  // 8: smoketest.gateway.testplan.v1.CreateTestPlanResponse.Info:type_name -> smoketest.gateway.testplan.v1.TestPlan
	7,  // 9: smoketest.gateway.testplan.v1.Gateway.CreateTestPlan:input_type -> smoketest.gateway.testplan.v1.CreateTestPlanRequest
	1,  // 10: smoketest.gateway.testplan.v1.Gateway.DeleteTestPlan:input_type -> smoketest.gateway.testplan.v1.DeleteTestPlanRequest
	5,  // 11: smoketest.gateway.testplan.v1.Gateway.UpdateTestPlan:input_type -> smoketest.gateway.testplan.v1.UpdateTestPlanRequest
	3,  // 12: smoketest.gateway.testplan.v1.Gateway.GetTestPlans:input_type -> smoketest.gateway.testplan.v1.GetTestPlansRequest
	8,  // 13: smoketest.gateway.testplan.v1.Gateway.CreateTestPlan:output_type -> smoketest.gateway.testplan.v1.CreateTestPlanResponse
	2,  // 14: smoketest.gateway.testplan.v1.Gateway.DeleteTestPlan:output_type -> smoketest.gateway.testplan.v1.DeleteTestPlanResponse
	6,  // 15: smoketest.gateway.testplan.v1.Gateway.UpdateTestPlan:output_type -> smoketest.gateway.testplan.v1.UpdateTestPlanResponse
	4,  // 16: smoketest.gateway.testplan.v1.Gateway.GetTestPlans:output_type -> smoketest.gateway.testplan.v1.GetTestPlansResponse
