...
const (
	Gateway_CreatePlanTestCase_FullMethodName = "/smoketest.gateway.testplan.plantestcase.v1.Gateway/CreatePlanTestCase"
	Gateway_DeletePlanTestCase_FullMethodName = "/smoketest.gateway.testplan.plantestcase.v1.Gateway/DeletePlanTestCase"
	Gateway_UpdatePlanTestCase_FullMethodName = "/smoketest.gateway.testplan.plantestcase.v1.Gateway/UpdatePlanTestCase"
	Gateway_GetPlanTestCases_FullMethodName   = "/smoketest.gateway.testplan.plantestcase.v1.Gateway/GetPlanTestCases"
)
...
func (c *gatewayClient) CreatePlanTestCase(ctx context.Context, in *CreatePlanTestCaseRequest, opts ...grpc.CallOption) (*CreatePlanTestCaseResponse, error) {
	...
	err := c.cc.Invoke(ctx, Gateway_CreatePlanTestCase_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gatewayClient) DeletePlanTestCase(ctx context.Context, in *DeletePlanTestCaseRequest, opts ...grpc.CallOption) (*DeletePlanTestCaseResponse, error) {
	...
	err := c.cc.Invoke(ctx, Gateway_DeletePlanTestCase_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gatewayClient) UpdatePlanTestCase(ctx context.Context, in *UpdatePlanTestCaseRequest, opts ...grpc.CallOption) (*UpdatePlanTestCaseResponse, error) {
	...
	err := c.cc.Invoke(ctx, Gateway_UpdatePlanTestCase_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gatewayClient) GetPlanTestCases(ctx context.Context, in *GetPlanTestCasesRequest, opts ...grpc.CallOption) (*GetPlanTestCasesResponse, error) {
	...
	err := c.cc.Invoke(ctx, Gateway_GetPlanTestCases_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Gateway_CreatePlanTestCase_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Gateway_CreatePlanTestCase_FullMethodName,
	}
...
func _Gateway_DeletePlanTestCase_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Gateway_DeletePlanTestCase_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Gateway_UpdatePlanTestCase_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Gateway_UpdatePlanTestCase_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Gateway_GetPlanTestCases_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Gateway_GetPlanTestCases_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
