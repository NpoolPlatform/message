...
var file_npool_smoketest_mw_v1_testcase_testcase_proto_rawDesc = []byte{
	...
	0x65, 0x64, 0x32, 0x09, 0x0a, 0x07, 0x4d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x72, 0x42, 0x41, 0x5a,
...
var file_npool_smoketest_mw_v1_testcase_testcase_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_npool_smoketest_mw_v1_testcase_testcase_proto_goTypes = []interface{}{
	...
	(*npool.StringVal)(nil), // 1: npool.v1.StringVal
	(*npool.BoolVal)(nil),   // 2: npool.v1.BoolVal
}
var file_npool_smoketest_mw_v1_testcase_testcase_proto_depIdxs = []int32{
	1, // 0: smoketest.middleware.testcase.v1.Conds.ID:type_name -> npool.v1.StringVal
	1, // 1: smoketest.middleware.testcase.v1.Conds.ModuleID:type_name -> npool.v1.StringVal
	1, // 2: smoketest.middleware.testcase.v1.Conds.ApiID:type_name -> npool.v1.StringVal
	1, // 3: smoketest.middleware.testcase.v1.Conds.TestcaseType:type_name -> npool.v1.StringVal
	2, // 4: smoketest.middleware.testcase.v1.Conds.Deprecated:type_name -> npool.v1.BoolVal
