...
func (x *DeleteTestPlanRequest) GetConds() *testplan.Conds {
	if x != nil {
		return x.Conds
	}
	return nil
...
var file_npool_smoketest_mw_v1_testplan_testplan_proto_rawDesc = []byte{
	...
	0x73, 0x22, 0x55, 0x0a, 0x16, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x54, 0x65, 0x73, 0x74, 0x50,
	...
	0x61, 0x6e, 0x52, 0x04, 0x49, 0x6e, 0x66, 0x6f, 0x32, 0xb3, 0x07, 0x0a, 0x0a, 0x4d, 0x69, 0x64,
	...
	0x65, 0x2e, 0x74, 0x65, 0x73, 0x74, 0x70, 0x6c, 0x61, 0x6e, 0x2e, 0x76, 0x31, 0x2e, 0x43, 0x72,
...
var file_npool_smoketest_mw_v1_testplan_testplan_proto_depIdxs = []int32{
	...
	16, // 9: smoketest.middleware.testplan.v1.DeleteTestPlanRequest.Conds:type_name -> smoketest.manager.testplan.v1.Conds
	15, // 10: smoketest.middleware.testplan.v1.DeleteTestPlanResponse.Info:type_name -> smoketest.manager.testplan.v1.TestPlan
	0,  // 11: smoketest.middleware.testplan.v1.Middleware.CreateTestPlan:input_type -> smoketest.middleware.testplan.v1.CreateTestPlanRequest
	2,  // 12: smoketest.middleware.testplan.v1.Middleware.UpdateTestPlan:input_type -> smoketest.middleware.testplan.v1.UpdateTestPlanRequest
	4,  // 13: smoketest.middleware.testplan.v1.Middleware.GetTestPlan:input_type -> smoketest.middleware.testplan.v1.GetTestPlanRequest
	8,  // 14: smoketest.middleware.testplan.v1.Middleware.GetTestPlanOnly:input_type -> smoketest.middleware.testplan.v1.GetTestPlanOnlyRequest
	6,  // 15: smoketest.middleware.testplan.v1.Middleware.GetTestPlans:input_type -> smoketest.middleware.testplan.v1.GetTestPlansRequest
	10, // 16: smoketest.middleware.testplan.v1.Middleware.ExistTestPlan:input_type -> smoketest.middleware.testplan.v1.ExistTestPlanRequest
	12, // 17: smoketest.middleware.testplan.v1.Middleware.DeleteTestPlan:input_type -> smoketest.middleware.testplan.v1.DeleteTestPlanRequest
	1,  // 18: smoketest.middleware.testplan.v1.Middleware.CreateTestPlan:output_type -> smoketest.middleware.testplan.v1.CreateTestPlanResponse
	3,  // 19: smoketest.middleware.testplan.v1.Middleware.UpdateTestPlan:output_type -> smoketest.middleware.testplan.v1.UpdateTestPlanResponse
	5,  // 20: smoketest.middleware.testplan.v1.Middleware.GetTestPlan:output_type -> smoketest.middleware.testplan.v1.GetTestPlanResponse
	9,  // 21: smoketest.middleware.testplan.v1.Middleware.GetTestPlanOnly:output_type -> smoketest.middleware.testplan.v1.GetTestPlanOnlyResponse
	7,  // 22: smoketest.middleware.testplan.v1.Middleware.GetTestPlans:output_type -> smoketest.middleware.testplan.v1.GetTestPlansResponse
	11, // 23: smoketest.middleware.testplan.v1.Middleware.ExistTestPlan:output_type -> smoketest.middleware.testplan.v1.ExistTestPlanResponse
	13, // 24: smoketest.middleware.testplan.v1.Middleware.DeleteTestPlan:output_type -> smoketest.middleware.testplan.v1.DeleteTestPlanResponse
