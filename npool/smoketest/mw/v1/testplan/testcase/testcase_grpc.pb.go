...
func (c *middlewareClient) GetTestCaseOnly(ctx context.Context, in *GetTestCaseOnlyRequest, opts ...grpc.CallOption) (*GetTestCaseOnlyResponse, error) {
	out := new(GetTestCaseOnlyResponse)
	err := c.cc.Invoke(ctx, "/smoketest.middleware.TestCase.v1.Middleware/GetTestCaseOnly", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMiddlewareServer) GetTestCaseOnly(context.Context, *GetTestCaseOnlyRequest) (*GetTestCaseOnlyResponse, error) {
...
func _Middleware_GetTestCaseOnly_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetTestCaseOnlyRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MiddlewareServer).GetTestCaseOnly(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/smoketest.middleware.TestCase.v1.Middleware/GetTestCaseOnly",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MiddlewareServer).GetTestCaseOnly(ctx, req.(*GetTestCaseOnlyRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Middleware_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Middleware_GetTestCaseOnly_Handler,
		},
		{
	...
	Metadata: "npool/smoketest/mw/v1/testplan/testcase/testcase.proto",
}
