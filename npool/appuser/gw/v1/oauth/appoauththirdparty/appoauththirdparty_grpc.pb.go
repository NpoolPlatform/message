...
func (c *gatewayClient) CreateOAuthThirdParty(ctx context.Context, in *CreateOAuthThirdPartyRequest, opts ...grpc.CallOption) (*CreateOAuthThirdPartyResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/appuser.gateway.oauth.appoauththirdparty.v1.Gateway/CreateOAuthThirdParty", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gatewayClient) UpdateOAuthThirdParty(ctx context.Context, in *UpdateOAuthThirdPartyRequest, opts ...grpc.CallOption) (*UpdateOAuthThirdPartyResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/appuser.gateway.oauth.appoauththirdparty.v1.Gateway/UpdateOAuthThirdParty", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gatewayClient) DeleteOAuthThirdParty(ctx context.Context, in *DeleteOAuthThirdPartyRequest, opts ...grpc.CallOption) (*DeleteOAuthThirdPartyResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/appuser.gateway.oauth.appoauththirdparty.v1.Gateway/DeleteOAuthThirdParty", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gatewayClient) GetOAuthThirdParties(ctx context.Context, in *GetOAuthThirdPartiesRequest, opts ...grpc.CallOption) (*GetOAuthThirdPartiesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/appuser.gateway.oauth.appoauththirdparty.v1.Gateway/GetOAuthThirdParties", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gatewayClient) GetAppOAuthThirdParties(ctx context.Context, in *GetAppOAuthThirdPartiesRequest, opts ...grpc.CallOption) (*GetAppOAuthThirdPartiesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/appuser.gateway.oauth.appoauththirdparty.v1.Gateway/GetAppOAuthThirdParties", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Gateway_CreateOAuthThirdParty_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/appuser.gateway.oauth.appoauththirdparty.v1.Gateway/CreateOAuthThirdParty",
	}
...
func _Gateway_UpdateOAuthThirdParty_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/appuser.gateway.oauth.appoauththirdparty.v1.Gateway/UpdateOAuthThirdParty",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Gateway_DeleteOAuthThirdParty_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/appuser.gateway.oauth.appoauththirdparty.v1.Gateway/DeleteOAuthThirdParty",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Gateway_GetOAuthThirdParties_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/appuser.gateway.oauth.appoauththirdparty.v1.Gateway/GetOAuthThirdParties",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Gateway_GetAppOAuthThirdParties_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/appuser.gateway.oauth.appoauththirdparty.v1.Gateway/GetAppOAuthThirdParties",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
