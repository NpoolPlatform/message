...
func (c *gatewayClient) DeleteUser(ctx context.Context, in *DeleteUserRequest, opts ...grpc.CallOption) (*DeleteUserResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/appuser.gateway.user.v1.Gateway/DeleteUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gatewayClient) UpdateAppUser(ctx context.Context, in *UpdateAppUserRequest, opts ...grpc.CallOption) (*UpdateAppUserResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/appuser.gateway.user.v1.Gateway/UpdateAppUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gatewayClient) PreResetUser(ctx context.Context, in *PreResetUserRequest, opts ...grpc.CallOption) (*PreResetUserResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/appuser.gateway.user.v1.Gateway/PreResetUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gatewayClient) BindUser(ctx context.Context, in *BindUserRequest, opts ...grpc.CallOption) (*BindUserResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/appuser.gateway.user.v1.Gateway/BindUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gatewayClient) UnbindOAuth(ctx context.Context, in *UnbindOAuthRequest, opts ...grpc.CallOption) (*UnbindOAuthResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/appuser.gateway.user.v1.Gateway/UnbindOAuth", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Gateway_DeleteUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/appuser.gateway.user.v1.Gateway/DeleteUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Gateway_UpdateAppUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/appuser.gateway.user.v1.Gateway/UpdateAppUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Gateway_PreResetUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/appuser.gateway.user.v1.Gateway/PreResetUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Gateway_BindUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/appuser.gateway.user.v1.Gateway/BindUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Gateway_UnbindOAuth_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/appuser.gateway.user.v1.Gateway/UnbindOAuth",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
