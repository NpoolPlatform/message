...
const (
	Gateway_CreateOAuthThirdParty_FullMethodName   = "/appuser.gateway.authing.oauth.appoauththirdparty.v1.Gateway/CreateOAuthThirdParty"
	Gateway_UpdateOAuthThirdParty_FullMethodName   = "/appuser.gateway.authing.oauth.appoauththirdparty.v1.Gateway/UpdateOAuthThirdParty"
	Gateway_DeleteOAuthThirdParty_FullMethodName   = "/appuser.gateway.authing.oauth.appoauththirdparty.v1.Gateway/DeleteOAuthThirdParty"
	Gateway_GetOAuthThirdParties_FullMethodName    = "/appuser.gateway.authing.oauth.appoauththirdparty.v1.Gateway/GetOAuthThirdParties"
	Gateway_GetAppOAuthThirdParties_FullMethodName = "/appuser.gateway.authing.oauth.appoauththirdparty.v1.Gateway/GetAppOAuthThirdParties"
)
...
func (c *gatewayClient) DeleteOAuthThirdParty(ctx context.Context, in *DeleteOAuthThirdPartyRequest, opts ...grpc.CallOption) (*DeleteOAuthThirdPartyResponse, error) {
	...
	err := c.cc.Invoke(ctx, Gateway_DeleteOAuthThirdParty_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gatewayClient) GetOAuthThirdParties(ctx context.Context, in *GetOAuthThirdPartiesRequest, opts ...grpc.CallOption) (*GetOAuthThirdPartiesResponse, error) {
	...
	err := c.cc.Invoke(ctx, Gateway_GetOAuthThirdParties_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gatewayClient) GetAppOAuthThirdParties(ctx context.Context, in *GetAppOAuthThirdPartiesRequest, opts ...grpc.CallOption) (*GetAppOAuthThirdPartiesResponse, error) {
	out := new(GetAppOAuthThirdPartiesResponse)
	err := c.cc.Invoke(ctx, Gateway_GetAppOAuthThirdParties_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedGatewayServer) GetAppOAuthThirdParties(context.Context, *GetAppOAuthThirdPartiesRequest) (*GetAppOAuthThirdPartiesResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAppOAuthThirdParties not implemented")
}
...
func _Gateway_CreateOAuthThirdParty_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Gateway_CreateOAuthThirdParty_FullMethodName,
	}
...
func _Gateway_DeleteOAuthThirdParty_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Gateway_DeleteOAuthThirdParty_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Gateway_GetOAuthThirdParties_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Gateway_GetOAuthThirdParties_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Gateway_GetAppOAuthThirdParties_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetAppOAuthThirdPartiesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GatewayServer).GetAppOAuthThirdParties(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Gateway_GetAppOAuthThirdParties_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GatewayServer).GetAppOAuthThirdParties(ctx, req.(*GetAppOAuthThirdPartiesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Gateway_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "appuser.gateway.authing.oauth.appoauththirdparty.v1.Gateway",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetAppOAuthThirdParties",
			Handler:    _Gateway_GetAppOAuthThirdParties_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "npool/appuser/gw/v1/authing/oauth/appoauththirdparty/appoauththirdparty.proto",
}
