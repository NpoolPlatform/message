...
var file_npool_appuser_gw_v1_authing_oauth_oauththirdparty_oauththirdparty_proto_rawDesc = []byte{
	...
	,
	...
	0x01, 0x2a, 0x12, 0xbf, 0x01, 0x0a, 0x15, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x4f, 0x41, 0x75,
	...
	0x79, 0x3a, 0x01, 0x2a, 0x12, 0xbf, 0x01, 0x0a, 0x15, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x4f,
	...
	0x72, 0x74, 0x79, 0x3a, 0x01, 0x2a, 0x12, 0xbb, 0x01, 0x0a, 0x14, 0x47, 0x65, 0x74, 0x4f, 0x41,
...
var file_npool_appuser_gw_v1_authing_oauth_oauththirdparty_oauththirdparty_proto_depIdxs = []int32{
	8,  // 0: appuser.gateway.authing.oauth.v1.CreateOAuthThirdPartyRequest.ClientName:type_name -> basetypes.v1.SignMethod
	9,  // 1: appuser.gateway.authing.oauth.v1.CreateOAuthThirdPartyResponse.Info:type_name -> appuser.middleware.authing.oauth.oauththirdparty.v1.OAuthThirdParty
	8,  // 2: appuser.gateway.authing.oauth.v1.UpdateOAuthThirdPartyRequest.ClientName:type_name -> basetypes.v1.SignMethod
	9,  // 3: appuser.gateway.authing.oauth.v1.UpdateOAuthThirdPartyResponse.Info:type_name -> appuser.middleware.authing.oauth.oauththirdparty.v1.OAuthThirdParty
	9,  // 4: appuser.gateway.authing.oauth.v1.DeleteOAuthThirdPartyResponse.Info:type_name -> appuser.middleware.authing.oauth.oauththirdparty.v1.OAuthThirdParty
	9,  // 5: appuser.gateway.authing.oauth.v1.GetOAuthThirdPartiesResponse.Infos:type_name -> appuser.middleware.authing.oauth.oauththirdparty.v1.OAuthThirdParty
	0,  // 6: appuser.gateway.authing.oauth.v1.Gateway.CreateOAuthThirdParty:input_type -> appuser.gateway.authing.oauth.v1.CreateOAuthThirdPartyRequest
	2,  // 7: appuser.gateway.authing.oauth.v1.Gateway.UpdateOAuthThirdParty:input_type -> appuser.gateway.authing.oauth.v1.UpdateOAuthThirdPartyRequest
	4,  // 8: appuser.gateway.authing.oauth.v1.Gateway.DeleteOAuthThirdParty:input_type -> appuser.gateway.authing.oauth.v1.DeleteOAuthThirdPartyRequest
	6,  // 9: appuser.gateway.authing.oauth.v1.Gateway.GetOAuthThirdParties:input_type -> appuser.gateway.authing.oauth.v1.GetOAuthThirdPartiesRequest
	...
	5,  // 12: appuser.gateway.authing.oauth.v1.Gateway.DeleteOAuthThirdParty:output_type -> appuser.gateway.authing.oauth.v1.DeleteOAuthThirdPartyResponse
	7,  // 13: appuser.gateway.authing.oauth.v1.Gateway.GetOAuthThirdParties:output_type -> appuser.gateway.authing.oauth.v1.GetOAuthThirdPartiesResponse
