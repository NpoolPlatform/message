...
const (
	Middleware_CreateHistory_FullMethodName = "/appuser.middleware.authing.history.v1.Middleware/CreateHistory"
	Middleware_GetHistories_FullMethodName  = "/appuser.middleware.authing.history.v1.Middleware/GetHistories"
)
