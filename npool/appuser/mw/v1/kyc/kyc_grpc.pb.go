...
const (
	Middleware_CreateKyc_FullMethodName = "/appuser.middleware.kyc.v1.Middleware/CreateKyc"
	Middleware_UpdateKyc_FullMethodName = "/appuser.middleware.kyc.v1.Middleware/UpdateKyc"
	Middleware_GetKyc_FullMethodName    = "/appuser.middleware.kyc.v1.Middleware/GetKyc"
	Middleware_GetKycs_FullMethodName   = "/appuser.middleware.kyc.v1.Middleware/GetKycs"
	Middleware_DeleteKyc_FullMethodName = "/appuser.middleware.kyc.v1.Middleware/DeleteKyc"
)
...
func (c *middlewareClient) CreateKyc(ctx context.Context, in *CreateKycRequest, opts ...grpc.CallOption) (*CreateKycResponse, error) {
	...
	err := c.cc.Invoke(ctx, Middleware_CreateKyc_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *middlewareClient) UpdateKyc(ctx context.Context, in *UpdateKycRequest, opts ...grpc.CallOption) (*UpdateKycResponse, error) {
	...
	err := c.cc.Invoke(ctx, Middleware_UpdateKyc_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *middlewareClient) GetKyc(ctx context.Context, in *GetKycRequest, opts ...grpc.CallOption) (*GetKycResponse, error) {
	...
	err := c.cc.Invoke(ctx, Middleware_GetKyc_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *middlewareClient) GetKycs(ctx context.Context, in *GetKycsRequest, opts ...grpc.CallOption) (*GetKycsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Middleware_GetKycs_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *middlewareClient) DeleteKyc(ctx context.Context, in *DeleteKycRequest, opts ...grpc.CallOption) (*DeleteKycResponse, error) {
	...
	err := c.cc.Invoke(ctx, Middleware_DeleteKyc_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Middleware_CreateKyc_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Middleware_CreateKyc_FullMethodName,
	}
...
func _Middleware_UpdateKyc_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Middleware_UpdateKyc_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Middleware_GetKyc_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Middleware_GetKyc_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Middleware_GetKycs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Middleware_GetKycs_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Middleware_DeleteKyc_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Middleware_DeleteKyc_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
