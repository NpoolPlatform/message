...
const (
	Middleware_CreateDetail_FullMethodName  = "/ledger.middleware.mining.detail.v2.Middleware/CreateDetail"
	Middleware_GetDetailOnly_FullMethodName = "/ledger.middleware.mining.detail.v2.Middleware/GetDetailOnly"
	Middleware_GetDetails_FullMethodName    = "/ledger.middleware.mining.detail.v2.Middleware/GetDetails"
)
