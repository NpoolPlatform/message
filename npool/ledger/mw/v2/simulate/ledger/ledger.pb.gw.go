...
func RegisterMiddlewareHandlerServer(ctx context.Context, mux *runtime.ServeMux, server MiddlewareServer) error {
	...
	mux.Handle("POST", pattern_Middleware_GetLedger_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/ledger.middleware.simulate.ledger.v2.Middleware/GetLedger", runtime.WithHTTPPathPattern("/v1/simulate/ledger_GetLedger"))
		if err != nil {
	...
	mux.Handle("POST", pattern_Middleware_GetLedgers_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/ledger.middleware.simulate.ledger.v2.Middleware/GetLedgers", runtime.WithHTTPPathPattern("/v1/simulate/ledger_GetLedgers"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterMiddlewareHandlerClient(ctx context.Context, mux *runtime.ServeMux, client MiddlewareClient) error {
	...
	mux.Handle("POST", pattern_Middleware_GetLedger_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/ledger.middleware.simulate.ledger.v2.Middleware/GetLedger", runtime.WithHTTPPathPattern("/v1/simulate/ledger_GetLedger"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_Middleware_GetLedgers_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/ledger.middleware.simulate.ledger.v2.Middleware/GetLedgers", runtime.WithHTTPPathPattern("/v1/simulate/ledger_GetLedgers"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_Middleware_GetLedger_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "simulate", "ledger_GetLedger"}, ""))

	pattern_Middleware_GetLedgers_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "simulate", "ledger_GetLedgers"}, ""))
)
