...
func (c *middlewareClient) GetStatements(ctx context.Context, in *GetStatementsRequest, opts ...grpc.CallOption) (*GetStatementsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ledger.middleware.ledger.statement.v2.Middleware/GetStatements", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *middlewareClient) GetStatement(ctx context.Context, in *GetStatementRequest, opts ...grpc.CallOption) (*GetStatementResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ledger.middleware.ledger.statement.v2.Middleware/GetStatement", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *middlewareClient) ExistStatementConds(ctx context.Context, in *ExistStatementCondsRequest, opts ...grpc.CallOption) (*ExistStatementCondsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ledger.middleware.ledger.statement.v2.Middleware/ExistStatementConds", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *middlewareClient) CreateStatements(ctx context.Context, in *CreateStatementsRequest, opts ...grpc.CallOption) (*CreateStatementsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ledger.middleware.ledger.statement.v2.Middleware/CreateStatements", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *middlewareClient) DeleteStatements(ctx context.Context, in *DeleteStatementsRequest, opts ...grpc.CallOption) (*DeleteStatementsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ledger.middleware.ledger.statement.v2.Middleware/DeleteStatements", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *middlewareClient) CreateStatement(ctx context.Context, in *CreateStatementRequest, opts ...grpc.CallOption) (*CreateStatementResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ledger.middleware.ledger.statement.v2.Middleware/CreateStatement", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *middlewareClient) DeleteStatement(ctx context.Context, in *DeleteStatementRequest, opts ...grpc.CallOption) (*DeleteStatementResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ledger.middleware.ledger.statement.v2.Middleware/DeleteStatement", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Middleware_GetStatements_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ledger.middleware.ledger.statement.v2.Middleware/GetStatements",
	}
...
func _Middleware_GetStatement_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ledger.middleware.ledger.statement.v2.Middleware/GetStatement",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Middleware_ExistStatementConds_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ledger.middleware.ledger.statement.v2.Middleware/ExistStatementConds",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Middleware_CreateStatements_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ledger.middleware.ledger.statement.v2.Middleware/CreateStatements",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Middleware_DeleteStatements_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ledger.middleware.ledger.statement.v2.Middleware/DeleteStatements",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Middleware_CreateStatement_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ledger.middleware.ledger.statement.v2.Middleware/CreateStatement",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Middleware_DeleteStatement_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ledger.middleware.ledger.statement.v2.Middleware/DeleteStatement",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
