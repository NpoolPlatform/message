...
var file_npool_ledger_mw_v2_ledger_ledger_proto_rawDesc = []byte{
	...
	0x05, 0x54, 0x6f, 0x74, 0x61, 0x6c, 0x22, 0x4f, 0x0a, 0x11, 0x41, 0x64, 0x64, 0x42, 0x61, 0x6c,
	...
	0x64, 0x67, 0x65, 0x72, 0x2e, 0x6d, 0x69, 0x64, 0x64, 0x6c, 0x65, 0x77, 0x61, 0x72, 0x65, 0x2e,
	0x6c, 0x65, 0x64, 0x67, 0x65, 0x72, 0x2e, 0x76, 0x32, 0x2e, 0x4c, 0x65, 0x64, 0x67, 0x65, 0x72,
	0x52, 0x04, 0x49, 0x6e, 0x66, 0x6f, 0x32, 0xcd, 0x03, 0x0a, 0x0a, 0x4d, 0x69, 0x64, 0x64, 0x6c,
	...
	0x65, 0x22, 0x00, 0x12, 0x6f, 0x0a, 0x0a, 0x47, 0x65, 0x74, 0x4c, 0x65, 0x64, 0x67, 0x65, 0x72,
	...
	0x65, 0x77, 0x61, 0x72, 0x65, 0x2e, 0x6c, 0x65, 0x64, 0x67, 0x65, 0x72, 0x2e, 0x76, 0x32, 0x2e,
	0x47, 0x65, 0x74, 0x4c, 0x65, 0x64, 0x67, 0x65, 0x72, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x22, 0x00, 0x12, 0x6f, 0x0a, 0x0a, 0x41, 0x64, 0x64, 0x42, 0x61, 0x6c, 0x61, 0x6e,
	...
	0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x6f, 0x0a, 0x0a, 0x53, 0x75, 0x62, 0x42, 0x61, 0x6c, 0x61,
	...
	0x32, 0x2e, 0x53, 0x75, 0x62, 0x42, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x1a, 0x2f, 0x2e, 0x6c, 0x65, 0x64, 0x67, 0x65, 0x72, 0x2e, 0x6d, 0x69, 0x64,
	0x64, 0x6c, 0x65, 0x77, 0x61, 0x72, 0x65, 0x2e, 0x6c, 0x65, 0x64, 0x67, 0x65, 0x72, 0x2e, 0x76,
	0x32, 0x2e, 0x53, 0x75, 0x62, 0x42, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x52, 0x65, 0x73, 0x70,
...
var file_npool_ledger_mw_v2_ledger_ledger_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_npool_ledger_mw_v2_ledger_ledger_proto_goTypes = []interface{}{
	...
	(*AddBalanceRequest)(nil),  // 7: ledger.middleware.ledger.v2.AddBalanceRequest
	(*AddBalanceResponse)(nil), // 8: ledger.middleware.ledger.v2.AddBalanceResponse
	(*SubBalanceRequest)(nil),  // 9: ledger.middleware.ledger.v2.SubBalanceRequest
	(*SubBalanceResponse)(nil), // 10: ledger.middleware.ledger.v2.SubBalanceResponse
...
var file_npool_ledger_mw_v2_ledger_ledger_proto_depIdxs = []int32{
	11, // 0: ledger.middleware.ledger.v2.LedgerReq.IOSubType:type_name -> basetypes.ledger.v1.IOSubType
	12, // 1: ledger.middleware.ledger.v2.Conds.ID:type_name -> basetypes.v1.StringVal
	12, // 2: ledger.middleware.ledger.v2.Conds.AppID:type_name -> basetypes.v1.StringVal
	12, // 3: ledger.middleware.ledger.v2.Conds.UserID:type_name -> basetypes.v1.StringVal
	12, // 4: ledger.middleware.ledger.v2.Conds.CoinTypeID:type_name -> basetypes.v1.StringVal
	13, // 5: ledger.middleware.ledger.v2.Conds.CoinTypeIDs:type_name -> basetypes.v1.StringSliceVal
	...
	0,  // 9: ledger.middleware.ledger.v2.AddBalanceRequest.Info:type_name -> ledger.middleware.ledger.v2.LedgerReq
	1,  // 10: ledger.middleware.ledger.v2.AddBalanceResponse.Info:type_name -> ledger.middleware.ledger.v2.Ledger
	0,  // 11: ledger.middleware.ledger.v2.SubBalanceRequest.Info:type_name -> ledger.middleware.ledger.v2.LedgerReq
	1,  // 12: ledger.middleware.ledger.v2.SubBalanceResponse.Info:type_name -> ledger.middleware.ledger.v2.Ledger
	3,  // 13: ledger.middleware.ledger.v2.Middleware.GetLedger:input_type -> ledger.middleware.ledger.v2.GetLedgerRequest
	5,  // 14: ledger.middleware.ledger.v2.Middleware.GetLedgers:input_type -> ledger.middleware.ledger.v2.GetLedgersRequest
	7,  // 15: ledger.middleware.ledger.v2.Middleware.AddBalance:input_type -> ledger.middleware.ledger.v2.AddBalanceRequest
	9,  // 16: ledger.middleware.ledger.v2.Middleware.SubBalance:input_type -> ledger.middleware.ledger.v2.SubBalanceRequest
	4,  // 17: ledger.middleware.ledger.v2.Middleware.GetLedger:output_type -> ledger.middleware.ledger.v2.GetLedgerResponse
	6,  // 18: ledger.middleware.ledger.v2.Middleware.GetLedgers:output_type -> ledger.middleware.ledger.v2.GetLedgersResponse
	8,  // 19: ledger.middleware.ledger.v2.Middleware.AddBalance:output_type -> ledger.middleware.ledger.v2.AddBalanceResponse
	10, // 20: ledger.middleware.ledger.v2.Middleware.SubBalance:output_type -> ledger.middleware.ledger.v2.SubBalanceResponse
