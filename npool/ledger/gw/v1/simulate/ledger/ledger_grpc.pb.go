...
const (
	Gateway_GetLedgers_FullMethodName    = "/ledger.gateway.simulate.ledger.v1.Gateway/GetLedgers"
	Gateway_GetAppLedgers_FullMethodName = "/ledger.gateway.simulate.ledger.v1.Gateway/GetAppLedgers"
)
