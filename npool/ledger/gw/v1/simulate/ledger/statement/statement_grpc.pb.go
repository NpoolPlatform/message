...
const (
	Gateway_GetStatements_FullMethodName    = "/ledger.gateway.simulate.ledger.statement.v1.Gateway/GetStatements"
	Gateway_GetAppStatements_FullMethodName = "/ledger.gateway.simulate.ledger.statement.v1.Gateway/GetAppStatements"
)
