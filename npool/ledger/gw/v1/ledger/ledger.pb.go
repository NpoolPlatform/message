...
var file_npool_ledger_gw_v1_ledger_ledger_proto_rawDesc = []byte{
	...
	0x69, 0x6d, 0x69, 0x74, 0x32, 0xc0, 0x0e, 0x0a, 0x07, 0x47, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79,
	0x12, 0x89, 0x01, 0x0a, 0x0b, 0x47, 0x65, 0x74, 0x47, 0x65, 0x6e, 0x65, 0x72, 0x61, 0x6c, 0x73,
	0x12, 0x2d, 0x2e, 0x6c, 0x65, 0x64, 0x67, 0x65, 0x72, 0x2e, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61,
	...
	0x2e, 0x2e, 0x6c, 0x65, 0x64, 0x67, 0x65, 0x72, 0x2e, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79,
	...
	,
	...
	0x73, 0x66, 0x65, 0x72, 0x3a, 0x01, 0x2a, 0x42, 0x3c, 0x5a, 0x3a, 0x67, 0x69, 0x74, 0x68, 0x75,
...
var file_npool_ledger_gw_v1_ledger_ledger_proto_msgTypes = make([]protoimpl.MessageInfo, 30)
var file_npool_ledger_gw_v1_ledger_ledger_proto_goTypes = []interface{}{
	...
	(detail.IOType)(0),                   // 30: ledger.manager.ledger.detail.v1.IOType
	(detail.IOSubType)(0),                // 31: ledger.manager.ledger.detail.v1.IOSubType
	(withdraw.WithdrawState)(0),          // 32: ledger.manager.ledger.withdraw.v1.WithdrawState
	(signmethod.SignMethodType)(0),       // 33: appuser.manager.signmethod.v2.SignMethodType
}
var file_npool_ledger_gw_v1_ledger_ledger_proto_depIdxs = []int32{
	...
	30, // 2: ledger.gateway.ledger1.v1.Detail.IOType:type_name -> ledger.manager.ledger.detail.v1.IOType
	31, // 3: ledger.gateway.ledger1.v1.Detail.IOSubType:type_name -> ledger.manager.ledger.detail.v1.IOSubType
	...
	32, // 8: ledger.gateway.ledger1.v1.Withdraw.State:type_name -> ledger.manager.ledger.withdraw.v1.WithdrawState
	33, // 9: ledger.gateway.ledger1.v1.CreateWithdrawRequest.AccountType:type_name -> appuser.manager.signmethod.v2.SignMethodType
	...
	33, // 15: ledger.gateway.ledger1.v1.CreateTransferRequest.AccountType:type_name -> appuser.manager.signmethod.v2.SignMethodType
	27, // 16: ledger.gateway.ledger1.v1.CreateTransferResponse.Info:type_name -> ledger.gateway.ledger1.v1.Transfer
	1,  // 17: ledger.gateway.ledger1.v1.Gateway.GetGenerals:input_type -> ledger.gateway.ledger1.v1.GetGeneralsRequest
	3,  // 18: ledger.gateway.ledger1.v1.Gateway.GetIntervalGenerals:input_type -> ledger.gateway.ledger1.v1.GetIntervalGeneralsRequest
	6,  // 19: ledger.gateway.ledger1.v1.Gateway.GetDetails:input_type -> ledger.gateway.ledger1.v1.GetDetailsRequest
	9,  // 20: ledger.gateway.ledger1.v1.Gateway.GetProfits:input_type -> ledger.gateway.ledger1.v1.GetProfitsRequest
	11, // 21: ledger.gateway.ledger1.v1.Gateway.GetIntervalProfits:input_type -> ledger.gateway.ledger1.v1.GetIntervalProfitsRequest
	14, // 22: ledger.gateway.ledger1.v1.Gateway.GetGoodProfits:input_type -> ledger.gateway.ledger1.v1.GetGoodProfitsRequest
	17, // 23: ledger.gateway.ledger1.v1.Gateway.CreateWithdraw:input_type -> ledger.gateway.ledger1.v1.CreateWithdrawRequest
	19, // 24: ledger.gateway.ledger1.v1.Gateway.GetWithdraws:input_type -> ledger.gateway.ledger1.v1.GetWithdrawsRequest
	21, // 25: ledger.gateway.ledger1.v1.Gateway.GetIntervalWithdraws:input_type -> ledger.gateway.ledger1.v1.GetIntervalWithdrawsRequest
	23, // 26: ledger.gateway.ledger1.v1.Gateway.GetAppWithdraws:input_type -> ledger.gateway.ledger1.v1.GetAppWithdrawsRequest
	25, // 27: ledger.gateway.ledger1.v1.Gateway.GetNAppWithdraws:input_type -> ledger.gateway.ledger1.v1.GetNAppWithdrawsRequest
	28, // 28: ledger.gateway.ledger1.v1.Gateway.CreateTransfer:input_type -> ledger.gateway.ledger1.v1.CreateTransferRequest
	2,  // 29: ledger.gateway.ledger1.v1.Gateway.GetGenerals:output_type -> ledger.gateway.ledger1.v1.GetGeneralsResponse
	4,  // 30: ledger.gateway.ledger1.v1.Gateway.GetIntervalGenerals:output_type -> ledger.gateway.ledger1.v1.GetIntervalGeneralsResponse
	7,  // 31: ledger.gateway.ledger1.v1.Gateway.GetDetails:output_type -> ledger.gateway.ledger1.v1.GetDetailsResponse
	10, // 32: ledger.gateway.ledger1.v1.Gateway.GetProfits:output_type -> ledger.gateway.ledger1.v1.GetProfitsResponse
	12, // 33: ledger.gateway.ledger1.v1.Gateway.GetIntervalProfits:output_type -> ledger.gateway.ledger1.v1.GetIntervalProfitsResponse
	15, // 34: ledger.gateway.ledger1.v1.Gateway.GetGoodProfits:output_type -> ledger.gateway.ledger1.v1.GetGoodProfitsResponse
	18, // 35: ledger.gateway.ledger1.v1.Gateway.CreateWithdraw:output_type -> ledger.gateway.ledger1.v1.CreateWithdrawResponse
	20, // 36: ledger.gateway.ledger1.v1.Gateway.GetWithdraws:output_type -> ledger.gateway.ledger1.v1.GetWithdrawsResponse
	22, // 37: ledger.gateway.ledger1.v1.Gateway.GetIntervalWithdraws:output_type -> ledger.gateway.ledger1.v1.GetIntervalWithdrawsResponse
	24, // 38: ledger.gateway.ledger1.v1.Gateway.GetAppWithdraws:output_type -> ledger.gateway.ledger1.v1.GetAppWithdrawsResponse
	26, // 39: ledger.gateway.ledger1.v1.Gateway.GetNAppWithdraws:output_type -> ledger.gateway.ledger1.v1.GetNAppWithdrawsResponse
	29, // 40: ledger.gateway.ledger1.v1.Gateway.CreateTransfer:output_type -> ledger.gateway.ledger1.v1.CreateTransferResponse
