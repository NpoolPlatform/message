...
func (c *gatewayClient) GetMiningRewards(ctx context.Context, in *GetMiningRewardsRequest, opts ...grpc.CallOption) (*GetMiningRewardsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ledger.gateway.ledger.profit.v1.Gateway/GetMiningRewards", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gatewayClient) GetCoinProfits(ctx context.Context, in *GetCoinProfitsRequest, opts ...grpc.CallOption) (*GetCoinProfitsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ledger.gateway.ledger.profit.v1.Gateway/GetCoinProfits", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gatewayClient) GetGoodProfits(ctx context.Context, in *GetGoodProfitsRequest, opts ...grpc.CallOption) (*GetGoodProfitsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ledger.gateway.ledger.profit.v1.Gateway/GetGoodProfits", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Gateway_GetMiningRewards_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ledger.gateway.ledger.profit.v1.Gateway/GetMiningRewards",
	}
...
func _Gateway_GetCoinProfits_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ledger.gateway.ledger.profit.v1.Gateway/GetCoinProfits",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Gateway_GetGoodProfits_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ledger.gateway.ledger.profit.v1.Gateway/GetGoodProfits",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
