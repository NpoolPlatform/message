...
const (
	Gateway_CreateWithdraw_FullMethodName   = "/ledger.gateway.withdraw.v1.Gateway/CreateWithdraw"
	Gateway_GetWithdraws_FullMethodName     = "/ledger.gateway.withdraw.v1.Gateway/GetWithdraws"
	Gateway_GetAppWithdraws_FullMethodName  = "/ledger.gateway.withdraw.v1.Gateway/GetAppWithdraws"
	Gateway_GetNAppWithdraws_FullMethodName = "/ledger.gateway.withdraw.v1.Gateway/GetNAppWithdraws"
)
