...
const (
	Manager_CreateDetail_FullMethodName     = "/ledger.manager.mining.detail.v1.Manager/CreateDetail"
	Manager_CreateDetails_FullMethodName    = "/ledger.manager.mining.detail.v1.Manager/CreateDetails"
	Manager_GetDetail_FullMethodName        = "/ledger.manager.mining.detail.v1.Manager/GetDetail"
	Manager_GetDetailOnly_FullMethodName    = "/ledger.manager.mining.detail.v1.Manager/GetDetailOnly"
	Manager_GetDetails_FullMethodName       = "/ledger.manager.mining.detail.v1.Manager/GetDetails"
	Manager_ExistDetail_FullMethodName      = "/ledger.manager.mining.detail.v1.Manager/ExistDetail"
	Manager_ExistDetailConds_FullMethodName = "/ledger.manager.mining.detail.v1.Manager/ExistDetailConds"
	Manager_CountDetails_FullMethodName     = "/ledger.manager.mining.detail.v1.Manager/CountDetails"
)
