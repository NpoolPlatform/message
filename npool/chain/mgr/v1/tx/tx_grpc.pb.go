...
const (
	Manager_CreateTx_FullMethodName     = "/chain.manager.tx.v1.Manager/CreateTx"
	Manager_CreateTxs_FullMethodName    = "/chain.manager.tx.v1.Manager/CreateTxs"
	Manager_UpdateTx_FullMethodName     = "/chain.manager.tx.v1.Manager/UpdateTx"
	Manager_GetTx_FullMethodName        = "/chain.manager.tx.v1.Manager/GetTx"
	Manager_GetTxOnly_FullMethodName    = "/chain.manager.tx.v1.Manager/GetTxOnly"
	Manager_GetTxs_FullMethodName       = "/chain.manager.tx.v1.Manager/GetTxs"
	Manager_ExistTx_FullMethodName      = "/chain.manager.tx.v1.Manager/ExistTx"
	Manager_ExistTxConds_FullMethodName = "/chain.manager.tx.v1.Manager/ExistTxConds"
	Manager_CountTxs_FullMethodName     = "/chain.manager.tx.v1.Manager/CountTxs"
	Manager_DeleteTx_FullMethodName     = "/chain.manager.tx.v1.Manager/DeleteTx"
)
