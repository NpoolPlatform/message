...
type UpdateTxRequest struct {
	...
	State *v1.TxState `protobuf:"varint,30,opt,name=State,proto3,enum=basetypes.v1.TxState,oneof" json:"State,omitempty"`
}
...
func (x *UpdateTxRequest) GetID() uint32 {
	if x != nil {
		return x.ID
	}
	return 0
...
func (x *UpdateTxRequest) GetEntID() string {
	if x != nil {
		return x.EntID
	}
	return ""
...
func (x *UpdateTxRequest) GetState() v1.TxState {
...
var file_npool_chain_gw_v1_tx_tx_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x0d, 0x52, 0x05, 0x54, 0x6f, 0x74, 0x61, 0x6c, 0x22, 0x73, 0x0a, 0x0f, 0x55, 0x70,
	0x64, 0x61, 0x74, 0x65, 0x54, 0x78, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x0e, 0x0a,
	...
	0x74, 0x49, 0x44, 0x12, 0x30, 0x0a, 0x05, 0x53, 0x74, 0x61, 0x74, 0x65, 0x18, 0x1e, 0x20, 0x01,
	0x28, 0x0e, 0x32, 0x15, 0x2e, 0x62, 0x61, 0x73, 0x65, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2e, 0x76,
	0x31, 0x2e, 0x54, 0x78, 0x53, 0x74, 0x61, 0x74, 0x65, 0x48, 0x00, 0x52, 0x05, 0x53, 0x74, 0x61,
	0x74, 0x65, 0x88, 0x01, 0x01, 0x42, 0x08, 0x0a, 0x06, 0x5f, 0x53, 0x74, 0x61, 0x74, 0x65, 0x22,
	...
	0x0b, 0x32, 0x17, 0x2e, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x2e, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61,
	0x79, 0x2e, 0x74, 0x78, 0x2e, 0x76, 0x31, 0x2e, 0x54, 0x78, 0x52, 0x04, 0x49, 0x6e, 0x66, 0x6f,
	0x32, 0xe7, 0x01, 0x0a, 0x07, 0x47, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x12, 0x69, 0x0a, 0x06,
	0x47, 0x65, 0x74, 0x54, 0x78, 0x73, 0x12, 0x22, 0x2e, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x2e, 0x67,
	0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2e, 0x74, 0x78, 0x2e, 0x76, 0x31, 0x2e, 0x47, 0x65, 0x74,
	...
	0x67, 0x65, 0x74, 0x2f, 0x74, 0x78, 0x73, 0x12, 0x71, 0x0a, 0x08, 0x55, 0x70, 0x64, 0x61, 0x74,
	0x65, 0x54, 0x78, 0x12, 0x24, 0x2e, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x2e, 0x67, 0x61, 0x74, 0x65,
	0x77, 0x61, 0x79, 0x2e, 0x74, 0x78, 0x2e, 0x76, 0x31, 0x2e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65,
	...
	0x2f, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x2f, 0x74, 0x78, 0x42, 0x37, 0x5a, 0x35, 0x67, 0x69,
...
var file_npool_chain_gw_v1_tx_tx_proto_depIdxs = []int32{
	...
	6, // 5: chain.gateway.tx.v1.UpdateTxRequest.State:type_name -> basetypes.v1.TxState
	0, // 6: chain.gateway.tx.v1.UpdateTxResponse.Info:type_name -> chain.gateway.tx.v1.Tx
	1, // 7: chain.gateway.tx.v1.Gateway.GetTxs:input_type -> chain.gateway.tx.v1.GetTxsRequest
	3, // 8: chain.gateway.tx.v1.Gateway.UpdateTx:input_type -> chain.gateway.tx.v1.UpdateTxRequest
	2, // 9: chain.gateway.tx.v1.Gateway.GetTxs:output_type -> chain.gateway.tx.v1.GetTxsResponse
	4, // 10: chain.gateway.tx.v1.Gateway.UpdateTx:output_type -> chain.gateway.tx.v1.UpdateTxResponse
...
func file_npool_chain_gw_v1_tx_tx_proto_init() {
	...
	file_npool_chain_gw_v1_tx_tx_proto_msgTypes[3].OneofWrappers = []interface{}{}
	type x struct{}
