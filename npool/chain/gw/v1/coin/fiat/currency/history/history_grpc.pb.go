...
func (c *gatewayClient) GetCurrencies(ctx context.Context, in *GetCurrenciesRequest, opts ...grpc.CallOption) (*GetCurrenciesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/chain.gateway.coin.fiat.currency.history.v1.Gateway/GetCurrencies", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Gateway_GetCurrencies_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/chain.gateway.coin.fiat.currency.history.v1.Gateway/GetCurrencies",
	}
...
var Gateway_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "chain.gateway.coin.fiat.currency.history.v1.Gateway",
	...
	Metadata: "npool/chain/gw/v1/coin/fiat/currency/history/history.proto",
}
