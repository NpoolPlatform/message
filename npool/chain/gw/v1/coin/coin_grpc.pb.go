...
const (
	Gateway_CreateCoin_FullMethodName = "/chain.gateway.coin.v1.Gateway/CreateCoin"
	Gateway_GetCoins_FullMethodName   = "/chain.gateway.coin.v1.Gateway/GetCoins"
	Gateway_UpdateCoin_FullMethodName = "/chain.gateway.coin.v1.Gateway/UpdateCoin"
)
