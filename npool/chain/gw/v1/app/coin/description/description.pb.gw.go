...
=======
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/chain.gateway.app.coin.description.v1.Gateway/CreateCoinDescription", runtime.WithHTTPPathPattern("/v1/create/coindescription"))
>>>>>>> Refactor gw proto:npool/chain/gw/v1/appcoin/description/description.pb.gw.go
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_Gateway_CreateCoinDescription_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		...
		forward_Gateway_CreateCoinDescription_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
>>>>>>> Refactor gw proto:npool/chain/gw/v1/appcoin/description/description.pb.gw.go
		...
		resp, md, err := local_request_Gateway_CreateAppCoinDescription_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_Gateway_CreateAppCoinDescription_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
>>>>>>> Refactor gw proto:npool/chain/gw/v1/appcoin/description/description.pb.gw.go
		...
		resp, md, err := local_request_Gateway_GetCoinDescriptions_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_Gateway_GetCoinDescriptions_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
>>>>>>> Refactor gw proto:npool/chain/gw/v1/appcoin/description/description.pb.gw.go
		...
		resp, md, err := local_request_Gateway_GetAppCoinDescriptions_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_Gateway_GetAppCoinDescriptions_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
>>>>>>> Refactor gw proto:npool/chain/gw/v1/appcoin/description/description.pb.gw.go
		...
		resp, md, err := local_request_Gateway_UpdateCoinDescription_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_Gateway_UpdateCoinDescription_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
>>>>>>> Refactor gw proto:npool/chain/gw/v1/appcoin/description/description.pb.gw.go
		...
		resp, md, err := request_Gateway_CreateCoinDescription_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
>>>>>>> Refactor gw proto:npool/chain/gw/v1/appcoin/description/description.pb.gw.go
		...
		resp, md, err := request_Gateway_CreateAppCoinDescription_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
>>>>>>> Refactor gw proto:npool/chain/gw/v1/appcoin/description/description.pb.gw.go
		...
		resp, md, err := request_Gateway_GetCoinDescriptions_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
>>>>>>> Refactor gw proto:npool/chain/gw/v1/appcoin/description/description.pb.gw.go
		...
		resp, md, err := request_Gateway_GetAppCoinDescriptions_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
>>>>>>> Refactor gw proto:npool/chain/gw/v1/appcoin/description/description.pb.gw.go
		...
		resp, md, err := request_Gateway_UpdateCoinDescription_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
