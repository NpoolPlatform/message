...
const (
	Gateway_CreateFeed_FullMethodName = "/chain.gateway.fiat.currency.feed.v1.Gateway/CreateFeed"
	Gateway_UpdateFeed_FullMethodName = "/chain.gateway.fiat.currency.feed.v1.Gateway/UpdateFeed"
	Gateway_GetFeeds_FullMethodName   = "/chain.gateway.fiat.currency.feed.v1.Gateway/GetFeeds"
)
