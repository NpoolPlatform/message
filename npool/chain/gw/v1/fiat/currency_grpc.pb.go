...
const (
	Gateway_GetFiatCurrency_FullMethodName        = "/chain.gateway.fiat.v1.Gateway/GetFiatCurrency"
	Gateway_GetCoinFiatCurrencies_FullMethodName  = "/chain.gateway.fiat.v1.Gateway/GetCoinFiatCurrencies"
	Gateway_GetHistories_FullMethodName           = "/chain.gateway.fiat.v1.Gateway/GetHistories"
	Gateway_GetFiatCurrencyTypes_FullMethodName   = "/chain.gateway.fiat.v1.Gateway/GetFiatCurrencyTypes"
	Gateway_CreateFiatCurrencyType_FullMethodName = "/chain.gateway.fiat.v1.Gateway/CreateFiatCurrencyType"
	Gateway_UpdateFiatCurrencyType_FullMethodName = "/chain.gateway.fiat.v1.Gateway/UpdateFiatCurrencyType"
)
...
func (c *gatewayClient) GetFiatCurrency(ctx context.Context, in *GetFiatCurrencyRequest, opts ...grpc.CallOption) (*GetFiatCurrencyResponse, error) {
	...
	err := c.cc.Invoke(ctx, Gateway_GetFiatCurrency_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gatewayClient) GetCoinFiatCurrencies(ctx context.Context, in *GetCoinFiatCurrenciesRequest, opts ...grpc.CallOption) (*GetCoinFiatCurrenciesResponse, error) {
	...
	err := c.cc.Invoke(ctx, Gateway_GetCoinFiatCurrencies_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gatewayClient) GetFiatCurrencyTypes(ctx context.Context, in *GetFiatCurrencyTypesRequest, opts ...grpc.CallOption) (*GetFiatCurrencyTypesResponse, error) {
	...
	err := c.cc.Invoke(ctx, Gateway_GetFiatCurrencyTypes_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gatewayClient) CreateFiatCurrencyType(ctx context.Context, in *CreateFiatCurrencyTypeRequest, opts ...grpc.CallOption) (*CreateFiatCurrencyTypeResponse, error) {
	...
	err := c.cc.Invoke(ctx, Gateway_CreateFiatCurrencyType_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gatewayClient) UpdateFiatCurrencyType(ctx context.Context, in *UpdateFiatCurrencyTypeRequest, opts ...grpc.CallOption) (*UpdateFiatCurrencyTypeResponse, error) {
	...
	err := c.cc.Invoke(ctx, Gateway_UpdateFiatCurrencyType_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Gateway_GetFiatCurrency_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Gateway_GetFiatCurrency_FullMethodName,
	}
...
func _Gateway_GetCoinFiatCurrencies_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Gateway_GetCoinFiatCurrencies_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Gateway_GetFiatCurrencyTypes_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Gateway_GetFiatCurrencyTypes_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Gateway_CreateFiatCurrencyType_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Gateway_CreateFiatCurrencyType_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Gateway_UpdateFiatCurrencyType_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Gateway_UpdateFiatCurrencyType_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Gateway_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "npool/chain/gw/v1/fiat/currency.proto",
}
