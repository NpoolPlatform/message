...
const (
	Middleware_GetCurrency_FullMethodName   = "/chain.middleware.fiat.currency.v1.Middleware/GetCurrency"
	Middleware_GetCurrencies_FullMethodName = "/chain.middleware.fiat.currency.v1.Middleware/GetCurrencies"
)
