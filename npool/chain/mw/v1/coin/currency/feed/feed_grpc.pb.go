...
const (
	Middleware_CreateFeed_FullMethodName = "/chain.middleware.coin.currency1.feed.v1.Middleware/CreateFeed"
	Middleware_UpdateFeed_FullMethodName = "/chain.middleware.coin.currency1.feed.v1.Middleware/UpdateFeed"
	Middleware_GetFeeds_FullMethodName   = "/chain.middleware.coin.currency1.feed.v1.Middleware/GetFeeds"
)
...
var Middleware_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "chain.middleware.coin.currency1.feed.v1.Middleware",
