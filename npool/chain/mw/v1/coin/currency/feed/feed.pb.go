...
=======
	// @inject_tag: sql:"feed_type"
	FeedType v1.CurrencyFeedType `protobuf:"varint,30,opt,name=FeedType,proto3,enum=basetypes.v1.CurrencyFeedType" json:"FeedType,omitempty" sql:"feed_type"`
	// @inject_tag: sql:"feed_coin_name"
	FeedCoinName string `protobuf:"bytes,40,opt,name=FeedCoinName,proto3" json:"FeedCoinName,omitempty" sql:"feed_coin_name"`
	// @inject_tag: sql:"disabled"
