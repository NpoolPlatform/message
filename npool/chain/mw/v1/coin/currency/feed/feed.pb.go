...
var file_npool_chain_mw_v1_coin_currency_feed_feed_proto_goTypes = []interface{}{
	...
	(*feed.CurrencyFeedReq)(nil),       // 13: chain.manager.coin.currency.feed.v1.CurrencyFeedReq
}
var file_npool_chain_mw_v1_coin_currency_feed_feed_proto_depIdxs = []int32{
	...
	13, // 4: chain.middleware.coin.currency.feed.v1.CreateCurrencyFeedRequest.Info:type_name -> chain.manager.coin.currency.feed.v1.CurrencyFeedReq
	...
	13, // 6: chain.middleware.coin.currency.feed.v1.UpdateCurrencyFeedRequest.Info:type_name -> chain.manager.coin.currency.feed.v1.CurrencyFeedReq
	...
	0,  // 10: chain.middleware.coin.currency.feed.v1.DeleteCurrencyFeedResponse.Info:type_name -> chain.middleware.coin.currency.feed.v1.CurrencyFeed
	2,  // 11: chain.middleware.coin.currency.feed.v1.Middleware.CreateCurrencyFeed:input_type -> chain.middleware.coin.currency.feed.v1.CreateCurrencyFeedRequest
	4,  // 12: chain.middleware.coin.currency.feed.v1.Middleware.UpdateCurrencyFeed:input_type -> chain.middleware.coin.currency.feed.v1.UpdateCurrencyFeedRequest
	8,  // 13: chain.middleware.coin.currency.feed.v1.Middleware.DeleteCurrencyFeed:input_type -> chain.middleware.coin.currency.feed.v1.DeleteCurrencyFeedRequest
	6,  // 14: chain.middleware.coin.currency.feed.v1.Middleware.GetCurrencyFeeds:input_type -> chain.middleware.coin.currency.feed.v1.GetCurrencyFeedsRequest
	3,  // 15: chain.middleware.coin.currency.feed.v1.Middleware.CreateCurrencyFeed:output_type -> chain.middleware.coin.currency.feed.v1.CreateCurrencyFeedResponse
	5,  // 16: chain.middleware.coin.currency.feed.v1.Middleware.UpdateCurrencyFeed:output_type -> chain.middleware.coin.currency.feed.v1.UpdateCurrencyFeedResponse
	9,  // 17: chain.middleware.coin.currency.feed.v1.Middleware.DeleteCurrencyFeed:output_type -> chain.middleware.coin.currency.feed.v1.DeleteCurrencyFeedResponse
	7,  // 18: chain.middleware.coin.currency.feed.v1.Middleware.GetCurrencyFeeds:output_type -> chain.middleware.coin.currency.feed.v1.GetCurrencyFeedsResponse
