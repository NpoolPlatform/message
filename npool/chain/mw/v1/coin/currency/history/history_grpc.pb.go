...
func (c *middlewareClient) GetCurrencies(ctx context.Context, in *GetCurrenciesRequest, opts ...grpc.CallOption) (*GetCurrenciesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/chain.middleware.coin.currency1.history.v1.Middleware/GetCurrencies", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Middleware_GetCurrencies_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/chain.middleware.coin.currency1.history.v1.Middleware/GetCurrencies",
	}
...
var Middleware_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "chain.middleware.coin.currency1.history.v1.Middleware",
	...
	Metadata: "npool/chain/mw/v1/coin/currency/history/history.proto",
}
