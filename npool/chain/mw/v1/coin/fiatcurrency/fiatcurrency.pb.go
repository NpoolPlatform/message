...
var file_npool_chain_mw_v1_coin_fiatcurrency_fiatcurrency_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x68, 0x46, 0x69, 0x61, 0x74, 0x43, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x63, 0x69, 0x65,
	0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x72, 0x0a, 0x1c, 0x47, 0x65, 0x74,
	...
	0x14, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x05, 0x54, 0x6f, 0x74, 0x61, 0x6c, 0x32, 0x81, 0x05, 0x0a,
...
var file_npool_chain_mw_v1_coin_fiatcurrency_fiatcurrency_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_npool_chain_mw_v1_coin_fiatcurrency_fiatcurrency_proto_goTypes = []interface{}{
	...
	(*GetCoinFiatCurrenciesRequest)(nil),  // 8: chain.middleware.coin.fiatcurrency.v1.GetCoinFiatCurrenciesRequest
	(*GetCoinFiatCurrenciesResponse)(nil), // 9: chain.middleware.coin.fiatcurrency.v1.GetCoinFiatCurrenciesResponse
	(*GetHistoriesRequest)(nil),           // 10: chain.middleware.coin.fiatcurrency.v1.GetHistoriesRequest
	(*GetHistoriesResponse)(nil),          // 11: chain.middleware.coin.fiatcurrency.v1.GetHistoriesResponse
	(currency.FeedType)(0),                // 12: chain.manager.coin.currency.v1.FeedType
	...
	(*fiatcurrency.FiatCurrencyReq)(nil),  // 16: chain.manager.coin.fiatcurrency.v1.FiatCurrencyReq
}
var file_npool_chain_mw_v1_coin_fiatcurrency_fiatcurrency_proto_depIdxs = []int32{
	12, // 0: chain.middleware.coin.fiatcurrency.v1.FiatCurrency.FeedType:type_name -> chain.manager.coin.currency.v1.FeedType
	13, // 1: chain.middleware.coin.fiatcurrency.v1.Conds.ID:type_name -> npool.v1.StringVal
	13, // 2: chain.middleware.coin.fiatcurrency.v1.Conds.FiatCurrencyTypeID:type_name -> npool.v1.StringVal
	14, // 3: chain.middleware.coin.fiatcurrency.v1.Conds.FiatCurrencyTypeIDs:type_name -> npool.v1.StringSliceVal
	15, // 4: chain.middleware.coin.fiatcurrency.v1.Conds.StartAt:type_name -> npool.v1.Uint32Val
	15, // 5: chain.middleware.coin.fiatcurrency.v1.Conds.EndAt:type_name -> npool.v1.Uint32Val
	13, // 6: chain.middleware.coin.fiatcurrency.v1.Conds.CoinTypeID:type_name -> npool.v1.StringVal
	14, // 7: chain.middleware.coin.fiatcurrency.v1.Conds.CoinTypeIDs:type_name -> npool.v1.StringSliceVal
	16, // 8: chain.middleware.coin.fiatcurrency.v1.CreateFiatCurrencyRequest.Info:type_name -> chain.manager.coin.fiatcurrency.v1.FiatCurrencyReq
	...
	16, // 10: chain.middleware.coin.fiatcurrency.v1.CreateFiatCurrenciesRequest.Infos:type_name -> chain.manager.coin.fiatcurrency.v1.FiatCurrencyReq
	...
	0,  // 12: chain.middleware.coin.fiatcurrency.v1.GetCoinFiatCurrenciesResponse.Infos:type_name -> chain.middleware.coin.fiatcurrency.v1.FiatCurrency
	1,  // 13: chain.middleware.coin.fiatcurrency.v1.GetHistoriesRequest.Conds:type_name -> chain.middleware.coin.fiatcurrency.v1.Conds
	0,  // 14: chain.middleware.coin.fiatcurrency.v1.GetHistoriesResponse.Infos:type_name -> chain.middleware.coin.fiatcurrency.v1.FiatCurrency
	2,  // 15: chain.middleware.coin.fiatcurrency.v1.Middleware.CreateFiatCurrency:input_type -> chain.middleware.coin.fiatcurrency.v1.CreateFiatCurrencyRequest
	4,  // 16: chain.middleware.coin.fiatcurrency.v1.Middleware.CreateFiatCurrencies:input_type -> chain.middleware.coin.fiatcurrency.v1.CreateFiatCurrenciesRequest
	8,  // 17: chain.middleware.coin.fiatcurrency.v1.Middleware.GetCoinFiatCurrencies:input_type -> chain.middleware.coin.fiatcurrency.v1.GetCoinFiatCurrenciesRequest
	10, // 18: chain.middleware.coin.fiatcurrency.v1.Middleware.GetHistories:input_type -> chain.middleware.coin.fiatcurrency.v1.GetHistoriesRequest
	3,  // 19: chain.middleware.coin.fiatcurrency.v1.Middleware.CreateFiatCurrency:output_type -> chain.middleware.coin.fiatcurrency.v1.CreateFiatCurrencyResponse
	5,  // 20: chain.middleware.coin.fiatcurrency.v1.Middleware.CreateFiatCurrencies:output_type -> chain.middleware.coin.fiatcurrency.v1.CreateFiatCurrenciesResponse
	9,  // 21: chain.middleware.coin.fiatcurrency.v1.Middleware.GetCoinFiatCurrencies:output_type -> chain.middleware.coin.fiatcurrency.v1.GetCoinFiatCurrenciesResponse
	11, // 22: chain.middleware.coin.fiatcurrency.v1.Middleware.GetHistories:output_type -> chain.middleware.coin.fiatcurrency.v1.GetHistoriesResponse
