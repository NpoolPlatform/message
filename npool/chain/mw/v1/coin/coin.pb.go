...
var file_npool_chain_mw_v1_coin_coin_proto_rawDesc = []byte{
	...
	0x64, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x22, 0x9e, 0x02, 0x0a, 0x05, 0x43, 0x6f, 0x6e, 0x64,
	...
	0x46, 0x6f, 0x72, 0x50, 0x61, 0x79, 0x88, 0x01, 0x01, 0x12, 0x2f, 0x0a, 0x03, 0x49, 0x44, 0x73,
	...
	0x42, 0x06, 0x0a, 0x04, 0x5f, 0x49, 0x44, 0x73, 0x22, 0x4a, 0x0a, 0x11, 0x43, 0x72, 0x65, 0x61,
	...
	0x4a, 0x0a, 0x11, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x43, 0x6f, 0x69, 0x6e, 0x52, 0x65, 0x71,
	...
	0x65, 0x77, 0x61, 0x72, 0x65, 0x2e, 0x63, 0x6f, 0x69, 0x6e, 0x2e, 0x76, 0x31, 0x2e, 0x43, 0x6f,
	0x69, 0x6e, 0x52, 0x65, 0x71, 0x52, 0x04, 0x49, 0x6e, 0x66, 0x6f, 0x22, 0x48, 0x0a, 0x12, 0x55,
	...
	0x60, 0x0a, 0x07, 0x47, 0x65, 0x74, 0x43, 0x6f, 0x69, 0x6e, 0x12, 0x28, 0x2e, 0x63, 0x68, 0x61,
	...
	0x75, 0x65, 0x73, 0x74, 0x1a, 0x29, 0x2e, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x2e, 0x6d, 0x69, 0x64,
	...
	0x6e, 0x2f, 0x6d, 0x77, 0x2f, 0x76, 0x31, 0x2f, 0x63, 0x6f, 0x69, 0x6e, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_npool_chain_mw_v1_coin_coin_proto_depIdxs = []int32{
	...
	13, // 4: chain.middleware.coin.v1.Conds.IDs:type_name -> npool.v1.StringSliceVal
	0,  // 5: chain.middleware.coin.v1.CreateCoinRequest.Info:type_name -> chain.middleware.coin.v1.CoinReq
	1,  // 6: chain.middleware.coin.v1.CreateCoinResponse.Info:type_name -> chain.middleware.coin.v1.Coin
	1,  // 7: chain.middleware.coin.v1.GetCoinResponse.Info:type_name -> chain.middleware.coin.v1.Coin
	2,  // 8: chain.middleware.coin.v1.GetCoinsRequest.Conds:type_name -> chain.middleware.coin.v1.Conds
	1,  // 9: chain.middleware.coin.v1.GetCoinsResponse.Infos:type_name -> chain.middleware.coin.v1.Coin
	0,  // 10: chain.middleware.coin.v1.UpdateCoinRequest.Info:type_name -> chain.middleware.coin.v1.CoinReq
	1,  // 11: chain.middleware.coin.v1.UpdateCoinResponse.Info:type_name -> chain.middleware.coin.v1.Coin
	3,  // 12: chain.middleware.coin.v1.Middleware.CreateCoin:input_type -> chain.middleware.coin.v1.CreateCoinRequest
	5,  // 13: chain.middleware.coin.v1.Middleware.GetCoin:input_type -> chain.middleware.coin.v1.GetCoinRequest
	7,  // 14: chain.middleware.coin.v1.Middleware.GetCoins:input_type -> chain.middleware.coin.v1.GetCoinsRequest
	9,  // 15: chain.middleware.coin.v1.Middleware.UpdateCoin:input_type -> chain.middleware.coin.v1.UpdateCoinRequest
	4,  // 16: chain.middleware.coin.v1.Middleware.CreateCoin:output_type -> chain.middleware.coin.v1.CreateCoinResponse
	6,  // 17: chain.middleware.coin.v1.Middleware.GetCoin:output_type -> chain.middleware.coin.v1.GetCoinResponse
	8,  // 18: chain.middleware.coin.v1.Middleware.GetCoins:output_type -> chain.middleware.coin.v1.GetCoinsResponse
	10, // 19: chain.middleware.coin.v1.Middleware.UpdateCoin:output_type -> chain.middleware.coin.v1.UpdateCoinResponse
