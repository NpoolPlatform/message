...
const (
	Middleware_Lock_FullMethodName       = "/good.middleware.app.good1.stock.mining.v1.Middleware/Lock"
	Middleware_Locks_FullMethodName      = "/good.middleware.app.good1.stock.mining.v1.Middleware/Locks"
	Middleware_Unlock_FullMethodName     = "/good.middleware.app.good1.stock.mining.v1.Middleware/Unlock"
	Middleware_WaitStart_FullMethodName  = "/good.middleware.app.good1.stock.mining.v1.Middleware/WaitStart"
	Middleware_InService_FullMethodName  = "/good.middleware.app.good1.stock.mining.v1.Middleware/InService"
	Middleware_ChargeBack_FullMethodName = "/good.middleware.app.good1.stock.mining.v1.Middleware/ChargeBack"
	Middleware_Expire_FullMethodName     = "/good.middleware.app.good1.stock.mining.v1.Middleware/Expire"
)
...
func (c *middlewareClient) Locks(ctx context.Context, in *LocksRequest, opts ...grpc.CallOption) (*LocksResponse, error) {
	...
	err := c.cc.Invoke(ctx, Middleware_Locks_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Middleware_Locks_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Middleware_Locks_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Middleware_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "good.middleware.app.good1.stock.mining.v1.Middleware",
	...
	Metadata: "npool/good/mw/v1/app/good/stock/mining/mining.proto",
}
