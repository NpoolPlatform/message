...
type MiddlewareClient interface {
	...
	ExistTopMostConstraintConds(ctx context.Context, in *ExistTopMostConstraintCondsRequest, opts ...grpc.CallOption) (*ExistTopMostConstraintCondsResponse, error)
...
func (c *middlewareClient) CreateTopMostConstraint(ctx context.Context, in *CreateTopMostConstraintRequest, opts ...grpc.CallOption) (*CreateTopMostConstraintResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/good.middleware.app.good1.topmost.constraint.v1.Middleware/CreateTopMostConstraint", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *middlewareClient) UpdateTopMostConstraint(ctx context.Context, in *UpdateTopMostConstraintRequest, opts ...grpc.CallOption) (*UpdateTopMostConstraintResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/good.middleware.app.good1.topmost.constraint.v1.Middleware/UpdateTopMostConstraint", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *middlewareClient) GetTopMostConstraint(ctx context.Context, in *GetTopMostConstraintRequest, opts ...grpc.CallOption) (*GetTopMostConstraintResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/good.middleware.app.good1.topmost.constraint.v1.Middleware/GetTopMostConstraint", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *middlewareClient) GetTopMostConstraints(ctx context.Context, in *GetTopMostConstraintsRequest, opts ...grpc.CallOption) (*GetTopMostConstraintsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/good.middleware.app.good1.topmost.constraint.v1.Middleware/GetTopMostConstraints", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *middlewareClient) ExistTopMostConstraintConds(ctx context.Context, in *ExistTopMostConstraintCondsRequest, opts ...grpc.CallOption) (*ExistTopMostConstraintCondsResponse, error) {
	out := new(ExistTopMostConstraintCondsResponse)
	err := c.cc.Invoke(ctx, "/good.middleware.app.good1.topmost.constraint.v1.Middleware/ExistTopMostConstraintConds", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *middlewareClient) DeleteTopMostConstraint(ctx context.Context, in *DeleteTopMostConstraintRequest, opts ...grpc.CallOption) (*DeleteTopMostConstraintResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/good.middleware.app.good1.topmost.constraint.v1.Middleware/DeleteTopMostConstraint", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MiddlewareServer interface {
	...
	ExistTopMostConstraintConds(context.Context, *ExistTopMostConstraintCondsRequest) (*ExistTopMostConstraintCondsResponse, error)
...
func _Middleware_CreateTopMostConstraint_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/good.middleware.app.good1.topmost.constraint.v1.Middleware/CreateTopMostConstraint",
	}
...
func _Middleware_UpdateTopMostConstraint_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/good.middleware.app.good1.topmost.constraint.v1.Middleware/UpdateTopMostConstraint",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Middleware_GetTopMostConstraint_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/good.middleware.app.good1.topmost.constraint.v1.Middleware/GetTopMostConstraint",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Middleware_GetTopMostConstraints_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/good.middleware.app.good1.topmost.constraint.v1.Middleware/GetTopMostConstraints",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Middleware_ExistTopMostConstraintConds_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ExistTopMostConstraintCondsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MiddlewareServer).ExistTopMostConstraintConds(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/good.middleware.app.good1.topmost.constraint.v1.Middleware/ExistTopMostConstraintConds",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MiddlewareServer).ExistTopMostConstraintConds(ctx, req.(*ExistTopMostConstraintCondsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Middleware_DeleteTopMostConstraint_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/good.middleware.app.good1.topmost.constraint.v1.Middleware/DeleteTopMostConstraint",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Middleware_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ExistTopMostConstraintConds",
			Handler:    _Middleware_ExistTopMostConstraintConds_Handler,
		},
		{
