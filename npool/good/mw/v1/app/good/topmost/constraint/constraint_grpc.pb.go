...
const (
	...
	Middleware_ExistTopMostConstraintConds_FullMethodName = "/good.middleware.app.good1.topmost.constraint.v1.Middleware/ExistTopMostConstraintConds"
...
func (c *middlewareClient) ExistTopMostConstraintConds(ctx context.Context, in *ExistTopMostConstraintCondsRequest, opts ...grpc.CallOption) (*ExistTopMostConstraintCondsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Middleware_ExistTopMostConstraintConds_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Middleware_ExistTopMostConstraintConds_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Middleware_ExistTopMostConstraintConds_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
