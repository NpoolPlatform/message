...
type MiddlewareClient interface {
	...
	ExistTopMostGoodConds(ctx context.Context, in *ExistTopMostGoodCondsRequest, opts ...grpc.CallOption) (*ExistTopMostGoodCondsResponse, error)
...
func (c *middlewareClient) CreateTopMostGood(ctx context.Context, in *CreateTopMostGoodRequest, opts ...grpc.CallOption) (*CreateTopMostGoodResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/good.middleware.app.good1.topmost.good2.v1.Middleware/CreateTopMostGood", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *middlewareClient) UpdateTopMostGood(ctx context.Context, in *UpdateTopMostGoodRequest, opts ...grpc.CallOption) (*UpdateTopMostGoodResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/good.middleware.app.good1.topmost.good2.v1.Middleware/UpdateTopMostGood", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *middlewareClient) GetTopMostGood(ctx context.Context, in *GetTopMostGoodRequest, opts ...grpc.CallOption) (*GetTopMostGoodResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/good.middleware.app.good1.topmost.good2.v1.Middleware/GetTopMostGood", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *middlewareClient) GetTopMostGoods(ctx context.Context, in *GetTopMostGoodsRequest, opts ...grpc.CallOption) (*GetTopMostGoodsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/good.middleware.app.good1.topmost.good2.v1.Middleware/GetTopMostGoods", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *middlewareClient) ExistTopMostGoodConds(ctx context.Context, in *ExistTopMostGoodCondsRequest, opts ...grpc.CallOption) (*ExistTopMostGoodCondsResponse, error) {
	out := new(ExistTopMostGoodCondsResponse)
	err := c.cc.Invoke(ctx, "/good.middleware.app.good1.topmost.good2.v1.Middleware/ExistTopMostGoodConds", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *middlewareClient) DeleteTopMostGood(ctx context.Context, in *DeleteTopMostGoodRequest, opts ...grpc.CallOption) (*DeleteTopMostGoodResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/good.middleware.app.good1.topmost.good2.v1.Middleware/DeleteTopMostGood", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MiddlewareServer interface {
	...
	ExistTopMostGoodConds(context.Context, *ExistTopMostGoodCondsRequest) (*ExistTopMostGoodCondsResponse, error)
...
func (UnimplementedMiddlewareServer) ExistTopMostGoodConds(context.Context, *ExistTopMostGoodCondsRequest) (*ExistTopMostGoodCondsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ExistTopMostGoodConds not implemented")
}
...
func _Middleware_CreateTopMostGood_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/good.middleware.app.good1.topmost.good2.v1.Middleware/CreateTopMostGood",
	}
...
func _Middleware_UpdateTopMostGood_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/good.middleware.app.good1.topmost.good2.v1.Middleware/UpdateTopMostGood",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Middleware_GetTopMostGood_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/good.middleware.app.good1.topmost.good2.v1.Middleware/GetTopMostGood",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Middleware_GetTopMostGoods_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/good.middleware.app.good1.topmost.good2.v1.Middleware/GetTopMostGoods",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Middleware_ExistTopMostGoodConds_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ExistTopMostGoodCondsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MiddlewareServer).ExistTopMostGoodConds(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/good.middleware.app.good1.topmost.good2.v1.Middleware/ExistTopMostGoodConds",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MiddlewareServer).ExistTopMostGoodConds(ctx, req.(*ExistTopMostGoodCondsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Middleware_DeleteTopMostGood_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/good.middleware.app.good1.topmost.good2.v1.Middleware/DeleteTopMostGood",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Middleware_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ExistTopMostGoodConds",
			Handler:    _Middleware_ExistTopMostGoodConds_Handler,
		},
		{
