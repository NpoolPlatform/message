...
func (c *middlewareClient) CreateTopMost(ctx context.Context, in *CreateTopMostRequest, opts ...grpc.CallOption) (*CreateTopMostResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/good.middleware.app.good1.topmost.v1.Middleware/CreateTopMost", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *middlewareClient) UpdateTopMost(ctx context.Context, in *UpdateTopMostRequest, opts ...grpc.CallOption) (*UpdateTopMostResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/good.middleware.app.good1.topmost.v1.Middleware/UpdateTopMost", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *middlewareClient) GetTopMost(ctx context.Context, in *GetTopMostRequest, opts ...grpc.CallOption) (*GetTopMostResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/good.middleware.app.good1.topmost.v1.Middleware/GetTopMost", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *middlewareClient) GetTopMosts(ctx context.Context, in *GetTopMostsRequest, opts ...grpc.CallOption) (*GetTopMostsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/good.middleware.app.good1.topmost.v1.Middleware/GetTopMosts", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *middlewareClient) ExistTopMostConds(ctx context.Context, in *ExistTopMostCondsRequest, opts ...grpc.CallOption) (*ExistTopMostCondsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/good.middleware.app.good1.topmost.v1.Middleware/ExistTopMostConds", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *middlewareClient) DeleteTopMost(ctx context.Context, in *DeleteTopMostRequest, opts ...grpc.CallOption) (*DeleteTopMostResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/good.middleware.app.good1.topmost.v1.Middleware/DeleteTopMost", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Middleware_CreateTopMost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/good.middleware.app.good1.topmost.v1.Middleware/CreateTopMost",
	}
...
func _Middleware_UpdateTopMost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/good.middleware.app.good1.topmost.v1.Middleware/UpdateTopMost",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Middleware_GetTopMost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/good.middleware.app.good1.topmost.v1.Middleware/GetTopMost",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Middleware_GetTopMosts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/good.middleware.app.good1.topmost.v1.Middleware/GetTopMosts",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Middleware_ExistTopMostConds_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/good.middleware.app.good1.topmost.v1.Middleware/ExistTopMostConds",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Middleware_DeleteTopMost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/good.middleware.app.good1.topmost.v1.Middleware/DeleteTopMost",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
