...
const (
	Middleware_CreatePoster_FullMethodName     = "/good.middleware.device.poster.v1.Middleware/CreatePoster"
	Middleware_UpdatePoster_FullMethodName     = "/good.middleware.device.poster.v1.Middleware/UpdatePoster"
	Middleware_GetPoster_FullMethodName        = "/good.middleware.device.poster.v1.Middleware/GetPoster"
	Middleware_GetPosters_FullMethodName       = "/good.middleware.device.poster.v1.Middleware/GetPosters"
	Middleware_ExistPosterConds_FullMethodName = "/good.middleware.device.poster.v1.Middleware/ExistPosterConds"
	Middleware_DeletePoster_FullMethodName     = "/good.middleware.device.poster.v1.Middleware/DeletePoster"
)
