...
func (c *middlewareClient) CreateDeviceType(ctx context.Context, in *CreateDeviceTypeRequest, opts ...grpc.CallOption) (*CreateDeviceTypeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/good.middleware.device.v1.Middleware/CreateDeviceType", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *middlewareClient) UpdateDeviceType(ctx context.Context, in *UpdateDeviceTypeRequest, opts ...grpc.CallOption) (*UpdateDeviceTypeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/good.middleware.device.v1.Middleware/UpdateDeviceType", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *middlewareClient) GetDeviceType(ctx context.Context, in *GetDeviceTypeRequest, opts ...grpc.CallOption) (*GetDeviceTypeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/good.middleware.device.v1.Middleware/GetDeviceType", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *middlewareClient) GetDeviceTypes(ctx context.Context, in *GetDeviceTypesRequest, opts ...grpc.CallOption) (*GetDeviceTypesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/good.middleware.device.v1.Middleware/GetDeviceTypes", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *middlewareClient) ExistDeviceTypeConds(ctx context.Context, in *ExistDeviceTypeCondsRequest, opts ...grpc.CallOption) (*ExistDeviceTypeCondsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/good.middleware.device.v1.Middleware/ExistDeviceTypeConds", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *middlewareClient) DeleteDeviceType(ctx context.Context, in *DeleteDeviceTypeRequest, opts ...grpc.CallOption) (*DeleteDeviceTypeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/good.middleware.device.v1.Middleware/DeleteDeviceType", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Middleware_CreateDeviceType_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/good.middleware.device.v1.Middleware/CreateDeviceType",
	}
...
func _Middleware_UpdateDeviceType_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/good.middleware.device.v1.Middleware/UpdateDeviceType",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Middleware_GetDeviceType_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/good.middleware.device.v1.Middleware/GetDeviceType",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Middleware_GetDeviceTypes_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/good.middleware.device.v1.Middleware/GetDeviceTypes",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Middleware_ExistDeviceTypeConds_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/good.middleware.device.v1.Middleware/ExistDeviceTypeConds",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Middleware_DeleteDeviceType_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/good.middleware.device.v1.Middleware/DeleteDeviceType",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
