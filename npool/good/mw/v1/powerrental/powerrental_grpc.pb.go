...
func (c *middlewareClient) CreatePowerRental(ctx context.Context, in *CreatePowerRentalRequest, opts ...grpc.CallOption) (*CreatePowerRentalResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/good.middleware.powerrental.v1.Middleware/CreatePowerRental", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *middlewareClient) UpdatePowerRental(ctx context.Context, in *UpdatePowerRentalRequest, opts ...grpc.CallOption) (*UpdatePowerRentalResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/good.middleware.powerrental.v1.Middleware/UpdatePowerRental", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *middlewareClient) GetPowerRental(ctx context.Context, in *GetPowerRentalRequest, opts ...grpc.CallOption) (*GetPowerRentalResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/good.middleware.powerrental.v1.Middleware/GetPowerRental", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *middlewareClient) GetPowerRentals(ctx context.Context, in *GetPowerRentalsRequest, opts ...grpc.CallOption) (*GetPowerRentalsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/good.middleware.powerrental.v1.Middleware/GetPowerRentals", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *middlewareClient) ExistPowerRentalConds(ctx context.Context, in *ExistPowerRentalCondsRequest, opts ...grpc.CallOption) (*ExistPowerRentalCondsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/good.middleware.powerrental.v1.Middleware/ExistPowerRentalConds", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *middlewareClient) DeletePowerRental(ctx context.Context, in *DeletePowerRentalRequest, opts ...grpc.CallOption) (*DeletePowerRentalResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/good.middleware.powerrental.v1.Middleware/DeletePowerRental", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Middleware_CreatePowerRental_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/good.middleware.powerrental.v1.Middleware/CreatePowerRental",
	}
...
func _Middleware_UpdatePowerRental_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/good.middleware.powerrental.v1.Middleware/UpdatePowerRental",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Middleware_GetPowerRental_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/good.middleware.powerrental.v1.Middleware/GetPowerRental",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Middleware_GetPowerRentals_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/good.middleware.powerrental.v1.Middleware/GetPowerRentals",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Middleware_ExistPowerRentalConds_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/good.middleware.powerrental.v1.Middleware/ExistPowerRentalConds",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Middleware_DeletePowerRental_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/good.middleware.powerrental.v1.Middleware/DeletePowerRental",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
