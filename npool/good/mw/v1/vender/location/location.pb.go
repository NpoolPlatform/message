...
var file_npool_good_mw_v1_vender_location_location_proto_rawDesc = []byte{
	...
	0x64, 0x6c, 0x65, 0x77, 0x61, 0x72, 0x65, 0x2e, 0x76, 0x65, 0x6e, 0x64, 0x65, 0x72, 0x2e, 0x6c,
	...
	0x6c, 0x65, 0x77, 0x61, 0x72, 0x65, 0x2e, 0x76, 0x65, 0x6e, 0x64, 0x65, 0x72, 0x2e, 0x6c, 0x6f,
	...
	0x65, 0x72, 0x2e, 0x6c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x76, 0x31, 0x2e, 0x47,
...
var file_npool_good_mw_v1_vender_location_location_proto_goTypes = []interface{}{
	...
	(*ExistLocationCondsRequest)(nil),  // 11: good.middleware.vender.location.v1.ExistLocationCondsRequest
	(*ExistLocationCondsResponse)(nil), // 12: good.middleware.vender.location.v1.ExistLocationCondsResponse
	(*DeleteLocationRequest)(nil),      // 13: good.middleware.vender.location.v1.DeleteLocationRequest
	(*DeleteLocationResponse)(nil),     // 14: good.middleware.vender.location.v1.DeleteLocationResponse
...
var file_npool_good_mw_v1_vender_location_location_proto_depIdxs = []int32{
	15, // 0: good.middleware.vender.location.v1.Conds.ID:type_name -> basetypes.v1.Uint32Val
	16, // 1: good.middleware.vender.location.v1.Conds.EntID:type_name -> basetypes.v1.StringVal
	16, // 2: good.middleware.vender.location.v1.Conds.Country:type_name -> basetypes.v1.StringVal
	16, // 3: good.middleware.vender.location.v1.Conds.Province:type_name -> basetypes.v1.StringVal
	16, // 4: good.middleware.vender.location.v1.Conds.BrandID:type_name -> basetypes.v1.StringVal
	0,  // 5: good.middleware.vender.location.v1.CreateLocationRequest.Info:type_name -> good.middleware.vender.location.v1.LocationReq
	1,  // 6: good.middleware.vender.location.v1.CreateLocationResponse.Info:type_name -> good.middleware.vender.location.v1.Location
	0,  // 7: good.middleware.vender.location.v1.UpdateLocationRequest.Info:type_name -> good.middleware.vender.location.v1.LocationReq
	1,  // 8: good.middleware.vender.location.v1.UpdateLocationResponse.Info:type_name -> good.middleware.vender.location.v1.Location
	1,  // 9: good.middleware.vender.location.v1.GetLocationResponse.Info:type_name -> good.middleware.vender.location.v1.Location
	2,  // 10: good.middleware.vender.location.v1.GetLocationsRequest.Conds:type_name -> good.middleware.vender.location.v1.Conds
	1,  // 11: good.middleware.vender.location.v1.GetLocationsResponse.Infos:type_name -> good.middleware.vender.location.v1.Location
	2,  // 12: good.middleware.vender.location.v1.ExistLocationCondsRequest.Conds:type_name -> good.middleware.vender.location.v1.Conds
	0,  // 13: good.middleware.vender.location.v1.DeleteLocationRequest.Info:type_name -> good.middleware.vender.location.v1.LocationReq
	1,  // 14: good.middleware.vender.location.v1.DeleteLocationResponse.Info:type_name -> good.middleware.vender.location.v1.Location
	3,  // 15: good.middleware.vender.location.v1.Middleware.CreateLocation:input_type -> good.middleware.vender.location.v1.CreateLocationRequest
	5,  // 16: good.middleware.vender.location.v1.Middleware.UpdateLocation:input_type -> good.middleware.vender.location.v1.UpdateLocationRequest
	7,  // 17: good.middleware.vender.location.v1.Middleware.GetLocation:input_type -> good.middleware.vender.location.v1.GetLocationRequest
	9,  // 18: good.middleware.vender.location.v1.Middleware.GetLocations:input_type -> good.middleware.vender.location.v1.GetLocationsRequest
	11, // 19: good.middleware.vender.location.v1.Middleware.ExistLocationConds:input_type -> good.middleware.vender.location.v1.ExistLocationCondsRequest
	13, // 20: good.middleware.vender.location.v1.Middleware.DeleteLocation:input_type -> good.middleware.vender.location.v1.DeleteLocationRequest
	4,  // 21: good.middleware.vender.location.v1.Middleware.CreateLocation:output_type -> good.middleware.vender.location.v1.CreateLocationResponse
	6,  // 22: good.middleware.vender.location.v1.Middleware.UpdateLocation:output_type -> good.middleware.vender.location.v1.UpdateLocationResponse
	8,  // 23: good.middleware.vender.location.v1.Middleware.GetLocation:output_type -> good.middleware.vender.location.v1.GetLocationResponse
	10, // 24: good.middleware.vender.location.v1.Middleware.GetLocations:output_type -> good.middleware.vender.location.v1.GetLocationsResponse
	12, // 25: good.middleware.vender.location.v1.Middleware.ExistLocationConds:output_type -> good.middleware.vender.location.v1.ExistLocationCondsResponse
	14, // 26: good.middleware.vender.location.v1.Middleware.DeleteLocation:output_type -> good.middleware.vender.location.v1.DeleteLocationResponse
