...
var file_npool_good_mw_v1_vender_location_location_proto_depIdxs = []int32{
	...
	3,  // 13: good.middleware.vendor.location.v1.Middleware.CreateLocation:input_type -> good.middleware.vendor.location.v1.CreateLocationRequest
	5,  // 14: good.middleware.vendor.location.v1.Middleware.UpdateLocation:input_type -> good.middleware.vendor.location.v1.UpdateLocationRequest
	7,  // 15: good.middleware.vendor.location.v1.Middleware.GetLocation:input_type -> good.middleware.vendor.location.v1.GetLocationRequest
	9,  // 16: good.middleware.vendor.location.v1.Middleware.GetLocations:input_type -> good.middleware.vendor.location.v1.GetLocationsRequest
	11, // 17: good.middleware.vendor.location.v1.Middleware.DeleteLocation:input_type -> good.middleware.vendor.location.v1.DeleteLocationRequest
	4,  // 18: good.middleware.vendor.location.v1.Middleware.CreateLocation:output_type -> good.middleware.vendor.location.v1.CreateLocationResponse
	6,  // 19: good.middleware.vendor.location.v1.Middleware.UpdateLocation:output_type -> good.middleware.vendor.location.v1.UpdateLocationResponse
	8,  // 20: good.middleware.vendor.location.v1.Middleware.GetLocation:output_type -> good.middleware.vendor.location.v1.GetLocationResponse
	10, // 21: good.middleware.vendor.location.v1.Middleware.GetLocations:output_type -> good.middleware.vendor.location.v1.GetLocationsResponse
	12, // 22: good.middleware.vendor.location.v1.Middleware.DeleteLocation:output_type -> good.middleware.vendor.location.v1.DeleteLocationResponse
