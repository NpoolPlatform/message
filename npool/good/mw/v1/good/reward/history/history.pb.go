...
type History struct {
	...
	RewardDate string `protobuf:"bytes,40,opt,name=RewardDate,proto3" json:"RewardDate,omitempty" sql:"reward_date"`
	// @inject_tag: sql:"tid"
...
func (x *History) GetRewardDate() string {
	if x != nil {
		return x.RewardDate
	}
	return ""
...
var file_npool_good_mw_v1_good_reward_history_history_proto_rawDesc = []byte{
	...
	0x74, 0x65, 0x18, 0x28, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x52, 0x65, 0x77, 0x61, 0x72, 0x64,
