...
var file_npool_good_mw_v1_good_good_proto_rawDesc = []byte{
	...
	0x41, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0xdf, 0x04, 0x0a, 0x05, 0x43, 0x6f, 0x6e, 0x64, 0x73,
	...
	0x74, 0x61, 0x74, 0x65, 0x88, 0x01, 0x01, 0x42, 0x05, 0x0a, 0x03, 0x5f, 0x49, 0x44, 0x42, 0x0f,
	...
	0x61, 0x72, 0x64, 0x53, 0x74, 0x61, 0x74, 0x65, 0x22, 0x4a, 0x0a, 0x11, 0x43, 0x72, 0x65, 0x61,
	0x74, 0x65, 0x47, 0x6f, 0x6f, 0x64, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x35, 0x0a,
	...
	0x49, 0x6e, 0x66, 0x6f, 0x22, 0x48, 0x0a, 0x12, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x47, 0x6f,
...
var file_npool_good_mw_v1_good_good_proto_depIdxs = []int32{
	...
	0,  // 18: good.middleware.good1.v1.CreateGoodRequest.Info:type_name -> good.middleware.good1.v1.GoodReq
	1,  // 19: good.middleware.good1.v1.CreateGoodResponse.Info:type_name -> good.middleware.good1.v1.Good
	1,  // 20: good.middleware.good1.v1.GetGoodResponse.Info:type_name -> good.middleware.good1.v1.Good
	2,  // 21: good.middleware.good1.v1.GetGoodsRequest.Conds:type_name -> good.middleware.good1.v1.Conds
	1,  // 22: good.middleware.good1.v1.GetGoodsResponse.Infos:type_name -> good.middleware.good1.v1.Good
	0,  // 23: good.middleware.good1.v1.UpdateGoodRequest.Info:type_name -> good.middleware.good1.v1.GoodReq
	1,  // 24: good.middleware.good1.v1.UpdateGoodResponse.Info:type_name -> good.middleware.good1.v1.Good
	0,  // 25: good.middleware.good1.v1.DeleteGoodRequest.Info:type_name -> good.middleware.good1.v1.GoodReq
	1,  // 26: good.middleware.good1.v1.DeleteGoodResponse.Info:type_name -> good.middleware.good1.v1.Good
	3,  // 27: good.middleware.good1.v1.Middleware.CreateGood:input_type -> good.middleware.good1.v1.CreateGoodRequest
	5,  // 28: good.middleware.good1.v1.Middleware.GetGood:input_type -> good.middleware.good1.v1.GetGoodRequest
	7,  // 29: good.middleware.good1.v1.Middleware.GetGoods:input_type -> good.middleware.good1.v1.GetGoodsRequest
	9,  // 30: good.middleware.good1.v1.Middleware.UpdateGood:input_type -> good.middleware.good1.v1.UpdateGoodRequest
	11, // 31: good.middleware.good1.v1.Middleware.DeleteGood:input_type -> good.middleware.good1.v1.DeleteGoodRequest
	4,  // 32: good.middleware.good1.v1.Middleware.CreateGood:output_type -> good.middleware.good1.v1.CreateGoodResponse
	6,  // 33: good.middleware.good1.v1.Middleware.GetGood:output_type -> good.middleware.good1.v1.GetGoodResponse
	8,  // 34: good.middleware.good1.v1.Middleware.GetGoods:output_type -> good.middleware.good1.v1.GetGoodsResponse
	10, // 35: good.middleware.good1.v1.Middleware.UpdateGood:output_type -> good.middleware.good1.v1.UpdateGoodResponse
	12, // 36: good.middleware.good1.v1.Middleware.DeleteGood:output_type -> good.middleware.good1.v1.DeleteGoodResponse
