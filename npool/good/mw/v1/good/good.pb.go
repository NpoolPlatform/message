...
type Good struct {
	...
	StateStr bool         `protobuf:"varint,150,opt,name=StateStr,proto3" json:"StateStr,omitempty" sql:"state"`
...
var file_npool_good_mw_v1_good_good_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0xad, 0x05, 0x0a, 0x04, 0x47, 0x6f, 0x6f, 0x64, 0x12, 0x0e, 0x0a, 0x02, 0x49, 0x44,
	...
	0x65, 0x12, 0x1b, 0x0a, 0x08, 0x53, 0x74, 0x61, 0x74, 0x65, 0x53, 0x74, 0x72, 0x18, 0x96, 0x01,
	0x20, 0x01, 0x28, 0x08, 0x52, 0x08, 0x53, 0x74, 0x61, 0x74, 0x65, 0x53, 0x74, 0x72, 0x12, 0x33,
	0x0a, 0x05, 0x53, 0x74, 0x61, 0x74, 0x65, 0x18, 0x97, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1c,
	...
	0x74, 0x22, 0x93, 0x03, 0x0a, 0x05, 0x43, 0x6f, 0x6e, 0x64, 0x73, 0x12, 0x2c, 0x0a, 0x02, 0x49,
	...
	0x48, 0x03, 0x52, 0x06, 0x45, 0x6e, 0x74, 0x49, 0x44, 0x73, 0x88, 0x01, 0x01, 0x12, 0x38, 0x0a,
	...
	0x44, 0x42, 0x09, 0x0a, 0x07, 0x5f, 0x45, 0x6e, 0x74, 0x49, 0x44, 0x73, 0x42, 0x0b, 0x0a, 0x09,
	0x5f, 0x47, 0x6f, 0x6f, 0x64, 0x54, 0x79, 0x70, 0x65, 0x42, 0x0c, 0x0a, 0x0a, 0x5f, 0x47, 0x6f,
	0x6f, 0x64, 0x54, 0x79, 0x70, 0x65, 0x73, 0x22, 0x26, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x47, 0x6f,
...
var file_npool_good_mw_v1_good_good_proto_depIdxs = []int32{
	...
	11, // 3: good.middleware.good1.v1.Good.State:type_name -> basetypes.good.v1.GoodState
	12, // 4: good.middleware.good1.v1.Conds.ID:type_name -> basetypes.v1.Uint32Val
	13, // 5: good.middleware.good1.v1.Conds.IDs:type_name -> basetypes.v1.Uint32SliceVal
	14, // 6: good.middleware.good1.v1.Conds.EntID:type_name -> basetypes.v1.StringVal
	15, // 7: good.middleware.good1.v1.Conds.EntIDs:type_name -> basetypes.v1.StringSliceVal
	12, // 8: good.middleware.good1.v1.Conds.GoodType:type_name -> basetypes.v1.Uint32Val
	13, // 9: good.middleware.good1.v1.Conds.GoodTypes:type_name -> basetypes.v1.Uint32SliceVal
	0,  // 10: good.middleware.good1.v1.GetGoodResponse.Info:type_name -> good.middleware.good1.v1.Good
	1,  // 11: good.middleware.good1.v1.GetGoodsRequest.Conds:type_name -> good.middleware.good1.v1.Conds
	0,  // 12: good.middleware.good1.v1.GetGoodsResponse.Infos:type_name -> good.middleware.good1.v1.Good
	1,  // 13: good.middleware.good1.v1.ExistGoodCondsRequest.Conds:type_name -> good.middleware.good1.v1.Conds
	2,  // 14: good.middleware.good1.v1.Middleware.GetGood:input_type -> good.middleware.good1.v1.GetGoodRequest
	4,  // 15: good.middleware.good1.v1.Middleware.GetGoods:input_type -> good.middleware.good1.v1.GetGoodsRequest
	6,  // 16: good.middleware.good1.v1.Middleware.ExistGoodConds:input_type -> good.middleware.good1.v1.ExistGoodCondsRequest
	3,  // 17: good.middleware.good1.v1.Middleware.GetGood:output_type -> good.middleware.good1.v1.GetGoodResponse
	5,  // 18: good.middleware.good1.v1.Middleware.GetGoods:output_type -> good.middleware.good1.v1.GetGoodsResponse
	7,  // 19: good.middleware.good1.v1.Middleware.ExistGoodConds:output_type -> good.middleware.good1.v1.ExistGoodCondsResponse
