...
var file_npool_good_mw_v1_appgood_appgood_proto_rawDesc = []byte{
	...
	0x64, 0x65, 0x78, 0x22, 0x20, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x47, 0x6f, 0x6f, 0x64, 0x52, 0x65,
	...
	0x6f, 0x32, 0xca, 0x02, 0x0a, 0x0a, 0x4d, 0x69, 0x64, 0x64, 0x6c, 0x65, 0x77, 0x61, 0x72, 0x65,
	0x12, 0x64, 0x0a, 0x07, 0x47, 0x65, 0x74, 0x47, 0x6f, 0x6f, 0x64, 0x12, 0x2a, 0x2e, 0x67, 0x6f,
	...
	0x69, 0x64, 0x64, 0x6c, 0x65, 0x77, 0x61, 0x72, 0x65, 0x2e, 0x61, 0x70, 0x70, 0x67, 0x6f, 0x6f,
	0x64, 0x2e, 0x76, 0x31, 0x2e, 0x47, 0x65, 0x74, 0x47, 0x6f, 0x6f, 0x64, 0x52, 0x65, 0x73, 0x70,
...
var file_npool_good_mw_v1_appgood_appgood_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_npool_good_mw_v1_appgood_appgood_proto_goTypes = []interface{}{
	(*Good)(nil),               // 0: good.middleware.appgood.v1.Good
	(*GetGoodRequest)(nil),     // 1: good.middleware.appgood.v1.GetGoodRequest
	(*GetGoodResponse)(nil),    // 2: good.middleware.appgood.v1.GetGoodResponse
	(*GetGoodsRequest)(nil),    // 3: good.middleware.appgood.v1.GetGoodsRequest
	(*GetGoodsResponse)(nil),   // 4: good.middleware.appgood.v1.GetGoodsResponse
	(*UpdateGoodRequest)(nil),  // 5: good.middleware.appgood.v1.UpdateGoodRequest
	(*UpdateGoodResponse)(nil), // 6: good.middleware.appgood.v1.UpdateGoodResponse
	(good.GoodType)(0),         // 7: good.manager.good.v1.GoodType
	(good.BenefitType)(0),      // 8: good.manager.good.v1.BenefitType
	(*appgood.Conds)(nil),      // 9: good.manager.appgood.v1.Conds
...
var file_npool_good_mw_v1_appgood_appgood_proto_depIdxs = []int32{
	7,  // 0: good.middleware.appgood.v1.Good.GoodType:type_name -> good.manager.good.v1.GoodType
	8,  // 1: good.middleware.appgood.v1.Good.BenefitType:type_name -> good.manager.good.v1.BenefitType
	0,  // 2: good.middleware.appgood.v1.GetGoodResponse.Info:type_name -> good.middleware.appgood.v1.Good
	9,  // 3: good.middleware.appgood.v1.GetGoodsRequest.Conds:type_name -> good.manager.appgood.v1.Conds
	0,  // 4: good.middleware.appgood.v1.GetGoodsResponse.Infos:type_name -> good.middleware.appgood.v1.Good
	10, // 5: good.middleware.appgood.v1.UpdateGoodRequest.Info:type_name -> good.manager.appgood.v1.AppGoodReq
	0,  // 6: good.middleware.appgood.v1.UpdateGoodResponse.Info:type_name -> good.middleware.appgood.v1.Good
	1,  // 7: good.middleware.appgood.v1.Middleware.GetGood:input_type -> good.middleware.appgood.v1.GetGoodRequest
	3,  // 8: good.middleware.appgood.v1.Middleware.GetGoods:input_type -> good.middleware.appgood.v1.GetGoodsRequest
	5,  // 9: good.middleware.appgood.v1.Middleware.UpdateGood:input_type -> good.middleware.appgood.v1.UpdateGoodRequest
	2,  // 10: good.middleware.appgood.v1.Middleware.GetGood:output_type -> good.middleware.appgood.v1.GetGoodResponse
	4,  // 11: good.middleware.appgood.v1.Middleware.GetGoods:output_type -> good.middleware.appgood.v1.GetGoodsResponse
	6,  // 12: good.middleware.appgood.v1.Middleware.UpdateGood:output_type -> good.middleware.appgood.v1.UpdateGoodResponse
