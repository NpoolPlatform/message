...
var file_npool_good_mgr_v1_subgood_subgood_proto_rawDesc = []byte{
	...
	0x0d, 0x52, 0x09, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x64, 0x41, 0x74, 0x22, 0xd2, 0x01, 0x0a,
	...
	0x6e, 0x47, 0x6f, 0x6f, 0x64, 0x49, 0x44, 0x73, 0x88, 0x01, 0x01, 0x42, 0x05, 0x0a, 0x03, 0x5f,
	...
	0x73, 0x22, 0x4f, 0x0a, 0x14, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x53, 0x75, 0x62, 0x47, 0x6f,
...
var file_npool_good_mgr_v1_subgood_subgood_proto_depIdxs = []int32{
	...
	0,  // 3: good.manager.subgood.v1.CreateSubGoodRequest.Info:type_name -> good.manager.subgood.v1.SubGoodReq
	1,  // 4: good.manager.subgood.v1.CreateSubGoodResponse.Info:type_name -> good.manager.subgood.v1.SubGood
	0,  // 5: good.manager.subgood.v1.CreateSubGoodsRequest.Infos:type_name -> good.manager.subgood.v1.SubGoodReq
	1,  // 6: good.manager.subgood.v1.CreateSubGoodsResponse.Infos:type_name -> good.manager.subgood.v1.SubGood
	0,  // 7: good.manager.subgood.v1.UpdateSubGoodRequest.Info:type_name -> good.manager.subgood.v1.SubGoodReq
	1,  // 8: good.manager.subgood.v1.UpdateSubGoodResponse.Info:type_name -> good.manager.subgood.v1.SubGood
	1,  // 9: good.manager.subgood.v1.GetSubGoodResponse.Info:type_name -> good.manager.subgood.v1.SubGood
	2,  // 10: good.manager.subgood.v1.GetSubGoodsRequest.Conds:type_name -> good.manager.subgood.v1.Conds
	1,  // 11: good.manager.subgood.v1.GetSubGoodsResponse.Infos:type_name -> good.manager.subgood.v1.SubGood
	2,  // 12: good.manager.subgood.v1.GetSubGoodOnlyRequest.Conds:type_name -> good.manager.subgood.v1.Conds
	1,  // 13: good.manager.subgood.v1.GetSubGoodOnlyResponse.Info:type_name -> good.manager.subgood.v1.SubGood
	2,  // 14: good.manager.subgood.v1.ExistSubGoodCondsRequest.Conds:type_name -> good.manager.subgood.v1.Conds
	2,  // 15: good.manager.subgood.v1.CountSubGoodsRequest.Conds:type_name -> good.manager.subgood.v1.Conds
	1,  // 16: good.manager.subgood.v1.DeleteSubGoodResponse.Info:type_name -> good.manager.subgood.v1.SubGood
	3,  // 17: good.manager.subgood.v1.Manager.CreateSubGood:input_type -> good.manager.subgood.v1.CreateSubGoodRequest
	5,  // 18: good.manager.subgood.v1.Manager.CreateSubGoods:input_type -> good.manager.subgood.v1.CreateSubGoodsRequest
	7,  // 19: good.manager.subgood.v1.Manager.UpdateSubGood:input_type -> good.manager.subgood.v1.UpdateSubGoodRequest
	9,  // 20: good.manager.subgood.v1.Manager.GetSubGood:input_type -> good.manager.subgood.v1.GetSubGoodRequest
	13, // 21: good.manager.subgood.v1.Manager.GetSubGoodOnly:input_type -> good.manager.subgood.v1.GetSubGoodOnlyRequest
	11, // 22: good.manager.subgood.v1.Manager.GetSubGoods:input_type -> good.manager.subgood.v1.GetSubGoodsRequest
	15, // 23: good.manager.subgood.v1.Manager.ExistSubGood:input_type -> good.manager.subgood.v1.ExistSubGoodRequest
	17, // 24: good.manager.subgood.v1.Manager.ExistSubGoodConds:input_type -> good.manager.subgood.v1.ExistSubGoodCondsRequest
	19, // 25: good.manager.subgood.v1.Manager.CountSubGoods:input_type -> good.manager.subgood.v1.CountSubGoodsRequest
	21, // 26: good.manager.subgood.v1.Manager.DeleteSubGood:input_type -> good.manager.subgood.v1.DeleteSubGoodRequest
	4,  // 27: good.manager.subgood.v1.Manager.CreateSubGood:output_type -> good.manager.subgood.v1.CreateSubGoodResponse
	6,  // 28: good.manager.subgood.v1.Manager.CreateSubGoods:output_type -> good.manager.subgood.v1.CreateSubGoodsResponse
	8,  // 29: good.manager.subgood.v1.Manager.UpdateSubGood:output_type -> good.manager.subgood.v1.UpdateSubGoodResponse
	10, // 30: good.manager.subgood.v1.Manager.GetSubGood:output_type -> good.manager.subgood.v1.GetSubGoodResponse
	14, // 31: good.manager.subgood.v1.Manager.GetSubGoodOnly:output_type -> good.manager.subgood.v1.GetSubGoodOnlyResponse
	12, // 32: good.manager.subgood.v1.Manager.GetSubGoods:output_type -> good.manager.subgood.v1.GetSubGoodsResponse
	16, // 33: good.manager.subgood.v1.Manager.ExistSubGood:output_type -> good.manager.subgood.v1.ExistSubGoodResponse
	18, // 34: good.manager.subgood.v1.Manager.ExistSubGoodConds:output_type -> good.manager.subgood.v1.ExistSubGoodCondsResponse
	20, // 35: good.manager.subgood.v1.Manager.CountSubGoods:output_type -> good.manager.subgood.v1.CountSubGoodsResponse
	22, // 36: good.manager.subgood.v1.Manager.DeleteSubGood:output_type -> good.manager.subgood.v1.DeleteSubGoodResponse
