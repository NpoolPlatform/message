...
const (
	Manager_CreateDeviceInfo_FullMethodName     = "/good.manager.deviceinfo.v1.Manager/CreateDeviceInfo"
	Manager_CreateDeviceInfos_FullMethodName    = "/good.manager.deviceinfo.v1.Manager/CreateDeviceInfos"
	Manager_UpdateDeviceInfo_FullMethodName     = "/good.manager.deviceinfo.v1.Manager/UpdateDeviceInfo"
	Manager_GetDeviceInfo_FullMethodName        = "/good.manager.deviceinfo.v1.Manager/GetDeviceInfo"
	Manager_GetDeviceInfoOnly_FullMethodName    = "/good.manager.deviceinfo.v1.Manager/GetDeviceInfoOnly"
	Manager_GetDeviceInfos_FullMethodName       = "/good.manager.deviceinfo.v1.Manager/GetDeviceInfos"
	Manager_ExistDeviceInfo_FullMethodName      = "/good.manager.deviceinfo.v1.Manager/ExistDeviceInfo"
	Manager_ExistDeviceInfoConds_FullMethodName = "/good.manager.deviceinfo.v1.Manager/ExistDeviceInfoConds"
	Manager_CountDeviceInfos_FullMethodName     = "/good.manager.deviceinfo.v1.Manager/CountDeviceInfos"
	Manager_DeleteDeviceInfo_FullMethodName     = "/good.manager.deviceinfo.v1.Manager/DeleteDeviceInfo"
)
...
func (c *managerClient) CreateDeviceInfos(ctx context.Context, in *CreateDeviceInfosRequest, opts ...grpc.CallOption) (*CreateDeviceInfosResponse, error) {
	...
	err := c.cc.Invoke(ctx, Manager_CreateDeviceInfos_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *managerClient) GetDeviceInfoOnly(ctx context.Context, in *GetDeviceInfoOnlyRequest, opts ...grpc.CallOption) (*GetDeviceInfoOnlyResponse, error) {
	...
	err := c.cc.Invoke(ctx, Manager_GetDeviceInfoOnly_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *managerClient) ExistDeviceInfo(ctx context.Context, in *ExistDeviceInfoRequest, opts ...grpc.CallOption) (*ExistDeviceInfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, Manager_ExistDeviceInfo_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *managerClient) ExistDeviceInfoConds(ctx context.Context, in *ExistDeviceInfoCondsRequest, opts ...grpc.CallOption) (*ExistDeviceInfoCondsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Manager_ExistDeviceInfoConds_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *managerClient) CountDeviceInfos(ctx context.Context, in *CountDeviceInfosRequest, opts ...grpc.CallOption) (*CountDeviceInfosResponse, error) {
	...
	err := c.cc.Invoke(ctx, Manager_CountDeviceInfos_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Manager_CreateDeviceInfos_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Manager_CreateDeviceInfos_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Manager_GetDeviceInfoOnly_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Manager_GetDeviceInfoOnly_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Manager_ExistDeviceInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Manager_ExistDeviceInfo_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Manager_ExistDeviceInfoConds_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Manager_ExistDeviceInfoConds_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Manager_CountDeviceInfos_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Manager_CountDeviceInfos_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
