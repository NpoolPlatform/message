...
var file_npool_good_mgr_v1_appgood_appgood_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0xe6, 0x07, 0x0a, 0x0a, 0x41, 0x70, 0x70, 0x47, 0x6f, 0x6f, 0x64,
	...
	0x65, 0x74, 0x74, 0x6c, 0x65, 0x54, 0x79, 0x70, 0x65, 0x88, 0x01, 0x01, 0x42, 0x05, 0x0a, 0x03,
	...
	0x69, 0x6f, 0x6e, 0x53, 0x65, 0x74, 0x74, 0x6c, 0x65, 0x54, 0x79, 0x70, 0x65, 0x22, 0xda, 0x05,
	...
	0x77, 0x61, 0x72, 0x64, 0x41, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x5e, 0x0a, 0x14, 0x43, 0x6f,
	0x6d, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x53, 0x65, 0x74, 0x74, 0x6c, 0x65, 0x54, 0x79,
	0x70, 0x65, 0x18, 0xc8, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x29, 0x2e, 0x69, 0x6e, 0x73, 0x70,
	...
	0x53, 0x65, 0x74, 0x74, 0x6c, 0x65, 0x54, 0x79, 0x70, 0x65, 0x22, 0xf4, 0x01, 0x0a, 0x05, 0x43,
...
var file_npool_good_mgr_v1_appgood_appgood_proto_depIdxs = []int32{
	...
	0,  // 6: good.manager.appgood.v1.CreateAppGoodRequest.Info:type_name -> good.manager.appgood.v1.AppGoodReq
	1,  // 7: good.manager.appgood.v1.CreateAppGoodResponse.Info:type_name -> good.manager.appgood.v1.AppGood
	0,  // 8: good.manager.appgood.v1.CreateAppGoodsRequest.Infos:type_name -> good.manager.appgood.v1.AppGoodReq
	1,  // 9: good.manager.appgood.v1.CreateAppGoodsResponse.Infos:type_name -> good.manager.appgood.v1.AppGood
	0,  // 10: good.manager.appgood.v1.UpdateAppGoodRequest.Info:type_name -> good.manager.appgood.v1.AppGoodReq
	1,  // 11: good.manager.appgood.v1.UpdateAppGoodResponse.Info:type_name -> good.manager.appgood.v1.AppGood
	1,  // 12: good.manager.appgood.v1.GetAppGoodResponse.Info:type_name -> good.manager.appgood.v1.AppGood
	2,  // 13: good.manager.appgood.v1.GetAppGoodsRequest.Conds:type_name -> good.manager.appgood.v1.Conds
	1,  // 14: good.manager.appgood.v1.GetAppGoodsResponse.Infos:type_name -> good.manager.appgood.v1.AppGood
	2,  // 15: good.manager.appgood.v1.GetAppGoodOnlyRequest.Conds:type_name -> good.manager.appgood.v1.Conds
	1,  // 16: good.manager.appgood.v1.GetAppGoodOnlyResponse.Info:type_name -> good.manager.appgood.v1.AppGood
	2,  // 17: good.manager.appgood.v1.ExistAppGoodCondsRequest.Conds:type_name -> good.manager.appgood.v1.Conds
	2,  // 18: good.manager.appgood.v1.CountAppGoodsRequest.Conds:type_name -> good.manager.appgood.v1.Conds
	1,  // 19: good.manager.appgood.v1.DeleteAppGoodResponse.Info:type_name -> good.manager.appgood.v1.AppGood
	3,  // 20: good.manager.appgood.v1.Manager.CreateAppGood:input_type -> good.manager.appgood.v1.CreateAppGoodRequest
	5,  // 21: good.manager.appgood.v1.Manager.CreateAppGoods:input_type -> good.manager.appgood.v1.CreateAppGoodsRequest
	7,  // 22: good.manager.appgood.v1.Manager.UpdateAppGood:input_type -> good.manager.appgood.v1.UpdateAppGoodRequest
	9,  // 23: good.manager.appgood.v1.Manager.GetAppGood:input_type -> good.manager.appgood.v1.GetAppGoodRequest
	13, // 24: good.manager.appgood.v1.Manager.GetAppGoodOnly:input_type -> good.manager.appgood.v1.GetAppGoodOnlyRequest
	11, // 25: good.manager.appgood.v1.Manager.GetAppGoods:input_type -> good.manager.appgood.v1.GetAppGoodsRequest
	15, // 26: good.manager.appgood.v1.Manager.ExistAppGood:input_type -> good.manager.appgood.v1.ExistAppGoodRequest
	17, // 27: good.manager.appgood.v1.Manager.ExistAppGoodConds:input_type -> good.manager.appgood.v1.ExistAppGoodCondsRequest
	19, // 28: good.manager.appgood.v1.Manager.CountAppGoods:input_type -> good.manager.appgood.v1.CountAppGoodsRequest
	21, // 29: good.manager.appgood.v1.Manager.DeleteAppGood:input_type -> good.manager.appgood.v1.DeleteAppGoodRequest
	4,  // 30: good.manager.appgood.v1.Manager.CreateAppGood:output_type -> good.manager.appgood.v1.CreateAppGoodResponse
	6,  // 31: good.manager.appgood.v1.Manager.CreateAppGoods:output_type -> good.manager.appgood.v1.CreateAppGoodsResponse
	8,  // 32: good.manager.appgood.v1.Manager.UpdateAppGood:output_type -> good.manager.appgood.v1.UpdateAppGoodResponse
	10, // 33: good.manager.appgood.v1.Manager.GetAppGood:output_type -> good.manager.appgood.v1.GetAppGoodResponse
	14, // 34: good.manager.appgood.v1.Manager.GetAppGoodOnly:output_type -> good.manager.appgood.v1.GetAppGoodOnlyResponse
	12, // 35: good.manager.appgood.v1.Manager.GetAppGoods:output_type -> good.manager.appgood.v1.GetAppGoodsResponse
	16, // 36: good.manager.appgood.v1.Manager.ExistAppGood:output_type -> good.manager.appgood.v1.ExistAppGoodResponse
	18, // 37: good.manager.appgood.v1.Manager.ExistAppGoodConds:output_type -> good.manager.appgood.v1.ExistAppGoodCondsResponse
	20, // 38: good.manager.appgood.v1.Manager.CountAppGoods:output_type -> good.manager.appgood.v1.CountAppGoodsResponse
	22, // 39: good.manager.appgood.v1.Manager.DeleteAppGood:output_type -> good.manager.appgood.v1.DeleteAppGoodResponse
