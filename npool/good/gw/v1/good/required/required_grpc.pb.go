...
const (
	Gateway_AdminCreateRequired_FullMethodName = "/good.gateway.good1.required1.v1.Gateway/AdminCreateRequired"
	Gateway_AdminUpdateRequired_FullMethodName = "/good.gateway.good1.required1.v1.Gateway/AdminUpdateRequired"
	Gateway_GetRequireds_FullMethodName        = "/good.gateway.good1.required1.v1.Gateway/GetRequireds"
	Gateway_AdminDeleteRequired_FullMethodName = "/good.gateway.good1.required1.v1.Gateway/AdminDeleteRequired"
)
