...
type AdminCreateGoodCoinRequest struct {
	...
	Index      *bool  `protobuf:"varint,40,opt,name=Index,proto3,oneof" json:"Index,omitempty"`
}
...
func (x *AdminCreateGoodCoinRequest) GetIndex() bool {
...
func (x *AdminUpdateGoodCoinRequest) GetIndex() bool {
	if x != nil && x.Index != nil {
		return *x.Index
	}
	return false
...
var file_npool_good_gw_v1_good_coin_coin_proto_rawDesc = []byte{
	...
	0x78, 0x18, 0x28, 0x20, 0x01, 0x28, 0x08, 0x48, 0x01, 0x52, 0x05, 0x49, 0x6e, 0x64, 0x65, 0x78,
	...
	0x12, 0x19, 0x0a, 0x05, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x18, 0x28, 0x20, 0x01, 0x28, 0x08, 0x48,
