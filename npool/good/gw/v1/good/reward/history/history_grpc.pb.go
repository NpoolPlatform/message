...
const (
	Gateway_GetHistories_FullMethodName = "/good.middleware.good1.reward.history.v1.Gateway/GetHistories"
)
...
var Gateway_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "good.middleware.good1.reward.history.v1.Gateway",
