...
const (
	Gateway_CreateRecommend_FullMethodName    = "/good.gateway.recommend.v1.Gateway/CreateRecommend"
	Gateway_CreateAppRecommend_FullMethodName = "/good.gateway.recommend.v1.Gateway/CreateAppRecommend"
	Gateway_UpdateRecommend_FullMethodName    = "/good.gateway.recommend.v1.Gateway/UpdateRecommend"
	Gateway_UpdateAppRecommend_FullMethodName = "/good.gateway.recommend.v1.Gateway/UpdateAppRecommend"
	Gateway_GetRecommends_FullMethodName      = "/good.gateway.recommend.v1.Gateway/GetRecommends"
	Gateway_GetAppRecommends_FullMethodName   = "/good.gateway.recommend.v1.Gateway/GetAppRecommends"
	Gateway_DeleteRecommend_FullMethodName    = "/good.gateway.recommend.v1.Gateway/DeleteRecommend"
)
...
func (c *gatewayClient) CreateAppRecommend(ctx context.Context, in *CreateAppRecommendRequest, opts ...grpc.CallOption) (*CreateAppRecommendResponse, error) {
	...
	err := c.cc.Invoke(ctx, Gateway_CreateAppRecommend_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gatewayClient) UpdateAppRecommend(ctx context.Context, in *UpdateAppRecommendRequest, opts ...grpc.CallOption) (*UpdateAppRecommendResponse, error) {
	...
	err := c.cc.Invoke(ctx, Gateway_UpdateAppRecommend_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gatewayClient) GetAppRecommends(ctx context.Context, in *GetAppRecommendsRequest, opts ...grpc.CallOption) (*GetAppRecommendsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Gateway_GetAppRecommends_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Gateway_CreateAppRecommend_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Gateway_CreateAppRecommend_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Gateway_UpdateAppRecommend_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Gateway_UpdateAppRecommend_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Gateway_GetAppRecommends_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Gateway_GetAppRecommends_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
