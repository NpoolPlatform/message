...
const (
	Gateway_CreatePoster_FullMethodName      = "/good.gateway.app.good1.topmost.poster.v1.Gateway/CreatePoster"
	Gateway_UpdatePoster_FullMethodName      = "/good.gateway.app.good1.topmost.poster.v1.Gateway/UpdatePoster"
	Gateway_GetPosters_FullMethodName        = "/good.gateway.app.good1.topmost.poster.v1.Gateway/GetPosters"
	Gateway_DeletePoster_FullMethodName      = "/good.gateway.app.good1.topmost.poster.v1.Gateway/DeletePoster"
	Gateway_AdminCreatePoster_FullMethodName = "/good.gateway.app.good1.topmost.poster.v1.Gateway/AdminCreatePoster"
	Gateway_AdminUpdatePoster_FullMethodName = "/good.gateway.app.good1.topmost.poster.v1.Gateway/AdminUpdatePoster"
	Gateway_AdminGetPosters_FullMethodName   = "/good.gateway.app.good1.topmost.poster.v1.Gateway/AdminGetPosters"
	Gateway_AdminDeletePoster_FullMethodName = "/good.gateway.app.good1.topmost.poster.v1.Gateway/AdminDeletePoster"
)
