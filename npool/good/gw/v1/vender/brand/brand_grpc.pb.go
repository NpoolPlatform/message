...
func (c *gatewayClient) AdminCreateBrand(ctx context.Context, in *AdminCreateBrandRequest, opts ...grpc.CallOption) (*AdminCreateBrandResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/good.gateway.vendor.brand.v1.Gateway/AdminCreateBrand", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gatewayClient) AdminUpdateBrand(ctx context.Context, in *AdminUpdateBrandRequest, opts ...grpc.CallOption) (*AdminUpdateBrandResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/good.gateway.vendor.brand.v1.Gateway/AdminUpdateBrand", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gatewayClient) GetBrands(ctx context.Context, in *GetBrandsRequest, opts ...grpc.CallOption) (*GetBrandsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/good.gateway.vendor.brand.v1.Gateway/GetBrands", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gatewayClient) AdminDeleteBrand(ctx context.Context, in *AdminDeleteBrandRequest, opts ...grpc.CallOption) (*AdminDeleteBrandResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/good.gateway.vendor.brand.v1.Gateway/AdminDeleteBrand", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Gateway_AdminCreateBrand_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/good.gateway.vendor.brand.v1.Gateway/AdminCreateBrand",
	}
...
func _Gateway_AdminUpdateBrand_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/good.gateway.vendor.brand.v1.Gateway/AdminUpdateBrand",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Gateway_GetBrands_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/good.gateway.vendor.brand.v1.Gateway/GetBrands",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Gateway_AdminDeleteBrand_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/good.gateway.vendor.brand.v1.Gateway/AdminDeleteBrand",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
