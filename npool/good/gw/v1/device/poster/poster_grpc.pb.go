...
const (
	Gateway_AdminCreatePoster_FullMethodName = "/good.gateway.device.poster.v1.Gateway/AdminCreatePoster"
	Gateway_AdminUpdatePoster_FullMethodName = "/good.gateway.device.poster.v1.Gateway/AdminUpdatePoster"
	Gateway_GetPosters_FullMethodName        = "/good.gateway.device.poster.v1.Gateway/GetPosters"
	Gateway_AdminDeletePoster_FullMethodName = "/good.gateway.device.poster.v1.Gateway/AdminDeletePoster"
)
