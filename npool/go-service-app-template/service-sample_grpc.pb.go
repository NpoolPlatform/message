...
func (c *serviceExampleClient) Version(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*npool.VersionResponse, error) {
...
func (UnimplementedServiceExampleServer) Version(context.Context, *emptypb.Empty) (*npool.VersionResponse, error) {
...
var ServiceExample_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "npool/go-service-app-template/service-sample.proto",
}
